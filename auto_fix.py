...
# 1. Update proposal.md with all exact source, standard, depth, data, metric, and task tags
proposal_path = os.path.join(sub_dir, "proposal.md")

content = """# 《百年京张·智算双轴：AI原生基础设施与算力生态城市设计》
...
# 2. Fix source_type and geometry_role in all geometry/*.geojson files
...
print("Updated auto_fix with valid enums and metric format.")
