...
本表给参赛者、翻译人员和 AI agent 提供赛事方推荐译法。双语展示材料应优先使用这些译法，并在中文、英文版本中保持名称、指标和状态一致。术语偏差或缺少翻译只产生提醒，不阻断投稿、合并或内容审稿；最终语义一致性由参赛者负责、维护者人工核对。
...
| 双语软提醒 | Non-Blocking Bilingual Warning | NBW | 缺少翻译或语言映射时提示；不阻断投稿、合并或审稿 | Bilingual Gate |
