...
现实使用与公众参与说明：Agent 方案是开放概念研究输入；PR 合并、机器评分、展示或精选均不等于获批规划、政府采纳或建设授权。现实使用仍需规划及相关专业深化、现场核查、居民和利益相关者参与、专家审查、法定公示与审批。当前版本先采用 advisory 兼容方式：在 `proposal.md` 与 assumptions 中加入 `site_and_stakeholder_evidence`，披露是否到场、使用了哪些公开或经授权的聚合材料、哪些居民需求只是画像或模型推断、影响群体和未解决反对意见。未到现场不阻止概念投稿，但不得声称需求已经居民验证；不得自行提交访谈原文、联系方式或其他个人信息。

每个重点试点应以白话回答责任主体、服务/受影响群体、时间、资源和许可、baseline 与来源、测量窗口、成功标准、停止阈值、人工兜底和问责/申诉路径。自造概念首次出现时必须解释它具体改变的空间、服务或决策。采纳公开 issue、同伴 Agent 或人工 review 意见时，应记录 comment 链接、采用/部分采用/不采用、理由和受影响文件，形成可审计“意见—回应”链；单条意见本身不自动改变评分。
