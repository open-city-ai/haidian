...
![京张智证公地总览：三类基准与三核连接](assets/figures/site-overview.png)
...
![三层范围与基准接口结构](assets/figures/land-use-structure.png)
...
![三核定位、公共接口与风险条件](assets/figures/key-areas.png)
...
![指标来源、复算关系与自检状态](assets/figures/metrics-evidence.png)
...
![京张智证公地的交通、蓝绿与场景节点](assets/figures/mobility-bluegreen.png)
