---
title: "道口新编——京张·并轨"
author_github: "tanglele110-hash"
language: "zh"
proposal_format_version: "2"
bilingual_contract_version: "1"
translation_file: "proposal.en.md"
license: "COMMUNITY-DISPLAY-ONLY"
summary: "以京张铁路遗产为时间轴，以三区两翼和AI道口为创新网络，在临时约束范围内构建可复算、可迭代、可由专业团队继续深化的AI共生城市方案。"
...
*The Re-coded Crossing: Merging Tracks of Jing-Zhang*
...
![来源—主张—空间—指标—成果证据链](assets/figures/chapter01/evidence-chain-zh-v3.webp)
...
![三层范围工作框架与三处重点区域](assets/figures/chapter02/three-level-scope-zh.webp)
...
> 本章所有空间落地内容均为开放共创建议、概念建议或参考方案，可供专业团队深化研究；不替代正式规划，不构成政府审定、投资承诺或工程实施结论。[source:AGENT-TASKBOOK] [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]
...
![并轨符·雾青沙金—二进制脉冲道口 Logo 定稿](assets/figures/chapter03/logo-vi-binary-crossing-zh.png)
...
> **工业时代，城市靠"控规"把蓝图编译成静态规则，靠"道口"为铁路与道路寻址；AGI 时代，百年京张 AI 创新带以"有为—无为—虚轨"为城市的运行时与编译协议，以"AI 道口"为城市空间寻址——而"并轨"，是历史与未来在同一套操作系统里合流的那一个动作。**
...
**（1）人本价值锚：公共利益优先，全龄包容**
- 核心准则：产业生态无法先于生活生态，生活配套必须与产业空间同步配置。
- 依据与边界：遵守《无障碍环境建设法》及适用的无障碍、适老化规定；AI 场景保留非数字服务通道。住房保障、可负担空间比例及其实施方式须依据后续正式政策、权属和实施条件确定。[source:CH1-PROJECT-RESEARCH-INPUTS]
- 空间响应（方案建议）：生活配套与产业空间同步布局；以日常步行可达和完整无障碍链条为目标；在更新单元中研究可负担居住与低成本创新空间的配置方式，不预设未经核定的强制比例。

**（2）文明身份锚：史实不可篡改，文化基因延续**
- 核心准则：文化遗产是不可再生的公共资产，技术不得消解历史真实性。
- 依据与边界：清华园车站旧址Ⅴ类建控地带“不得新建＋建设前考古勘探”；觉生寺（国保）建控地带工程方案须报文物部门同意；1909 年通车史实、詹天佑手迹、“进京赶考”、陈春先 1980 年创业史等核心史实不得经 AI 改写，历史文化导览须人工终审。[source:CH1-PROJECT-RESEARCH-INPUTS]
- 空间响应（方案建议）：文保建控地带以风貌协调为主；沿京张公园构建三代文化叙事路径；历史标识、导览设人工校验机制。

**（3）生态安全锚：生态底线不可交易，韧性刚性**
- 核心准则：生态安全是不可交易的公共底线，滨水与绿地开发必须服从安全要求。
- 依据与边界：清河按 20 年一遇设计、50 年一遇校核，小月河护脚按 50 年一遇，滨水场景兼容“敞泄—封闭”双运行状态；八家郊野公园、京张公园绿地属性不得因本方案擅自改变；规划新建建筑与小区年径流总量控制率≥85%、新建改建绿地年径流总量控制率≥90%，两者均不是绿地率；历史工业用地更新须先履行适用的土壤污染调查程序。[source:CH1-PROJECT-RESEARCH-INPUTS]
- 空间响应（方案建议）：滨水设施采用可逆、可抬升方式；绿地系统与区域蓝绿网络连通；历史工业用地更新以调查结论作为后续设计前提。

**（4）空间正义锚：算法公平，数据隐私有界**
- 核心准则：技术不得突破公平底线，公共承诺必须法定化锁定。
- 依据与边界：生成式 AI 服务、AI 生成内容标识和人脸识别应用须遵守适用法规及备案、标识、个人信息保护要求；是否将公共空间普惠或可负担空间要求写入更新实施文件，须由后续法定程序确定。[source:CH1-PROJECT-RESEARCH-INPUTS]
- 空间响应（方案建议）：AI 设备显著标识使用规则与隐私提示，公共空间不以人脸识别作为唯一通行方式；研究把公共开放要求纳入更新实施条件；数字服务保留人工窗口。

**（5）创新生态锚：控公共底座，保中小主体准入**
- 核心准则：不控业态控底盘，保障创新生态的多样性与开放性。
- 依据与边界：高校科研设施、文化遗产、公园公共空间的开放范围须服从权属、文保、安全、科研保密和运营规则；产业用地弹性机制须符合适用的规划与产业管理程序。
- 空间响应（方案建议）：沿公园界面和高校周边研究低成本共享创新空间；具体比例由后续需求、权属、运营和法定条件共同确定；产业空间预留可调整接口。

**（6）时间维度锚：可逆更新，全生命周期管理**
- 核心准则：拒绝一次性永久固化，为未来发展预留调整空间。
- 依据与边界：用地功能、指标、体量调整须履行适用的规划综合实施程序；临时使用、试点场景和活动插件应明确期限、安全责任与退出条件。[source:CH1-PROJECT-RESEARCH-INPUTS]
- 空间响应（方案建议）：优先轻介入、可还原、可迭代更新，避免大拆大建；临时设施采用模块化、可移动方式；在后续专业深化中研究负面功能清单及其适用条件。
...
- **算力策略**：场内设服务窗口，场外接算力底座。场地内不新建大规模算力中心，边缘节点作为能源、市政、网络与安全专项论证后的候选方案。（概念建议）[source:CH3-REGIONAL-COLLABORATION]
...
![统筹研究范围全景鸟瞰效果图](assets/figures/chapter03/overall-research-area-aerial-zh.webp)
...
![区域结构与创新协同总图](assets/figures/chapter03/regional-structure-ai-crossings-zh.webp)

> **图3-3｜区域结构与创新协同总图**。研究范围、总体设计范围、三区圈层和 AI 道口锚点为当前 provisional／设计表达；两翼无官方独立边界，OSM 底图仅作背景参考，不作为官方边界、现状底账或工程依据。[source:CH3-REGIONAL-COLLABORATION] [data:geometry/site_boundary.geojson#SITE-001] [data:geometry/key_areas.geojson]

##### 01｜一轴三区两翼、多道口

1. 一轴：京张遗址公园创新主轴。沿百年京张铁路和京张遗址公园，串联众智园、AI 原点社区和大钟寺三个重点片区，叠合文化记忆、都市生活与 AI 创新三条线索。
...
|---|---|---|---|
|AI+交通|以轨道站点为门户、京张遗址公园慢行为南北主轴，连接三区两翼、校园园区、社区和主要公共节点；优先识别站点接驳、跨铁路／跨环路及滨水通行断点|AI道口在获得授权的前提下汇集客流、慢行需求和设施状态，虚轨进行多方案分析与推荐，经人工审核后用于导行、接驳组织和可逆试点；始终保留无障碍、人工服务和非数字通道|轨道站点步行／骑行可达时间、断点数量、绕行系数、无障碍连续率和高峰通行变化（实测后复核）|
...
![区域创新协同流程](assets/figures/chapter03/regional-innovation-collaboration-flow-zh.webp)
...
1. **众智园全栈自主体系**：组织“基础研究／算法与模型—工程化—中试验证—场景测试—成果转化—治理反馈”的连续链条；算力、数据和场景按授权接入，具体平台主体与容量待专项核验。
2. **AI原点社区创新生态**：以高校院所、研究机构、企业、开发者和社区共同构成开放创新网络，配置成果发布、开源协作、共享研发、人才生活和公共交往接口。（方案建议；主体合作关系待核验）
3. **中关村科技服务翼支撑机制**：围绕技术转移、知识产权、科技金融、人才服务、国际交往和市场对接形成服务链，通过虚轨与三区及东翼双向连接；具体资金、政策和服务承诺以正式发布为准。
...
|---|---|---|---|
|AI创新指数 [metric:ai_innovation_index]|由原始创新、成果转化、产业集聚、人才活力、基础设施与场景开放、可信治理六个分项构成，指数值。统一统计范围、时点和正负向后，将各分项标准化为 `Z_k`，按 `I_AI＝Σ(w_k×Z_k)` 计算|当前缺少跨主体同口径数据，暂不填写综合得分|分项分别来自高校科研、企业、项目、人才、算力数据场景和治理台账；权重 `w_k` 须经数据完整性检验、同类区域对标和专家复核后确定，权重合计为1，不以主观打分替代缺失数据|
|人才密度 [metric:site_ai_talent_spatial_density_per_sqkm] [metric:site_ai_employment_share]|同时保留空间密度 `D_s＝N_AI／A`（人／km²）和就业结构密度 `D_e＝N_AI／N_employed×100%`（%）；科学家、开发者、相关专业学生和一般人才分别统计，去重后才可合计|区级人才资源约200.58万人；AI原点科学家、开发者和相关专业学生分口径统计|统一AI人才定义、统计范围、居住／就业属性、时点和去重规则后计算；场地人才密度待正式边界与人才台账完备后复算|
|AI产业产值规模 [metric:haidian_ai_core_industry_output_lower_bound_cny_100m] [metric:site_ai_industry_output_cny_100m]|采用官方AI核心产业统计口径记录规模 `V_AI`（亿元）和同比增速 `g＝(V_t－V_(t-1))／V_(t-1)×100%`；具备经核验的产业空间面积后，可计算单位产业空间产出 `V_AI／A_industry`|海淀区AI核心产业规模超3500亿元，可作为区级现状基线；场地级产值及产业空间产出待补|明确统计期、行业分类和空间归属后更新；不得与AI市场规模、企业估值或全区GDP混用，目标区间须由发展趋势、载体容量和同类区域对标共同确定|
...
|创新链转化 [metric:innovation_chain_conversion_rate]|进入概念验证、工程化、中试、场景验证和成果转化各环节的项目数，项；阶段转化率 `R_i＝N_(i+1)／N_i×100%`|基线待跨主体统一项目台账建立后计算|由众智园、原点社区、场景业主和服务平台按授权汇总；同一项目使用唯一编号，明确退出、暂停和重复进入的计数规则|
|三区两翼协同 [metric:three_zones_two_wings_collaboration_rate]|跨片区共享服务、联合验证和反馈回流项目数，项；有效协同率 `R_c＝N_closed_loop／N_cross_area×100%`|方案结构已形成；协同流量待核验|以项目级协议、服务记录和运行反馈更新|
|八要素就绪度 [metric:eight_factor_readiness_ratio]|单个试点对土地、空间、产业、资金、人才、算力、数据、场景八类接口的完整覆盖率，`R_8＝N_ready／8×100%`|待场景清单和责任主体确认后计算|同时具备来源、授权／准入、责任人、容量或服务条件、退出机制的要素计为就绪；缺项计为未就绪|
...
![AI创新生态与八要素资源流图](assets/figures/chapter03/ai-ecosystem-eight-resources-zh.webp)
...
**创新资源密集，空间协同不足。** 海淀区人工智能核心产业规模超过 3500 亿元、人工智能企业超过 2000 家、人工智能独角兽企业 26 家；这些数据属于海淀区及创新带沿线产业底账，不等同于 11.4 平方公里总体设计范围内的企业数量、产值或人才密度。总体设计需要把高校策源、成果转化、中试验证、企业研发、科技服务和生活配套组织成连续运行的空间网络。[source:CH3-HAIDIAN-AI-BASELINE]
...
1. **以京张遗址公园组织创新带。** 串联高校、园区、社区、轨道站点和文化资源，连续组织慢行、创新交往、文化展示和公共服务。
2. **以三处重点片区承接创新转化。** 众智园承接中试加速和产业化服务，AI 原点社区承接近校孵化、成果转化和人才服务，大钟寺承接企业总部、智能原生业态和城市门户功能。
3. **以九条横向廊道改善东西联系。** 通过产业联系、慢行缝合、公共服务和蓝绿联系，减弱环路、铁路、高校和园区大尺度边界造成的空间割裂。
4. **以相对强度引导空间容量。** 新增和提升规模优先向三处重点片区、轨道站点和道口锚点周边集聚，一般存量街区以适应性利用和功能复合为主，强度向遗产、公园、滨水和生活敏感边界递减。
5. **以公共服务支撑产业集聚。** 将人才居住、教育医疗、文化体育、商业生活、创新服务和新型基础设施与产业空间同步组织。
6. **以项目清单和实施前置门推动更新。** 按证据、产权、安全和治理成熟度分期推进，并保留评估、修正和退出机制。

### 4.3 总体空间结构

**总体空间结构形成“一轴·三区·九廊·多节点”。**

![总体空间结构图：一轴·三区·九廊·多节点](assets/figures/site-overview.png)
...
![道口锚点分布图](assets/figures/chapter04/crossing-anchor-distribution.webp)
...
**总体设计范围承担人工智能创新链的核心空间承载功能，以基础研究、技术研发、成果孵化、中试验证、科技服务、应用展示和人才服务为主，不布局大规模制造。** 高校和科研院所形成策源网络，AI 原点社区组织近校孵化和人才交流，众智园承担共享中试与产业化服务，大钟寺承接企业总部、智能原生业态和城市展示，沿线公共空间为测试、发布、交流和公众体验提供接口。[source:CH4-V9-DESIGN-BASELINE]
...
![总体用地与功能结构图](assets/figures/land-use-structure.png)

> **图4-3｜总体用地与功能结构图**。功能组织和用地关系为方案阶段设计判断，不作为法定用地分类、官方精确边界或产权依据。

**总体功能形成“创新生产为主、城市服务复合、公共底座支撑”的三类结构。** 按建筑面积测算，研发办公及中试孵化以 **55%** 为基准，弹性范围为 50%—60%；展示交流、商业生活及人才服务以 **30%** 为基准，弹性范围为 25%—35%；公共服务及新型基础设施以 **15%** 为基准，弹性范围为 10%—15%。任何实施方案的三类功能合计必须为 100%，不能分别取各区间上限；该比例是方案设计模型，不替代法定用地和控规指标。[metric:chapter04_innovation_production_share] [metric:chapter04_city_service_share] [metric:chapter04_public_support_share]
...
![交通—蓝绿公共空间复合系统](assets/figures/mobility-bluegreen.png)

> **图4-4｜交通—蓝绿公共空间复合系统**。图中表达主轴慢行、轨道接驳、横向缝合、蓝绿接口与 AI 公共节点的总体关系；站口、桥隧、停车容量、市政管线和工程形式仍待正式资料与专业校核。
...
![开发强度分区图](assets/figures/chapter04/development-intensity.webp)
...
![城市更新总体框架图](assets/figures/chapter04/urban-renewal-framework.webp)
...
|大钟寺（DK-04）|大钟寺 AI 产业聚集区|AI 原生业态承载、企业周边公共环境、商业服务和四象限连通不足|文化先导→AI 导入；站城一体；四象限缝合；公共界面复合|D-01～D-04|文保、产权、跨环路交通和实施周期待核|
...
<!-- CH5_IMPLEMENTATION_DEPTH_START -->
...
|---|---|---:|---:|---|
|Z-01 共享中试平台|存量中试适配＋条件性轻量增补|23.2—29.5万㎡|0.9—2.4万㎡|适用载体保留；低效空间功能转换；新增量设置上限；中期织补条件触发|
|Z-02 学知园站城融合|站点首层复合利用；不安排大体量新建|2.8—3.6万㎡|0.0—0.1万㎡|建筑主体保留；入口、雨棚和无障碍界面更新；近期试点条件触发|
|Z-03 青年生活配套|存量生活服务利用＋小规模可逆增补|14.4—18.1万㎡|0.1—0.5万㎡|居住服务建筑保留；首层转换；新增避让敏感界面；中期织补条件触发|
|Z-04 京张—八家郊野慢行绿廊|不形成独立建设容量|16.6—21.0万㎡|0.0—0.0万㎡|生态、公园和水系空间保留；设施轻量可撤除；近期试点条件触发|
|Y-01 黑客屋／人才驿站|存量楼宇首层与共享空间优先；微量可逆增补|7.9—10.0万㎡|0.1—0.2万㎡|主体保留；短约可逆内装；连续首层开放；近期试点条件触发|
|Y-02 站外无障碍链|不新增独立建筑容量|15.6—19.7万㎡|0.0—0.0万㎡|沿线建筑保留；入口、坡道、铺装和街具更新；近期试点条件触发|
|Y-03 校城开放道口|利用既有入口与沿街楼宇；仅轻量可逆设施|9.9—12.6万㎡|0.0—0.1万㎡|校园建筑保留；开放界面按一校一策实施；中期织补条件触发|
|Y-04 华清嘉园记忆空间|存量商业与公共空间承载；不新增独立容量|5.0—6.3万㎡|0.0—0.0万㎡|社区肌理保留；首层转换；文保条件优先；中期织补条件触发|
|D-01 公共空间治理|企业首层、站前和可逆设施复合利用|10.7—13.5万㎡|0.0—0.3万㎡|办公主体保留；公共界面开放；设施可撤除；近期试点条件触发|
|D-02 四象限步行缝合|不预设地下工程或新增建筑容量|18.4—23.3万㎡|0.0—0.0万㎡|既有建筑保留；入口、桥下和站口界面更新；中期织补条件触发|
|D-03 觉生寺文化先导界面|存量文化商业载体优先；建控外条件性增补|17.5—22.3万㎡|0.2—0.7万㎡|文保与工业遗存保留；商业功能转换；拆建须过前置门；长期演化条件触发|
|D-04 双智体验段|可替换设备布置；不形成独立建筑容量|12.6—16.0万㎡|0.0—0.0万㎡|道路与建筑主体不变；设备模块化、可维护、可退出；近期试点条件触发|
...
![三区实施深度节点与剖面控制](assets/figures/chapter05/a-05-05-implementation-depth-final.png)

> **图5-2｜三区实施深度节点与剖面控制**。表达12个项目单元的方案级容量、逐栋拆改留对象及三个关键实施界面；全部为 provisional 方案建议，待官方资料与专业团队深化。

<!-- CH5_IMPLEMENTATION_DEPTH_END -->

### 5.2 众智园 AI 自主创新加速区

#### 5.2.1 设计目标与核心问题

**众智园重点区域约192.1ha，以众智园核心载体、学知园站、腾讯学院路新总部及周边高校、科研机构和绿色空间为基础。** 核心载体总建筑面积采用约23.8万㎡口径；腾讯学院路新总部采用约46万㎡、建筑高度80m、绿地率33.12%的公开项目口径，上述指标仅适用于各自项目，不外推为片区控规指标。站点和产业界面采用中高强度复合研发与公共服务，向清河、京张公园北段和八家郊野公园一侧降低体量、增加开敞界面；片区总建筑量、潜力地块FAR和新增建设规模待核。[source:CH4-V9-DESIGN-BASELINE] [source:CH5-ZZY-DATA]
...
**一是组织高校核、企业核和共享中试第三极。** 高校核面向科研与人才，企业核面向产业与工程化，共享中试平台提供试制、开放测试、产业展示、成果发布、标准与安全治理展示；生产测试区与公众展示区实行物理分区和分时管理。Z-01设置柔性中试空间和一站式服务界面，LM-01“AI共试灯塔”承担产业展示。[source:CH5-CASE-TRANSLATION] [source:CH6-SCENARIO-BASELINE]

**二是组合花园式载体与重载中试空间。** 已建研发、总部、园区塔楼和公共服务载体原则上保留并提升首层界面；适合中试的存量空间经承重、层高、装卸、消防和设备核验后功能转换；低效产业空间可更新为可拆分、可复用的中试单元；已批准在建项目不改变建设边界，完善慢行与公共空间；清河、京张公园和郊野公园不作为建设增量或拆改对象。[source:CH4-V9-DESIGN-BASELINE] [depth:retain_renovate_demolish]

**三是以九廊组织站城—园区—生态联系。** 通过清华东路会客厅线、跨五环缝合和清河廊道，补齐学知园站、园区首层、腾讯总部、京张公园北段和八家郊野公园之间的步行和骑行联系；五环路、京藏高速对外联系由第08章核验。[depth:traffic_rail_slow_parking]
...
![众智园重点区域综合详细设计图](assets/figures/chapter05/a-05-02-zhongzhiyuan-detailed-design.webp)

> **图5-3｜众智园重点区域综合详细设计图**。表达众智园产业／项目链、建筑更新方向、站城与慢行、蓝绿公共空间及实施风险；边界为 provisional，项目节点为方案建议和示意落位。

![众智园花园型AI创新街区概念鸟瞰](assets/figures/chapter05/a-05-02a-zhongzhiyuan-aerial-concept.webp)
...
![众智园共享中试平台首层活力界面](assets/figures/chapter06/lm-01-ai-co-testing-lighthouse.webp)

> **图5-5｜众智园·共享中试平台首层活力界面**。对应 Z-01／节点 B，表达共享中试平台面向公众的成果展示、产业交流与首层开放界面；使用ChatGPT图像生成工具制作，由GPT-5.6 Pro完成指令理解与生成编排，内置图像生成工具使用`gpt-image-2`生成，为方案概念表达，非现状实景或已建成项目。[source:CH6-LM01-RENDER]

![众智园学知园站城融合剖面](assets/figures/chapter05/ch05-scene-03-dazhongsi-culture-interface.webp)

> **图5-6｜众智园·学知园站城融合剖面**。对应 Z-02，表达轨道接驳、商业服务与园区首层的复合关系；豆包 AI 辅助生成，为方案概念表达，地下空间、结构和工程条件须经专项核验。

**P-05腾讯学院路新总部的建设状态、时间和规模仅作为项目研究线索，待补直达官方来源后才能转为正式事实。** P-06众智园共享中试平台的约23.8万㎡规模与开园信息同样保持待核；Z-02、Z-03、Z-04分别为学知园站城融合、青年生活配套和京张—八家郊野慢行绿廊。[source:CH10-PROJECT-INTERFACE]
...
|项目统筹|P-05、P-06的建设状态、时间与规模均为待直达官方来源核验的研究线索；Z-01—Z-04包括中试、站城、青年服务和慢行绿廊|
|空间形态与风貌|花园型创新街区、研发塔楼、共享中试和产业展示界面组合；以清河、京张铁路北段和郊野公园形成低碳、开放、具有地域记忆的未来产业环境|
|主要风险|provisional 边界和北部控规覆盖待核；历史工业用地须先完成适用调查；五环路、生态、防洪、设备承重和青年生活服务条件需专业复核|

#### 5.2.5 风险与待核边界

**众智园片区边界与约23.8万㎡核心园区不是同一尺度，其他存量空间和潜力用地仍需核验。** 腾讯新总部建设进度及协同条件以公开资料和项目协议为准；创新空间比例、配套比例和重载中试层高由后续规划及工程设计确定。[source:CH5-ZZY-DATA]

### 5.3 北京 AI 原点社区

#### 5.3.1 设计目标与核心问题

**北京 AI 原点社区重点区域约104.3ha，是以五道口、成府路、清华科技园和周边高校科研资源为基础的近校型AI创新街区。** 产业功能覆盖基础研发、概念验证、孵化转化、开源协作、成果展示发布、品牌活动和人才服务；居住、餐饮、文化、托育及夜间活动用于支撑创新人才日常生活，不将人才社区写成封闭园区。[source:CH5-ORIGIN-DATA] [standard:PROJECT-OFFICIAL-ANNOUNCEMENT]

**片区核心矛盾是高校、园区、社区和商业街区在围墙、轨道高架、过街和楼宇内部形成割裂，成果发布、人才生活和公共空间不足。** 把成果、人才、生活和公共活动组织成可步行、可停留、可持续更新的前台社区。站点和现有创新载体周边采用中高强度功能复合，高校、社区、清华园站旧址和生活敏感界面采用中等或低扰动织补。[source:CH4-V9-DESIGN-BASELINE]

#### 5.3.2 空间结构与重点动作

**一是建立成果孵化、转化、发布和开源协作网络。** 以原点大厦、清华科技园、智源研究院和周边高校为节点，配置成果展示、概念验证、开发者协作、品牌活动和人才服务空间，把“学习—社交—商机—生活”延伸到首层和街道。SC-01、SC-02、SC-04和SC-12分别布置于开放楼宇、短期试点、服务窗口和公共活动节点。[source:CH5-ORIGIN-DATA] [source:CH6-SCENARIO-BASELINE]

**二是采用保留为主的低扰动更新。** 保留适用的高校、科研、办公、商业与居住建筑；低效楼宇通过功能转换、首层开放、设备更新和可逆内装承接创新活动；高校与园区边界按“一校一策”分级开放；清华园站旧址及建控范围以保护和环境提升为先；不预设成片拆除，只有经结构安全、产权、文保和交通论证的局部服务设施才可条件性更新。[source:CH4-V9-DESIGN-BASELINE] [source:CH5-CASE-TRANSLATION] [depth:retain_renovate_demolish]

**三是以九廊组织连续步行前台。** 依托成府路产业带、跨四环缝合和学院南路廊道，连接五道口、清华东路西口、校园、园区、社区和京张公园中段，研究300m无障碍链、非机动车停放和校城开放道口。[depth:traffic_rail_slow_parking]

**四是把五道口层积文化转化为空间记忆。** 清华园站旧址属 DK-05 原点社区，五道口和华清嘉园叠加铁路、金融教育、国际社区、互联网创业和 AI 文化，建议形成“铁路记忆—民间创业—AI新文化”路径，避免简化为消费标签。[source:CH5-ORIGIN-DATA] [source:CH5-CASE-TRANSLATION]

![北京AI原点社区重点区域综合详细设计图](assets/figures/chapter05/a-05-03-ai-origin-community-detailed-design.webp)

> **图5-7｜北京AI原点社区重点区域综合详细设计图**。表达成果转化网络、低扰动更新、连续步行前台、站点联系与公共空间；边界为 provisional，项目节点为方案建议和示意落位。

![北京AI原点社区概念鸟瞰](assets/figures/chapter05/a-05-03a-ai-origin-community-aerial-concept.webp)
...
![原点社区五道口与京张公园中段活动场景](assets/figures/chapter05/ch05-scene-05-origin-campus-crossing.webp)

> **图5-9｜原点社区·五道口／京张公园中段活动场景**。对应 Y-04，表达铁路记忆、社区活动、夜间交往与京张公园公共界面的叠合；豆包 AI 辅助生成，为方案概念表达，非现状实景或确定运营安排。

![AI原点社区城市创新公共客厅](assets/figures/chapter05/ch05-scene-07-ai-origin-urban-innovation-living-room.webp)

> **图5-11｜AI原点社区·城市创新公共客厅**。对应 Y-01／Y-03，以开放议事、跨龄共创、无障碍参与和创新成果展示组织面向社区的公共协作界面；使用ChatGPT图像生成工具制作，由GPT-5.6 Pro完成指令理解与生成编排，内置图像生成工具使用`gpt-image-2`生成，为方案概念表达，非现状实景、已建成项目或真实公众参与记录，具体运营、无障碍和人物／展示材料权利仍须核验。[source:CH5-ORIGIN-INNOVATION-LIVING-ROOM-RENDER]
...
|开发建设规模|重点区域公告约104.3ha，临时范围复算104.7ha；方案级现状承载基线约130.8—165.4万㎡、等效强度1.25—1.58；以高密度混合街区和存量渐进式更新为主，少量新建仅作条件性补充；新增建设量和法定FAR、高度待核|
...
![大钟寺重点区域综合详细设计图](assets/figures/chapter05/a-05-04-dazhongsi-detailed-design.webp)

> **图5-12｜大钟寺重点区域综合详细设计图**。表达文化先导、存量分类更新、四象限缝合、站城联系与 AI 应用公共界面；边界为 provisional，项目节点为方案建议和示意落位。

![大钟寺AI产业集聚区概念鸟瞰](assets/figures/chapter05/a-05-04a-dazhongsi-aerial-concept.webp)
...
![大钟寺四象限缝合与双智体验段](assets/figures/chapter05/ch05-scene-01-zhongzhiyuan-pilot-interface.webp)

> **图5-15｜大钟寺·四象限缝合／双智体验段**。对应 D-02／D-04，表达站点、北三环四象限慢行联系与可替换双智体验设施；豆包 AI 辅助生成，为方案概念表达，地下工程、道路交通和设备部署须经专项论证。

![大钟寺站前广场](assets/figures/chapter05/ch05-scene-08-dazhongsi-station-plaza.webp)

> **图5-16｜大钟寺站前广场**。对应 D-02／D-04，以站点到达、连续步行、公共停留、文化意象与轻量服务设施形成面向四象限的站前公共界面；使用ChatGPT图像生成工具制作，由GPT-5.6 Pro完成指令理解与生成编排，内置图像生成工具使用`gpt-image-2`生成，为方案概念表达，非现状实景、文物复原、已建成项目或批准建设依据，交通组织、文保建控、地下工程与设施落位仍须专业核验。[source:CH5-DAZHONGSI-STATION-PLAZA-RENDER]

**P-01京张遗址公园的分期开放状态作为公开资料研究线索，待补直达官方来源核验。** P-02卫星制造厂以保留修缮为先；P-03中坤广场作为商改办和首层开放参照；P-04蓝景丽家保留条件性拆除重建线索；P-08和P-14分别组织文化界面与四象限站城缝合。[source:CH4-V9-DESIGN-BASELINE] [source:CH10-PROJECT-INTERFACE]
...
|项目统筹|P-01开放状态待直达官方来源核验，P-02保留修缮，P-03功能转换，P-04条件性重建，P-08/P-14为概念项目；D-01—D-04继续承担公共治理、缝合、文化和体验|
...
![AI创新生态与场景闭环](assets/figures/chapter06/fig-6-1-ai-ecosystem-loop-zh.webp)
...
![五类用户的一日使用节律](assets/figures/chapter06/fig-6-2-persona-daily-rhythm-zh.webp)
...
![SC-01 AI创新客厅](assets/figures/chapter06/sc-01-ai-innovation-living-room-zh.webp)

> **图6-3｜SC-01 AI创新客厅**。本图为 AI 辅助生成的方案场景卡，仅作概念表达，非现状实景、已建成项目、批准项目或实际运行证明。
...
![SC-02 AI教育与科研协作站](assets/figures/chapter06/sc-02-education-research-collaboration-zh.webp)

> **图6-4｜SC-02 AI教育与科研协作站**。本图为 AI 辅助生成的方案场景卡，仅作概念表达，非现状实景、已建成项目、批准项目或实际运行证明。

只使用经授权的课程、导师、实验室和科研资源目录，不采集个体学习轨迹，不自动评价学生。教师或专业人员复核学术内容，高校、科研机构和公共服务平台为建议主体；检索异常时只展示核验目录，退出后撤销授权并恢复人工咨询。

#### 6.3.3 SC-03 人机协作与原型验证工坊

![SC-03 人机协作与原型验证工坊](assets/figures/chapter06/sc-03-human-ai-prototype-workshop-zh.webp)

> **图6-5｜SC-03 人机协作与原型验证工坊**。本图为 AI 辅助生成的方案场景卡，仅作概念表达，非现状实景、已建成项目、批准项目或实际运行证明。
...
![SC-04 公共算力服务窗口](assets/figures/chapter06/sc-04-public-compute-service-zh.webp)

> **图6-6｜SC-04 公共算力服务窗口**。本图为 AI 辅助生成的方案场景卡，仅作概念表达，非现状实景、已建成项目、批准项目或实际运行证明。
...
![SC-05 社区健康协同服务站](assets/figures/chapter06/sc-05-community-health-coordination-zh.webp)

> **图6-7｜SC-05 社区健康协同服务站**。本图为 AI 辅助生成的方案场景卡，仅作概念表达，非现状实景、已建成项目、批准项目或实际运行证明。
...
![SC-06 AI社区服务工作站](assets/figures/chapter06/sc-06-ai-community-service-station-zh.webp)

> **图6-8｜SC-06 AI社区服务工作站**。本图为 AI 辅助生成的方案场景卡，仅作概念表达，非现状实景、已建成项目、批准项目或实际运行证明。

只调用公开或经授权的政策、办事和社区资源目录，不把建议当作审批结果。街道、社区及其授权服务机构为建议主体，必要事项进入人工受理；信息库异常时停止自动答复并转人工，退出后保留原办事流程和线下服务。

#### 6.3.7 SC-07 四道口智慧交通协同测试

![SC-07 四道口智慧交通协同测试](assets/figures/chapter06/sc-07-sidaokou-traffic-coordination-zh.webp)

> **图6-9｜SC-07 四道口智慧交通协同测试**。本图为 AI 辅助生成的方案场景卡，仅作概念表达，非现状实景、已建成项目、批准项目或实际运行证明。
...
![SC-08 小月河具身智能公共空间测试](assets/figures/chapter06/sc-08-xiaoyuehe-embodied-ai-test-zh.webp)

> **图6-10｜SC-08 小月河具身智能公共空间测试**。本图为 AI 辅助生成的方案场景卡，仅作概念表达，非现状实景、已建成项目、批准项目或实际运行证明。
...
![SC-09 小月河生态感知与滨水预警站](assets/figures/chapter06/sc-09-xiaoyuehe-eco-sensing-zh.webp)

> **图6-11｜SC-09 小月河生态感知与滨水预警站**。本图为 AI 辅助生成的方案场景卡，仅作概念表达，非现状实景、已建成项目、批准项目或实际运行证明。
...
![SC-10 京张铁路记忆导览](assets/figures/chapter06/sc-10-jingzhang-memory-guide-zh.webp)

> **图6-12｜SC-10 京张铁路记忆导览**。本图为 AI 辅助生成的方案场景卡，仅作概念表达，非现状实景、已建成项目、批准项目或实际运行证明。

只使用来源明确、可公开展示并经文博或档案专业人员审核的史料；AI复原必须标注“核验史料复原·非历史原貌”。文博／文化机构和公园运营方为建议主体，保留实体标识、人工讲解和无设备体验；内容未核验时只显示静态导览，争议内容可更正或撤下。[data:geometry/public_space.geojson#PUBLIC-001]

#### 6.3.11 SC-11 中关村创新口述史共创站

![SC-11 中关村创新口述史共创站](assets/figures/chapter06/sc-11-zhongguancun-oral-history-zh.webp)

> **图6-13｜SC-11 中关村创新口述史共创站**。本图为 AI 辅助生成的方案场景卡，仅作概念表达，非现状实景、已建成项目、批准项目或实际运行证明。

讲述、肖像和原始材料须获得明确授权，个人记忆、核验史实和AI整理分层展示。档案／文博机构、高校、公共文化机构与社区代表为建议主体；史实和权利经人工复核，提供者可纠错或撤回，系统退出后只保留依法保存且经核验的材料。

#### 6.3.12 SC-12 AI新文化公共议事厅

![SC-12 AI新文化公共议事厅](assets/figures/chapter06/sc-12-ai-culture-forum-zh.webp)

> **图6-14｜SC-12 AI新文化公共议事厅**。本图为 AI 辅助生成的方案场景卡，仅作概念表达，非现状实景、已建成项目、批准项目或实际运行证明。
...
![众智园“AI共试灯塔”共享中试与公众观察场景](assets/figures/chapter06/lm-01-ai-co-testing-lighthouse.webp)

> **图6-15｜众智园“AI共试灯塔”场景效果图**。对应LM-01与Z-01，以透明共享中试平台、公众观察界面和花园型公共空间表现模型、终端与具身设备的受控测试及成果展示；本图为用户提供的AI辅助生成概念效果图，非现状实景、已建成项目、测试认证或工程设计依据，生产与公众区的安全分隔仍须专业深化。[source:CH6-LM01-RENDER]

![AI原点“开源共创星图”开放共创与公共议事场景](assets/figures/chapter06/lm-02-open-source-co-creation-star-map.webp)
...
![大钟寺“古今共鸣门户”历史展陈与公共服务场景](assets/figures/chapter06/lm-03-ancient-future-resonance-gateway.webp)
...
**建筑规模采用总体模型、矢量模型、公开单体事实和待确认法定控制四层口径。** 1600万—1800万平方米及平均强度1.3922—1.5662仅用于方案比较；3663个低置信度GABLE对象的95.08万平方米基底和8.272980%覆盖率只是重点片区部分下限，不代表全范围建筑密度。[data:geometry/buildings.geojson] [metric:building_footprint_area_sqm] [metric:site_coverage_ratio]
...
![拆改留分类与空间对象方向图](assets/figures/chapter07/retain-renovate-demolish-direction.webp)
...
![交通慢行、轨道接驳、蓝绿公共空间与AI场景节点复合系统](assets/figures/mobility-bluegreen.png)
...
**施工叠加期按风险情景预留。** 13号线扩能提升、小月河滨水工程和清河滨水慢行系统的“实施中／在建”状态、站点范围与日期目前仅为专题研究汇编线索，尚未在本包登记可逐项复核的直达官方来源；因此本方案只保留「施工期」与「改造后」双状态适配，不把2027-12-28等日期写成已核定工期。[source:CH8-TRANSPORT]
...
- **四道口「双智」试点**：约1.2km²、13个路口、约9公里道路及运营主体等信息目前为专题研究汇编线索，待补直达官方来源后核定；本方案仅把它作为局部信控案例候选，不据此主张已常态化运行或全场地交通治理能力。扩展为「信控→环境反馈→公共空间分时管理」属于设计建议，须以数据授权、人工复核、非数字兜底与退出机制为前提。[source:CH8-TRANSPORT]

### 8.3 道路层级、微循环与停车策略

**道路层级：概念性识别，不做工程结论。** 北三环、北四环、北五环三条城市快速路横切场地，是区域机动效率与场地慢行连续的结构性矛盾来源；知春路、成府路、清华东路、学院路等构成主要地面干路骨架（九廊沿线）。**不绘制道路红线、不给出断面、不核定线位**；道路层级作为空间组织的背景层进入 `roads.geojson`，仅表达概念层级与接驳关系 [source:CH8-TRANSPORT] [depth:traffic_rail_slow_parking]。

**道路微循环组织。** 在概念层级基础上，按「主干路—次支路—园区内部路—轨道站点」组织微循环，强调轨道站点的最后一公里接驳（概念建议，不涉及道路线位、红线和断面）[source:CH8-TRANSPORT]：
...
- **行洪功能为刚性前置**：清河与小月河的分洪、泄洪功能决定任何方案不得压缩河道行洪断面；20年一遇／50年一遇标准、6.83亿元估算投资和在建状态仍属于专题汇编线索，待直达官方来源与专业水务资料复核，不能作为已核定工程结论。[source:CH8-MUNICIPAL]
...
**制度供给强、空间分布不均**是本章公服判断的现状基础：医疗有北医三院、北大口腔两大国家级锚点与社区卫生服务中心全覆盖；养老有驿站 160 家、助餐点 293 家、「海淀食堂」56 家；便民生活圈 92 个（全市第二）——但北部众智园片区文化商业薄弱、站点周边场馆型体育供给不足，中部依赖轨道与公园底盘 [source:CH8-PUBLIC-SERVICE]。
...
**试点不写成已部署能力。** 四道口约1.2km²信控试点及运营主体属于待直达官方来源核验的案例线索。低速机器人、配送与自动驾驶只提出**弹性试点路段＋分时交通推演机制**，须明确**公共价值**、**数据边界**与**运营和退出**条件。[source:CH8-SAFETY]
...
- **一脊：京张遗址公园活力带。** 约9km、约53ha、2026年8月全线开放、46处出入口、覆盖70个社区约45万人等数值与状态均保留为专题汇编线索，待补直达官方来源后核定；本方案只确认其作为南北公共空间骨架的设计角色。[data:geometry/green_space.geojson]

- **两带之一：小月河蓝线。** 全河长度、流域面积、治理段6.41km、步道11.4km、绿化11万㎡及2026年建设状态均为专题汇编线索，待直达官方来源核验；其泄洪河道与蓝绿骨架的双重角色要求：**亲水开放与场景导入以行洪安全和生态保育为前置条件**。[source:CH9-XIAOYUEHE]

- **两带之二：清河—八家郊野生态基底。** 清河长度、流域面积、防洪标准、海淀段10.36km在建状态，以及八家郊野公园101.45ha、绿地率约90%和灌溉数据，均为专题汇编线索，待直达官方来源和水务／园林专业资料复核；本方案只据此提出北部生态基底的衔接方向。[source:CH9-QINGHE]
...
1. **AI 公共艺术与荣誉展示组件**：动态艺术装置、荣誉柱、排行榜（无为系统驱动，见 9.8）。
2. **AI 场景节点组件**：生态感知站（东翼延伸）、公共算力亭（公园边缘算力节点）、XR 遗址剧场（铁路记忆馆延伸）。[source:CH9-COMPONENT]
3. **文化导视组件**：三代叙事导视系统（见 9.7.2），"AI 讲故事、人类守史实"，历史内容专业机构人工终审。[source:CH9-CULTURE-GUIDE]
...
**功能补足与标志节点**（呼应公告 1.5.2.4 京张遗址公园活力带要求）：沿公园补足停车、体育、创新交往等设施与科技测试、应用展示等特色功能的空间接口（与第08章交通市政、第06章 AI 场景、第10章实施运营接口衔接）；聚焦公园**南端（西直门）、北端（箭亭桥）以及上跨环路区域（三环门户、落日客厅）**打造标志性城市景观节点，与既有退台、钢廊桥等已建成节点叠加升级，不另设无现实基础的构筑物。[source:CH9-PARK-FUNCTIONS]
...
**问题**：纵向 9km 蓝绿慢行已成系统，但跨三环／四环／五环、跨围墙、跨河道的横向联系薄弱——"十字"只有半笔；三环（大钟寺四象限）、四环（落日客厅下方）、五环（箭亭桥—清河）三次环路切割构成工程级硬断点。[source:CH9-STITCH]

**动作**（概念建议，工程条件以第08章交通市政方案为准）：
...
- **公园慢行断点优化**（呼应公告 1.5.2.4）：聚焦公园出入口落地（规划约 46 处，落地待核）、跨环路绕行与高差断点，结合第08章交通方案提出步行骑行绕行系数与接驳优化方向，并保留无障碍与非数字通行通道。[source:CH9-SLOW-BREAKS]
...
**（二）步行连通关系。** 大钟寺站为 12/13 号线换乘节点，四道口"双智"试点约 1.2km²、13 个路口、约 9km 道路（科学城数投运营）；四象限步行连通度目标 100%（任务书要求），以步行优先重构路口、完善非机动车停放；跨环路、地下连接、信控扩展由第08章交通市政设计深化。[source:CH9-QUADRANT]
...
|---|---|---|---|---|
|**众智园 AI 创新朝圣地标**|DK-07 学知园口|虚轨·创新|中试开放日、公共算力亭、创新荣誉柱，集聚开发者与中小主体|花园型园区、东升开放园区界面、八家郊野—京张北段生态底盘（对标埃因霍温共享中试、肯德尔 5% 创新空间）|
...
- **空间载体与概念落位**：花园型园区主入口门户节点（东升开放园区界面），紧邻八家郊野—京张北段生态底盘；以轻构筑物（公共算力亭、创新荣誉柱）落位，可迁移、可复刻，不另设无现实基础的建筑。
...
- **公共价值**：铁路记忆传承、文化先导界面、知识经济与公共文化复合（对标国王十字 Knowledge Quarter）。
...
|无障碍与人工服务组件|站外 300m 链、公园出入口|行动不便者、老年人、数字弱势人群|全龄友好、非数字兜底|公共空间管理方＋志愿服务|符合《无障碍环境建设法》"五同步"、隐私保护|定期巡检、应急响应；设施失效时提供人工替代服务|官方底线（无障碍法）|
...
|**AI 新文化**（虚轨）|中关村论坛、开源生态、开发者社区、街区化日常活动|AI 公共空间、贡献展示、可变导视、场景反馈|数据隐私、人工审议、内容标识、非数字兜底和退出机制；AI 辅助解释不越文保与史实判断边界|
...
> 下表为概念项目清单，非既定实施计划。凡状态、日期、投资或规模尚未在 `sources.json` 登记可逐项复核的直达官方来源，均统一降级为“公开资料研究线索”，不得作为正式事实、预算或工期引用。

**表10-1｜更新项目清单**

|编号|项目名称|类型|位置/关联片区|解决的问题|状态|责任主体类别|成本状态|待核验条件|
|---|---|---|---|---|---|---|---|---|
|P-01|京张遗址公园活力带贯通与环境提升|遗产保护与环境提升|京张遗址公园沿线（北至清河、南至西直门）|蓝绿主轴贯通、文化叙事、公共空间连续|开放状态为研究线索，待直达官方来源核验|公园建设管理主体＋运营主体（待正式确认）|1.62亿／约2.0亿元为研究线索，不作预算依据|开放分期、连续运营模式、经营权归属与公共开放责任|
|P-02|卫星制造厂保留＋修复改造|遗产保护与环境提升|大钟寺片区北部（铁路授权带）|工业遗产保护、24 小时开放公共界面|已公布先例|铁路授权协商＋文保程序|成本待专业测算|文保精确边界、授权期限、经营许可范围|
|P-03|中坤广场商改办深度改造|存量建筑功能转换|大钟寺片区|低效商业楼宇转产业总部载体|收购与更新状态为媒体研究线索|国有出让自持主体＋存量改造专业团队|约90亿元为媒体线索，不作预算依据|交易与改造状态、改造后业态与规模、结构检测|
|P-04|蓝景丽家收储—出让—自持重建|低效产业空间更新|大钟寺片区|引入社会资本供地、市级指标支持先例|投资与工期为研究线索，待直达官方来源核验|收储出让实施主体＋自持运营主体|28亿元／自持20年为研究线索，不作预算依据|市级指标条件、产权、投资与竣工节奏|
|P-05|腾讯学院路新总部（含公共界面）|低效产业空间更新/潜在新建|北部众智园片区|企业核新建载体、轨道微中心一体化连通|建设状态与2025年开工为研究线索，待核验|国有出让自持主体＋园区运营主体|64.2亿元为研究线索，不作预算依据|建设状态、竣工规模与分期、公共界面安排|
|P-06|众智园共享中试平台（Z-01）|低效产业空间更新|众智园片区（DK-07）|"中试—资本—认证"链路中试环节|建设状态与2026-09开园为研究线索，待核验|集体自持主体＋园区招商运营主体|约23.8万㎡为研究线索，不作核定规模|实际建设／开放状态、规模、项目公司架构|
...
|P-08|大钟寺文化先导界面与四象限缝合（D-03/D-04）|公共空间与慢行织补|大钟寺片区（DK-04）|觉生寺—1733 文化界面、四象限步行连通|本次概念；四道口试点状态为待核研究线索|国有出让自持主体＋存量改造专业团队＋公共文化运营主体|成本待专业测算|试点状态、四象限工程审批（轨道＋三环）、文保建控|
|P-09|小月河滨水跨界设施管护协议试点|公共空间与慢行织补|小月河沿线（东翼 E1）|滨水公共空间管护接缝（水务/园林分治）|在建与6.41km为研究线索，待直达官方来源核验|水务建设管理主体＋园林绿化管护主体|投资信息未核定，不作预算依据|建设状态、规模、跨界设施接管主体与经费渠道|
|P-10|AI 原点创新客厅与公共算力服务窗口（SC-01/SC-04）|校区园区界面开放|原点社区（DK-05）|场景—空间—运营一体化、算力普惠|近期可试点|园区运营方＋公共算力机构|成本待专业测算|空间主体与运营机制确认|
...
![分期逻辑：证据成熟度排序，不是日历排序](assets/figures/chapter10/phasing-three-stage-logic-zh.webp)

> **图10-1｜分期逻辑：证据成熟度排序，不是日历排序**。图示将七阶段证据与治理门折叠为近期试点、中期织补和长期演化；属于概念性实施机制，不代表已批时序，空间表达以 `geometry/phasing.geojson` 的 PHASE-001—003 为准。[source:CH10-FIGURE-ASSETS] [data:geometry/phasing.geojson]

**试点时序判断（研究判断，非既定承诺）**：按治理成熟度而非空间新颖度排序——原点社区**近期**（活动最活跃、商户自投已验证）；众智园**中期**（空间最新、产权最清晰、产业生态未成，开园后）；大钟寺**远期**（产权范式成熟但主体单一、建设期至 2030 年）；科技服务翼**近期机制型试点**；小月河翼**近期可逆试点＋远期工程**。跨片区协同必须新建统筹机制，不沿用任一现成机制。[source:CH10-PHASING]

逐项目分期以“当前状态＋进入条件＋可逆性”为判断基础，不等同于已批建设时序。跨阶段项目只在前一阶段通过安全、产权、维护和公众反馈门后进入下一阶段；评估条件用于比较实施前后变化，未达到条件时按项目属性限缩、暂停、撤除可逆设施或恢复原状：

**表10-3｜逐项目分期与评估退出门**

|项目|建议阶段|阶段进入条件与衔接要求|评估与退出门|
|---|---|---|---|
|P-01 京张遗址公园活力带贯通与环境提升|**近期衔接（PHASE-001）**|衔接已开放的一期和二期，确认运营模式、经营权和公共开放责任，形成连续运营安排。|评估慢行连续性、公共开放时段和维护响应；经营权或开放责任不清时，限缩新增经营与活动安排。|
|P-02 卫星制造厂保留＋修复改造|**中期织补（PHASE-002）**|文保精确边界、铁路授权期限、结构安全和经营许可范围确认后进入修复与开放设计。|以文保合规、结构安全和公共界面开放条件为门；任一条件未通过即暂停改造和开放。|
|P-03 中坤广场商改办深度改造|**中期织补（PHASE-002）**|完成产权、结构、消防和改造后业态核验，以存量改造方式分段实施。|评估结构消防合规、低效空间利用改善和公共界面质量；安全或业态适配不达标时停止后续分段。|
|P-04 蓝景丽家收储—出让—自持重建|**长期演化（PHASE-003）**|待出让条件、公共开放义务、建设进度和市级指标适用条件明确后，与大钟寺整体连通同步推进。|以公共开放义务、实施进度和产权协议可执行性为门；条件未落实时不启动后续连通工程。|
|P-05 腾讯学院路新总部公共界面|**中期织补（PHASE-002）**|结合在建工程进度确认公共界面、轨道微中心衔接和分期开放条件。|评估公共界面可达性、开放连续性和轨道衔接安全；不具备开放条件时延后相关界面启用。|
|P-06 众智园共享中试平台|**中期织补（PHASE-002）**|开园、实际规模和运营主体确认后，先开放展厅、商业和绿地界面，再评估中试平台扩展。|评估共享服务使用、公共界面开放、设施维护和运营稳定性；运营主体或维护资源不足时不扩展。|
|P-07 原点社区低效楼宇低扰动更新与人才驿站|**近期试点（PHASE-001）**|产权和商户协商、安全预案、撤场恢复条件齐备后，以低扰动、可逆方式先行。|评估使用率、居民与商户反馈、投诉和维护负担；安全、公平或维护阈值失败时撤场恢复。|
|P-08 大钟寺文化先导界面与四象限缝合|**长期演化（PHASE-003）**|轨道、三环、文保建控和连通空间产权条件通过专业审查后实施。|以文保影响、步行可达性和交通安全为门；专业审查未通过时不建设固定连通设施。|
|P-09 小月河滨水跨界设施管护协议试点|**近期机制试点＋长期工程（PHASE-001→003）**|近期先建立接管、经费和维护协议；固定设施和工程改造待防洪及专业审批后进入长期阶段。|评估接管响应、维护经费、防洪安全和生态影响；责任或经费中断时暂停新增设施，工程风险触发时恢复安全状态。|
|P-10 AI 原点创新客厅与公共算力服务窗口|**近期试点（PHASE-001）**|空间主体、数据授权、人工服务和运营机制确认后，以可撤回服务窗口启动。|评估服务可达性、人工接管、隐私投诉和运行稳定性；数据越界、服务失效或无法人工接管时暂停。|
|P-11 小月河具身智能与生态感知测试界面|**近期可逆试点（PHASE-001）**|防洪优先、测试边界、安全责任、公众告知和退出预案齐备后开展限定测试；未通过评估不得扩展。|以零重大安全事件、测试边界遵守、人工急停和生态影响为门；越界、事故或防洪冲突立即停止并复原现场。|
...
分期空间表达由 `geometry/phasing.geojson` 承载：PHASE-001 对应近期试点，PHASE-002 对应中期织补，PHASE-003 对应长期演化。每个阶段要素记录进入条件、关联项目、停止或退出条件和 provisional 状态；跨阶段项目保留前后阶段关系，不把阶段边界或时间节点表述为已批时序。[data:geometry/phasing.geojson]
...
总体设计范围产权呈"**铁路授权带＋集体产业用地＋出让自持＋高校划拨**"四元结构，没有任何单一主体能独立完成全线实施；产权类型直接决定实施通道：[source:CH10-POLICY]
...
- **五类法定前置门**（有为底线，任何项目不可绕过）：规划刚性管控（控规）、文保许可（清华园车站/觉生寺/清河汉城建控地带）、土壤污染"不调查禁建"、轨道交通安全保护区（13 号线高架外侧 30 米）、公共数据授权（区级部门不得擅自开展）；每个项目在清单"待核验条件"栏对应登记。[source:CH10-POLICY]
...
|年度复盘|AI 城市治理年审：发布运行、安全、公平、维护、异议与退出记录，重审荣誉展示|线上公共知识库＋AI 原点议事空间|每个运营年度结束或重大事故后|区级统筹类平台＋专业复核＋第三方评估＋公众代表|

![京张未来开轨季年度活动四层节律](assets/figures/chapter10/annual-events-four-tier-rhythm-zh.webp)

> **图10-3｜京张未来开轨季年度活动四层节律**。常态开放、月度共创、季度联动和年度复盘构成长效运营建议；活动名称、频次和主体均为方案机制，不表示政府活动或既定安排。[source:CH10-FIGURE-ASSETS] [source:CH10-EVENTS]
...
- **城市地标（荣誉节点）运营**：三处 AI 荣誉节点（LM-01 众智园"AI 共试灯塔"、LM-02 AI 原点"开源共创星图"、LM-03 大钟寺"古今共鸣门户"，对应项目 P-12）按"公开提名—证据核验—权利确认—多方复核—限期展示—年度重审—修订/撤下"机制运营；广告、冠名和赞助信息与公共荣誉分区呈现，任何企业不得通过付费获得荣誉排序（与 10.4.2 防垄断规则一致）。[source:CH10-EVENTS]

- **与年度年审衔接**：荣誉展示在"年度 AI 城市治理年审"（10.6.2）中重审，未通过年审的荣誉项可修订、降级或撤下；数据来源、评价规则、更新周期与异议处理可解释，断网或争议时保留静态展示与人工说明。[source:CH10-OPERATION] [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]
...
承接第06章 6.6.2 与第05章 Y-01 黑客屋/人才驿站：以**公开问题池、可核验数据、小额工具任务、场景沙盒和维护轮值**为主，贡献记录可进入 LM-01/02 荣誉展示；不以一次黑客松代替长期维护，不公开个人敏感信息和未授权代码。[source:CH10-DEVELOPER]
...
"无为"体现为**三级弹性分层**（活动层市场调节／设施层管理方决策／空间层法定程序——没有任何现状机制允许 Agent 自主调整物理空间，动态运营只发生在信息与服务层）、**年度价值评估＋目标校准与试点—扩展—迭代**（10.6.2）、**开发者活动提案闭环与场景开放准入—评估—退出**（10.5）；Agent 只作感知、建议、匹配、记录，不批准、不替代、不独断（与第06章 6.7.1 一致）。[source:CH10-OPERATION] [source:CH10-DEVELOPER]
...
AI创新指数由原始创新、成果转化、产业集聚、人才活力、基础设施与场景开放、可信治理六个维度组成，采用 `I_AI=Σ(w_k×Z_k)` 计算，权重之和为1。正式发布指数前，须统一统计范围、基准年、正负向、标准化方法和数据完整度，并经过同类区域对标与专家复核。当前不填报缺乏共同底账的综合得分；规划目标是形成六维可连续监测的创新生态，避免以企业数量或单项投资替代全链条表现。[metric:ai_innovation_index]
...
场地级目标采用“核定T0基线＋相对增长指数”表达。T0须在同一总体范围、同一统计时点和同一去重规则下，分别核定实际使用场地的AI企业数 `E0`、AI人才空间密度 `D0` 和可归属场地的AI核心产业产值 `V0`，并统一设为指数100。AI原点社区现有325余家AI企业、1000余名AI科学家和1.3万名开发者仅作为局部现状锚点，不替代11.4平方公里总体设计范围的T0普查。[source:CH3-HAIDIAN-AI-BASELINE]

**表11-3｜场地级企业、人才与产值阶段目标**

|方案目标指标（T0＝100）|近期试点|中期织补|长期演化|核验边界|
|---|---:|---:|---:|---|
|AI企业有效聚集指数 `E/E0×100`|≥110|≥125|≥140|只统计在场地内有可核验办公、研发、中试、服务或运营活动的主体；注册地址不能单独计数|
|AI人才空间密度指数 `D/D0×100`|≥108|≥120|≥130|科学家、开发者、相关专业学生和其他人才分列去重；同步核验住房、通勤、公共服务和创新交往承载|
|场地AI产业产值指数 `V/V0×100`|≥115|≥140|≥170|固定行业分类、统计周期和空间归属；不得混入企业估值、市场规模或无法归属场地的区级产值|
...
|---|---:|---:|---:|---|
|总体设计范围|11,400,000㎡|11,492,502.43㎡|+0.81%|公告为任务尺度；几何值为临时模型分母|
|三处重点区域合计|3,684,000㎡|3,687,872.19㎡|+0.11%|接近公告约值不证明边界精确|
|众智园|1,921,000㎡|1,918,001.919㎡|-0.16%|保留 provisional 标识|
|北京AI原点社区|1,043,000㎡|1,046,952.810㎡|+0.38%|保留 provisional 标识|
|大钟寺|720,000㎡|722,917.464㎡|+0.41%|保留 provisional 标识|
...
![核心指标复算与任务证据链](assets/figures/metrics-evidence.png)
...
**方案以“证据未闭合即不形成确定结论”为风险控制原则。** 前十一章中的范围、用地、建筑、交通、市政、蓝绿、项目、场景和运营判断，均按资料可信度、空间精度、专业深度和实施条件分级；下表所列责任主体是后续核验的专业主体类别，不代表已经获得任何单位授权、采购关系或实施承诺。[depth:risk_missing_data] [source:SITE-PACKAGE]
...
|技术成熟度与试点安全|具身智能、交通协同、公共算力和场景调度仍属于受控测试或概念机制|不得写成已全面部署、自动审批或已批准运营|先在隔离或限定环境测试，保留物理急停、人工接管、既有方案回退、事故记录和空间复原；越界、失联或安全事件立即停止|测试运营方、设备责任方、第三方安全评估与主管专业人员|
...
**当前提交几何形成的是可复算的设计模型，而不是法定现状或审批底图。** 总体范围和重点区为临时约束；560个用地要素、最低可行绿地与公共空间、9条概念交通要素及分期空间均继承这一精度边界。它们可以支撑当前方案内部的面积、比例、网络和项目对应关系，但不能证明权属、道路红线、工程线位或法定指标。[source:BOUNDARY-SOURCE] [source:KEY-AREA-SOURCE] [depth:risk_missing_data]
...
**所有外部或生成资产均按“来源—生成或处理方式—许可—用途—限制”登记，完整记录以 `sources.json` 和 `report/copyright_statement.md` 为准。** 第01章证据链图与第03章Logo已由参与者确认用于本 GitHub 智能体开源征集、公开仓库展示和投稿材料分发；必须保持AI辅助生成标识，不扩展为排他权、不侵权保证、注册商标或征集外商业授权。[source:CH1-EVIDENCE-CHAIN-FIGURE] [source:CH3-LOGO-V3]

第05章三幅鸟瞰图为基于锁定空间底板的合成概念表达，参与者已确认其用于本 GitHub 智能体开源征集公开展示；精确模型版本和提示记录未保留，因此不主张独创性、绝对不侵权或模型级溯源，也不能用于证明建筑数量、精确位置、高度、道路、景观现状、建成状态或批准情况。[source:CH5-ZZY-AERIAL] [source:CH5-ORIGIN-AERIAL] [source:CH5-DZS-AERIAL]

第06章14张场景图由Codex Desktop直接调用内置 `image_gen` 于2026-08-25生成（部分逐图复核延续至8月26日），逐文件哈希、生成方式、任务记录、适用OpenAI条款和2026-08-31参与者公开仓库展示／再分发授权已登记；界面未暴露底层图像模型版本，因此不主张模型级溯源、唯一性或绝对不侵权。[source:CH6-SCENARIO-ASSETS] [source:OPENAI-TERMS-2026-01-01] 第08章原北京地铁简化标识虽可确认Wikimedia版权标记为PD-shape，但未取得运营方商标公开展示授权，现已从中英文图纸移除并替换为团队原创中性站点符号。[source:CH8-BEIJING-SUBWAY-LOGO] [source:CH8-NEUTRAL-STATION-SYMBOL]
