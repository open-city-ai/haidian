---
title: "Centennial Jing-Zhang AI Innovation Belt Open Call for Urban Design Submission"
...
# Centennial Jing-Zhang AI Innovation Belt Open Call for Urban Design Submission
...
### Naming System, Visual Identity, and Logo Direction (agent.1)

This proposal builds on the official announcement's formal name, "Centennial Jing-Zhang AI Innovation Belt" (English: Centennial Jing-Zhang AI Innovation Belt), and proposes a scalable naming system and visual identity direction to enhance the overall recognizability of the "Centennial Jing-Zhang Cultural Belt, Urban AI Living Experience Belt, and AI Fusion Innovation Belt" [source:AGENT-TASKBOOK].

- **Concept Name for Spatial Organization**: "Jing-Zhang Symbiotic Intelligence Belt". "Intelligence Belt" draws on the concept of the "bloodline" of the Jing-Zhang Railway, while also metaphorically representing the AI innovation chain as the city's neural network. It serves only as a working method and narrative theme for the proposal and does not replace any statutory redlines [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK].
- **Nomenclature System**: Based on the framework of "three belts + Three Zones and Two Wings" — three belts (Cultural Belt / Life Experience Belt / Integration Innovation Belt), three zones (Zhongzhiyuan AI Independent Innovation Acceleration Area, Beijing AI Origin Community, Dazhongsi AI Industry Cluster), and two wings (Zhongguancun Technology Services Wing, Xiaoyue River Scenario Enablement Wing); all sub-zone names follow the descriptions in the task book and public materials, without creating new names for parks or companies [source:AGENT-TASKBOOK].
- **Logo and Visual Direction (Conceptual Recommendation)**: The logo evolves from the "human" character zigzag railway line designed by Zhan Tianyou, forming a "Smart Vein Network" icon composed of nodes and connections. The main colors are deep gray of the railway tracks (#2B2F33), signal orange (#E8590C), and digital blue (#0CA678), symbolizing history, vitality, and intelligence, respectively. All fonts and graphics must obtain the right to use; the logo will not be officially implemented until authorization is granted.
- **Extension Rules**: The identification system uses modular components (node symbols, corridor line types, pilgrimage markers), which can be reused annually for events, contribution honor walls, and global promotion, thereby forming long-term brand assets [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK].

All named elements and identifiers are Conceptual Recommendations for Open Co-Creation and do not constitute government approval or official branding [source:AGENT-TASKBOOK].
...
### Global AI Innovation Ecosystem Case Studies (agent.2 Background Reference)

To serve the positioning for the "Full-Stack Independent AI Innovation System" and the "World-Class AI Innovation Ecosystem," the proposal reviews 8 globally recognized, verifiable innovation ecosystem cases as a reference (all based on publicly available information, not official data; references are for methodological inspiration only and do not constitute investment, output, or recruitment commitments for Haidian) [source:AGENT-TASKBOOK]:

| Case | City | Relevant Mechanism | Connection to  |
| --- | --- | --- | --- |
| Station F | Paris | Renovated Old Train Station into a Giant Startup Hub, Open Source and Maker Ecological Space | Jing-Zhang Heritage Park Activating Existent Railway Spaces |
| MaRS Discovery District | Toronto | Urban-Type Innovation District, Health and AI Academic-Industry-Community Translational Pathway | University—Campus—Community Conversion Pathway |
| MaRS / Kendall Square | Boston/Cambridge | Innovative Core Adjacent to Top Universities | Tsinghua, ,  university-led innovation |
| Shenzhenwan Technology Ecology Park | Shenzhen | Industry Services + Policy + Capital Integration | Zhongguancun Technology Services Wing |
| Hangzhou Future Technology City | Hangzhou | Zhijiang Laboratory, Talent Special Zone, Algorithm Source | Zhongzhiyuan Full Stack Autonomous System |
| Vector Institute | Toronto | Hub for AI Talent and Ethics Governance | Safe Governance and Standard Setting |
| EU AI Factory (AI Factories) | EU | Public Computing Power + Ecosystem Co-construction | Edge-side Computing Power and Open Testing |
| Zhongguancun Science City | Beijing | Reform Breakthrough to Science City Evolution | Peer Comparison within the City, Learning from Nearby Experiences |

The examples collectively demonstrate that a world-class AI ecosystem = university origination + open-source collaboration + corporate transformation + public computing/power testing + talent special zone + capital services + international dissemination. This plan constructs an innovation chain of "university origination - open-source collaboration - corporate transformation - public experience - international dissemination" and locates it in [data:geometry/key_areas.geojson#PROV-KEY-001], [data:geometry/key_areas.geojson#PROV-KEY-002], and [data:geometry/key_areas.geojson#PROV-KEY-003] at three key areas, as detailed in [depth:three_key_area_detailed_design].
...
In the active zone of the Jing-Zhang Site Park and at three key areas, the proposal suggests a group of "AI Holy Sites" and honor display nodes (Conceptual Recommendation, not an engineering feasibility conclusion, subject to cultural heritage, green space, blue line, and traffic safety constraints) [source:AGENT-TASKBOOK]:

- **Developer Promenade**: A pathway that connects three zones along the site park, embedding showcases of open-source achievements and interpretable wayfinding to form a walkable and shareable pilgrimage route.
- **Open-Source Achievement Gallery**: Scroll through the selected proposals and Agent contributions, reflecting the open, transparent, and learnable philosophy of the call.
- **Agent Honor Wall & AI Milestone** / **Intelligent Body Contribution Honor Wall**: Preserve the selected proposals and the corresponding GitHub usernames of the Agents in a plaque form, with annual outstanding contributions to be added, forming a long-term brand asset [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK].
- **Global Developer Honor Wall**: A public honor node for the international open-source and developer community.

Landmarks shall not be arbitrarily renovated or modified, and shall not violate cultural heritage protection or green space control measures. Avoid excessive entertainment or internet-famous trends [depth:blue_green_public_space].

### Centennial Jing-Zhang—Zhongguancun—AI-Driven Fusion Narrative and Signage (agent.5)

The proposal presents a three-layer narrative of cultural fusion [source:AGENT-TASKBOOK]:
- **Jing-Zhang Railway Culture**: The historical theme of Zhan Tianyou's autonomous design of the first mainline railway, cultural resources such as the old Qinghua Garden Railway Station.
- **Zhongguancun Culture**: From Electronic Street to the Reform Breakthrough and Innovative Spirit of Science City.
- **AI New Culture**: Open-source collaboration, explainable design, people-centric governance, and long-term public knowledge accumulation.

The spatial narrative line is organized around "history—present—future": from the old Tsinghua Garden Railway Station site → Jing-Zhang Heritage Park → the three zones → the Xiaoyue River Scenario Enablement Wing, forming a readable pedestrian narrative and wayfinding system; wayfinding uses rail track motif symbols, bilingual Chinese and English, and accessibility design, with an international communication slogan example being "century-old tracks, smart here / Where the first Chinese railway meets the first AI-native city" [standard:MOHURD-URBAN-DESIGN-MEASURES]. The cultural sign system and the One-Belt-One-Road overall logo system are kept distinct to avoid confusion.

### Global AI Innovation Ecosystem and Long-Term Operations (agent.6)

The proposal suggests further developing annual activities and long-term operational mechanisms (both Conceptual Recommendations/reference proposals, not firm commitments, and not overstating government pledges) [source:AGENT-TASKBOOK]:

- **Annual Activity Framework**: Global AI Week, Open Source Release Day, Security Governance Workshop, Pilgrimage Route City Walk, Annual Stele Ceremony; time anchors are open for submissions as of the call for proposals, with a deadline of August 31, and results to be announced in September (for public reporting background, not part of this proposal).
- **Developer Community Operations**: Maintain the global developer community through GitHub discussions, open-source contribution boards, and honor walls, while preserving a public knowledge repository.
- **Scenario Access Operations**: Scenario open days and test sandbox reservations to establish a "scenario-space-operation" mapping.
- **Transformation Pathway**: Talent Special Zone → Business Landing → Policy and Resource Alignment, forming a subsequent transformation channel from "Selected Proposal—Community—Industry—City" [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK].
- **International Promotion**: Build global attention and recognition through pilgrimage routes, honor walls, and annual events, with all activities requiring a clear operational entity, frequency, responsibility boundaries, and risk assessment.
