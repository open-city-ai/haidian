...
京张不是等待 AI 填满的空白线。地下运行的铁路、并行轨道、已开放或在实施的公园工程、受控校园、创新载体、社区商业、河道和遗产共同组成状态、权限与断面不等的既有城市。`STATUS × ACTION` 先决定既有城市可以做什么；只有普通空间被证明不足时，AI 才能在该行动内部获得最小、可退出的空间差异。12 项任务里，只有 S01、S04、S07 进入深度空间包；三处界面使用后都回到普通城市。[data:visual/assets/ai-spatial-admission.json#admission_chain]

> 三个概念交接：S01 / S04 / S07｜D0–30 证据与权利｜D31–60 最小可撤界面｜D61–100 有界任务｜STOP / RESET；不是批准工期。[data:visual/assets/ai-spatial-admission.json#delivery_contracts]
...
AI-off 时，公共路径、混合城市、蓝绿、普通房间、人工服务和维护全部成立。AI 先经过“普通城市 → 普通空间充足性 → 是否必须有特殊空间条件 → 证据/权利/人工责任 → 最小可撤差异 → TTL/停止/降级 → 退出/复位 → 普通城市”的规划判断；它不替代 `STATUS × ACTION`，也不自动授权空间变化。[data:visual/assets/ai-spatial-admission.json#admission_chain]
...
| 任务 | 普通基线与充足性 | 空间决定 | 人工 / TTL | 停止与退出 / 复位 |
| --- | --- | --- | --- | --- |
| S01 物理验证 | 普通房间可做代码/模拟；真实受监督物理验证不足 | 深度：受控测试、观察、服务复位 | 合格操作/复核角色；会话 | 授权过期、危险或路径冲突；撤设备，普通培训/工作 |
...
| S08 无障碍换乘帮助 | 固定标识和人工帮助充分 | NO BUILD；物理备选路优先 | 人工责任；设施状态 | 路径未核验；普通导向 |
| S09 雨后维护检查 | 人工检查/工单充分 | NO BUILD；维护进入/临时关闭 | 维护责任；检查状态 | 无现场确认；检查后撤除关闭 |
| S10 无障碍设施状态 | 人工/固定替代路充分 | NO BUILD；决策点提示 + 物理替代 | 人工确认；短状态窗口 | 信息过期；常规标识持续 |
...
公共权利底线不另造新制度：被准入的专业状态不能移除普通路径或普通任务；人工可达、受影响者挑战/停止、无障碍备选和复位后的普通使用必须持续。[data:visual/assets/ai-spatial-admission.json#public_rights_floor]
...
不把 15 项都写成实施承诺：只为三个已准入空间包设置 D0–D100 概念交接。它们先确认普通基线、证据、权利/进入和合格角色；再画最小可撤界面并演练人工停止；最后只在有界任务中记录公共保障、测量、复位和交接。成本只称为成本类别及待确认的构成/数量/采购触发，不作金额、伙伴、采购或实施承诺。[data:visual/assets/ai-spatial-admission.json#delivery_contracts]

| 合同 | D0–D30 | D31–D60 | D61–D100 与交接 |
| --- | --- | --- | --- |
| CONTRACT-S01 众智园 | 物理验证不足、载体、权利/通行与安全角色证据 | 公共/受控/服务复位界面，监督测试和无障碍检查 | 有界会话；测路径、安全、人工备选与复位；交接案卷/图/停止复位记录 |
| CONTRACT-S04 AI 原点 | 公开侧载体、开放/可负担、权利/数据与人工交接 | 可撤分区、声学/数据边界，验证不失公共路 | 授权会话；测开放、交接、清除和普通房间恢复；交接清单/边界/复位记录 |
| CONTRACT-S07 大钟寺 | 普通载体、复核能力、隐私/申诉、到达与纸面/电话备选 | 进场/排队/隐私/复核界面，演练人工申诉/停止 | 有界人工评审；测转介、复核、申诉与复位；交接评审/申诉/复位记录 |

| 阶段 | 证据门 | 可行动作 |
| --- | --- | --- |
| G0 | 来源、状态、权利、通行、容量调查 | 对齐、审计、登记 |
| G1 | 同意、公共使用、人工替代、退出证明 | 低遗憾修复和可撤测试 |
| G2 | 结构、消防、遗产、无障碍、服务、连续性复核 | 选择性适应改造 |
| G3 | 实测缺口、官方控制、公共利益审查 | 条件性填补 |
| G4 | 维护、反馈、证据版本 | 运营和修订 |
