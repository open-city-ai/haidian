---
title: "TURNBACK COMMONS / 京张折返共生线"
...
![Overview: one spine, three stations, two wings, and a low-contrast provisional constraint](assets/figures/site-overview.en.png)
...
![Three levels and spatial structure: from strategy to everyday service](assets/figures/land-use-structure.en.png)
...
![Key-area diagram: differentiated spatial, scenario, and operation roles](assets/figures/key-areas.en.png)
...
![Mobility, blue-green space, and human takeover: a reviewable network](assets/figures/mobility-bluegreen.en.png)
...
![Core metrics and pending data: a consistent JSON-to-board chain](assets/figures/metrics-evidence.en.png)
