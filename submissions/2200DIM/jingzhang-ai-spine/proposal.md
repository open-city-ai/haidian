...
![三处重点区域详设](assets/figures/key-areas.png)
三处重点区域（众智园 / AI 原点 / 大钟寺）的概念深化抓手与关联场景卡。

![交通蓝绿与AI节点](assets/figures/mobility-bluegreen.png)
交通—蓝绿—AI 节点一体化网络与 5 处朝圣地标（LM-01..05）。

![核心指标与证据图表](assets/figures/metrics-evidence.png)
核心指标与证据来源（基于临时边界在 EPSG:4548 复算）。

![生态图谱与区域协同概念流图](assets/figures/region-coop.png)
生态图谱与区域协同概念流图（5 个区域协同节点 + 8 个全球案例参考）。

![三区两翼与五大功能协同](assets/figures/three-district-coordination.png)
三区两翼与五大功能协同图：三处重点区沿京张遗址主轴分工，两翼承接要素与场景。

![京张智脉品牌徽记 Logo（双轨三节点数据流）](assets/brand/logo.png)
品牌徽记（Logo 方向）：京张双轨为骨、三处节点为脉、AI 数据流为络。
...
- Logo 方向：以京张铁路双轨为骨、三处节点为脉、AI 数据流为络的线性徽记方向（当前为文字标识，未制作独立图形文件）（品牌徽记见 assets/brand/logo.png）
...
| 中文 | English |
| --- | --- |
| 众智园AI自主创新加速区 | Zhongzhiyuan AI Autonomous Innovation Accelerator — sovereign stack, governance voice |
| 北京AI原点社区 | Beijing AI Origin Community — world-class ecosystem, talent magnet |
| 大钟寺AI产业集聚区 | Dazhongsi AI Industry Cluster — intelligent-native new business |

招引转化路径（EN）：
> Scenario Open Lounge → Zhongzhiyuan incubation → Dazhongsi first-store debut (conceptual proposal, not a committed investment plan).
...
| ID | 场景 | 运营主体 | 可复制条件 |
| --- | --- | --- | --- |
| SC-01 | AI 步行导航导览 | 运营公司导览组 | 可复制到任意步行街区，仅需匿名定位与路线偏好 |
| SC-02 | 开源贡献荣誉墙（线下） | 社区基金会 | 依赖开源社区文化，复制需社区认同与署名授权 |
| SC-03 | 城市智能体治理沙盘（演示版） | 众智园研究院 | 依赖算力+模型能力，可复制到有算力条件的园区 |
| SC-04 | 智能原生消费门店 | 品牌方 + 运营公司 | 可复制到高流量商业街区，需门店合规审核 |
| SC-05 | 机器人低速配送 | 物流平台 + 安全运营 | 依赖路权与安全审批，复制需本地法规适配 |
| SC-06 | 青年第三空间·24h创客客厅 | 社区运营 | 依赖青年人口密度，可复制到大学城/创新园区周边 |
| SC-07 | 京张铁路遗产解说（多语） | 文旅运营 + 文保顾问 | 依赖京张铁路遗产资源，独特性强、难以直接替换 |
| SC-08 | 蓝绿廊低碳跑步/骑行 | 社区 + 环保组织 | 依赖滨水绿廊，可复制到有河道蓝绿系统的城市 |
| SC-09 | 自动驾驶低速接驳（验证） | 交通运营 + 车企 | 依赖路测许可，复制需安全审批与封闭/半封闭路段 |
| SC-10 | 开源模型工场（验证） | 众智园算力平台 | 依赖算力投入 + 开源社区，复制需持续算力保障 |
| SC-11 | 城市智能体治理沙盘（验证·含公众参与版） | 众智园研究院 + 公众委员会 | 依赖公众参与机制，复制需社区共建与人工终审 |
| SC-12 | 15 分钟生活圈智能调度 | 城市运营平台 | 依赖供需数据聚合，复制需数据治理与隐私合规 |
### 6.7 公共空间组件库（8 类）

| ID | 类型 | 尺度 | 功能 |
| --- | --- | --- | --- |
| PS-01 | 滨水绿廊 | 线状 1–3 km | 蓝绿慢行、碳汇、雨水滞蓄 |
| PS-02 | 口袋公园 | 500–2000 ㎡ | 全龄休憩、AI 互动装置 |
| PS-03 | 广场 / 场景客厅 | 2000–10000 ㎡ | 路演、集会、AI 场景开放 |
| PS-04 | 慢行道 / 自行车道 | 3–5 m 宽 | 轨道接驳、低碳出行 |
| PS-05 | AI 朝圣地标 | 点状 | 开源记忆、导视、叙事 |
| PS-06 | 儿童 / 长者友好角 | 200–500 ㎡ | 无障碍、代际互动 |
| PS-07 | 雨水花园 / 海绵设施 | 点状 / 带状 | 雨水滞蓄、生态修复 |
| PS-08 | 多语导视系统 | 点状 | 中文 / English / 无障碍三语导视 |
### 6.8 开发者社区与招引转化路径

| ID | 机制 | 说明 |
| --- | --- | --- |
| DC-01 | 开源贡献者荣誉墙（线下） | 全球开源贡献者署名，每年在众智园现场更新 |
| DC-02 | 黑客松 / 路演 | 京张 AI 创新周并行举办，孵化场景卡 |
| DC-03 | 开发者大使计划 | 高校/企业开发者结对，共建 12 张场景卡 |
| DC-04 | 招引转化路径 | 场景开放客厅 → 众智园孵化 → 大钟寺首店首演（概念建议，非已确定招商安排） |
### 6.9 文化导视系统

| ID | 类型 | 说明 |
| --- | --- | --- |
| WF-01 | 地标导视 | 5 处朝圣地标统一视觉符号 |
| WF-02 | 多语标识 | 中文 / English / 无障碍三语 |
| WF-03 | 遗产解说牌 | 京张铁路史实解说，经文保顾问核校 |
| WF-04 | 数字导览 | AR / AI 多语讲解（匿名，无需注册） |
### 6.10 弱势群体专属需求、保障与非数字替代路径

| 群体 | 需求 | 保障 | 非数字替代 |
| --- | --- | --- | --- |
| 老年人 | 无障碍慢行、休息座椅、大字导视 | 全龄友好角、平缓坡道、语音导览 | 纸质地图、人工问询点 |
| 儿童 | 安全活动场地、看护 | 儿童友好角、安全围合、家长看护区 | 实体游乐设施 |
| 残障人士 | 无障碍通行、信息无障碍 | 盲道、轮椅坡道、触觉标识 | 无障碍人工服务 |
| 低数字素养人群 | 非数字服务替代 | 人工柜台、纸质指南 | 全线下替代通道 |
| 平台劳动者 | 配送/接驳安全、休息补给 | 专用停车、休息驿站 | 实体休息区 |
| 受自动化影响人群 | 技能转型、就业衔接 | 技能培训、转岗支持（概念建议） | 线下培训点 |
## 用地、建筑规模与拆改留方案
