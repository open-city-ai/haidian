...
**Six personas** [source:AGENT-TASKBOOK]:
...
| --- | --- | --- | --- | --- | --- |
| SC-01 | Embodied-intelligence realistic training site | Xiaoyue River wing (one of the two wings, not one of the three key areas; see overall spatial-structure figure) | Embodied-AI enterprises, developers | Real-machine operation data feeds back into models; public review before test-report release | M2 |
| SC-02 | AI+healthcare application corridor | Xiaoyue River wing (Zhonggu Pilot Harbor CDMO) | Medical institutions, patients | Healthcare data minimization, compliant outbound | M2 |
| SC-03 | AI+film content production line | Xiaoyue River wing | Content enterprises, creators | AI-generated content source-labeled | M3 |
| SC-04 | Smart crossing experience station | Wudaokou/Sidaokou [data:geometry/public_space.geojson#PUBLIC-002] | Residents, visitors | Multimodal interaction; anonymized footfall data | M3 |
| SC-05 | Accessible AI guide system | Heritage-park spine [data:geometry/green_space.geojson#GREEN-001] | Elderly, children, people with disabilities | Real-time environmental sensing; personal-data minimization | M3 |
| SC-06 | Urban data-visualization scroll | Public art screens along the route | Residents, visitors | Aggregated data, no personal privacy | M3 |
| SC-07 | Agent co-creation workshop | Origin Community, Origin Academy [data:geometry/key_areas.geojson#PROV-KEY-002] | Developers, residents | Sandbox isolation; public review before test-log release | M3 |
| SC-08 | Talent-scenario matching platform | AI Origin Community | Entrepreneurs, enterprises | AI matching; personal-data minimization | M3 |
| SC-09 | AI-native consumption venue | Dazhongsi [data:geometry/key_areas.geojson#PROV-KEY-003] | Consumers, brand merchants | Consumption-as-data; desensitized aggregation | M3 |
| SC-10 | Smart-city governance sandbox | Zhongzhiyuan / technology-service wing | Residents, governors | Urban-operations AI simulation; reviewable | M3 |
| SC-11 | Smart district (AI sensing + commercial flow + smart lighting) | Dazhongsi station - Beishatan | Commuters, residents, merchants | Aggregated footfall statistics, no facial recognition | M3 |
| SC-12 | Ecological-resilience waterfront (AI water-level regulation) | Xiaoyue River | Residents, universities | Environmental data (water level/rainfall); manual confirmation of sluice gates | M3 |
...
- 12 scenario cards [metric:scenario_card_count], 12 scenario nodes [metric:scenario_node_count], 6 personas [metric:persona_type_count], 3 test-and-verification scenarios [metric:test_verification_scenario_count], 4 landmarks [metric:landmark_count], 15 renewal projects [metric:renewal_project_count]: full coverage of the six tasks' hard quantity requirements.
...
- **Copyright authorization (registered scope)**: AI-generated images are recorded in `report/copyright_statement.md` and `sources.json` with their generation tools; fonts, images, trademarks and basemaps used in the final package are registered item by item in report/copyright_statement.md and sources.json (author/generator, source, license, redistribution, review status); assets still pending verification are marked provisional in the ledger and replaced or removed as required, and no asset whose rights cannot be proven is used in the final deliverables.
