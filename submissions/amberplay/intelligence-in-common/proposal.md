...
v3.2 把这套协议压缩为一个国际可读的城市品牌：**AI 上街，先拿 PASS / NO PASS, NO AI**。PASS 是 Public Acceptance & Safe-Street Standard 的项目内部简称，也是四项不可加权的入场条件：**P / Purpose visible**（目的可见）、**A / Accountable owner**（责任明确）、**S / Staffed handover**（人工接管）、**S / Stop-safe restoration**（停止并恢复）。众智园以“安全验收庭”证明停得住；AI 原点以“权利与贡献廊”证明撤得回；大钟寺以“100 米公共验收街”证明接得住。任一 PASS 条件失败，当场景不得激活 AI，必须恢复普通花园、普通展廊或人工服务街的无 AI 基线。PASS 是本方案原创概念协议，不是现行法定标准、政府认证或真实铁路信号工程。
...
v3.2 将八项清单升级为八份逐项目交付合约，记录在 `visual/assets/renewal-projects.json`。每项独立声明项目类型、地点、纳入和排除范围、唯一 A、R/C 角色、G0-G4 进入门、L1/L2/L3 成本带、0—30/31—60/61—90 天交付物、验收 KPI、可接受证据、依赖与停止恢复动作。成本带只描述工作量级和询价前提，不虚构货币投资额；任何一项不因其他项目或总体平均表现而放行。
