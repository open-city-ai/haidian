...
![Six innovation-ecosystem interfaces and the two service wings.](assets/figures/ecosystem-interfaces.en.png)
...
![A matrix of ten scenario cards, places, participants, and pause gates.](assets/figures/scenario-protocol.en.png)
...
![The J·Z COMMONS mark, palette, and civic components as a maintainable identity system.](assets/figures/identity-system.en.png)
...
![A trusted implementation ladder from evidence and prototypes to daily service and public review.](assets/figures/implementation-ladder.en.png)
