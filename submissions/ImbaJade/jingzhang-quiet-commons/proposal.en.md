---
title: "QUIET COMMONS JINGZHANG / 京张静域"
...
![Overall Quiet Commons system and evidence boundary: provisional constraints are dashed and design intentions are solid](assets/figures/site-overview.en.png)
...
![Land-use and six sensory programs: a complete conceptual partition, not statutory land use](assets/figures/land-use-structure.en.png)
...
![Slow mobility, blue-green and restorative routes with bypass, rest and staffed-help options](assets/figures/mobility-bluegreen.en.png)
...
![Metrics, evidence and governance loop with known, unknown and provisional separated](assets/figures/metrics-evidence.en.png)
