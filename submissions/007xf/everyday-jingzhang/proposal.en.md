...
![One Everyday Line, three staffed rooms, twelve service cells, ten links and twelve points inside provisional geometry](assets/figures/site-overview.en.png)
...
![Twelve exact-cover service cells organised by the Everyday Line and three public rooms](assets/figures/land-use-structure.en.png)
...
![Plans, sections, reuse adaptation, staffed service and staff-tool back-of-house at the three key areas](assets/figures/key-areas.en.png)
...
![Evidence chain linking spatial metrics, delivery, sources, bilingual material and self-check](assets/figures/metrics-evidence.en.png)
...
![Everyday Line, blue-green comfort, east-west connections and three accessible loops](assets/figures/mobility-bluegreen.en.png)
