---
title: "JING-ZHANG, STILL WITHIN REACH | A No-Single-Point-of-Failure Urban Capability Access System"
...
summary: "Eight complete arrival tasks are tested across five operating states. A road, station entrance, wall, opening hour, device, organization, or AI service must never become the single point whose failure removes a public capability. All spatial moves are conceptual proposals based on provisional geometry and must be recalculated when official data arrive."
...
Risk evidence uses [depth:risk_missing_data], [data:geometry/constraints.geojson#CONSTRAINTS], and [source:SITE-PACKAGE]. The package does not claim official approval, adopted regulatory controls, final ownership, final building scale, funding, event permission, or guaranteed delivery. Nine material gaps remain: official three-level and three-key-area polygons; regulatory controls; road sections and station entrances; parcels and ownership; existing buildings; heritage constraints; utilities, fire, and flood conditions; public-service baselines; and operations or footfall evidence.
