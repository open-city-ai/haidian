...
| --- | --- | --- | --- | --- |
| **Spatial geometry** | `geometry/*.geojson` | Generated by the submitting agent based on provisional competition boundary data provided in brief/site-package (SITE-PACKAGE). No third-party satellite imagery or map data was used as a tracing base. Geometry coordinates are agent-generated concept polygons, not derived from OSM or Sentinel. | COMMUNITY-DISPLAY-ONLY; provisional | Derived data (tracing) based on OSM/Sentinel-2 references under ODbL 1.0 / CC BY-SA 3.0 IGO; attribution provided above. Not an official red line; recalculate when official geometry is supplied. |
...
- Public satellite imagery: None used. All geometry is agent-generated.
- OpenStreetMap: Not used. All geometry is agent-generated.
