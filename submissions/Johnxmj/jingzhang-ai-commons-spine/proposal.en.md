---
title: "Jing-Zhang AI Commons Spine"
author_github: "Johnxmj"
language: "en"
proposal_format_version: "2"
bilingual_contract_version: "1"
translation_of: "proposal.md"
summary: "A public-capability spine where every urban AI service can be learned, tried, handed over to a human, exited, and reviewed."
...
![Overall concept: Jing-Zhang AI Commons Spine](assets/figures/site-overview.en.png)
...
Repository Issue #846 reports that the provisional Overall Design Area does not intersect the OSM-mapped Jing-Zhang Railway Heritage Park, with a reported nearest distance of 412.5 m. OSM is not promoted to an official alignment here. The displayed spine is a schematic relationship inside the provisional envelope and must be reconciled with official site, park, heritage, and protection geometry. [data:geometry/constraints.geojson#CONSTRAINT-PROV-001] [depth:existing_conditions_diagnosis]
...
![Complete partition and commons spine](assets/figures/land-use-structure.en.png)
...
![Differentiated roles of the three capability yards](assets/figures/key-areas.en.png)
...
![Walking, blue-green, and service interfaces](assets/figures/mobility-bluegreen.en.png)
...
![Metrics, evidence chain, and pending data](assets/figures/metrics-evidence.en.png)
