...
summary: "以京张铁路遗址公园为公共接口公地，用一脊三港两翼十二接口把全栈创新、近校转化、智能原生消费与可退出的城市 AI 场景连成可审计的公共价值回路。"
...
本次当前方案包的可评分状态为：**临时边界，保留精度警示并待正式数据发布后复算；不阻断内容评分**。因此，正文中的空间结构、场景、项目和指标均按“可讨论、可复核、可替换官方边界后重算”的原则写入；当官方边界和重点区 polygon 更新后，agent 必须重新生成方案包、自检和图纸/HTML生成，不能只替换单个文件。
...
本方案提出“京张接口公地 / JZ COMMON PORTS”：把京张铁路遗址公园视为所有人都能进入、理解、质询并退出的公共接口，而不是企业展厅的线性集合。空间结构为“一脊三港两翼十二接口”：一脊是遗产公地与蓝绿慢行脊；三港分别是众智园的“验证港”、北京 AI 原点社区的“开源港”和大钟寺的“生活港”；两翼分别组织科技服务供给与场景反馈；十二接口把研发、验证、发布、学习、照护、通勤、消费、文化和治理转译为可预约、可审计、可回退的小尺度公共空间。Logo 方向以铁路道岔与 API 花括号组合成 `{JZ}`，采用不依赖专有字体的几何线框，中文名强调公共性，英文名强调城市资源的开放接入。该结构是概念建议，不新增法定红线，也不预设建设承诺。
...
全球案例不照搬空间形象，只抽取可验证机制：波士顿 Kendall Square 的高校-企业转化界面、巴黎 Station F 的共享孵化服务、新加坡 one-north 的科研生活混合、赫尔辛基 Maria 01 的旧建筑创业社区、加拿大 Vector Institute 的人才网络、伦敦 Knowledge Quarter 的文化科研协作、深圳南山的高密度创新服务网络。对应京张的转化分别是近校成果转化街、共享法务与算力柜台、十五分钟人才服务、遗产建筑低扰动再用、跨机构导师池、文化机构联合策展和轨道站点周边公共服务接口。案例仅用于背景比较，不用于推导本项目红线、指标或政府承诺。
...
AI 场景必须落到空间和治理边界：公共空间场景引用 [data:geometry/public_space.geojson#PUBLIC-001]，慢行与交通场景引用 [data:geometry/roads.geojson#ROAD-001]，开放空间场景引用 [data:geometry/green_space.geojson#GREEN-001] 和 [metric:public_space_ratio]、[metric:green_ratio]。这些引用让评审者知道场景不是口号，而是位于具体图层和指标中的设计对象。面向智能体任务书要求不少于10张AI场景卡、不少于3个产业测试验证场景和不少于5类用户画像；本方案给出可供深化的结构，正式参赛者必须把场景卡、画像表、隐私边界、人工复核和运营主体写入正文、HTML、A3/A0 和合规矩阵。
...
| 老年人与行动不便者 | 无障碍通行、人工服务、低门槛数字帮助 | 无障碍连续接口、线下服务窗口、可关闭语音辅助 | 不以纯数字渠道替代人工服务 |
...
| 11 无障碍共测站 | 三港及慢行接口 | 由老年人、残障人士与工程人员共同测试数字服务，保留人工服务和退出通道 |
| 12 城市模型责任台 | 三处开放接口港 | 公示测试目的、数据最小集、责任人、暂停条件和复盘记录，作为第三个产业测试验证场景 |
...
四个“朝圣/荣誉”节点以贡献而非崇拜为核心：众智园“责任验证塔”用可变灯带显示测试是否开放、暂停或复盘；原点社区“开源年轮庭”按年份记录经授权的公共贡献；大钟寺“城市回声廊”展示居民意见如何改变产品与空间；遗址公地中段“百年接口碑”并置铁路工程、现代计算与公共维护者名录。它们均为可撤除、可更新的公共组件概念，需在文保、结构、消防、无障碍与版权复核后由专业团队深化。
