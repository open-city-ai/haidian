---
title: "IN TIME JINGZHANG: Making AI Response Time a Civic Responsibility"
...
summary: "The proposal translates AI response time from a technical metric into a civic responsibility through one response spine, three staffed response rooms, two support wings, and twelve reversible scenarios."
...
![Three key areas and spatial prototypes](assets/figures/key-areas.en.png)
...
![Mobility, walking, and blue-green public space](assets/figures/mobility-bluegreen.en.png)
...
![Metrics, sources, and self-check chain](assets/figures/metrics-evidence.en.png)
