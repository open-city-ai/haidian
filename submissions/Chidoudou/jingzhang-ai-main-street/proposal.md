...
summary: "公园已经连南北，京张上街补六个横向入口；一项AI服务凭上街票依次回答安全吗、说得清吗、真能用吗，并在变化中的大钟寺站城界面随时暂停、迁移或退场。"
...
一句话提案：**公园已经把南北连起来；我们补上六个横向入口，并让每一项 AI 上街前回答三个普通问题：安全吗？说得清吗？真能用吗？**

京张铁路遗址公园构成持续完善的南北公共底板；六个横向入口把街区、校区、园区、社区和轨道节点接入这条底板。“京张上街”以一条可核验的责任链组织首用：众智园做安全验证，AI 原点社区把技术翻译成普通语言，大钟寺在真实站城与商业界面限时首用；证据与责任凭一张 Street Pass 在三处交接。十二个街角站把规则落到日常入口。

所有空间落地内容均为开放共创建议、概念建议或供专业团队深化研究的参考方案，不替代正式规划，不构成政府审定、工程可行性、投资、招商或实施承诺。

## 30秒看懂：公园是路，上街票是规则

本方案以“一项待上街的 AI 服务”和随行证据为叙事主角。以大钟寺多语换乘与无障碍到达为例：先由乘客、照护者和维护者共同定义问题并画出无 App 普通路线；众智园只有在测试范围、实体急停、近失记录与撤场线清楚时才盖 `PROVE`；AI 原点社区只有在普通人能复述用途、局限、人工责任和撤回方法时才盖 `TRANSLATE`；大钟寺只有在实体图、人工服务和连续通行先成立时，才允许自愿、限时、可关闭的 `FIRST USE`。最后，成功、暂停和失败以同一张结果卡回到公共账本。[metric:journey_stage_count] [data:geometry/public_space.geojson#SCN-03]

四类人共同决定结果：受影响使用者、现场维护者、专业复核者和可被授权运营者。任一方都可提出暂停，提案者或运营者不能单独决定复制；设备撤走后，花园、院落、人工服务与普通通行必须继续成立。[metric:public_co_review_role_count] [metric:first_use_right_count]

![一项AI服务如何凭上街票从真实问题走到首用决定](assets/figures/street-pass-journey.png)

以上流程是帮助专业讨论的概念情景，不代表既有运营、已获授权日程或绩效。这里的“最后500米”指研究成果获得普通人、小组织与维护人员理解和信任的最后一段转化，不是精确服务半径。

## Agent 评审速览

官方规划中的遗址公园创新交往带、五道口与大钟寺中心，以及街区—校区—园区—社区融合，共同构成本方案的空间骨架；六个真实方向的横向入口和一套可暂停的首用规则构成设计回应。评委只需记住四句话：**公园是路；三地分工；街票交证据；AI关掉后城市仍好用。**
...
| 产业如何转化 | 以“问题库—验证场—转译台—首用窗—责任账本”连接全栈验证、科研转化、智能体/内容消费/智能终端与两翼服务；大钟寺以真实换乘和多层商业作为首用压力测试 | 三区两翼产业接口、12 张场景卡、3 张试验单、现场证据板 |
...
| 哪些信息仍未知 | 官方 polygon、道路红线、权属、控规、市政、逐栋现状和授权均未提供；大钟寺站内换乘当前运营状态、连续无障碍路线和分时冲突也须专业核验 | assumptions、constraints、metrics、现场证据、三类矩阵 |

## 大钟寺现场证据：A口—1733—D口的三时态首用接口

2026年8月13日18:07—19:44，人工贡献者从13号线大钟寺站A口方向出发，经地面路径、1733地面/B1/B2、12号线D口，再到北三环西路桥下，从公共视点采集30张Live Photo与2段短视频。本投稿包提交其中4张重新编码、移除EXIF和动态负载的静帧；不提交原始定位轨迹或视频。[source:USER-FIELD-DAZHONGSI-20260813]

现场由高架13号线、地面步行、1733多层商业/景观界面、12号线D口和桥下非机动车边缘共同构成垂直换乘系统。首用接口据此采用“A口—1733—D口”的普通到达序列，并将其定义为随站城建设迁移的 `T0` 时间切片，而非永久换乘结论。“暂停—纠正—恢复”是运行规则：入口、围挡、通道、运营或无障碍条件变化时，既有路线立即失效并回到人工复核。官方任务书要求优化大钟寺站一体化、四象限步行连通和非机动车停放；现状证据把这一要求落实为可被证伪的第一段到达。[standard:PROJECT-OFFICIAL-ANNOUNCEMENT] [source:OFFICIAL-BEIJING-SUBWAY-L13-DAZHONGSI]

| 现场所见 | 对设计的直接要求 | 尚不能推出什么 |
| --- | --- | --- |
| A口邻近地面路径同时出现高架站体、施工/围挡、台阶和指向12号线的导向 | C1实体状态、C2人工问路和经核验的无障碍替代先于App建议 | 不能仅凭照片判断施工边界、通道权属或无障碍合规 |
| 1733地面、B1、B2与D口形成多层公共商业界面 | 首用采用“普通换乘+既有商业嵌入”，运营和维护承担第一责任 | 不能由一次傍晚观察推断全天客流、商业经营规律或因果 |
| 当前官方页面分别列示13号线A/B口及12号线D/E口无障碍设施；2024年开通期报道记录过D口—1733—A/B口的站外换乘路径 | 将跨线运营状态写入开场前数据门；实体路线、人工服务与站口状态必须现场更新 | 不宣称当前站内通道已开通或永久关闭，不把2024年8分钟记录当2026年保证 [source:OFFICIAL-BEIJING-SUBWAY-ACCESSIBILITY] [source:BACKGROUND-DAZHONGSI-OUT-OF-STATION-TRANSFER-2024] |
| 桥下步行、公交等候和大量非机动车共享有限边缘 | 先划定不占盲道、楼梯口和通勤主线的停放/等候边界，明确维护责任，再讨论数字引导 | 未做数量统计，不能外推分时需求或给出道路工程结论 |

![大钟寺现场证据：一次观察如何定义三时态空间原型](assets/figures/dazhongsi-field-evidence.png)

高德Web服务仅用于2026年8月16日的非提交型合理性核验：A口、D口与1733的POI关系和短距离步行量级与现场序列相符；商业地图瓦片、原始路线坐标、精确距离和时耗均不进入投稿几何、指标或正式证据。换言之，高德帮助检查“这个空间逻辑是否走得通”，但不替代官方运营信息、测绘或无障碍审计。
...
| STATION F | 共享服务、创业计划与公共界面 | 大钟寺小组织与换乘首用接口 | 企业品牌和招商承诺 [source:CASE-STATION-F] |
...
## 与既有规划衔接：一条公共底板，六个横向入口

2024年公开的沿线控规草案提出“一带一轴、两心多点”：京张铁路遗址公园创新交往带、中关村大街创新发展轴，五道口与大钟寺两个中心，以及知春路、四道口等节点。本方案将其作为公开草案背景，而非已批准控规或正式边界，并在这套骨架上设置“成果进入街道、公众进入决策”的六个横向接口。[source:OFFICIAL-JINGZHANG-CONTROL-PLAN-DRAFT-2024]

| 既有规划或建设方向 | 已经解决什么 | 京张上街的接口动作 |
| --- | --- | --- |
| 沿线控规公开草案“一带一轴、两心多点” | 城市结构、中心与节点关系 | 三个首发场和六个横向入口嵌入既有结构；法定轴线以正式规划为准 [source:OFFICIAL-JINGZHANG-CONTROL-PLAN-DRAFT-2024] |
| 京张铁路遗址公园二期与“三道一绿” | 南北慢行、绿廊、遗产和东西缝合的公共底板 | 通过状态、人工服务、无App导向和可逆试验接口接入既有公园 [source:OFFICIAL-JINGZHANG-PARK-PHASE2-2026] |
| 《海淀区城市更新导则（2025年版）》 | 街区、校区、园区、社区融合，连通共享的公共首层，五道口与大钟寺更新方向 | 把“融合”落实为可进入的一层、人工窗口、共测院和站城接口 [source:OFFICIAL-HAIDIAN-URBAN-RENEWAL-GUIDE-2025] |
| 北京花园城市专项规划 | 人本、城绿融合、绿道连续和共同参与 | 先保证遮荫、座椅、雨洪、无障碍与普通通行，AI只作可关闭侧层 [source:OFFICIAL-BEIJING-GARDEN-CITY-PLAN-2024] |
| 大钟寺区域更新、蓝景丽家交通研究与13号线扩能提升 | 站城整合正在变化，未来可能形成新的连廊和公共首层 | 以T0/T1/T2维护可迁移构件和路线版本 [source:OFFICIAL-DAZHONGSI-LANJING-TRANSPORT-2025] [source:OFFICIAL-L13-CAPACITY-EXPANSION] |

六个横向入口按真实地名由北向南排列：**X1 众智园—学知园—清河/小月河方向，X2 清华东路西口—高校/园区，X3 五道口—AI原点—中关村大街，X4 知春路—社区/轨道，X5 四道口—学院南路—铁路遗存，X6 大钟寺—北三环—1733/蓝景丽家更新片区。**它们是需要后续测绘和权属核验的方向关系，不是新增道路或确定出入口。高德POI只用于核对地名与相邻关系，未进入投稿几何、精确距离或指标。

![规划衔接总图：既有南北公共底板与六个横向入口](assets/figures/site-overview.png)

![三张规划如何变成一套设计动作](assets/figures/land-use-structure.png)
...
| --- | --- | --- |
| AI 原点社区一公里范围的高校、科研平台、人才与 AI 企业高度集聚；官方报道给出 37 所高校、10 家新型研发机构、52 家全国重点实验室、106 家国家级科研院所、1.23 万名 AI 学者，以及 439 家企业中 325 家为 AI 企业的时点数据 | 空间组织采用“一公里转化圈”：公开成果窗—OPC/开发者共修—首用需求—资本/知识产权/出海转介—社区反馈 | 不能证明每个机构会参与，也不能成为当前企业清单、地块边界或绩效预测 [source:OFFICIAL-AI-ORIGIN-BASELINE] |
...
三区两翼因此形成一条产业转化链：众智园面向全栈技术、标准、安全和综合验证，负责 `PROVE`；AI 原点社区以科研成果、人才创业与一公里转化圈负责 `TRANSLATE`；大钟寺面向智能体、内容消费和智能终端负责 `FIRST USE`；中关村科技服务翼提供知识产权、资本、法律、产品化和国际服务接口；小月河场景赋能翼承接具身智能、AI+医疗与 AI+影视等真实场景。两张跨区旗舰票分别是“小组织首用街票”和“具身智能共路街票”；北影—大钟寺的 AI 内容首发作为 S09 的产业拓展方向，必须先完成内容权利、公众影响与运营授权复核。
...
三大定位被翻译为空间行为：百年京张文化带对应“看得见演进”的公共时间线；都市 AI 生活体验带对应“日常首用而非炫技展示”；AI 融合创新带对应“从研究到行业再到街角”的协同链。五大功能通过前述产业转化链落实到盖章责任、试验单和空间接口。
...
总体结构改写为“**一条现有公共底板、六个横向入口、三处首发场、十二个街角站**”。京张铁路遗址公园及其慢行绿廊承担南北公共底板；六个入口把高校、园区、社区、轨道和更新片区接入；三处首发场只负责不同的证据闸门；十二个街角站把服务拆成小尺度、可维护的日常接口。[data:geometry/roads.geojson#ROAD-001] [data:geometry/public_space.geojson#PUBLIC-001] 这套分工同时回应总体用地关系与交通慢行深度。[depth:land_use_layout] [depth:traffic_rail_slow_parking]

空间骨架的分工很简单：南北公共底板负责“走得到”，横向入口负责“进得来”，公共首层负责“愿意停”，Street Pass负责“谁签字、何时停”。三个首发场不是同一模块换名，而分别固定为“验证庭、转译廊院、可迁移站城接口”三种空间原型。[data:geometry/public_space.geojson#SCN-04] [depth:overall_spatial_structure]
...
AI 原点社区承担“把论文语言翻译为城市语言”。概念空间由研究成果首用窗、开发者共修室、模型卡阅览架、人才日常服务台、亲子和长者共测时段组成。高校、科研机构、创业团队和居民的接触面布置在可步行到达的一层与院落；“一公里转化圈”把真实需求送入开放成果窗，再把首用结果送回研发团队。任何涉及高校或园区的连接都是概念关系，须经权属、消防、校园管理与交通条件核验。[data:geometry/key_areas.geojson#PROV-KEY-002]
...
大钟寺承担“第一次真实到达和采用”。2026年8月13日的现场证据将A口—地面—1733—D口多层界面定义为当期研究对象，而非永久格局。[data:geometry/key_areas.geojson#PROV-KEY-003] [source:USER-FIELD-DAZHONGSI-20260813] 13号线扩能提升和蓝景丽家更新的站城整合，可能改变入口、围挡、连廊与公共首层。[source:OFFICIAL-L13-CAPACITY-EXPANSION] [source:OFFICIAL-DAZHONGSI-LANJING-TRANSPORT-2025] 大钟寺首用场采用可迁移接口：乘客、照护者、运营者、配送骑手和维护人员共享同一张实时更新的普通到达底图，数字服务只能依附其上。

原型有三个时态。`T0 现状时间切片`按“A口—地面—1733地面/B1/B2—D口”逐日核验；`T1 施工转换期`中，旧路线自动失效，C1状态板、C2人工台和C3实体图迁到临时入口，未经复核不发布数字建议；`T2 未来站城整合`再接入获批连廊和公共首层，准确位置、开放时间和无障碍链由专业设计确定。C4始终只是不占主线的可逆侧袋，C5/C6负责关闭、迁移和恢复。入口、围挡、运营或无障碍条件任一变化，旧路线立即作废；实体导向或人工服务不可用、推荐未经核验路线、占用盲道/楼梯口/通勤主线、持续身份追踪、非机动车冲突无法隔离或没有维护责任人，任一项都不得盖 `FIRST USE` 章。[data:geometry/key_areas.geojson#PROV-KEY-003] [source:OFFICIAL-DAZHONGSI-RENEWAL]

![大钟寺可迁移站城首用接口：T0现状、T1施工、T2未来整合](assets/figures/prototype-dazhongsi.png)

三处重点区共享“一张街票”，但移动的是问题、证据与责任，不是要求同一位使用者跨城跑流程。同一服务在众智园验证、在原点社区转译、在大钟寺限时首用，最终把故障、申诉、人工接管、非 AI 替代和退出结果写入公共账本。每处都形成“到达—普通公共使用—状态板—人工窗口—可选 AI—恢复普通使用”的空间序列；试点设备撤走后，步行、遮荫、座椅、导视和人工服务仍应成立。[depth:three_key_area_detailed_design]
...
| S03 | 换乘与多语首用台 / 大钟寺A—1733—D界面 | 乘客、照护者、商户/运营者 | 不上传乘客身份；实体导向与人工服务先成立 | 产业测试验证 |
...
首轮不同时铺开十二个场景，而是选择“一公两产”三张最小试验单 [metric:minimum_pilot_count]。公共版“无障碍同行街票”从原点社区人工窗口出发，经遗址公园慢行主线到大钟寺服务台，并在大钟寺具体核验A口—1733—D口：先保证实体地图、人工求助、无 App 路径和真实无障碍替代，再由使用者主动开启 AI 建议；阻断无障碍主链、没有人工求助、推荐未经核验路线、持续身份追踪或无法恢复普通通行时立即停止。产业版“小组织首用街票”把同一个脱敏运营/内容问题依次送入众智园验证、原点社区转译和大钟寺限时试用；要求人工需求拆解、纸面模板、不上传乘客或顾客身份、经营/运营者最终确认和可撤回试用。
...
交通策略以“从两侧进入遗址公园和街角站”为目标。南北慢行绿廊以既有/在建京张铁路遗址公园为公共底板；六个横向入口不是六条新建道路，而是六组需要逐项核验的到达关系。提交线网总长度为 [metric:walking_cycling_network_length_m]，只是临时几何中的概念中心线长度，不代表既有公园长度、道路红线、断面或施工长度。[data:geometry/roads.geojson#ROAD-002] 断点治理按“先地面、后工程”排序：先做导视、过街时序、路口视距、非机动车停放和无障碍连续核验；确需桥隧或站城改造时再进入交通与工程专项。[source:OFFICIAL-JINGZHANG-PARK-PHASE2-2026]

轨道站点一体化采用“最后 500 米服务清单”：出站后应能找到遮荫路径、无障碍路径、非机动车停放、公共厕所、人工咨询、场景状态与投诉入口。大钟寺以现场观察到的A口—地面—1733—D口作为 `T0` 待复核样链；北京地铁当前页面列示13号线A/B口及12号线D/E口相关设施，而2024年开通期报道记录的是经1733的站外换乘，因此真实运营状态、无障碍连续和高峰冲突须在每次试点前更新。[source:OFFICIAL-BEIJING-SUBWAY-L13-DAZHONGSI] [source:OFFICIAL-BEIJING-SUBWAY-ACCESSIBILITY] [source:BACKGROUND-DAZHONGSI-OUT-OF-STATION-TRANSFER-2024] 13号线扩能提升与相邻更新研究只说明未来条件会变，不能据此绘制最终换乘方案；任何入口、围挡或通道改变都触发旧路线下线和人工重审。[source:OFFICIAL-L13-CAPACITY-EXPANSION] [source:OFFICIAL-DAZHONGSI-LANJING-TRANSPORT-2025] 五道口、清华东路西口及其他节点仍只标示公共到达关系，不提出道路、桥隧、出入口迁移或地下空间结论。
...
十项概念更新项目形成“空间小投入、制度先到位”的组合：1 六个横向入口连续性审计；2 上街票协议与公共状态板；3 众智园公开验证庭；4 原点社区成果转译窗；5 大钟寺可迁移站城接口；6 十二站统一服务组件；7 无障碍同行最小试验；8 小组织首用最小试验；9 具身智能共路最小试验；10 可纠错贡献里程碑与运维、申诉、退场公开账本。[metric:renewal_project_count] 每项都须在现状、权属、文保、交通、市政、运营授权和公众影响核验后才能进入专业深化。[depth:renewal_project_list]
...
| G3 大钟寺换乘与存量更新 | 13/12号线跨线运营状态、T0路线、T1施工转换、T2未来连廊、连续无障碍、非机动车/公交冲突、场地权属消防、1733运营维护、更新项目库接口 | 哪个时态可形成普通到达基线、服务接口迁到哪里、谁可被授权维护、何时退出 | 只做实体导向与人工问路；入口或围挡一变旧路线即失效，不发布未经核验的无障碍路线 |
...
| SP-04 大钟寺可迁移站城接口 | T0/T1/T2路线版本、实体图、人工台、运营状态板、可迁移多语/无障碍建议侧袋 | 轨道/场地/片区可被授权运营者 / 使用者、无障碍、交通、消防、维护和数据专业方 | 入口或通道变化未复核、普通路线或人工服务不成立、占主线或无维护人即停止 | 版本更新时间、到达完成、人工纠正、暂停回执、迁移/撤场恢复 |
...
### 大钟寺90天证伪试点：先证明普通换乘，再讨论AI

90天只是一段适用于任一有效时态的概念决策序列，不是获批工期、预算、采购或真实试点。开始前先确认当前属于T0现状、T1施工还是T2未来整合；入口或通道一变，计时暂停并回到D0–15。其价值是让专业团队知道“第一天做什么、什么证据才进入下一步、失败后交还什么”；结构化决策门随包保存在 `visual/assets/dazhongsi-90-day-gates.json`。

| 决策窗 | 最小交付 | 进入/停止门 |
| --- | --- | --- |
| D0–15 现场复核 | 分时路线、站口状态、无障碍替代、非机动车冲突、1733管理与维护责任 | 无运营/场地确认或普通路线不成立，不安装 |
| D16–30 非AI基线 | 实体图、纸面导向、人工台、暂停/申诉回执、撤场演练 | 无App不能完成到达，先修普通服务 |
| D31–60 限时首用 | 自愿多语/无障碍建议、现场解释/纠正/关闭 | 错误路线、身份追踪、无人接管或占主线即停 |
| D61–75 四方共评 | 使用者、维护者、专业复核者、可被授权运营者分别签结果卡 | 未关闭高风险问题不能被平均分抵消 |
| D76–90 采用/暂停/退场 | 三种同权结论，设备、账号、数据退出并恢复普通换乘 | 每个新点位和时段重新授权，不自动复制 |
...
本包的指标分三类。第一类是从提交几何复算的内部一致性指标：临时 site area、绿地和公共空间面积/比例、概念建筑基底、慢行线长、三处重点区与三期面积；第二类是计数指标：12 个场景节点、10 项概念更新项目、3 处重点区、6 个全球案例、3 次街票盖章、7 项首用权、3 张最小试验单与 4 项通过的自检闸门 [metric:validation_gate_pass_count]。方案包含3处100米概念窗口 [metric:prototype_study_count]、6类可逆构件 [metric:reversible_component_type_count]、5段证据旅程 [metric:journey_stage_count]、4类共评角色 [metric:public_co_review_role_count]、4张证据卡 [metric:public_evidence_card_count]、3个交付窗口 [metric:delivery_horizon_count]、六个命名入口和大钟寺T0/T1/T2三时态；这些都是结构/阶段计数，不冒充城市绩效。第三类是必须保持待正式数据补齐的法定或工程指标：总建筑面积、容积率、建筑高度和道路面积率。指标的 status、value、unit、source_files、formula、confidence 和 assumptions 全部记录于 metrics.json。[depth:metrics_recalculation]
...
版权方面，核心空间图由本包 GeoJSON、metrics、矩阵、`visual/assets/spatial-prototypes.json` 与现场证据数据通过本地确定性生成流程重建；双语源数据、图件和方法说明随投稿包开放以便复核。原创 Logo 与街票协议以 SVG 提交。两张氛围图由 OpenAI 内置图像生成工具制作，只表达众智园与原点的概念体验；大钟寺主视觉使用人工贡献者在公共视点拍摄、重新编码、移除EXIF/动态负载的清权静帧，封面采用确定性示意图。单次观察不作为长期客流或工程证据。使用 Microsoft YaHei 仅用于本地排版生成，不在仓库分发字体文件；没有使用商业地图瓦片、新闻图片、企业 Logo、可识别人物肖像或第三方论文图像。外部案例文字以官方机构页面为背景来源，仅做简短机制概括。投稿知识产权与展示使用遵循公告和 `COMMUNITY-DISPLAY-ONLY` 声明，详细见 `report/copyright_statement.md`。
...
10. 投稿人于2026-08-13进行的大钟寺单次傍晚现场观察，仅用于空间序列纠错；北京地铁当前13号线站点页与无障碍页按访问时点使用。[source:USER-FIELD-DAZHONGSI-20260813] [source:OFFICIAL-BEIJING-SUBWAY-L13-DAZHONGSI] [source:OFFICIAL-BEIJING-SUBWAY-ACCESSIBILITY]
11. 北京日报2024年开通期大钟寺站外换乘报道仅作历史时点背景，不作为2026年运营或时耗保证。[source:BACKGROUND-DAZHONGSI-OUT-OF-STATION-TRANSFER-2024]
12. 2024年公开的京张沿线控规草案仅用于理解“一带一轴、两心多点”等空间关系；京张铁路遗址公园二期现状用于判断公共底板，不作为法定控制或完工保证。[source:OFFICIAL-JINGZHANG-CONTROL-PLAN-DRAFT-2024] [source:OFFICIAL-JINGZHANG-PARK-PHASE2-2026]
13. 《海淀区城市更新导则（2025年版）》与北京花园城市专项规划用于四区融合、公共首层和城绿融合的设计原则，不下推为地块审批结论。[source:OFFICIAL-HAIDIAN-URBAN-RENEWAL-GUIDE-2025] [source:OFFICIAL-BEIJING-GARDEN-CITY-PLAN-2024]
14. 13号线扩能提升与蓝景丽家一体化交通研究只支持“大钟寺界面会继续变化”的判断，不用于绘制最终换乘或连廊方案。[source:OFFICIAL-L13-CAPACITY-EXPANSION] [source:OFFICIAL-DAZHONGSI-LANJING-TRANSPORT-2025]
