...
方案把“创新带”理解为可持续运营的公共协议：空间允许试验，治理要求留痕，公众拥有反馈与退出权，专业团队保留最终判断。

v1.2 图纸统一采用本地中文字体离线生成，确保评审环境不依赖远程字体或外部资源。

v1.3 调整 A3 首页面图文比例与指标单位写法，保证打印阅读时没有空白封面或缺字字符。

空间上形成“一轴三锚、两翼五环”：京张遗址公园是公共创新轴；众智园、AI原点、大钟寺分别承担可信技术试场、开源人才社区、智能经济客厅；中关村科技服务翼与小月河场景赋能翼提供资本、法务、算力、数据、场景和公共服务；五环对应五大功能。该结构是概念建议，不是新增规划红线。[data:geometry/land_use.geojson#LU-001] [depth:overall_spatial_structure]

### 六个案例转译

| 案例 | 只提取的机制 | 京张转译 |
| --- | --- | --- |
| 多伦多 MaRS | 科研、企业、资本共址 | 原点社区“发布-验证-服务”共享首层 |
| 巴黎 Station F | 大尺度创业社区与服务集成 | 众智园共享测试与合规服务接口 |
| 波士顿 Kendall Square | 高校科研与公共空间联动 | 近校慢行、成果转化驿站与公共客厅 |
| 伦敦 Knowledge Quarter | 文化机构与知识网络协作 | 铁路遗产、中关村文化与AI社区共同策展 |
| 深圳河套 | 跨域创新规则与试验平台 | 可审计的场景开放清单和专业验证沙盒 |
| 新加坡 one-north | 产业、居住、绿地复合 | 三锚差异化、连续慢行和人才日常服务 |

以上为公开常识层面的参考机制，不用其图像、数据或品牌，不把案例成效当作本项目事实；后续需由专业团队补充可引用的一手案例研究。

### 三个可记忆公共节点

1. **零公里开源站**：在AI原点社区设置贡献可追溯的公共发布与荣誉界面，展示经许可的开源贡献，不做个人排名。
2. **可信AI试场塔**：众智园的可预约验证与标准展示节点，以模型卡、数据卡、人工复核流程为展陈核心，不宣称已批准建设。
3. **百年-下一站时间廊**：大钟寺至遗址公园的文化叙事节点，用铁路里程、城市创新事件和未来问题构成可更新年表，避免使用未清权史料。
...
本方案建议的总体概念为“京张智链公园”：以京张遗址公园为历史与公共空间主轴，以众智园、北京AI原点社区、大钟寺三处重点片区为创新锚点，以高校、企业、社区和轨道站点为日常网络，形成“一带三核、多点场景、蓝绿慢行复合环”的空间组织。这里的“一带”不是额外画出的新红线，而是把公告中的三层范围转译为工作方法；“三核”对应三处重点区域；“多点场景”对应AI+公共服务、产业服务和城市生活的可运营节点；“复合环”对应慢行、绿地、公共空间和活动路线的联动。
...
| 11 机器人共行验证场（产业测试） | 众智园封闭可控时段 | 以低速、人工接管、事故回放为前提验证人机共行，不进入开放道路 |
| 12 城市智能体评测周（产业测试） | 三锚共享测试空间 | 用合成/授权数据进行服务可用性、偏差、无障碍与人工复核评测 |
...
| 节律 | 概念活动 | 沉淀资产 | 转化路径 |
| --- | --- | --- | --- |
| 每周 | 开源门诊、居民问题台 | 可公开问题单、贡献记录 | 问题进入场景评审 |
| 每月 | 场景开放日、可信AI评测 | 模型卡、测试报告、复盘记录 | 合格原型进入受控试点 |
| 每季 | 三锚联合 Demo Walk | 步行路线、案例手册 | 团队与服务机构配对 |
| 每年 | Jing-Zhang Commons Week | 年度开放成果与城市议题 | 国际交流、人才与项目后续联系 |

运营采用“征集-伦理/安全预审-受控测试-公众反馈-人工复核-归档/退出”六步门。所有活动均为概念建议，频率、主办主体、经费和场地需另行确认。
