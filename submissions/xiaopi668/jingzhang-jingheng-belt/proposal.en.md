---
title: "Jing-Zhang Balancing Pulse: From Self-Reliance Railway to Open-Source Way — A Walkable Narrative of Chinese Modernity"
...
summary: "A concept design for the Centennial Jing-Zhang AI Innovation Belt, built on the railway's spirit of 'making the impossible possible', open-source collaboration as method, and people as the measure; generated on provisional boundaries with precision disclosure and a recomputation requirement after official data release."
...
![Overall Concept and Narrative Spine](assets/figures/site-overview.en.png)
...
![Slow Mobility and Blue-Green Space](assets/figures/mobility-bluegreen.en.png)
