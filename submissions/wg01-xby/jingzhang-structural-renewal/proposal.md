...
| 指标 | 数值 | 数据类型 |
|------|------|---------|
| 用地面积 | [metric:site_area_sqm] 平方米 | [data:geometry/site_boundary.geojson] |
| 绿地面积 | [metric:green_space_area_sqm] 平方米 | [data:geometry/green_space.geojson] |
| 公共空间面积 | [metric:public_space_area_sqm] 平方米 | [data:geometry/public_space.geojson] |
| 建筑基底面积 | [metric:building_footprint_area_sqm] 平方米 | [data:geometry/buildings.geojson] |
| 绿地率 | [metric:green_ratio] | AI计算 |
| 公共空间占比 | [metric:public_space_ratio] | AI计算 |

> **EPSG:4548投影计算**：site_area_sqm = 3,692,893.005 m²（约369.29 ha），数据来源：[source:SRC-PROVISIONAL-BOUNDARIES-2026]
