...
- **Building renewal**: a low-disturbance, organic renewal model guided by small parcels, open ground floors, and affordable space; the conceptual retain-renovate-demolish ratio is approx. 11% retained, approx. 39% renovated, and approx. 50% newly built (a belt-wide conceptual statistic, not a parcel-level conclusion).
