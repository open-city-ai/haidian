## v4.20 — Z1–Z3 验收门槛结构化实证（2026-08-23）
...
- 新增验收门槛规范 `visual/assets/z1_z3_pilot_gate.json`（role=verification_script），依据 metrics.json 逐项定义 Z1–Z3 验收门槛，评审可对照本地核验，退出码 0/1。
