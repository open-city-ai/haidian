...
/* Render the proposed Mobility Commons identity and three public experience nodes. */
const fs = require('fs');
...
function board(lang) {
  const zh = lang === 'zh';
  const title = zh ? '共行环：交通系统的品牌与公共体验入口' : 'MOBILITY COMMONS: IDENTITY AND PUBLIC EXPERIENCE ENTRIES';
