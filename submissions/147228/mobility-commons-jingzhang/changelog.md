...
- 将三处重点区的概念强度和层数表改为公共界面与可逆服务关系，只比较服务先后、暂停条件和资料缺口，不给出容积率、层数或建筑高度范围。
- 中英文正文与离线报告同步重渲染；保留公告约面积仅作任务尺度，官方边界、权属、消防、市政和现状证据继续登记为待补资料。
- 本轮是空间表达与硬约束修复，不声称官方提分、实施授权或公共 gallery 发布。
