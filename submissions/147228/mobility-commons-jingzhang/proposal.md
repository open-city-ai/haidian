...
交通动作不能替代城市设计。本节只把三处重点区的交通角色翻译成可比较的公共界面、服务先后和可撤回关系，不改变现有几何，也不代替控规、权属或工程控制。公告约面积 192.1、104.3、72.0 公顷仅作任务尺度，不是现状建筑面积、地块边界或开发控制指标 [data:geometry/key_areas.geojson#PROV-KEY-001] [source:OFFICIAL-ANNOUNCEMENT]。

| 重点区 | 空间关系 | 可逆服务关系 | 首先补齐的专业证据 |
| --- | --- | --- | --- |
| 众智园 AI 自主创新加速区 | 企业入口、班车候车、装卸与消防净空分层，公共首层优先服务到岗和物流 | 先开放人工交通台账与观察位；具身测试、接口模拟和维护后场可暂停、可撤回，不切断步行与无障碍主线 | 现状建筑、能源与消防、产权、企业 OD 和路缘测绘 |
| 北京 AI 原点社区 | 社区服务台、连续步行/无障碍路线、遮雨候车与日常服务相邻 | 普通路径先提供人工、电话和纸面入口；技能再造与代际共学可分段启用，服务不以账号或设备为前提 | 无障碍走查、居民服务基线、权属、照护与夜间安全证据 |
| 大钟寺 AI 产业聚集区 | 轨道换乘、骑行停放、公共首层和路缘装卸形成清晰分界 | 先做轨道到达、人工解释和路缘观察；活动、数据展示和接口试验可收回，不占用居民日常通行 | 站口客流、路缘计数、交通组织、消防与市政接口 |

上述关系只回答“先比较哪些公共界面、谁可以暂停、资料缺口在哪里”，不回答最终开发控制、建筑规模或工程断面；专业团队须在现状测绘、控规核验、产权、消防、结构、市政和公众参与完成后再深化 [depth:height_massing_character] [depth:development_intensity_controls]。
