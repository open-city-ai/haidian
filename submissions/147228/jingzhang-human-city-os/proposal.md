...
iteration: "v0.8"
summary: "以人的尊严为底座、以机器可调用为增量、以能源气候和治理为硬约束的可回滚城市版本；v0.8 把中关村科技服务翼落成可回接的场景卡，并加入三组可复算的概念空间取舍参数，同时把任务书 13 项统一评审维度与仓库 formal scorecard 的 7 项工作流问题分开映射到同一组包内证据，既有临时几何、已知指标与 unknown 均保持原值。"
