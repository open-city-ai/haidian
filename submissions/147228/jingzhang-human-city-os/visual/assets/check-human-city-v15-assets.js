...
const evidence = {
  ...
  status: ok ? 'PASS' : 'FAIL',
  checks,
  interpretation_zh: 'PASS 只证明 v1.5-v2.5 既有资产与 v3.0 节点/交付合同的结构、边界和双语回接可读；尺寸、成本、角色、SLA 与现场验收仍保持设计目标、低置信、未确认、未观测或 not_run，不证明官方评分、现场绩效、批准或实施。',
  interpretation_en: 'PASS proves only that the v1.5-v2.5 assets and v3.0 pilot-node/delivery contract resolve structurally with declared bilingual boundaries. Dimensions, costs, roles, SLAs, and field acceptance remain design-target, low-confidence, unconfirmed, unobserved, or not-run; this does not prove official scoring, field performance, approval, or implementation.'
};
