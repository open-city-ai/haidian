---
title: "Jing-Zhang Open Pulse, The City Releases Its Own Civic Versions"
...
![Civic version contract, whole-belt space and current evidence state](assets/figures/site-overview.en.png)
...
![One public spine, three civic release stations and two feedback wings](assets/figures/land-use-structure.en.png)
...
![Three civic release stations: test, review, release and stop conditions](assets/figures/key-areas.en.png)
...
![Ordinary route, three east-west seams and the S-02 release ladder](assets/figures/mobility-bluegreen.en.png)
