...
- 增加众智园、AI 原点、大钟寺三处公共版本发布接口原型，把首 168 小时/首 12 周时间合同映射到可进入、可申诉、可回退的空间节点。
- 增加中英文 1:500/1:50 概念关系图、机器可读合同、正例与五个负例；继续保持 HOLD、零授权、零现场观察、`unknown` baseline、空绩效和空现场声称。
- 明确普通服务、人工接收、公开状态、申诉、维护、BLACKOUT 回到 BASE 与 BEQUEST 清权边界；不把空间原型写成施工、许可或现场部署结果。

## v2.1 - 2026-08-21

- 在 94 分高水位包之上增加首 168 小时 / 首 12 周可回退发布合同，明确 BASE、BOOST、BLACKOUT、BEQUEST 四种状态。
- 增加普通服务先行、无 App 路径、人工接管、申诉、维护、回退和不扩容条件；所有现场授权、观察、baseline 与绩效结果继续保持空值/HOLD。
- 增加中英文发布链图板和离线 fail-closed runner/negative fixtures；不把设计合同写成现场部署或正式绩效。
