...
> **The city is not AI's showroom; it is a co-author.**
>
> **Culture turns AI into civic products.**
>
> **Jing-Zhang should not compete to become a “fourth AI park”; it should build the capacity to turn technology into real urban products.**
...
The prior five checks—daily life, legibility, ecology, human sequence and incremental reversibility—remain a checklist on every drawing; they no longer substitute for block and building design. [metric:spatial_decision_check_count] [data:visual/assets/spatial-decision-framework.json]
...
| Three Grounds | Controlled-validation space at Zhongzhiyuan; co-creation space at AI Origin; low-risk public-trial space at Dazhongsi | Three distinct atmospheres, thresholds and levels of public exposure | Three legible districts and urban nodes |
...
| --- | --- | --- |
| Full-stack AI autonomous innovation | Tiered validation package for models, edge systems, robots, and spatial interfaces | Zhongzhiyuan controlled validation; red-team, human takeover, stop, and failure archive |
| World-class AI innovation ecosystem | Network of civic briefs, co-authors, cultural rights, professional services, and adoption | AI Origin co-creation; rights-and-exit audit and twelve-month reuse |
...
| Intelligent and vibrant AI city | Everyday, accessible public service with non-digital backup | Permanent public baseline; access, rest, and help work without participation |
| Global voice in AI governance | Transferable public-space safeguards and rights-and-exit audit | Status desks and Standards Exchange Room; public risk, responsibility, version, and exit evidence |

**Three Zones and Two Wings** operate as a demand-and-supply circuit, not five isolated parks. Zhongzhiyuan handles hard technology and controlled validation; AI Origin converts real briefs through co-creation; Dazhongsi handles low-risk public trial and market adoption. The Zhongguancun Technology-Service Wing supplies talent, IP, capital, compute, and professional services; the Xiaoyue River Scenario Wing supplies neighbourhood, ecology, care, mobility, and public-service problems. Adoption evidence and open tools flow back to both wings to set the next R&D and commission cycle. [metric:core_function_count] [metric:spatial_zone_count] [metric:spatial_wing_count]
...
From a city-leadership perspective, Jing-Zhang is distinctive because research and enterprise supply, near-campus innovation, neighbourhood life, transit commerce, and a century-old public-infrastructure heritage can connect **technical results, civic products, public use, and durable value** in one auditable conversion path. The proposal therefore frames the belt as **a prototype AI-to-civic-value conversion infrastructure for national learning**. This is a design proposition, not a national designation or settled policy. [metric:adoption_core_count]

| Strategic decision | Recommended answer | Public value | Explicit non-commitment |
| --- | --- | --- | --- |
| How is this different from another AI park? | Move from technology concentration to AI-to-civic-value conversion infrastructure | A transferable method for commissioning, testing, low-risk public trial, operating, procuring, and exiting | No national title, new agency, or policy authority is claimed |
...
| How may AI use urban space? | Controlled validation, co-creation, and low-risk public trial; all time-limited and reversible | Risk is matched to public exposure | No substitute for statutory planning, permits, safety, or procurement |
...
| Originality | Civic commissions, cultural-production conversion, rights-and-exit auditing, reversible public interfaces, and public reinvestment |
...
The complete evidence index is `visual/assets/review-evidence-index.json`; the v7.8 cross-file evidence record is `visual/assets/v78-evidence-ledger.json`. They organise evidence and do not predetermine a review decision. [data:visual/assets/review-evidence-index.json] [data:visual/assets/v78-evidence-ledger.json]
...
| Safety validation and governance protocol | Risk grading, explainability, exit | Does not duplicate a stand-alone test field | Connects validation to cultural meaning, low-risk public trial, and twelve-month adoption |
...
| Quarterly creation clock | Weeks to months | Briefs, residencies, making, public trials, review | Reversible workshops, shared courtyards, service interfaces | One-off festivals and wasted content |
...
| Prototype tier - three areas totalling about 368.4 ha | How should different levels of risk and public exposure shape buildings and space? | Controlled validation, co-creation, and low-risk public trial | Technical, cultural, public, and operational thresholds match each area |
...
The three key areas are not three image landmarks. They are three risk gradients: Zhongzhiyuan provides controlled validation with low public exposure and a high technical threshold; AI Origin supports multi-party co-creation at a medium threshold; and Dazhongsi provides low-risk public trial with high public exposure but admits only mature, low-risk outcomes. Projects move among them according to risk and maturity rather than a mechanical geographic sequence, and no park permanently owns a project. [data:geometry/key_areas.geojson#PROV-KEY-001] [metric:key_area_count]

![Civic Production Floor, Nine Transverse Urban Rooms, and interwoven functions](assets/figures/land-use-structure.en.png)
...
The Foundry creates a seven-stage civic commission loop: **Civic Brief -> Cultural Calibration -> Human-AI Co-Production -> Controlled Validation -> Low-Risk Public Trial -> Sustained Adoption -> Public Reinvestment**. Every stage has a defined place, accountable actors, evidence, and stop conditions. Technology without a real user cannot enter co-production; content without cultural and rights provenance cannot enter a public trial; and a trial without evidence of daily reuse cannot become fixed construction. [metric:workflow_stage_count] [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]
...
- Low-Risk Public Trial: mature low-risk work is tested reversibly on the Civic Production Floor with human explanation, non-digital alternatives, and feedback channels.
...
### 2. Rights-and-exit audit: one record from technical result to durable civic value

Each project maintains one evidence-bound **rights-and-exit audit record** from commission and cultural calibration through controlled validation and low-risk public trial to adoption, renewal, or exit. It is not a government permit, product certification, procurement endorsement, or executed legal contract. It records who commissioned the work, who benefits, where it may operate, who is accountable, how it is funded and maintained, and how it stops in one evidence object. [data:visual/assets/rights-and-exit-audit.schema.json] [metric:rights_and_exit_audit_schema_count]

**One project, one audit record; one decision, one accountable role; one stage, one evidence set; one failure, one exit route.** This is a shared delivery checklist for planning, finance, culture, technology, and operations teams.

| Audit check | Required question | Human review role | Consequence of failure |
| --- | --- | --- | --- |
| Need and baseline | Is there a real commissioner, beneficiary, and non-AI baseline? | Civic commission and public-interest review | Do not start, or rewrite the problem |
| Culture and rights | Are facts, local knowledge, contemporary interpretation, AI generation, authorship, data, and licences clear? | Culture, rights, community, and user review | Research may continue; no public trial or distribution |
| Controlled validation | Are risk, spatial containment, takeover, accessibility, fallback, and exit workable? | Technical, safety, spatial, and frontline-operation review | Return to simulation or a manual process |
| Low-risk public trial | Can ordinary users understand status, decline participation, complain, correct, and retain basic service? | Public-service, accessibility, and site-operation review | No high-exposure public deployment |
| Adopt, renew, or exit | Do twelve months of evidence support continued use? | Public, operator/procurer, independent evaluator, and audit | Adopt, renew for a term, reduce, roll back, or exit |

The audit record covers public value, cultural authenticity, rights and provenance, safety and environment, operations, capex, annual opex, exit reserve, and stop conditions. Status changes are evidence-bound; a company cannot rename a successful display as civic adoption. The synthetic example remains `concept_only`, with zero months observed and no deployment, funding, procurement, or approval. [data:visual/assets/example-rights-and-exit-audit.json] [metric:rights_and_exit_audit_field_count]

```json
{
  "audit_record_id": "SYNTHETIC-JZ-001",
  "proposal_status": "concept_only",
  "spatial_setting": {
    "use_condition": "co_creation",
    "time_limited": true,
    "reversible": true,
...
| Creative calls and matching with public settings | Real users issue briefs before culture and technology co-produce | Civic Commission Room and co-creation space | Commissioner, beneficiary, co-authors, stop conditions |
| Resource linking and brand-rights design | Permit time-limited co-production and licensed distribution; prohibit purchase of public rights | Low-risk public-trial space and Public Status Desk | Rights disclosure, licence term, separation of public and commercial interfaces |
| Industrial coordination and long-term operation | Test, reuse, reasonable payment, maintenance, and exit all enter adoption decisions | Corridor service network, Conversion Office, rights-and-exit audit | Twelve-month reuse, costs, maintainers, creator pay, public reinvestment |
...
| --- | --- | --- | --- |
| Land and space | Three key areas; yard, arcade, workshop, test ground, public-trial room | Official boundary, ownership, use, survey, structure, fire, accessibility | Remain unknown; return to concept; no demolish/retain decision |
...
| Testing, culture, standards | Three Grounds, Xiaoyue River wing, R03/R09, G0–G4 | Baseline, owner, stop and rollback; evidence/rights/pay; applicable standards and human judgement | Close test, remove content, halt escalation, enter professional review |
...
| Future Science City | Frontier R&D, engineering, specialist talent, validation needs | Add cultural context, public explanation, and spatial-use conditions to research prototypes | Rights-and-exit audit and prototype protocol ready for real-city validation | Provenance, risk, professional review, removability |
...
| --- | --- | --- | --- | --- |
| R01 Public Trial Room | Help ordinary people understand mature low-risk projects | Enterprises and content teams | Public-trial forecourt, human interpretation, non-digital wayfinding | Transit connection and civic living room |
...
### 3. Three ordinary spatial objects: public baseline, reversible interface, time-limited service

The planning innovation is not another category of "AI land". It converts AI's right to use space into time-bound, risk-matched, publicly safeguarded and revocable conditions. All Nine Rooms and three key areas use three ordinary spatial objects. [data:visual/assets/urban-room-control-code.json] [metric:area_role_count]

| Spatial layer | Time responsibility | Content | Binding rule |
| --- | --- | --- | --- |
| Permanent public baseline | Long term | Continuous access, accessibility, shade and rest, physical wayfinding, staffed help, quiet bypass, basic lighting | Remains usable when AI fails, is removed, or changes supplier; cannot be displaced by events or paid services |
| Reversible public interface | Weeks to seasons | Commission tables, open making, observation, status displays, climate components, public explanation | Declares occupancy period, maintainer, rights, removal, and site restoration |
| Time-limited AI service | Hours to twelve months | Models, terminals, robots, digital content, and assisted services | Holds an active rights-and-exit audit record, retains human and non-AI routes, and never renews automatically |

Zhongzhiyuan is intended for controlled validation, AI Origin for co-creation, and Dazhongsi only for mature low-risk public trial after the applicable professional reviews. A project cannot lower its safeguards merely by moving location. Statutory controls, dimensions, fire, heritage, transport, capacity, and municipal conditions remain subject to official inputs and professional design. [metric:spatial_layer_count] [assumption:A-CONTROLS-001]
...
| P5 Public Trial Steps | Launch events generate traffic but little understanding or correction | Small steps facing an everyday street, staffed interpretation desk, status and exit sign | Ordinary seating and meeting place outside trial hours | Users can explain purpose, status, responsible person and refusal route |
...
Combination follows one order: **protect P4 quiet bypasses and everyday ground floors first; add P1/P2 only for real commissions; introduce P3/P5 only after the rights-and-exit audit is complete; build P6 from day one, not at the end.** The corridor can therefore begin with one crossing, one porch and one courtyard rather than depend on a single large capital project.
...
Six safeguards must coexist before a low-risk public trial: basic service is free; a physical, telephone, or on-site non-digital route exists; staffed takeover is available; accessibility is verified through field tasks rather than screenshots; a quiet no-scan bypass is provided; and the accountable owner, complaint route, response clock, and restoration plan are public. If any safeguard fails, the AI layer shuts down while the permanent public baseline continues. [metric:public_safeguard_count]
...
![Three key areas: controlled validation, co-creation, and low-risk public trial](assets/figures/key-areas.en.png)

### A. Zhongzhiyuan — controlled validation
...
### B. Beijing AI Origin — co-creation
...
The only numbered gates in this companion are the five canonical statutory-delivery hold points below. [metric:statutory_gate_count]
...
| G3 Specialist Technical | Transport, rail, heritage, fire, daylight, wind/heat/noise, drainage, municipal and access checks pass current standards | No works issue or public trial |
| G4 Built and In Use | As-built compliance, field-tested public baseline, maintenance handover and 12-month adopt/exit review | Correct, reduce or remove the reversible layer |
...
The twelve scenarios are not a feature list. Each is a spatial decision loop with a real problem, a limited AI role, named human review, a changed spatial object, a complete non-AI route, and a physical rollback. The Chinese primary and the structured v7.8 evidence ledger remain authoritative. [metric:scenario_count] [data:visual/assets/v78-evidence-ledger.json#scenarios]

| Scenario | Site / spatial host | Real problem | Limited role of AI | Human review | Spatial object changed | Non-AI route and rollback |
| --- | --- | --- | --- | --- | --- | --- |
| Civic Problem Commission | AI Origin / Civic Commission Room | Residents and frontline institutions lack a low-threshold way to turn a real problem into a designable task. | After de-identification, classify issues, retrieve similar cases, and flag evidence gaps. | Staffed-service operator, domain specialist, and proposer confirm. | Commission Arcade display, queue position, and opening hours. | Paper intake and human referral; delete model classification and restore the human record. |
| Thermal Comfort and Shade Co-design | AI Origin / Co-author Room | Courtyard routes, activity, and the quiet bypass may conflict in summer heat. | Compare reversible canopy, tree-crown, and activity-time options. | Landscape designer, operator, residents, and accessibility adviser. | Canopy position, tree beds, seating, public route, and activity hours. | Field walk and physical mock-up; remove the reversible canopy and restore the original route. |
| Accessible Quiet Bypass | AI Origin / Neighbourhood Content Room | High-intensity activity may displace quiet, accessible, non-digital everyday movement. | Compare route conflicts without collecting personal trajectories. | Accessibility specialist, users, and fire-safety reviewer. | Quiet bypass, wayfinding, waiting points, and activity boundary. | On-site guide and tactile/high-contrast signs; remove temporary activity facilities. |
| Cultural Provenance and Rights Calibration | AI Origin / Cultural Evidence Room | AI cultural content may miscite history, omit attribution, or infringe rights. | Assist retrieval, compare versions, and flag gaps; never decide rights automatically. | Curator, historical-source specialist, legal reviewer, and rightsholder. | Labels, provenance worktable, removable display, and public enquiry interface. | Printed source book and human consultation; remove the content and keep an empty display bay. |
| Controlled Last-mile Robot Validation | Zhongzhiyuan / Physical-AI Validation Room | Robot tests may conflict with pedestrians, fire access, and logistics. | Simulate different time windows, routes, and conflict points. | Safety engineer, fire adviser, operator, and on-site safety staff. | Test loop, observation buffer, closable gate, and timed loading window. | Manual trolley and conventional delivery; close the test gate and restore manual logistics. |
| Embodied-AI Safety Test | Zhongzhiyuan / Physical-AI Validation Room | Embodied devices lack a graded, observable, and pausable validation space before public contact. | Generate boundary cases and assist replay of failure events. | Robotics specialist, safety officer, ethics reviewer, and operator. | Test cells, separation zone, observation window, and emergency-stop points. | Mechanical protection, human inspection, and a physical test checklist; return to the previous enclosed test level. |
| Compute and Energy Load Sandbox | Zhongzhiyuan / Standards Exchange Room | Compute demand may be converted into unsupported data-centre or energy promises. | Compare external compute, off-peak use, task compression, and local deployment. | Energy, IT, procurement, and operations specialists. | Reserved interfaces, opening hours, and heat separation in the shared equipment room; no plant size is asserted. | Human capacity calculation and service procurement; remove temporary equipment and restore ordinary use. |
| Xiaoyue River Micro-stormwater and Shade Trial | Xiaoyue River Scenario Wing / Neighbourhood Content Room | The public experience route must address ponding, shade, ecology, and accessibility together. | Compare reversible planters, permeable sample strips, and activity diversions. | Water, landscape, ecology, accessibility, and maintenance specialists. | Trial strip, seating, temporary planting, and diversion signs. | Human inspection and conventional sample comparison; remove reversible components. |
| Station-City-Heritage Wayfinding | Dazhongsi / Low-risk Public Trial Room | Metro exits, everyday commerce, and a quiet heritage interface may create wayfinding and movement conflicts. | Compare wayfinding, queues, seating, and activity-boundary options. | Transport, heritage, accessibility, operations, and public representatives. | Wayfinding posts, waiting area, quiet bypass, and low-risk public-trial entrance. | Fixed signs, human guidance, and a paper map; remove temporary wayfinding and trial facilities. |
| Low-risk Civic Public Trial | Dazhongsi / Low-risk Public Trial Room | Civic trials of AI products can become screen displays without everyday use, refusal, or exit. | Assist reviewed multilingual explanation, accessible versions, and non-identifying feedback grouping. | Product owner, curator, accessibility reviewer, and floor staff. | Removable stand, seating orientation, trial hours, and quiet-bypass boundary. | Human explanation, physical instructions, and paper feedback; remove equipment and restore the everyday civic living room. |
| Peripheral Interpretation for Juesheng Temple | Dazhongsi / Cultural Evidence Room | A technology narrative may obscure real temple and bell culture or cross a heritage boundary. | Assist multilingual drafting and source comparison; never generate historical facts. | Museum, heritage, historical-source, and language specialists. | Peripheral removable labels, silent guide, and stopping points only. | Human guide and paper labels; remove the added reversible labels. |
| Nine-Room Public-Service Routing | One Line, Three Grounds, Nine Rooms / all nine rooms | The Nine Rooms may remain conceptual if people cannot tell where to go or when staffed help exists. | Retrieve the most suitable service room and make the human entrance explicit. | Central service desk and staff in each room. | Opening hours, wayfinding, and temporary service-desk configuration. | Printed master plan, phone, and human consultation; disable recommendations and keep fixed wayfinding. |

### Three tests compare options and change spatial objects

| Test | Baseline and A/B alternatives | Limited AI role and human review | Spatial change and stop owner | Failure and rollback |
| --- | --- | --- | --- | --- |
| Zhongzhiyuan controlled last-mile robot test | Baseline: manual trolley and conventional delivery; actual conflicts pending measurement. A: all-day shared-road test with little spatial change but high exposure. B: limited time window, geofence, closable gate, human safety officer, and observation buffer. Recommend B, subject to equipment and site evidence. | Only after equipment and site data exist, simulate conflicts, blind spots, and timing; never replace safety judgement. Robotics safety, fire, operations, and user representatives review. | Test loop, gate, emergency-stop points, observation gallery, and timed loading window. Stop owners: on-site safety lead and fire reviewer. | Any boundary breach, signal loss, emergency-stop failure, or person entering the buffer; close the test gate and restore manual logistics. |
| AI Origin controlled multimodal public-service validation | Baseline: staffed window, paper fact cards, and offline explanation. A: unattended terminal on the public route, efficient but over-collecting and excluding non-digital users. B: staffed window first, limited model inside the workshop, sources visible, one-step human transfer. Recommend B. | Retrieve public material, compare accounts, and flag conflicts and gaps; never generate unsourced local history. Cultural research, frontline service, accessibility, copyright, and resident representatives review. | Staffed window, fact cards, public/production boundary, human-transfer prompt, and opening hours. Stop owners: staffed-service lead and cultural-fact reviewer. | Any unsourced conclusion, failed human transfer, unnecessary data collection, or occupation of the quiet bypass; close the model terminal and restore paper fact cards and fully human service. |
| Dazhongsi edge-based multilingual low-risk public-trial validation | Baseline: paper bilingual labels, human explanation, and everyday movement; signal and sound/light baselines pending. A: continuous cloud-based large-screen display, visually strong but network-dependent and intrusive. B: bounded edge content, small removable stand, human explanation, quiet bypass, and paper backup. Recommend B. | Use a bounded edge glossary for multilingual translation, accessible rewriting, and offline-state checks. Heritage, transport, curatorial, accessibility, operations, and public representatives review. | Removable stand, edge cabinet, paper backup, seating, wayfinding, and limited hours. Stop owners: site operations lead, cultural-content reviewer, and quietness steward. | Any untraceable mistranslation, offline failure, interference with movement or quietness, or absence of human explanation; remove equipment and stand, then restore paper labels and the everyday civic living room. |
...
These seven journeys test goal, path, friction, spatial consequence, no-AI route, and verification. They differ from the operational roles below: journeys verify use, while roles describe the division of work. Neither creates personal scoring or automatic profiling. [metric:journey_persona_count]

## Cultural Production, Rights Boundaries, and Market Mechanism

### 1. Rights-and-exit audit: every project must answer the same core questions

The Foundry does not add an abstract digital platform. Every civic commission maintains one rights-and-exit audit record. [data:visual/assets/rights-and-exit-audit.schema.json] [metric:rights_and_exit_audit_field_count]

The record asks whose problem is being solved, what essential service and non-digital route remain, and who may benefit or be harmed. It separates historical fact, local knowledge, contemporary interpretation and AI generation; names reviewers and correction routes; records materials, data, models, human edits, authors, licences and expiry dates; states risk, test boundary, human takeover, accessibility, energy, noise, waste and removal; and identifies costs, maintainers, revenue source, creator pay, public reinvestment, reuse and exit.

The audit record is not official certification. It is a design protocol for professional scrutiny, public understanding, and project review. Matters of law, engineering, and administrative approval remain with competent authorities. [source:AUTHOR-CULTURE-METHOD]
...
| New AI culture | Publish model capability and human responsibility together, making technology understandable, refusable, and correctable | Status desk, staffed window, stop/exit sign, twelve-month adoption review record | AI STATUS label shows purpose, data, risk, accountability, refusal, and exit |
...
![Rights-and-exit audit, rights boundaries, and civic-adoption evidence](assets/figures/metrics-evidence.en.png)

## Talent, Governance, and Annual Operation

### 1. Operational roles and division of work

| Operational role | Contribution | Space and service needed | Right protected |
| --- | --- | --- | --- |
...
| Creator and designer | Content packs, experience modules, aesthetic judgement | Open workshop, public-trial space, residency | Attribution, pay, licence, exit |
...
### 2. Three contribution landmarks record public capability

The route is not a hero ranking. It records how the city solves problems collectively through three lightweight, updateable landmarks: a controlled-validation observation court at Zhongzhiyuan publishes test status, failures and reusable rules; a co-creation table at AI Origin records authors, rights and handovers; and a low-risk public-trial status desk at Dazhongsi shows whether projects entered normal service, were corrected or exited. None carries a permanent corporate or individual ranking. [metric:pilgrimage_landmark_count]

### 3. Governance and five annual beats

A conceptual Civic Foundry Conversion Office is proposed without assuming administrative status, staffing, or a confirmed lead agency. A public-interest and policy interface sits above it. Professional review covers planning and public space; technology, data, and safety; culture, rights, and authorship; and finance, procurement, and independent audit. Site and service operators own daily maintenance and incidents. Community, accessibility, and public representatives hold correction and stop routes. No sponsor may control problem selection, review, and returns simultaneously. [source:CASE-SEOUL-AI-HUB]

Five annual beats are proposed: spring publication of Civic Commissions and evidence; early-summer cultural calibration, co-author teams, and residencies; summer closed or limited validation; autumn low-risk public trial of mature projects on the public floor; winter publication of adoption, cost, failure, and reinvestment review. Community services and daily public space continue throughout the year and do not stop for the annual programme. [metric:annual_cycle_stage_count]

The annual operating brand is proposed as **CIVIC FOUNDRY OPENING CYCLE / 万象开场**, not another generic AI conference. Spring “City Sets the Brief”, early-summer “Co-Make”, summer “Controlled Field”, autumn “Public Trial”, and winter “Adopt or Exit” share one logo, status palette, and rights-and-exit audit record. Every season leaves a usable brief, rights pack, test report, service route, or exit record. Communications never substitute attendance for value, close the park for staging, or present an unapproved prototype as a city outcome.

Developers progress through open problem–prototype–controlled validation–low-risk public trial–twelve-month adoption. Cultural creators progress through fact and context–shared attribution–licensed distribution–reuse pay–public reinvestment. International contributors progress through an open problem pack–local co-production–local review–bilingual evidence pack–cross-city transfer. The three routes meet at the co-creation table while retaining their own professional and rights review routes.
...
2. Publish the rights-and-exit audit template and the canonical G0–G4 definitions—Data Freeze, Statutory Control, Spatial Delivery, Specialist Technical, and Built and In Use—together with complaint, correction, data-closure, and exit routes.
...
4. Identify one reversible candidate prototype in each key area and review its controlled-validation, co-creation, or low-risk public-trial condition, together with removal, maintenance, and public impact.
...
| PKG-03 Rights-and-Exit Audit and Status Desk | Programme, law, data, cultural rights, audit | Open public protocol; research or public-interest support | Accountability, privacy, complaint, portability, shutdown |
| PKG-04 Three Spatial Prototypes | Site operation, R&D, safety, frontline maintenance | Research funding; each prototype carries removal reserve | Controlled validation, co-creation, or low-risk public trial; takeover drill |
...
| PKG-06 Twelve-Month Adoption and Reinvestment | Operator, service/procurement, public, independent evaluation | Adopted-service funding and earned revenue | G4 Built and In Use records use evidence; review adopts, renews, reduces, or exits |
...
| P06 | Co-Author Workshops and Provenance Lab | Creators, R&D, copyright, users | Material, model, data, author declarations complete | Complete licence and compensated labour; unresolved rights stop public trial |
| P07 | Zhongzhiyuan controlled-validation space | Park, enterprise, safety, emergency, independent review | Test protocol and shutdown capability complete | Isolated risk and reviewable failure; stop immediately on boundary breach |
| P08 | Dazhongsi low-risk public-trial space | Operator, merchant, curator, transport, resident | Public baseline, evacuation, noise, staffed service pass | Twelve-month adoption review; never opening-day traffic alone |
...
| P10 | Rights-and-Exit Audit and Public Status Desk | Operations, culture, copyright, safety, audit | Data definitions, responsibility, interests disclosed | Project status legible; personal data not public |
...
v7.8 retains one machine-readable rights-and-exit audit record and six delivery packages as auditable structures; neither count implies deployment, budget or government authority. [metric:rights_and_exit_audit_schema_count] [metric:delivery_package_count]
...
| Culture and rights | Completeness of sources, authors, licences, corrections | Establish baseline | No low-risk public trial if incomplete |
...
- **Cultural hallucination**: historical fact, local knowledge, contemporary interpretation, and AI generation are separated; unsourced content never enters low-risk public trial.
...
- **Unsustainable operations**: maintenance staff, energy, content updates, insurance, safety, removal, and renewal costs enter every project record; unaffordable work is not made permanent.

Copyright, sources, assumptions, self-check, standards, professional depth, and announcement tasks are cross-referenced in `report/copyright_statement.md`, `sources.json`, `assumptions.json`, `self_check.json`, `standard_matrix.json`, `design_depth_matrix.json`, and `compliance_matrix.json`. [data:visual/assets/v78-evidence-ledger.json#scenarios] [data:geometry/constraints.geojson#ANCHOR-JUESHENG]

The rights-and-exit audit, canonical G0–G4 gates, ordinary spatial conditions, public safeguards, funding channels, first-100-day actions, and delivery packages are represented as auditable records or counts. The narrative retains only representative claim-adjacent anchors. [metric:rights_and_exit_audit_schema_count] [metric:first_100_day_action_count] [metric:delivery_package_count] Complete definitions, formulas, source files, confidence, and assumptions remain in `metrics.json` so machine indexes do not obstruct professional reading.
