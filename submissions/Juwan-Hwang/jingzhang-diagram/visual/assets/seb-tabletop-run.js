...
const FIXTURES_PATH = fs.existsSync(path.join(HERE, "jingzhang-seb-fixtures.json")) ? path.join(HERE, "jingzhang-seb-fixtures.json") : path.join(HERE, "seb-tabletop-fixtures.json");
