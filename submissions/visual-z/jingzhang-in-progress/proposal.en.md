---
title: "JINGZHANG IN PROGRESS: Keep the City Open"
...
license: "CC-BY-4.0"
summary: "A construction-time urbanism proposal that keeps the Centennial Jingzhang AI Innovation Belt open while it changes: a three-layer contract for continuous access, an open-works buffer, and permanent handover, joined to 1:1 embodied-AI construction tests, a public co-design model room, and uninterrupted resident and business services."
...
![Sources, provisional geometry, and implementation evidence chain](assets/figures/site-overview.en.png)
...
![Three scopes, three-layer contract, and three-area roles](assets/figures/land-use-structure.en.png)
...
![Three-area roles, twelve scenarios, and pilot index](assets/figures/key-areas.en.png)
...
| SC-07 | Zhongzhiyuan test cell; workers, researchers; segregated robot cell | Embodied AI tests handling or assembly | Safety officer can physically isolate energy; manual work plan is backup | Progress from no-load to dummy load to live load; boundary breach, abnormal force, or person intrusion isolates energy |
| SC-08 | Zhongzhiyuan test cell; equipment team; emergency-stop and lost-link rig | Monitors latency, location, and lost link | Independent safety officer leads; mechanical lock and manual evacuation | Drill after every change; no load operation until emergency stop and lost-link protection pass |
...
![Continuous access, blue-green interfaces, and utility-service floors](assets/figures/mobility-bluegreen.en.png)
...
![Metrics, scenarios, responsibility, and handover evidence matrix](assets/figures/metrics-evidence.en.png)
