...
![证据链、临时边界和双轨概念总览](assets/figures/site-overview.png)
...
![第一轨、第二轨、道岔与场域空间结构](assets/figures/land-use-structure.png)
...
![任务书总映射：三大定位、五大功能、三区两翼与区域协同](assets/figures/taskbook-collaboration.png)
...
![众智园、AI原点社区与大钟寺三种原型比较](assets/figures/key-areas.png)
...
![双轨、五类移动网络与蓝绿伴随系统](assets/figures/mobility-bluegreen.png)
