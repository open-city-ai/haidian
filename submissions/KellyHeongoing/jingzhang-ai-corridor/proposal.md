...
![启·序章｜时空序章台概念表达](assets/media/scene-s01.png)

![创·序貌｜清河创新界面概念表达](assets/media/scene-s02.png)

![尚·序风｜四象限会客厅概念表达](assets/media/scene-s04.png)

![承·序脉｜百年时序步道概念表达](assets/media/scene-s03.png)
...
识别规范：主色为深炭黑 `#0A1119`、铁路铜金 `#D1A85A`、电光蓝 `#64D5E8`；生态辅助色为翡翠绿 `#55C7AA`，活力强调色为珊瑚橙 `#F0B44C`。导视采用“时间轨/智能轨”双层编码：时间轨使用 1909、1920s、2020s 等年代编号，智能轨使用 S01–S08 场景编号；节点格式统一为 `JZ–序–场景号`，例如 `JZ–启–S02`。图形、字体、企业标识和公共艺术在实施前完成清权与专业深化 [source:AGENT-TASKBOOK] [depth:brand_wayfinding_system]。
