---
title: "百年京张·霓光脊：可见、可问、可停的公民 AI 创新带"
subtitle: "一脊、三引擎、两翼、十二端口、双账本"
author_github: "scarletkc"
language: "zh"
...
官方公开依据采用“能证明 / 不能证明 / 触发动作”三栏纪律。检索完成不等于控制条件到位；相邻地块有数值也不等于本方案可以借用。

| 官方公开依据 | 本轮可证明 | 不能证明与触发动作 |
| --- | --- | --- |
| 京张沿线 HD00-1601 等街区控规草案公示采信通告 | 证明规划名称、2022—2035 年期限、公示时段，以及部分道路节点意见已被回应 | 页面正文没有本提交适用的 polygon、容积率、高度分区、密度、退线、权属或市政容量；审定图则到位即在 G0 由规划负责人整包复算 [source:HD-JINGZHANG-CONTROL-PLAN-ADOPTION-20250208] |
| 蓝景丽家综合实施方案公示采信通告 | 证明相邻项目的高度、日照、用地、权属、配套和交通必须地块化公示与审查 | 其中 60 米、36 米、用地与 700 平方米配套均只属于具名 HD00-1603 地块，禁止移植到三处 provisional 重点区 [source:HD-LANJINGLIJIA-SCHEME-ADOPTION-20250606] |
| 海淀区城市更新导则（2025 年版）征求意见稿 | 为公众参与、功能复合、AI 创新街区、开放首层、公共空间、慢行与无障碍提供公开征求意见阶段的定性参考 | 尚不能证明正式印发或法定效力，也不提供本项目地块强度、测绘、权属或审批；只能辅助方法讨论，不能生成数值 [source:HD-URBAN-RENEWAL-GUIDELINE-2025] |
| 北京首批人工智能创新街区公开信息 | 证明“一核多点”背景与原点社区的公开定位 | 不证明本方案已获委托、资金、数据共享、建设许可或任何区域合作 [source:BJ-AI-INNOVATION-DISTRICTS-20260106] |

![总体范围、三处重点区域与霓光脊关系](assets/figures/site-overview.png)

本次国际案例只提炼运行机制，不复制形态、指标或治理权限。图片生成资产只作为非证据性封面，五张核心图均由提交 GeoJSON 与 metrics.json 本地生成。完整来源、检索日期、发布者与用途限制见 sources.json，版权和工具说明见 report/copyright_statement.md。[source:IMGGEN-HERO]

## 三层范围工作框架

总体结构为一脊、三引擎、两翼、十二端口、双账本。一脊是百年轨道公地，把京张遗产、连续慢行、蓝绿空间与 AI 公共体验组织成南北共同骨架。三引擎对应众智园可信铸造花园、北京 AI 原点社区零号站开源公地、大钟寺智能体市集。两翼分别承接中关村科技服务与小月河真实城市场景。十二端口采用可识别、可管理、可停用的试点入口，避免形成满城传感器。[depth:three_level_scope_framework]
...
产业生态按五步运行：研究开源、验证转化、城市采用、公众评议、对外传播。高校与研究机构不只提供人才，也承担可复现研究和模型卡；众智园提供安全、算力与物理 AI 验证；原点社区提供开源协作、创业服务和人才生活；大钟寺让智能体、终端与内容服务在真实消费环境中接受选择；独立评议席贯穿每一步。品牌中文名为百年京张·霓光脊，英文名为 JINGZHANG NEON SPINE。标识由两条轨道括号夹住一条可中断信号线，表达连接、人工停用与重新协商。[standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]

| 案例 | 可转化机制 | 京张转译 | 证据 |
| --- | --- | --- | --- |
| 新加坡榜鹅数码园区 | 教育、产业、社区共址，开放数字平台支撑试验 | 共享但分级授权的测试端口，先仿真、后封闭测试、再公共试点 | [source:CASE-PUNGGOL] |
| 赫尔辛基智慧城市 | 敏捷试点、居民共创、真实环境评价 | 每个试点设基线、停止条件与公开复盘 | [source:CASE-HELSINKI] |
| 伦敦国王十字 | 铁路工业遗产、大学锚点与公共空间共同激活 | 让京张历史成为学习、交往与开放创新的社会基础设施 | [source:CASE-KINGS-CROSS] |
| 巴黎 STATION F | 历史建筑内的多计划创业平台与共享支持 | 原点社区采用多计划共平台，降低团队寻找空间与服务的成本 | [source:CASE-STATION-F] |
| 蒙特利尔 Mila | 开放科学、人才、产业转化与负责任 AI 相连 | 众智园建立研究、治理、转化三角 | [source:CASE-MILA] |
| 多伦多滨水区数字评议 | 独立审议、隐私优先和民主问责 | 公民 AI 评议席与公开测试登记簿独立于供应商 | [source:CASE-WATERFRONT] |
| 阿姆斯特丹 Marineterrein | 公共可达、专业管理的户外 Living Lab | 小月河翼设置真实但有边界的水陆测试，并规定时段与撤场 | [source:CASE-MARINETERREIN] |

七个案例说明：创新城区既需要研究与企业密度，也需要测试方法、公共空间、历史再利用和独立数字治理。方案尤其吸收敏捷试点的停止条件、Waterfront Toronto 的独立评议、Marineterrein 的边界化实测；不把平台规模、楼宇数量或投资额移植为京张指标。结合当前公开数据缺口，产业空间只给功能与运行关系，不给就业、产值、资本或人才密度的承诺。[source:CASE-WATERFRONT]

未来城市形态的判断标准很直接：能否被日常使用和质询。一项 AI 服务只有同时具备可见责任人、人工检查点、申诉、退出和适用的非数字通道，才进入公共端口。长期运营采用年度京张可见智能周、季度霓光夜班开放测试、月度城市补丁日和常设公开测试登记簿，让项目从一次性展示转为持续维护。[metric:ai_scenario_count]

## 总体设计范围城市更新与控规深度城市设计

总体设计以保留利用和可逆更新优先。五类用地从西向东形成可信研发、轨道公园、开源文化、产业服务、社区配套的完整分区，拓扑上无缝覆盖当前 provisional boundary。5 个用地 polygon 是设计结构，不是法定用地调整；分类使用场地包提供的国土空间用途代码。南北慢行双线与三条东西连接将三处重点区域接入公共骨架，概念道路均位于提交边界内。[data:geometry/land_use.geojson#LU-001]

建筑图层设置 12 个概念载体，用于验证功能、街道界面与项目组织。retain_and_adapt 表示优先保留后适配，renovate 表示待普查后改造，new_concept 只表达所需空间原型。由于缺少现状建筑、权属、消防、文保与控规，容积率、建筑高度、建筑密度、退线和建筑规模均保持 unknown；方案不以虚构体量制造完成度。[metric:building_footprint_area_sqm]

空间操作系统采用四道测试门：仿真门核对问题与数据，封闭门核对安全和故障降级，公共门核对无障碍、投诉与人工接管，扩展门依据公开评价决定续期或日落。对应的实体环境采用可撤除测试庭院、开放首层、共享工坊、公共评议席和人工服务窗口，不预设永久高科技装置。道路红线、停车、市政与承载力必须在专业资料到位后复核。[data:geometry/constraints.geojson#CONSTRAINTS]

八项更新项目和三期空间在 phasing.geojson 中交叉验证。近期优先做治理、资料核验与可撤除原型，中期连接公共空间和片区服务，长期只扩展通过评价的场景。城市更新先交付一套能拒绝不合格技术进入公共空间的共同规则，新建面积不作为首个成果。[depth:overall_spatial_structure]

## 重点区域详细设计

三处重点区域拥有不同的创新任务，不能用同一套园区语言复制。众智园是可信铸造花园，聚焦全栈自主、模型安全、标准治理、物理 AI 与边缘算力；空间上用研究内院、可控测试庭院、协议灯塔和清河绿色界面形成从封闭验证到公共展示的梯度。原点社区是零号站开源公地，聚焦近校成果转化、开放源码、人才学习生活和低扰动微更新；空间上以开放首层、共享工坊、发布厅和慢行连桥缝合校区、园区与社区。大钟寺是智能体市集，聚焦智能体、终端、内容、创作者与小微企业；空间上以四象限人本接驳、可变市集、溯源舞台和人工确认点把技术带入真实交易。

![三处重点区域的角色、场景与空间动作](assets/figures/key-areas.png)

下一轮现场设计必须用平面序列、剖面分层和第一份可签收证据组织三个引擎的接力；下表是待 G0 核验的概念合同，不是完成图纸或现场证据。片区只传递签署后的非个人证据对象，不传个人数据。任何失败证据回到众智园重测，不以“下一片区会解决”为由带病放行。

| 重点区 | 平面序列 | 剖面分层 | 第一份验收证据 | AI-OFF 基线 / 拒绝条件 / 下一站 |
| --- | --- | --- | --- | --- |
| 众智园可信铸造花园 [data:geometry/key_areas.geojson#PROV-KEY-001] | 公共到达 → 有人值守门 → 可观察缓冲 → 可控测试庭院 → 边缘算力与维护后场 | 公众解释层 / 受控验证层 / 电气维护层 | 安全事件、人工接管、来源与角色任命回执 | 静态导视、人工桌与关闭庭院仍保通行；G0 条件不全或 A/R 未具名即拒绝；签署后的安全与接管包送原点社区 |
| 原点社区零号站 [data:geometry/key_areas.geojson#PROV-KEY-002] | 开放首层 → 有人门诊/工坊 → 受控复现与发布室 → 邻里安静缓冲 | 日常公共层 / 开源复现层 / 维护与许可证层 | 输入版本、模型卡、人工选择、异议与维护清单 | 纸质地图、人工工坊和普通开放首层继续服务；许可证、维护者或邻里影响不清即拒绝；签署后的复现包送大钟寺 |
| 大钟寺智能体市集 [data:geometry/key_areas.geojson#PROV-KEY-003] | 轨道到达 → 无 App 柜台 → 普通市集 → 人工确认/溯源界面 → 受控后台 | 普通交易层 / 可质询智能体层 / 权限与下架后场 | 权限、人工确认、申诉、退款/下架与真实使用台账 | 普通导视、人工交易和投诉始终可用；暗黑模式、权利缺口或无人值守即拒绝；采用/拒绝回执回送众智园形成下一轮测试 |
...
六类人物用于场景准入测试，不用于营销分群。每个场景要回答谁受益、谁可能被排除、数据最少到什么程度、谁能停机、失败后如何获得人工服务。运营者、维护人员和独立评议者另作为治理角色，不挤占用户画像。可达性测试邀请轮椅或低视力通勤者参与，数字包容测试邀请非智能机居民参与，版权与交易测试邀请小微商户和独立创作者参与。[metric:persona_count]
...
十二端口中 T1-T4 为产业测试验证场景，S5-S12 为城市服务、文化与公共生活场景。下面每行都是概念操作合同，不是已任命组织、获批预算或实测成绩；A、R 与预算角色均须在 G0-G1 具名，所有 KPI/SLO 都是待批准的候选测量，现场值保持 null。[source:AGENT-TASKBOOK]

| ID / 公共任务与使用者 | 场所、AI 角色、最少 / 禁止数据 | A / R、预算角色与最小资源 | 人工 / 无 App 等价路径 | 候选测量；硬停止；恢复与首证据 |
| --- | --- | --- | --- | --- |
| T1 多机共行试验街：让行人、骑行者与维护人员安全共享测试界面 | 众智园 / 小月河翼；AI 只做轨迹协调；最少为设备遥测与非身份化近失事件，禁止脸、步态与持续个人轨迹 | A：待任命试点办公室；R：现场安全员；预算：测试运营者；急停、护栏、观察员、事故记录 | 普通步行/骑行绕行线与现场指挥一直开放 | 让行、接管、近失；碰撞或急停失效即停；关闭机器人、恢复普通通行，首证据为安全与接管回执 |
| T2 模型可信公开测场：让公众和评议者质询模型主张 | 众智园；AI 只生成可核验回答；最少为公开、清权或合成数据，禁止默认生物识别、设备 ID 与未清权材料 | A：待任命公共 AI 负责人；R：模型评估员；预算：未来场地运营者；离线环境、证据台、人工解释席 | 人工证据查询、纸质来源单和人工决定；高风险结果从不自动生效 | 来源覆盖、修复、人工差异；来源篡改、缺岗、无障碍失败即停；隔离模型并恢复人工桌，首证据为来源—主张—责任签收表 |
| T3 边缘算力能效试验舱：让维护者和公众看见计算代价 | 众智园；AI 只调度任务；最少为设备能耗、温度、延迟，禁止用户行为与身份字段 | A：待任命设施负责人；R：持证电气/运维人员；预算：算力运营者；隔离开关、计量、散热与噪声记录 | 人工隔离与静态状态公告，不依赖实时算法保持安全 | 单位任务能耗、延迟、稳定、热/噪声；电气、热、噪声或不可解释能耗异常即停；断电隔离，首证据为能耗与安全签字表 |
| T4 多智能体城市仿真室：让规划选项可比较而不自动决策 | 原点社区；AI 只生成选项；最少为公开/合成聚合数据，禁止地址或身份评分 | A：待任命研究发起方；R：人工主持人；预算：研究计划；离线沙盘、纸图、异议记录 | 纸图工作坊与人工比较形成同等输出 | 复现率、异议与人工改动；冒充官方结论、来源不明即停；封存输出并回到人工工作坊，首证据为选项—异议—决定差异表 |
| S5 开源成果门诊：帮助研究者和小团队形成可维护交付 | 原点社区；AI 只辅助检查；最少为已清权仓库与许可证元数据，禁止客户秘密与未授权代码 | A：待任命项目运营者；R：许可证/IP 维护员；预算：转化计划；离线清单、模型卡模板、人工门诊 | 人工许可证检查与纸质移交清单 | 许可证、模型卡、下一维护者覆盖；权利或安全未决即停；不发布并退回整改，首证据为可复现包与维护签收 |
| S6 无障碍共行导航：让轮椅、低视力和非智能机通勤者得到同等到达结果 | 轨道节点/遗址公园；AI 只推荐路径；最少为可选端点与障碍状态，禁止连续身份/位置留存 | A：待任命无障碍负责人；R：现场服务员；预算：交通/公园运营者；触觉导视、纸图、人工柜台 | 触觉、纸质与人工路径与数字路径同等可用 | 等价到达与障碍修复；无障碍主链断裂即停数字引导；恢复可达线，首证据为用户见证的等价验收表 |
| S7 百年记忆代理：让居民和访客获得可纠正的铁路记忆 | 京张遗址公园；AI 只检索/解释；最少为清权档案与逐条引用，禁止人脸识别和伪造归属 | A：待任命文化保管方；R：策展/权利人员；预算：文化运营者；纸质档案、人工讲解、纠错台 | 纸质档案、实体标牌与人工讲解 | 来源覆盖、纠错和下架；权利不清或无来源主张即停；撤下内容，首证据为来源—解释—复核记录 |
| S8 小月河气候舒适路：帮助全年龄使用者找到遮阴与休息 | 小月河翼；AI 只解释环境状态；最少为非个人天气、温湿度，禁止设备 ID 与个人轨迹 | A：待任命公共空间负责人；R：现场管养员；预算：景观维护方；静态遮阴图、休息点、校准记录 | 静态遮阴图、普通休息设施和人工提示 | 校准、遮阴/休息可用性；危险建议、休息点损坏或个人跟踪即停；切回静态地图，首证据为舒适路径巡检表 |
| S9 城市服务副驾驶：帮助居民找到官方流程而不替代行政决定 | 社区服务节点；AI 只检索官方信息；最少为公开来源与自愿问题，禁止画像、账户与自动行政判断 | A：待任命服务运营者；R：授权窗口人员；预算：公共服务方；官方资料、纸表、电话/柜台 | 纸质、电话与人工窗口保持同等办理结果 | 来源新鲜度、人工移交、无 App 等价；来源过期、缺岗或自动作决定即停；关闭助手，首证据为来源与移交台账 |
| S10 大钟寺智能体市集：让小微商户和消费者可控地使用助手 | 大钟寺；AI 只辅助发现与草拟；最少为商品元数据与明确权限，禁止支付凭证和行为画像 | A：待任命市集运营者；R：商户/消费者确认员；预算：市场运营方；人工收银、权限牌、投诉台 | 普通导视、现金/常规交易、人工合同与发布确认 | 确认、投诉、无 App 可达；未授权交易、暗黑模式或无人确认即停；撤销权限并恢复普通摊位，首证据为确认与申诉回执 |
| S11 创作者溯源舞台：让创作者保有许可、署名和下架权 | 大钟寺；AI 只辅助标注；最少为许可、作者和编辑记录，禁止未同意的生物特征或风格训练主张 | A：待任命活动权利负责人；R：策展/下架人员；预算：活动运营者；实体标签、人工申诉与下架台 | 实体署名、人工展签和线下申诉 | 标签覆盖、申诉和下架；许可争议或责任缺失即停；撤展并保留结案回执，首证据为创作权利链 |
| S12 夜光信号公园：提供低扰动、可关闭的夜间安全信息 | 霓光脊公共空间；AI 只调节状态提示；最少为非身份化计数与环境状态，禁止脸、设备跟踪和个体画像 | A：待任命公园负责人；R：巡护/照明人员；预算：照明维护方；人工开关、静态标识、暗行路线 | 静态安全标识、人工巡护与不依赖灯光的普通路径 | 眩光、能耗、噪声、投诉；安全、生态、文保或投诉越界即停；熄灯并恢复暗行路线，首证据为夜间巡检与投诉结案表 |
...
交通结构以两条南北连续线和四条东西支线构成。步行主线沿百年轨道公地串联三处重点区，骑行线保持并行但在公共节点减速，东西支线分别服务大钟寺接驳、原点社区开放首层、众智园测试庭院和小月河气候舒适路线。当前设计中心线总长约 23.12 公里，仅作为连通策略；道路红线、交叉口、站点接口、停车与消防通道需要正式交通资料。[data:geometry/roads.geojson#ROAD-001]

![交通慢行、蓝绿公共空间与三处公共端口](assets/figures/mobility-bluegreen.png)

轨道一体化坚持人先于智能体。机器人和自动配送只能在标识清楚的测试端口运行，默认不占用无障碍通道；大钟寺四象限联系先解决步行连续和人工导引，再叠加导航服务。无障碍共行导航自愿启用，提供触觉、纸质与人工路径，不以手机或视觉识别作为唯一入口。[depth:traffic_rail_slow_parking]

新型基础设施采用小型、分布式和可隔离原则。边缘算力舱只处理明确授权的试验数据，能源沙盒记录设备级能耗而非个人行为；故障时切回人工流程或离线服务。供配电、通信、排水、防洪、消防、环卫、冷却与算力容量尚无官方工程资料，因此本方案只提出节点类型和治理门槛，不给管线、容量或服务半径的伪精确值。[depth:municipal_new_infrastructure]

## 蓝绿空间、公共空间与城市风貌

百年轨道公地把线性遗产、雨洪绿地、步行骑行、开放测试和日常休息叠合为连续公共骨架。设计绿地占当前 provisional boundary 的约 15.03%，公共空间约 2.99%；两者由独立图层复算，允许功能重叠但指标分别统计。绿地不是技术展示的背景，必须保留无消费休息、遮阴、运动和安静时段；测试活动采用预约、分区和撤场规则。[metric:green_ratio]

四个 AI 朝圣地标是公共机制，不预设高层地标建筑。众智园的协议灯塔展示测试状态、责任人、事故与整改；原点社区的零号站承载开源发布、研究转化和京张档案；大钟寺的智能体市集穹廊提供有人确认的体验与交易界面；沿线百年贡献轨经授权记录工程师、研究者、维护者和市民贡献。所有准确位置、文保关系、姓名与图像授权待核验。[metric:landmark_count]

城市风貌把铁路信号、程序状态和公共账本转译为导视。青色表示开放连接，洋红表示需要确认，酸绿表示通过验证，琥珀表示待修复；颜色始终配合文字、编号和图形，避免色觉依赖。夜光信号公园采用低眩光、分时运行和非身份化客流计数，优先人工巡护，不以监控强度塑造安全感。[standard:MOHURD-URBAN-DESIGN-MEASURES]

文化叙事从工程师个人英雄扩展到可见的集体维护。百年京张的工程精神被转化为一套城市方法：公开问题、验证方案、记录失败、修复系统。年度活动通过看见、试用、质询、贡献、试点、维护、向外复制七步形成参与路径，让游客体验与本地居民日常利益保持同一条公共逻辑。[data:geometry/public_space.geojson#PUBLIC-001]

## 更新项目清单、实施政策与分期计划

实施先建立规则和责任，再增加永久建设。八个项目覆盖慢行、治理、产业验证、开源微更新、蓝绿、轨道接驳、智能体产业与文化运营。每个项目都写明专业依赖，不把缺少权属、资金、审批或运营主体的内容表述为已确定工程。[metric:renewal_project_count]
...
官方任务入口包括北京市规划和自然资源委员会海淀分局征集公告、仓库 site package、agent taskbook、标准索引、来源登记与 provisional boundary。公告用于任务与范围文字，site package 用于枚举、工作边界和验证规则，provisional geometry 只用于可重复的空间草案。若来源登记将材料标为 background_only 或 provisional_only，本方案不将其升级为官方控制。[source:OFFICIAL-ANNOUNCEMENT]
