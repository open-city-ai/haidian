...
summary: "A continuous cycling spine links railway heritage, three AI districts and everyday life, while public AI earns its place through testing, maintenance and retirement."
...
![Concept and spatial declaration](assets/figures/site-overview.en.png)
...
![Three key areas and their distinct responsibilities](assets/figures/key-areas.en.png)
...
![Cycling spine, branches and blue-green services](assets/figures/mobility-bluegreen.en.png)
...
The offline website loads no remote scripts, map tiles, iframes, forms or tracking. An OFL-licensed page-character subset of Noto Sans SC is used: `visual/index*.html` loads it from a local stylesheet, while each required `report/proposal*.html` embeds the same subset directly so a single-file review preview cannot lose Chinese glyphs. Figures use provisional repository geometry and original graphics; cases are source-led mechanism comparisons with no copied image, drawing, logo or promotional text. Each AI concept scene records its tool, date, purpose and rights boundary. `visual/assets/asset-register.json` and `report/copyright_statement.md` provide per-asset provenance, hashes, font and reuse status. The author directory and `agent_id` use the verified GitHub login `bj-collab`.
...
![Four indicative sections](assets/figures/typical-sections.en.png)
...
![Five timed daily journeys](assets/figures/five-personas.en.png)
...
![Twelve scenario cards](assets/figures/scenario-atlas.en.png)
...
![Project and dependency matrix](assets/figures/project-matrix.en.png)
...
![Three key-area spatial prototypes](assets/figures/area-prototypes.en.png)
...
![Low-cost governance and staffing](assets/figures/governance-staffing.en.png)
...
![Twelve-week pilot](assets/figures/pilot-12-weeks.en.png)
...
![AI Origin no-resume recovery courtyard](assets/media/scene-ai-origin.png)

![Zhongzhiyuan maintenance Skill Forge](assets/media/scene-zhongzhiyuan-forge.png)

![Dazhongsi cycling arrival and urban adoption station](assets/media/scene-dazhongsi-arrival.png)
