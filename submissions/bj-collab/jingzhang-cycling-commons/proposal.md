...
区域协同也采用明确交换物：京张向未来科学城、怀柔科学城、经开区和京津冀伙伴开放骑行设施维护Skill、公共AI准入单和失败清单；外部节点可提供专门测试环境、制造验证或场景复核。所有合作均为概念建议，需由真实主体另行确认 [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]。
