---
title: "Jingzhang Resonance Loop: A Heritage-Park Innovation Network for a Human-Centred AI City"
...
summary: "A public validation line along the Jingzhang heritage park links Zhongzhiyuan, the AI Origin Community and Dazhongsi through AI innovation, civic service and cultural experience. All spatial proposals are conceptual and subject to professional refinement."
...
![Three anchor detailed-design logic](assets/figures/key-areas.en.png)
...
![Six-part public-interface chain: spatial priorities from railway memory and walking transition through trusted test, knowledge front desk and cross-line connection to station-city daily life](assets/figures/public-interface-chain.en.svg)
...
![Mobility and blue-green loop](assets/figures/mobility-bluegreen.en.png)
...
![Climate–space–service care loop: blue-green elements, human maintenance and low-carbon compute explanation retain offline civic value across sun, rain and evening conditions](assets/figures/climate-care-loop.en.svg)
...
![Three-stage Resonance Roadmap: from baseline observation and light pilots, through reversible collaboration, to long-term governance under public review](assets/figures/phased-governance-roadmap.en.svg)
...
![Resonance Loop Lasting Return System: three key areas translate digital services into offline public benefits for mobility, knowledge and care](assets/figures/resonance-return-system.en.svg)
...
![Culture-operation loop: four route segments, four seasonal themes and three returns to site](assets/figures/culture-operation-loop.en.svg)
...
![Four cultural-node family: Qinghuayuan, Dongsheng, Zhongguancun and Dazhongsi each have a reason to stop, public narrative, action, offline retained benefit and clear boundary](assets/figures/cultural-node-family.en.svg)
...
![Three anchors, one day: public-service rhythm at Zhongzhiyuan, AI Origin and Dazhongsi across commute peak, daytime and evening](assets/figures/daily-rhythm.en.svg)
...
![Ecosystem relay: six spatial front desks, handoff materials and return paths from basic research to city adoption](assets/figures/ecosystem-relay.en.svg)
...
![Three reversible detail kits: a heritage-park mobility court, campus-edge knowledge front desk and station-city daily gate move from observation to temporary setup, review and professional handoff](assets/figures/reversible-detail-kits.en.svg)
...
![Public-value evidence ledger: five non-profiling observations—movement, understanding, human alternative, care and feedback—lead to a public decision to retain, revise, return to people or exit](assets/figures/public-value-ledger.en.svg)
