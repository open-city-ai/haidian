...
[metric:ai_pilgrimage_landmark_count]=3个朝圣地标：(1)"开源之核"——AI原点开源发布广场中央的互动装置，象征开源精神源头；(2)"京张智脉之门"——众智园研发中心主入口门廊，融合铁路拱券意象与AI数据流形态；(3)"数据穹顶"——大钟寺路演客厅顶部球形投影空间，展示全球AI数据流动。三个地标分别锚定"源头-加速-集聚"三阶段，构成完整的AI朝圣体验序列。
...
城市风貌控制 [depth:height_massing_character]：受[assumption:A-FAR-001]制约，风貌建议为概念框架。提出"三核三貌"策略——众智园采用"花园科研"风貌（低层花园办公+滨水绿廊，色彩以暖灰和木色为主）；AI原点采用"学术先锋"风貌（通透玻璃幕墙+学术广场，色彩以冷灰和蓝色为主）；大钟寺采用"智城都会"风貌（高层智城地标+地面客厅，色彩以深灰和金色为主）。京张铁路沿线风貌以遗址保护为优先，新建建筑退让铁路遗址不低于30米（[assumption:A-HERITAGE-001]）。
