...
license: "COMMUNITY-DISPLAY-ONLY"
 summary: "OPEN KMARKS is a time-space crossing: three chapters (1909 one person's self-reliance / 1980s one generation's march / 2026 one city's convergence), three gates (XiuYuan, XingWen, HeHe), and a steel-wood-light material grammar. The most beautiful scenery of Haidian is its people. v0.3 adds a professional design evaluation, quantitative benchmark checks and a refined visual presentation."
...
## Professional Evaluation, Quantitative Review, and Visual Presentation

v0.3 adds a professional evaluation layer on top of the existing evidence chain. Six composite categories are scored on a 1–5 scale using Gehl's 12 quality criteria [standard:GEHL-12-QUALITY-CRITERIA], Bentley's 7 responsive-environment qualities [standard:BENTLEY-RESPONSIVE-ENVIRONMENTS], PPS placemaking [standard:PPS-PLACEMAKING], TfL Healthy Streets [standard:TFL-HEALTHY-STREETS], NACTO street design [standard:NACTO-STREET-DESIGN], WHO/UN-Habitat green-space guidance [standard:WHO-URBAN-GREEN-SPACE] and ICOMOS heritage-sensitivity principles [standard:ICOMOS-HERITAGE-SENSITIVITY]. The full report is `report/narrative.md` [depth:professional_evaluation_scorecard] [depth:quantitative_benchmark_check].

The conceptual self-assessment scores connectivity and access 4/5, vitality and mix 3/5, public realm 4/5, comfort and safety 4/5, identity and heritage 5/5, and sustainability and resilience 3/5, totalling 23/30 (about 115/150, Good). Identity and heritage is the strongest dimension: the Ren-Cong-Zhong chapters, the three-gate character chain (亻→彳→human-component) and the steel-wood-light grammar grow from the Jing-Zhang zig-zag line, Zhongguancun's innovation history and Haidian's official "talent is the most beautiful scenery" [source:SRC-ERA-1909-ZHANG-QUOTE] [source:SRC-ERA-1988-ZGC-FIRST-ZONE] [source:SRC-ERA-2026-BJ-AI-POLICY] [source:SRC-ERA-HAIDIAN-TALENT-SLOGAN]. Vitality and sustainability are constrained by missing regulatory, ownership and engineering data and must be re-scored after official data is released [depth:professional_evaluation_scorecard] [depth:risk_missing_data].

Quantitative review adds the K-spine greenway length of about 8.95 km [metric:kmark_spine_length_m] alongside the 12.6 km slow network [metric:slow_network_length_m], and proposes concept standards for rest intervals, seating, lighting, canopy and clear walking width [depth:quantitative_benchmark_check]. Concept cross-sections are proposed for the K-spine — a heritage section (about 12 m, shared slow surface) and an urban section (about 20 m, complete slow street) with a minimum 2.4 m clear walking zone, 2.0 m cycle track plus 0.6 m buffer, and a central green band doubling as rain garden and rail-memory display [depth:street_cross_section_spec] [standard:NACTO-STREET-DESIGN]. The three gate plazas follow Sitte proportions of 1:1–1:2, a minimum net dimension of 15 m, seating of 1 linear metre per 3 m2, 20–50 lux lighting, and 30–40% canopy [depth:public_space_component_spec] [standard:GEHL-12-QUALITY-CRITERIA] [standard:PPS-PLACEMAKING] [standard:WHO-URBAN-GREEN-SPACE].

Implementation is organised as catalyst projects → phasing → annual operation → inclusion review [depth:regeneration_delivery_framework] [standard:ICOMOS-HERITAGE-SENSITIVITY]. The P1 catalysts are the Origin Community open-source release hall, the Origin cycling loop and K-spine slow-network gap stitching [depth:renewal_project_list] [depth:phasing_implementation]. The "one mark, four seasons" operation includes an annual public-life observation and scenario review; talent housing, free public zones and public participation enter the operation loop, with rent and demographic indicators monitored for displacement risk [depth:regeneration_delivery_framework] [standard:PPS-PLACEMAKING]. All sections, plaza parameters and scores are conceptual recommendations to be recomputed as a whole after official data is released [depth:metrics_recalculation] [depth:risk_missing_data].
