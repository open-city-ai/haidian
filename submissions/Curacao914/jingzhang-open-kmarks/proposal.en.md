...
summary: "OPEN KMARKS turns the kilometre marks of the Jing-Zhang Railway into an open-source milestone system: one cultural spine, three key areas, two wings and twelve AI scenario stations, all expressed as recomputable GeoJSON and clearly labelled conceptual suggestions."
...
The overall concept is OPEN KMARKS: the railway kilometre mark becomes an open-source milestone system. Along the Jing-Zhang Heritage Park, a K-spine hosts ten open kilometre marks K-00 to K-09 [metric:kmark_node_count]; the three key areas act as hub kilometre marks; the Zhongguancun technology-service wing and the Xiaoyuehe scenario wing form the two wings; twelve AI scenario stations are distributed along the spine and wings [metric:scenario_node_count].
...
### Zhongzhiyuan AI Acceleration Area (K-08/K-09 full-stack and governance hub)
...
### Beijing AI Origin Community (K-04/K-05 open-source and origin hub)
...
### Dazhongsi AI Industry Cluster (K-00/K-01 application and exchange hub)
