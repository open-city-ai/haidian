...
- Minor text refinements and consistency improvements

## v0.1 - 2026-08-08
- Initial scaffold and content generation
- Created all required GeoJSON layers, metrics, compliance matrices
- Generated 5 required figures (site-overview, land-use-structure, key-areas, mobility-bluegreen, metrics-evidence)
- Generated A3 booklet and A0 boards
- Created offline visual/index.html and report/proposal.html
- Passed self-check validation
