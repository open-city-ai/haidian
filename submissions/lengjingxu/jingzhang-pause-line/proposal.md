---
title: "京张留白线 / THE PAUSE LINE — 面向感官选择与创新节律的 AI 城市设计"
author_github: "lengjingxu"
language: "zh"
proposal_format_version: "2"
bilingual_contract_version: "1"
translation_file: "proposal.en.md"
license: "COMMUNITY-DISPLAY-ONLY"
summary: "让算力持续运行，也让城市保有停下来解释、照料与反思的权利：以一条慢行留白脊、三座节律庭、六条转换横廊和十二个留白驿，把 AI 创新转译为可步入、可质疑、可共同维护的日常城市。"
...
![三层范围与五条功能带](assets/figures/land-use-structure.png)
...
| --- | --- | --- | --- | --- |
| 众智园“冷静验证庭” | 发布前验证 | 低刺激评审室、具身设备慢速测试环、清河绿色会谈界面 | 静默红队室、机器人可听意图测试、健康友好服务驿 | official polygon、安全、河道、道路、网络条件 |
...
![指标、证据链与待补条件](assets/figures/metrics-evidence.png)
