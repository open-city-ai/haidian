...
图中 B、C 两组概念场景插图由内置生图工具生成，仅用于把首层空间动作和人行体验讲清楚；它们不承载坐标、距离、道路红线或工程尺寸。位置、路径、尺度和功能标签仍以同页局部平面图、GeoJSON 与指标为准 [source:ASSET-IMAGEGEN-CONCEPT-SCENES] [data:geometry/key_areas.geojson#PROV-KEY-001]。
