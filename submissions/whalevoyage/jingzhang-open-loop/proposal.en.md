---
title: "Jingzhang Resonance: Co-evolving with AI"
...
summary: "A public AI innovation belt organized around Jingzhang railway heritage, the AI Origin Community, and an open-loop model of public experimentation."
...
![Overall map and Jingzhang Open Loop](assets/figures/site-overview.png)
...
The operating loop is: the technology-service wing provides standards and compute/data compliance → the three zones host research, community learning, and industry display → the Xiaoyue River wing supplies public questions and low-disturbance pilots → results return to universities, developer communities, and the enterprise question bank. Six public reference cases are recorded in the Chinese proposal with source IDs [source:CASE-HELSINKI-KALASATAMA], [source:CASE-AMSTERDAM-SMART-CITY], [source:CASE-BARCELONA-22AT], [source:CASE-WATERFRONT-SIDEWALK], [source:CASE-MIT-SENSEABLE], and [source:CASE-SEOUL-DMC]. These are methods, not imported facts.
...
1. Jingzhang AI time-space guide
2. Developer walking and knowledge exchange
3. AI public-service navigator
4. Human-reviewable accessible walking assistant
5. Community learning and model workshop
6. Low-speed robot delivery test
7. AI-assisted railway heritage exhibition
8. Open work and rest nodes for young teams
9. Enterprise question publishing and scenario matching
...
### Inclusive service flows and transfer loop

Children's activities require guardian consent, low-risk offline materials, and staff supervision. Older adults and non-smartphone users can complete wayfinding, registration, and feedback through a service desk, paper maps, telephone, and human explanation. Visitors with hearing, visual, or mobility disabilities can choose high-contrast large text, tactile wayfinding, captions, text relay, and human assistance. People with cognitive disabilities receive short sentences, step-by-step arrows, and paired color-and-shape cues. Accessibility walks are recorded quarterly; complaints are logged within 24 hours, with a status response within seven days and a human appeal route when unresolved.

Talent and enterprise transfer follows five steps: public question → intake screening → authorized test → published result → referral. The developer community publishes quarterly question and contribution records; enterprise requests pass rights, data, and safety screening before matching; international visitors receive a bilingual short project card and contact route; eligible teams are referred by the technology-service wing to university, park, or development-area interfaces. Only anonymous project IDs, stage, and outcome are recorded; no resident profiling, financing promise, or guaranteed investment is implied.
...
![Key areas and task coverage](assets/figures/key-areas.png)

![Walking, mobility, blue and green public space](assets/figures/mobility-bluegreen.png)
