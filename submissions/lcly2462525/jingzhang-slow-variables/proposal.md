...
| 03* 无障碍路线共测 | AI 原点协商工场无障碍审计台 | 路线断点、坡度、通行耗时 | 每月共测一次 | 轮椅使用者与审计员共同签字确认 | 断点连续两月未修复，暂停相关路线推荐 | 断点修复率与参与者复测通过率 | 测断点密度、通行耗时与复测通过率；参与者不适或求助即转人工陪同；共测路线与未修补路线对照，兼做修补前后对照；原型期小样本共测，试点期月度共测，推广期季度抽查 |
