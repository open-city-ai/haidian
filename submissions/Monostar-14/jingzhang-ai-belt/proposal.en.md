...
**Positioning:** the intelligence-native consumption and business scenario district [source:AGENT-TASKBOOK]. **Spatial structure:** the "Intelligent Machine Gallery" (an AI innovation retail and display corridor) is the skeleton; commercial-services land (05) dominates, with residential clusters retained to the east [data:geometry/land_use.geojson]. **Building renewal:** the intelligent-machine consumption experience center, intelligence-native business tower, AI innovation retail blocks, and digital consumption laboratory are conceptual buildings [data:geometry/buildings.geojson#BLDG-012]. **Transport and slow mobility:** the Third Ring Road North connector meets the southern green corridor at a station-front plaza [data:geometry/roads.geojson#ROAD-006]. **AI scenarios:** robot retail, delivery-drone last-mile, AI art performances. **Implementation risks:** adjacent to the heritage-protected Dazhongsi Temple, the style and view-corridor controls need professional teams to deepen [depth:three_key_area_detailed_design].
...
**Renewal project list (8 items):** 1. Green-corridor connection and landscape upgrading along the heritage park; 2. Origin Plaza and Origin Community renewal; 3. Zhongzhiyuan R&D clusters and shared pilot platform; 4. Dazhongsi Intelligent Machine Gallery renewal; 5. Xiaoyuehe scenario test loop; 6. Wudaokou station-city integration node; 7. Zhichun Road stitching node; 8. Accessible and slow-mobility system completion along the corridor [data:geometry/phasing.geojson] [metric:renewal_project_count].
