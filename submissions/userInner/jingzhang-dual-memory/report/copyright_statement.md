...
- assets/media/cover-v5.webp：由 OpenAI 图像生成工具在 06-proof-mile-masterplan-v4.jpg 的空间母题基础上生成并压缩的蓝调时刻概念主视觉；用于表达 24 小时公共创新线的空间氛围。图像不作为现状、测绘、居民意见、建成事实或审批效果证据。
- assets/media/cover-v5-professional.webp：由 OpenAI 图像生成工具生成的专业轴测剖透视概念主视觉，表达普通公共路线、铁路遗产、蓝绿基础设施与围合 AI 试验庭的空间关系；未使用第三方输入图，不作为现状、测绘、居民意见、建成事实或审批效果证据。
- assets/boards/board-08.jpg 与 board-08.en.jpg：本方案原创中英双语“24 小时公共创新线”展板，图面整合上述轴测概念图与本包结构化运营数据。
- assets/media/cover-v6-vision.webp：由参赛者在本次共创过程中提供的 AI 生成总体鸟瞰概念图，经压缩后纳入成果；未提供或识别到第三方照片输入。仅表达公共记忆脊、铁路遗产、蓝绿系统与公共生活的总体愿景，不作为现状、测绘、民意、建成事实或审批效果证据。
- assets/boards/board-09.jpg 与 board-09.en.jpg：本方案原创中英双语“三处双记样段”展板，由上述概念图及 `visual/assets/three-proof-blocks.json` 的原创结构化设计数据生成。
- assets/boards/board-10.jpg 与 board-10.en.jpg：本方案原创中英双语“证据落位”信息设计，由官方公开记录的文字与数值、原创现场调查协议和离线复算结果生成；未使用第三方图片或地图瓦片。
- assets/boards/board-01.jpg 与 board-01.en.jpg：本方案原创中英双语 v8 技术信息设计，由 `proof-block-technical-spec.json` 的尺寸、判废线和验证状态生成；未使用第三方图片或地图瓦片。
...
- v8 五张必交信息图由本包结构化技术规格、场地证据账本和原创图形语言生成；其中的尺寸均标注为测前设计验收条件，不是测绘或施工图数据。
