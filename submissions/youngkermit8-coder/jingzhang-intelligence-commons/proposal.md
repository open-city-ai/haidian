...
![证据链、三层范围与总体概念图](assets/figures/site-overview.png)
...
![用地与“一脊三庭两翼”空间结构图](assets/figures/land-use-structure.png)
...
![三处重点区域、三种原型与场景节点图](assets/figures/key-areas.png)
...
![交通、慢行、蓝绿与公共空间复合系统图](assets/figures/mobility-bluegreen.png)
