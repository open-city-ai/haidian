...
| 项目 | 建议责任主体类型 | 时间窗 | 资源投入 | 审批接口 | 退出条件 | 阶段 KPI |
| --- | --- | --- | --- | --- | --- | --- |
| P1 出海服务清单 0.1 | 园区运营方＋专业服务机构 | 0-6 月 | 现有服务梳理与数字目录 | 数据、法务、知识产权 | 无法确认责任人则不发布 | 服务项责任人覆盖率 100% |
| P2 城市档案试点 | 运营主体＋公共文化机构 | 0-6 月 | 三类档案模板与公开页面 | 版权、隐私、档案管理 | 删除机制不可用即停 | 每条记录可追溯、可撤回 |
| P3 启航节点首批 3 处 | 属地部门＋专业设计团队 | 6-18 月 | 可逆构件、无障碍与照明 | 道路、文保、绿地、市政 | 干扰保底功能即撤除 | 无障碍问题闭环率 |
| P4 三座母港场景包 | 三片区运营方 | 1-3 年 | 测试、路演、驻留与维护资源 | 安全、消防、权属、活动 | 责任或经费缺失即缩减 | 测试后 12 月留存率 |
| P5 桥下修补实验室 | 交通/属地＋维护机构 | 1-3 年 | 轻量工坊和课程 | 桥梁安全、消防、噪声 | 安全与扰民超阈值即退 | 维修闭环时长 |
| P6 全球路演季与治理双年展 | 运营主体＋行业组织 | 年度 | 场地、策展、多语服务 | 活动、版权、国际传播 | 无实质合作成果则停办 | 合作转化与公开档案数 |

资金采用公共投入、园区自筹、服务收入、社会赞助和公共回投组合；不预设投资额。增值回投优先支持公益时段、维护岗位、无障碍改善与公开档案。[data:geometry/phasing.geojson#PHASE-001] [depth:phasing_implementation]
