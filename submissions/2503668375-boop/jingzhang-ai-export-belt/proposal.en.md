---
title: "Jing-Zhang AI Export Belt: The China AI Gateway"
...
summary: "A city-scale gateway that connects the century-old spirit of the Jing-Zhang Railway with AI packaging, global launch, overseas adoption, local care, maintenance and public memory."
...
![One Departure Line, three ports and two service wings](assets/figures/site-overview.en.png)
...
![Three levels move from institutions to structure and port prototypes](assets/figures/land-use-structure.en.png)
...
![Technology, talent/open source and commercial/global roles](assets/figures/key-areas.en.png)
...
![Departure Line, rail micro-centres, blue-green spaces and east-west nodes](assets/figures/mobility-bluegreen.en.png)
...
![Provisional-derived, pending official and operating-target metrics](assets/figures/metrics-evidence.en.png)
