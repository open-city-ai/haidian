---
title: "COMMON TIME JING-ZHANG: A Civic AI Adoption Belt Governed by Evidence Gates"
...
![Three-level scope, contextual base and relational masterplan](assets/figures/site-overview.en.png)
...
![Existing unknowns, spatial roles and time-sharing layers](assets/figures/land-use-structure.en.png)
...
![Three key areas: context, relational plan, realistic concept and implementation gates](assets/figures/key-areas.en.png)
...
| --- | --- |
| ![Qinghe old station preserved in the park](assets/photos/qinghe-old-station-park-2020.jpg) | ![VERIFY concept image](assets/figures/verify-photoreal-v3.jpg) |
...
| Real context | Realistic concept test |
| --- | --- |
| ![Qinghuayuan Station after conservation](assets/photos/qinghuayuan-station-2024.jpg) | ![LEARN concept image](assets/figures/learn-photoreal-v3.jpg) |
...
| Real context | Realistic concept test |
| --- | --- |
| ![Dazhongsi metro Exit A](assets/photos/dazhongsi-exit-a-2025.jpg) | ![LIVE concept image](assets/figures/live-photoreal-v3.jpg) |
...
As of 2026-08-17, the official repository at `main@fc1b6de15094fbe6200ae669342519b6e124bdb1` provides only provisional boundaries, their basis note and a study frame in its geometry directory. The data explicitly states `official_boundary=false`; no package area, ratio, location or section is statutory. [source:OFFICIAL-CURRENT-REPO-GEOMETRY-20260817]
...
![Mobility breaks, blue-green tasks, municipal interfaces and section types](assets/figures/mobility-bluegreen.en.png)
...
![Projects, gates, responsibility chain and metric status](assets/figures/metrics-evidence.en.png)
