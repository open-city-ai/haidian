...
<!-- [source:OFFICIAL-ANNOUNCEMENT] --> <!-- [source:AGENT-TASKBOOK] --> <!-- [source:SITE-PACKAGE] --> <!-- [source:BOUNDARY-SOURCE] --> <!-- [source:KEY-AREA-SOURCE] --> <!-- [source:SOURCE-REGISTRY] --> <!-- [source:PROCESSED-FACT-PACK] -->
...
<!-- [source:OFFICIAL-ANNOUNCEMENT] --> <!-- [source:AGENT-TASKBOOK] --> <!-- site_boundary.geojson --> <!-- key_areas.geojson --> <!-- [depth:three_level_scope_framework] --> <!-- [depth:overall_spatial_structure] --> <!-- [metric:site_area_sqm] -->
...
<!-- [source:OFFICIAL-ANNOUNCEMENT] --> <!-- [source:AGENT-TASKBOOK] --> <!-- [depth:existing_conditions_diagnosis] --> <!-- [depth:overall_spatial_structure] --> <!-- land_use.geojson -->
...
<!-- [source:OFFICIAL-ANNOUNCEMENT] --> <!-- [standard:MOHURD-CONTROL-DETAILED-PLANNING] --> <!-- [standard:MNR-LAND-USE-CLASSIFICATION-GUIDE] --> <!-- land_use.geojson --> <!-- constraints.geojson --> <!-- green_space.geojson --> <!-- [depth:land_use_layout] --> <!-- [depth:development_intensity_controls] --> <!-- [depth:height_massing_character] --> <!-- [depth:retain_renovate_demolish] --> <!-- [metric:total_floor_area_sqm] --> <!-- [metric:floor_area_ratio] --> <!-- [metric:building_density] -->
...
<!-- [source:AGENT-TASKBOOK] --> <!-- [standard:MOHURD-URBAN-DESIGN-MEASURES] --> <!-- [standard:MOHURD-CONTROL-DETAILED-PLANNING] --> <!-- key_areas.geojson --> <!-- buildings.geojson --> <!-- roads.geojson --> <!-- public_space.geojson --> <!-- [depth:three_key_area_detailed_design] --> <!-- [depth:blue_green_public_space] --> <!-- [depth:traffic_rail_slow_parking] --> <!-- [depth:height_massing_character] --> <!-- [depth:risk_missing_data] --> <!-- [metric:key_area_zhongzhiyuan_ai_acceleration_area_area_sqm] --> <!-- [metric:key_area_beijing_ai_origin_community_area_sqm] --> <!-- [metric:key_area_dazhongsi_ai_industry_cluster_area_sqm] -->
...
<!-- [source:AGENT-TASKBOOK] --> <!-- [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK] --> <!-- public_space.geojson --> <!-- [depth:three_key_area_detailed_design] --> <!-- [depth:risk_missing_data] -->
...
<!-- [standard:MNR-LAND-USE-CLASSIFICATION-GUIDE] --> <!-- [standard:MOHURD-CONTROL-DETAILED-PLANNING] --> <!-- [source:AGENT-TASKBOOK] --> <!-- land_use.geojson --> <!-- buildings.geojson --> <!-- [depth:land_use_layout] --> <!-- [depth:height_massing_character] --> <!-- [depth:retain_renovate_demolish] --> <!-- [depth:metrics_recalculation] --> <!-- [depth:risk_missing_data] --> <!-- [metric:building_footprint_area_sqm] --> <!-- [metric:total_floor_area_sqm] --> <!-- [metric:land_use_0701_area_sqm] --> <!-- [metric:land_use_0702_area_sqm] --> <!-- [metric:land_use_0802_area_sqm] --> <!-- [metric:land_use_1401_area_sqm] --> <!-- [metric:land_use_0803_area_sqm] --> <!-- [metric:land_use_05_area_sqm] --> <!-- [metric:land_use_16_area_sqm] -->
...
<!-- [standard:MOHURD-URBAN-DESIGN-MEASURES] --> <!-- [source:AGENT-TASKBOOK] --> <!-- roads.geojson --> <!-- constraints.geojson --> <!-- green_space.geojson --> <!-- [depth:traffic_rail_slow_parking] --> <!-- [depth:municipal_new_infrastructure] --> <!-- [depth:three_key_area_detailed_design] --> <!-- [metric:road_area_sqm] --> <!-- [depth:risk_missing_data] -->
...
1. **铺路人纪念碑**——碑上刻的不只是詹天佑，还有那些无名工人的名字。位于众智园铺路人广场，与京张铁路遗址线位相邻；
2. **万家灯墙**——展示贡献者和居民的故事，不只是科技大佬。位于AI原点社区万家灯广场，是智能体贡献荣誉墙的实体化；
3. **人间广场**——给所有人用的公共空间，不只是办AI峰会。位于大钟寺，是社区日常活动和AI公共体验的共享场所。
...
<!-- [standard:MOHURD-URBAN-DESIGN-MEASURES] --> <!-- [source:AGENT-TASKBOOK] --> <!-- green_space.geojson --> <!-- public_space.geojson --> <!-- constraints.geojson --> <!-- [depth:blue_green_public_space] --> <!-- [depth:height_massing_character] --> <!-- [depth:three_key_area_detailed_design] --> <!-- [depth:traffic_rail_slow_parking] --> <!-- [depth:risk_missing_data] --> <!-- [metric:green_space_area_sqm] --> <!-- [metric:green_ratio] --> <!-- [metric:public_space_area_sqm] --> <!-- [metric:public_space_ratio] -->
...
1. **年度活动体系**——每年举办「人间轨开发者大会」「京张AI文化节」和「万家灯火社区AI体验日」三类年度活动；
2. **活动品牌与传播视觉系统**——以「人间轨」为统一品牌，视觉系统延续铁轨灰+暖木色+公园绿的基调；
3. **开发者社区运营机制**——建立开源贡献积分体系，贡献者名称和Agent名称可持续保存；
4. **AI场景开放运营机制**——10张以上场景卡向公众开放体验，设置人工复核和隐私保护边界；
5. **公共体验路线**——沿中央绿廊串联三个广场和AI场景节点；
6. **国际传播和招引转化机制**——通过年度活动吸引全球AI人才和企业，对接海淀科创政策与资源。

所有活动、招商、资金、政策和运营安排均为概念建议或深化方向，不得表述为已确定政府安排。

<!-- [source:AGENT-TASKBOOK] --> <!-- [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK] --> <!-- phasing.geojson --> <!-- buildings.geojson --> <!-- green_space.geojson --> <!-- public_space.geojson --> <!-- roads.geojson --> <!-- [depth:phasing_implementation] --> <!-- [depth:renewal_project_list] --> <!-- [depth:retain_renovate_demolish] --> <!-- [depth:municipal_new_infrastructure] --> <!-- [depth:height_massing_character] --> <!-- [depth:risk_missing_data] --> <!-- [metric:phase_1_area_sqm] --> <!-- [metric:phase_2_area_sqm] --> <!-- [metric:phase_3_area_sqm] -->
...
<!-- [source:AGENT-TASKBOOK] --> <!-- [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK] --> <!-- [standard:MOHURD-CONTROL-DETAILED-PLANNING] --> <!-- [source:BOUNDARY-SOURCE] --> <!-- [source:KEY-AREA-SOURCE] --> <!-- [source:SITE-PACKAGE] --> <!-- [depth:risk_missing_data] --> <!-- [depth:metrics_recalculation] -->
...
<!-- [metric:key_area_beijing_ai_origin_community_area_sqm] -->
| key_area_dazhongsi_ai_industry_cluster_area_sqm | 720,454 | ㎡ |
<!-- [metric:key_area_dazhongsi_ai_industry_cluster_area_sqm] -->
...
<!-- [metric:phase_3_area_sqm] -->

## 参考资料

<!-- [source:SITE-PACKAGE] [source:AGENT-TASKBOOK] [source:OFFICIAL-ANNOUNCEMENT] [source:SOURCE-REGISTRY] [source:PROCESSED-FACT-PACK] [source:BOUNDARY-SOURCE] [source:KEY-AREA-SOURCE] [standard:PROJECT-OFFICIAL-ANNOUNCEMENT] [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK] [standard:MOHURD-URBAN-DESIGN-MEASURES] [standard:MOHURD-CONTROL-DETAILED-PLANNING] [standard:MNR-LAND-USE-CLASSIFICATION-GUIDE] [standard:MOHURD-ARCH-DESIGN-DEPTH-2016] [depth:existing_conditions_diagnosis] [depth:three_level_scope_framework] [depth:overall_spatial_structure] [depth:land_use_layout] [depth:development_intensity_controls] [depth:height_massing_character] [depth:retain_renovate_demolish] [depth:traffic_rail_slow_parking] [depth:municipal_new_infrastructure] [depth:blue_green_public_space] [depth:three_key_area_detailed_design] [depth:renewal_project_list] [depth:phasing_implementation] [depth:metrics_recalculation] [depth:risk_missing_data] [data:geometry/site_boundary.geojson] [data:geometry/key_areas.geojson] [data:geometry/land_use.geojson] [data:geometry/buildings.geojson] [data:geometry/roads.geojson] [data:geometry/green_space.geojson] [data:geometry/public_space.geojson] [data:geometry/constraints.geojson] [data:geometry/phasing.geojson] [metric:site_area_sqm] [metric:green_ratio] [metric:public_space_ratio] -->
