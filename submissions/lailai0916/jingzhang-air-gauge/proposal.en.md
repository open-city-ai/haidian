---
title: "JING-ZHANG AIR GAUGE: FROM STEAM TO BREATH"
...
license: "CC-BY-4.0"
summary: "An air-exposure equity infrastructure without personal profiling, organized around an evidence spine in the Jing-Zhang Railway Heritage Park and linking calibrated measurement, lower-exposure route comparison, indoor air evidence rooms awaiting professional verification, and product-claim testing."
...
![Evidence chain and provisional spatial scope of the Jing-Zhang Air Gauge](assets/figures/site-overview.en.png)
...
![Three-level framework of Three Zones, Two Wings, and one air-evidence spine](assets/figures/land-use-structure.en.png)
...
![Index of three provisional Key Areas and their air-verification tasks](assets/figures/key-areas.en.png)
...
![Composite network of lower-exposure walking, transit access, and blue-green space](assets/figures/mobility-bluegreen.en.png)
...
![Core spatial metrics, air-evidence levels, and recalculation logic](assets/figures/metrics-evidence.en.png)
