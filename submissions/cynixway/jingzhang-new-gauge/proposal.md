...
> **The New Gauge** — 1909年，詹天佑主持建成中国人自力的第一条铁路京张铁路，并在这条铁路上定下了通行至今的标准轨距。2026年，百年京张AI创新带要回答的不是"再建一个AI园区"，而是：**当AI成为城市的基础设施，我们应为下一代城市定下什么样的"新轨距"？** 轨距是标准，标准服务所有人、流传百年——这正契合AI应服务于人民生活、企业生产与社会运行的本意。本方案以科学和工程的方法组织空间、指标与证据，把"新轨距"从一句口号落成可复核的结构化提交包。
...
**总体概念：京张新轨 / The New Gauge**。核心隐喻——1909年京张铁路定下标准轨距(1435mm)，让不同线路、不同车辆、不同货物得以互通；本带为AI原生城市定下"新轨距"，让数据、算力、场景、人才、企业、治理在统一标准下互通互联。这不是给传统园区贴AI标签，而是**用标准与工程方法解决"AI如何服务人/企业/社会"的问题** `[standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]`。
...
| 层级 | 中文 | 英文 | 隐喻 |
|---|---|---|---|
| 总名 | 京张新轨 | The New Gauge | 为AI原生城市定下新轨距(新标准) |
...
**Logo方向**：轨距符号(两条平行轨)与AI节点网络的几何重组，极简线条，主色取京张铁路工程蓝(#1d4ed8)与琥珀色(#b45309，provisional/警示色)。所有标识、字体、图像须清权，未经授权不使用企业/人物标识——本方案仅给方向，不提交最终Logo成品 `[standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]`。
...
本方案研究以下全球案例并提炼可转化的空间/运营机制（均为公开资料研究，不编造企业数据 `[standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]`）：

1. **中关村历史演进**——从电子街到自主创新示范区，验证"标准+政策+人才"协同的长期价值；转化为基准轨的制度设计。
2. **硅谷沙丘路生态**——资本+大学+创业的三角；转化为中关村科技服务翼的要素配置机制。
3. **伦敦King's Cross更新**——铁路遗存与知识经济融合，与京张遗址公园高度同构；转译为铁路遗产+AI公共空间策略。
4. **深圳南山科技园**——高密度产业集聚与城市服务融合；转译为大钟寺产业轨的密度与配套。
5. **东京涩谷站城一体化**——轨道枢纽与城市功能复合；转译为三区站点一体化。
6. **新加坡One-North**——研发-生活-产业混合的紧凑布局；转译为三轨并置的空间结构。
7. **阿姆斯特丹Open Data平台**——公共数据开放驱动创新；转译为新轨距的"数据标准"层。
...
| 协同对象 | 功能互补 | "新轨距"接口 | 概念机制 |
|---|---|---|---|
| 北纬社区（北太平庄/北下关） | 生活服务、社区治理、人才居住 | 生活轨 | 共建AI便民服务节点、全龄慢行网衔接 |
| 未来科学城（昌平） | 基础研究、大科学装置 | 基准轨·算力标准 | 算力调度互备、基准测试数据共享 |
| 怀柔科学城 | 国家实验室、交叉研究 | 基准轨·研发标准 | 研究成果转化通道、联合实验室概念 |
| 经开区（亦庄） | 产业制造、规模化落地 | 产业轨 | "海淀研发-亦庄制造"概念分工 |
| 京津冀 | 数据/人才/资本区域流动 | 标准·数据层 | 统一数据接口标准、人才通行概念 |

协同机制均为开放共创建议，不构成已确定的政府安排或资金承诺 `[standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]`。具体主体、接口与可公开证据待补 `[source:AGENT-TASKBOOK-20260518]`。

## 总体设计范围城市更新与控规深度城市设计

总体设计范围（约11.4 km²，provisional `[data:geometry/site_boundary.geojson#SITE-001]`）的城市更新框架采用**"五轨分区"**——将范围划分为五条南北向功能带，每带承担一种"轨"的功能，共享顶点、无重叠、全覆盖 `[depth:land_use_layout]` `[depth:overall_spatial_structure]`：
...
**生态图谱（agent.2 ecosystem_map）**：以"新轨距标准层"为底座，连接算力/数据/场景/人才/资本/治理六个要素层，三轨(基准/生活/产业)两翼(中关村/小月河)为节点，形成"标准→要素→节点→场景"的四层生态图谱。要素流向：基准轨产研→生活轨转化体验→产业轨规模化，两翼注入资本/场景。
...
**公共空间组件库（agent.4 component_library）**：模块化公共空间组件——轨距座椅、标准模块铺装、AI导览桩、可移动活动单元、无障碍坡道标准件、智能照明杆。组件遵循统一标准（呼应"新轨距"），可组合部署到三区广场与绿带。

**文化导视与空间故事线（agent.5 signage_system_direction / spatial_storyline）**：以"从1435mm到AI新轨距"为叙事主线，沿遗址公园设五段故事节点——铁路起源(1909)、标准奠基、创新转向、AI原生、百年传承。导视系统采用工程蓝图风格，与Logo统一。文化叙事区分于一带整体Logo系统。
...
以下为本方案引用的外部历史事实与案例的来源登记 `[assumption:A-SOURCE-REGISTRY-001]`。标注"待逐项核验"的条目需补充可公开第一手来源后才能用于正式评分证据：

| 引用 | 来源类型 | 来源/核验状态 |
|---|---|---|
| 京张铁路1909年建成、詹天佑主持 | 公共历史常识 | 待补第一手来源（如铁道部档案/詹天佑史料）逐项核验 |
| 标准轨距1435mm | 公共工程常识 | 待补第一手来源核验 |
| 中关村历史演进 | 公开资料 | 待补具体来源与逐项核验 |
| 硅谷沙丘路生态 | 公开资料 | 待补具体来源与逐项核验 |
| 伦敦King's Cross更新 | 公开资料 | 待补具体来源与逐项核验 |
| 深圳南山科技园 | 公开资料 | 待补具体来源与逐项核验 |
| 东京涩谷站城一体化 | 公开资料 | 待补具体来源与逐项核验 |
| 新加坡One-North | 公开资料 | 待补具体来源与逐项核验 |
| 阿姆斯特丹Open Data平台 | 公开资料 | 待补具体来源与逐项核验 |

上述案例的转化结论为概括性研究启示，不作为已核实数据；补齐逐项来源前不升级为正式评分证据 `[standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]`。
