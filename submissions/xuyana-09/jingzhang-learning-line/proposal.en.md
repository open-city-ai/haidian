---
title: "JING-ZHANG INTELLIGENCE VEIN | THE COMMONS LINE: An AI Innovation Urban Commons on a Century-Old Railway Heritage Corridor"
author_github: "xuyana-09"
language: "en"
bilingual_contract_version: "1"
translation_of: "proposal.md"
license: "COMMUNITY-DISPLAY-ONLY"
summary: "Using the century-old Jing-Zhang spirit as a temporal axis and all-age daily life as a value framework, the proposal combines heritage, knowledge, community, ecology, and trustworthy technology into an AI innovation urban commons that converts Haidian's scientific capacity into a shared, caring, and sustainable living environment."
...
![Four planning diagnoses and spatial responses](assets/figures/planning-diagnosis.en.png)
...
![The Commons Line: an AI innovation urban commons on railway heritage](assets/figures/concept-knowledge-rail.en.png)

![Five translations of Haidian humanism and the Jing-Zhang spirit](assets/figures/haidian-humanism-timeline.en.png)

![Twenty-four-hour needs of seven user groups](assets/figures/people-day-life-matrix.en.png)
...
![Overall spatial framework](assets/figures/civic-science-framework.en.png)

![Overall structure and public-innovation spine](assets/figures/site-overview.en.png)

![Axonometric master plan and six garden nodes](assets/figures/masterplan-civic-science-axon.en.png)

![High-density conceptual master plan](assets/figures/detailed-concept-masterplan.en.png)
...
![Public-value cycle of the six Taskbook missions](assets/figures/taskbook-six-missions.en.png)

![Five-tier evidence chain from task to Human Review](assets/figures/design-evidence-ladder.en.png)
...
![Five-layer overlay and eight program segments](assets/figures/land-use-structure.en.png)

![Development-intensity and urban-form typology controls](assets/figures/development-controls.en.png)
...
![Three differentiated urban types](assets/figures/key-areas.en.png)

![Independent master plan: Zhongzhiyuan open innovation campus](assets/figures/detail-zhongzhiyuan.en.png)

![Trustworthy validation campus: observation, low-speed testing, Human Review](assets/renders/scene-zhongzhiyuan-verification-campus-clean-v2.jpg)

![Independent master plan: AI Origin compact knowledge district](assets/figures/detail-ai-origin.en.png)

![AI Origin global civic-science festival: heritage-first reversible infrastructure](assets/renders/scene-ai-origin-global-civic-festival-clean-v2.jpg)

![Independent master plan: Dazhongsi transit-oriented application district](assets/figures/detail-dazhongsi.en.png)

![Dazhongsi station-city civic room: four-quadrant stitching and active ground floor](assets/renders/scene-dazhongsi-station-civic-room-clean-v2.jpg)

![Urban design control matrix for the three key areas](assets/figures/district-control-matrix.en.png)

![Building and public-frontage prototypes](assets/figures/building-interface.en.png)

![Public-space nodes and construction components](assets/figures/public-realm-details.en.png)

![Six human-centered urban design typologies](assets/figures/humanistic-design-guidelines.en.png)

![All-age living scenario](assets/renders/scene-humanistic-living-room.png)

![Evidence atlas from strategic proposition to lived experience](assets/figures/scenario-render-atlas.en.png)
...
![Transport, active travel, Blue-Green Space, and public-space network](assets/figures/mobility-bluegreen.en.png)

![Three public-space street sections](assets/figures/street-sections.en.png)

![Five-layer urban section: rail, source, stitch, water, governance](assets/figures/five-moves-section.en.png)

![Better living environment and 15-minute service network](assets/figures/beautiful-living-network.en.png)
...
![Xiaoyue River climate-resilient living: runoff path, dry accessible route, seasonal wetland](assets/renders/scene-xiaoyuehe-climate-living.jpg)
...
![Eight project packages and three phases](assets/figures/phasing-projects.en.png)
...
![Core metrics and professional Evidence Chain](assets/figures/metrics-evidence.en.png)
...
1. Haidian Branch of the Beijing Municipal Commission of Planning and Natural Resources, prequalification announcement for the Centennial Jing-Zhang AI Innovation Belt urban design call. [source:OFFICIAL-ANNOUNCEMENT]
2. Global Agent Open Call Taskbook and its structured repository extract. [source:AGENT-TASKBOOK]
3. Repository Site Package, Source Registry, and processed fact pack. [source:SITE-PACKAGE] [source:SOURCE-REGISTRY] [source:PROCESSED-FACT-PACK]
4. Applicable urban design, Regulatory Detailed Planning, land-use classification, and architectural-design depth standards listed in `standard_matrix.json`.
