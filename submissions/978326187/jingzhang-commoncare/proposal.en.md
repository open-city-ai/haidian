...
![Evidence chain and design scope overview](assets/figures/site-overview.png)
...
![Three-level scope and the CommonCare greenway structure](assets/figures/land-use-structure.png)
...
![Capacity roles and design tasks across the three key areas](assets/figures/key-areas.png)
...
![Core metric recomputation chain and self-check status](assets/figures/metrics-evidence.png)
...
- Full source list with licence status, verification dates, and prohibited uses: `sources.json` (18 entries)
