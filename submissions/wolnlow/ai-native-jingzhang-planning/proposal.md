...
summary: "以京张铁路创新带为现实试验场，将成果严格组织为总体理解、AI Agent规划操作和真实城市规划设计三部分；每项判断均落到三层范围、三区六点、实施项目与证据边界。"
tracks: ["ai-traffic-walkability", "enterprise-services-ecosystem", "civic-agent-governance"]
---

# 以构建城市规划新范式命题下的京张铁路创新带AI原生规划新思考

## 成果结构：三部分、三个问题、一次完整交付

本报告不把方法、概念和设计混写为一套泛化叙事。第一部分只回答**京张为什么需要AI原生规划、场地真正面对什么矛盾**；第二部分只回答**AI Agent如何在证据和人类责任约束下生产规划**；第三部分只回答**在京张具体地点规划什么空间、服务、项目和运营机制**。三部分通过同一地点编号、证据状态和项目台账衔接，但不互相替代。

| 部分 | 必须回答的问题 | 京张项目落点 | 本次交付 |
|---|---|---|---|
| 第一部分｜总体理解方案 | 为什么规划、为谁规划、京张的独特矛盾是什么 | 43.6平方公里统筹研究、11.4平方公里总体设计、368.4公顷三处重点区 | 场地判断、目标体系、三层尺度、“一带三区两翼”总体命题 |
| 第二部分｜AI Agent规划操作方案 | 资料怎样成立、问题怎样识别、方案怎样被反证和人工裁决 | 遗址公园、众智园、AI原点社区、大钟寺分别作为证据、协商、测试和需求验证场 | 七类底数、六类任务Agent、三地实操链、五道人类门、版本账本 |
| 第三部分｜城市规划设计方案 | 什么地方为谁解决什么问题，怎样建设、运营、停止和恢复 | 铁路公共脊梁、三区六点、13个场景、JZ-01—06项目 | 总体结构、空间界面、专项系统、分期项目、指标与退出合同 |

所有空间落点继续遵守同一精度纪律：官方多边形、控规、权属、站口、道路、市政和专业签章未提供时，结论保持`provisional/unknown`；但资料不足不等于没有设计，方案仍需明确片区角色、空间界面、用户动作、普通服务保底、责任和下一步补证。
...
## 第一部分结论：三类地点承担三种AI城市任务

第一部分的结论不是一句“建设AI创新带”，而是把京张的空间差异转成三种必须分别回答的城市任务。铁路遗址公园首先是连续公共底盘，任何AI叠加都不能破坏通行、休憩、无障碍和历史阅读；众智园与AI原点社区分别承担“可信测试”和“开放共创—专业转介”，解决技术能力与公共理解之间的接口；大钟寺承担“真实需求—自愿试用—市场反馈”，但必须防止流量数据替居民、通勤者和消费者作价值判断。

| 地点/尺度 | 已知场地角色 | 需要解决的真实问题 | 总体规划判断 | 进入下一部分的任务单 |
|---|---|---|---|---|
| 43.6平方公里统筹研究层 | 海淀创新资源、铁路文化与区域协同的关系场 | 科研、开源、测试、资本、市场和公共生活缺少可核对的交接机制 | 以八段创新接力和三文化叙事组织关系，不虚构机构联盟 | 由生态、文化和统筹Agent建立来源、交接件与禁止推断 |
| 11.4平方公里总体设计层 | 京张遗址公园及周边更新空间 | 公共脊梁、创新载体、慢行蓝绿和生活服务尚未形成同一空间系统 | 建立“一带三区两翼、多点场景、蓝绿慢行复合环” | 由空间、公共空间和运营Agent核对九层数据与空间接口 |
| 众智园 | 可信测试与全栈自主创新候选锚点 | 技术测试需要受控，成果又需要被需求方和公众理解 | 形成开放验证前台—安全阈值—受控测试后台 | 核对载体、消防、保险、数据责任、实体停机和清理条件 |
| AI原点社区 | 近校、混合、短周期共创候选锚点 | 创新资源丰富，但社区问题入口、开源维护和转介责任分散 | 形成公共客厅—安静共创—专业转介三级界面 | 核对居民通行、夜间安静、开放载体、维护人和权利许可 |
| 大钟寺 | 站城、商业、居住与访客叠合的需求验证区 | 真实需求复杂，但站口、路权、行为动机和消费公平不可由流量数据直接推断 | 先共同走查和单项自愿试用，再形成工程或商业判断 | 核对站口道路、商户授权、消费者权益、人工服务和投诉回访 |

由此形成项目总目标：**以铁路公共脊梁保持城市公共性，以三区差异化任务完成创新接力，以两翼导入专业与生活资源，并通过可逆试点把运行结果回写规划。** 第二部分不再重新讨论愿景，而是说明这些判断如何被Agent生产、质询和交付。

# 第二部分｜AI Agent规划操作方案：从证据到账本的工作系统

本部分只说明规划生产方法，不把Agent流程写成空间方案。每项操作均以第一部分形成的地点任务单为输入，以“可交给第三部分落位的规划合同”为输出；Agent不能用完整文案或漂亮图像掩盖资料、参与者、责任主体和专业条件仍为空缺。
...
在京张，Agent的输入按地点拆开：43.6平方公里层核对生态与区域接力，11.4平方公里层核对铁路遗产、更新、交通和蓝绿关系，众智园核对可信测试，AI原点社区核对居民生活与开放共创，大钟寺核对站城、商业、步行和需求真实性。没有地点、受影响者和证据状态的输出，不得进入规划设计方案。
...
六类任务不是六篇互不相干的文字，而是围绕同一地点形成可交接成果。统筹Agent为每项任务固定“地点—问题—证据—候选—反证—人工决定—版本”七个字段；没有地点和受影响者的输出不得进入第三部分。

| 任务Agent | 京张主要落点 | 本次实际输入 | 必须产出的规划成果 | 不能越过的人类门 |
|---|---|---|---|---|
| 概念与品牌Agent | 全带、铁路公共脊梁及三区入口 | 三层尺度、铁路/中关村/AI三类文化证据、地点角色 | “京张智脉共生带”候选命名、L0—L5命名树、可纠错导视语法 | 商标、语言误读、文保环境、公众识别与正式发布 |
| 生态Agent | AI原点社区—众智园—大钟寺接力 | 七个国际案例机制、八段生态链、海淀任务书 | 每一区承担的生态环节、交接件、进入条件和失败沉淀方式 | 机构授权、真实载体、资金/算力/数据责任和合作承诺 |
| 场景空间Agent | 三区六点及铁路公共脊梁 | 八类用户、13张场景卡、非数字服务要求 | 用户动作、空间组件、AI/人工分工、开放时段、退出恢复 | 医疗教育商业专业判断、隐私、数据授权和普通服务保底 |
| 公共空间Agent | 遗址公园、各区面向公共脊梁的首层界面 | 公园公共性、慢行/蓝绿图层、文保与权利缺口 | 可撤故事站、开发者散步任务、停留/无障碍/人工服务组件 | 公园、文保、道路、园林、消防、无障碍和日常通行 |
| 文化Agent | 铁路遗址、公园节点、AI原点社区与大钟寺访客入口 | 史实来源、异文、版权、双语和空间粒度 | 三条独立证据线、五类导览任务、纠错和撤回接口 | 史实审校、肖像/字体/商标权利、语言和现场开放条件 |
| 运营Agent | JZ-01—06及日/周/季/年活动 | 项目台账、阶段门、父指标、投诉和停止协议 | 活动—社群—项目—测试—应用—知识六段闭环 | 具名运营者、预算与采购、许可、基线、人工接管和清理 |
...
### 众智园：从“技术能力清单”到“可信测试空间合同”

Agent先把全栈自主创新、测试需求和安全约束拆成问题卡，核对哪些是任务书要求、哪些只是案例背景、哪些仍未知；再比较“完全封闭测试、公众开放测试、前台解释+后台受控测试”三案。反证表明完全开放会把安全风险外溢，完全封闭又无法形成公共理解，因而输出“开放验证前台—安全阈值—受控测试后台”空间合同。进入第三部分前仍需人类确认真实载体、消防保险、数据责任、实体停机和清理流程，否则只保留离线验证桌。

### AI原点社区：从“资源密度”到“居民可改变方案的开放前台”

Agent不从高校和企业数量直接推导“创新活力”，而是把社区问题入口、开源任务、维护人、许可、夜间安静和居民通行组织为证据图谱；同时生成活动密集型、线上平台型和公共客厅型三案。价值协商要求普通生活优先、居民可不使用AI、成果必须有人维护，因此输出“公共客厅—安静共创—专业转介”三级界面，并把每周开源桌和成果转化门诊作为可撤服务。没有真实居民共同定义和具名接收者时，项目停在G0—G1。

### 大钟寺：从“流量与站城推断”退回“共同走查与单项试用”

Agent曾利用开放地图和关系图生成四象限工程路线，但站口、道路、路权、无障碍连续性和人的出行动机均无法核验，人类空间门否决该路线。修订后的输出是分时共同走查、纸质问题单、单商户单服务自愿试用和人工回访；只有位置证据、受影响者、责任去向和专业核验闭合后，才允许转为设施或工程设计。这一退回不是降低规划深度，而是避免把错误确定性固化为工程线。
...
第二部分最终向第三部分交付五类合同，而不是继续输出概念：一是标明来源、状态和禁用范围的**证据合同**；二是写清受影响者、冲突与人工裁决的**问题合同**；三是包含“不实施/不用AI”备选的**方案合同**；四是明确空间界面、普通服务、接管和退出的**场景合同**；五是记录项目ID、责任、版本差异和重开条件的**实施合同**。众智园、AI原点社区和大钟寺分别完成一套场地化合同后，第三部分才能作出空间设计决定。

# 第三部分｜城市规划设计方案：从总体结构到三区六点真实空间回答

本部分不再解释Agent如何工作，只提交规划设计判断。所谓“真实方案”不是在缺少正式红线时伪造坐标，而是对每个尺度和地点明确：服务谁、解决什么矛盾、形成什么空间关系、先做什么、谁负责、如何评价、何时停止。效果图仅用于帮助理解，不能替代下列空间和实施合同。

| 空间层级 | 规划结构 | 具体地点 | 必须成立的设计结果 |
|---|---|---|---|
| 统筹研究层 | 八段创新接力+三文化叙事+区域协同接口 | 43.6平方公里研究范围及任务书所列协同对象 | 每个创新项目有问题来源、交接件、责任和失败沉淀，不以“生态圈”口号替代交接 |
| 总体设计层 | 一带三区两翼、多点场景、蓝绿慢行复合环 | 11.4平方公里总体设计范围和铁路遗址公园公共脊梁 | 公共底盘连续，三区与两翼通过任务和服务接口衔接，AI退出后普通城市功能仍可用 |
| 重点设计层 | 三区六点、前台—阈值—后台空间序列 | 众智园、AI原点社区、大钟寺 | 六个点均有用户旅程、组件、人工接管、指标和恢复方式 |
| 项目实施层 | JZ-01—06+G0—G3/X阶段门 | 遗址公园、三区候选载体及活动路线 | 未取得载体、主体、许可、预算、基线和专业签章不得进入真实受控试点 |
...
| 区域 | 首层/开放空间优先用途 | 建筑更新方向 | 必须保留的普通城市功能 | 正式设计前待核 |
|---|---|---|---|---|
| 众智园 | 面向公共脊梁的验证前台、人工说明与安全等候 | 既有载体内部可逆分隔，测试后台与公众前台物理分区 | 消防疏散、物流维护、普通访客说明和无障碍到达 | 具体楼宇、产权、结构荷载、消防、保险、设备与能源容量 |
| AI原点社区 | 免费公共客厅、纸质问题入口、开源共创和安静停留 | 优先复用临街首层或公共配套，不侵占住宅门厅与消防通道 | 居民通行、休憩、社区服务、夜间安静和不扫码参与 | 载体开放权、居民共同定义、噪声时段、维护人和成果许可 |
| 大钟寺 | 多入口问题受理、商户单项试用、人工客服与回访 | 商业首层以可撤服务台为主，不因试验改变原价格和基本服务 | 原有消费、换乘、步行、无障碍和线下投诉 | 站口道路、商户授权、租赁权、客流基线、消费者权益和消防容量 |
...
| 地点 | 首轮交通/设施动作 | 当前可形成的成果 | 当前不得形成的结论 |
|---|---|---|---|
| 遗址公园公共脊梁 | 分段记录断点、停留、遮雨、照明、骑行停放和无障碍替代 | 问题点账本、纸质任务路线、可撤导向小样 | 未经公园/文保/道路核验的连续工程线和永久构筑物 |
| 众智园 | 检查访客、物流、设备维护和紧急退出是否交叉 | 前后台流线原则、安全阈值和人工观察点合同 | 具体出入口、消防疏散距离和设备运输路线 |
| AI原点社区 | 检查校区—社区—公共脊梁的日常步行与夜间安静冲突 | 公共前台选址准则、活动时段和无障碍停留要求 | 以活动需求侵占住宅出入口或将校园资源视为已开放 |
| 大钟寺 | 按早晚高峰、平峰和周末开展站口/过街/非机动车/无障碍共同走查 | 四象限问题单、责任派单和专业复核清单 | 基于开放地图直接生成工程路线、站口改造或接驳承诺 |
...
公共空间风貌采用“铁路材料记忆+海淀理性技术语言+可替换信息层”三层控制：铺装、树阵、座椅和照明构成耐久底盘；栏杆、雨棚和首层界面保持克制、连续和可维护；数字屏、传感器、互动装置与活动标识全部属于可替换层。众智园突出清晰的安全边界，AI原点社区突出日常尺度与可坐可谈，大钟寺突出多入口识别和人工服务，遗址公园不以发光设备和大型造型压过铁路遗存。
...
指标口径也按京张三层范围分开：43.6平方公里只评估区域接力和生态关系，11.4平方公里才讨论总体设计结构，368.4公顷重点区只在暂定几何内复算工作值；众智园、AI原点社区和大钟寺的六点指标分别绑定可信测试、公共共创和真实需求任务，不跨地点拼成一项“综合高分”。
...
六点的首轮指标直接对应空间任务：`P-ZZY-01`看材料完整、人工复核、物理停机与清理；`P-ZZY-02`看状态公开、责任确认和线下任务完成；`P-ORI-01`看许可完整、无障碍可达、居民问题被接收和维护响应；`P-ORI-02`看首次转接、具名接收、退回原因和人工回执；`P-DZS-01`看知情拒绝、普通服务可用、投诉响应和数据清理；`P-DZS-02`看分时走查覆盖、无障碍连续、责任派单和回访闭环。没有真实实例和分群基线时，这些指标保持unknown，不以目标值冒充绩效。
...
风险不是全带一张通用清单：铁路遗址公园优先核对文保、通行、内容权利和撤场；众智园优先核对数据、设备、安全阈值和人工停机；AI原点社区优先核对居民同意、安静时段、开放公平与贡献许可；大钟寺优先核对站口道路、消费者知情拒绝、普通服务保底和无障碍。任一地点的高风险缺口不得用其他地点的材料代替。
...
## 最终系统梳理：三部分如何形成一套京张方案

第一部分形成的不是宏观口号，而是三层尺度和五类地点任务：铁路公共脊梁保护公共性，众智园解决可信测试接口，AI原点社区解决开放共创与责任转介，大钟寺解决真实需求与自愿试用，两翼补充专业和生活资源。第二部分不重复这些空间结论，而是用七类底数、六类任务Agent、反证、人类门和版本账本证明结论怎样产生、怎样被否决、怎样交给设计。第三部分则把前两部分冻结为“一带三区两翼、三区六点、13场景、JZ-01—06项目、G0—G3/X阶段门”，形成可供后续选址、专业深化和受控试点使用的规划合同。

| 闭环环节 | 已形成成果 | 对应京张地点 | 下一现实动作 | 未满足时的状态 |
|---|---|---|---|---|
| 理解 | 三层尺度、五个场地矛盾、总体目标和文化/生态判断 | 全带、遗址公园、众智园、AI原点社区、大钟寺 | 取得正式范围与专项资料，组织场地主体共同核对 | 保持研究判断，不升级为官方结论 |
| 操作 | 证据图谱、Agent任务板、纠错实验、五道人类门和版本账本 | 三处重点区各一条实操链 | 建立真实问题卡、具名责任和少数意见台账 | 保持G0，不声称完成公众参与 |
| 设计 | 总体结构、前后台空间序列、六点、专项与项目库 | 11.4平方公里总体范围、368.4公顷重点区 | 将空间合同匹配到合格载体并开展专业会签 | 保持provisional，不输出精确坐标和容量 |
| 试点 | JZ-01—06、场景卡、指标、停止清理和恢复 | 遗址公园及三区获授权载体 | 完成载体、许可、预算、基线、签章和接管演练 | 停在G0—G1，不进入真实运行 |
| 回写 | 分众成果、公众反馈、指标复算和版本差异 | 全带知识库与各点服务账本 | 由具名责任人解释结果并决定保留、修改或退出 | 不让运行数据自动修改规划或替代公共判断 |

因此，本项目探索的“AI Agent做城市规划之路”可以被概括为：**先把京张理解正确，再让Agent把推理过程公开，最后由规划设计把判断落实为可使用、可审查、可停止的空间与项目。** 三部分缺一不可，但职责不能混淆；只有正式空间、公众参与、主体责任和专业审查逐步补齐时，当前研究成果才按证据等级进入下一阶段。
