...
- Design Basis and Source List / Three-Level Scope Framework / Coordinated Research Area / Overall Design Area / Detailed Design of Key Areas / AI Innovation Ecosystem, Personas, and AI+ Scenarios / Land Use, Building Scale, and Retain-Renovate-Demolish Strategy / Transport,

 Rail, Municipal Infrastructure, and Public Services / Blue-Green Network, Public Space, and Urban Character / Renewal Projects, Implementation Policy, and Phasing / Metrics, Area Recalculation, and Compliance Matrix / Risk, Copyright, and Compliance
