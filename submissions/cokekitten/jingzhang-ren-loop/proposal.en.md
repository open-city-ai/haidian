---
title: "The Ren Loop: An Urban Design Concept for the Centennial Jing-Zhang AI Innovation Belt"
...
![Overall concept: the Ren Loop — Forward and Return Tracks meet at Origin Station in a REN glyph; three stations and twelve crossings organise the belt; provisional boundary dashed](assets/figures/site-overview.en.png)
...
![Three-level scope cascade and land-use structure of the Overall Design Area: a seamless partition of the provisional boundary](assets/figures/land-use-structure.en.png)
...
![Detailed design index of the three key areas: Dazhongsi Gateway, Origin Station and Zhongzhiyuan Switchback with their key projects](assets/figures/key-areas.en.png)
...
![Mobility and blue-green public space system: green spine, twelve crossings, Qinghe waterfront and the Fifth-Ring buffer](assets/figures/mobility-bluegreen.en.png)
...
![Metrics recalculation and evidence chain: which layer produces which metric by which formula, where official gaps remain](assets/figures/metrics-evidence.en.png)
