...
品牌采用 **EVERY SENSE JING-ZHANG**，国际传播句为 **One city. Many ways to sense it.**，中文表达为“**一座城市，多种感知，共同行走**”。品牌的判词只有一句：**城市的智能，由最不便利的那个人来证明。** 面向公众的自检口径是**万感四问**——看得懂、挑得动、做得完、**走得掉**：前三问问的是通道，最后一问问的是权利，「走得掉」是传播上的第一锚点，因为它最难做到也最少被承诺。视觉语法从铁路“统一轨距”提炼为原创的平行感知线与开放节点：统一轨距使不同列车共享网络，通用设计使不同身体共享城市。标志、导视与活动视觉不借用企业商标、人物肖像或未清权字体；文化比喻也不替代京张历史研究。
...
三区各有一句可在平面上核对的骨架判词：众智园**双带并列**——主脊与安静替代线南北并行，验证在两带之间展开；原点社区**一街两院**——共创横街连缀主脊两侧的公共院落；大钟寺**四向一厅**——四向路径在采用市场的四象限接口交汇成厅。判词是概念骨架的助记，不是测绘断言，深化时以审定几何为准。

空间动作与角色严格匹配。众智园设置验证门槛、状态可视界面和人工接管点，避免未成熟技术直接进入开放空间；原点社区设置低刺激路径、共同设计室、易读服务前厅和真实反馈台，任何参与都须自愿、可理解并可退出；大钟寺设置多通道消费界面、现金与人工替代、公开采用回执和维护入口；其最小物理载体是一张**万感服务桌**——四个位序为人工窗口、多通道信息位、AI 开关、退出回执位，顺序不可调换：人工窗口先于一切 AI 构件设立，退出回执位永远在最后一步之后仍然在场。服务桌是制度里最容易被别的城市直接带走的一件东西。采用市场同时承诺**不消费也能停留**：休息、如厕、问询与等候不以消费为前提，停留权先于商业界面成立。三处通过公园主脊和两翼支持相连，形成技术问题向生活任务转译、生活证据向产品和运营反馈的循环。
...
前面各章把判据分散在场景卡、节点属性、指标口径、风险条目与开放层级里，读者要拼出“怎样才算做到了”，需要在五处之间来回翻。本章把这些判据封装成一件独立的、可被任何城市取走就用的东西：**服务等价基准（Service Equivalence Baseline，SEB）v0.4**。它不是本方案的附录，而是本方案希望留下的公共产品——海淀能否成为包容 AI 的策源地，最终取决于别的城市是否愿意用海淀写下的判据来检验自己 [source:AGENT-TASKBOOK] [metric:op_node_count]。
...
主脊读作一条有方向的序列：使用者沿线从**被引导走向独立完成**——引导性构件的密度沿程递减，人工求助点保持恒定，序列的终点不是某个设施而是「不再需要引导」这件事本身。十个独立完成节点在平面形态上是十次**通道分岔**：每处都把同一件事拆成不止一条可选路径——直接线、安静线、触觉带、人工点——分岔本身就是包容在平面上的形状。
...
**万感定律。** 把上述三件史实读成一条线，京张一百年每一次进步的真正刻度不是速度，而是「谁能用得上」的门槛又降了一格——从工程师才懂的线路，到人人可乘的车站，到本方案要求的「每一种身体都能独立完成」。本方案把这条定律接着写下去：AI 时代的这一格，降给不同身体、感官与认知方式的人。对「独立完成」最常见的误读在此一并回答：**独立不是孤立**——独立指不被迫依赖某一条特定通道，而人工求助点恰是通道之一；一个人选择求助与被迫求助，是两种城市。四道证据闸门由此获得一组京张语汇的助记别名——G0 道岔（定线定权）、G1 站台（可上可下）、G2 试车线（封闭成对）、G3 发车（独立复核放行）；别名只助记，判据仍以闸门条文为准。
...
**为什么要做这一层。** 方案批评「关键信息只存在于单一感官通道」，那么交付物必须先过自己这一关。文本与图版给眼睛，双语语音导览给耳朵——本轮为断点这个最关键的空间事实补上**手**的通道，并把连通性数据翻译成任何人三十秒能共情的**声音**。四件交付都围绕 OP-04，与深化图版、实施包同一叙事线。
...
保障对象包含一类最容易被忽略的人：**值守与维护人员是本方案的第四行人群**——前三行是使用者、参与者与沿线居民。对他们的保护与对使用者的数据边界对称展开：接管耗时、响应记录只用于评价系统与流程，不用于评价个人；不得以「AI 提效」为由削减值守班次后把接管压力转嫁给留岗者，任何 AI 层的运维成本不得转嫁为一线值守者的无偿加班——成本转嫁触发 R-04 停止条件。两次 G3 复核之间的空档由**常设独立申诉官**补位：不隶属运营方与供应商，受理使用者与值守者双向申诉，其受理与处置记录进入下一次 G3 的必审材料。
