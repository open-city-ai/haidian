...
> 本段旁白由计算机语音合成，无真人录音、无采样音乐、无实地录音。
...
- **合成声明：** 本音频为计算机语音合成产物，不含真人录音。旁白声音由 MiniMax 语音合成服务（模型 speech-2.8-hd，经官方命令行工具 mmx 调用，预置合成音色）生成，不对应任何真实自然人，不是任何人物的声音复制、模仿或克隆，也不代表任何机构发言人。
