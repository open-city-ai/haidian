...
summary: "把AI创新带设计成一条可被城市使用、采购、维修和再利用的原型制造链：众智园做组件研发与标准验证，AI原点社区做开放接口与公众共创，大钟寺做维修、展示与再配置。当前边界为 provisional intake geometry，面积和控制条件待正式数据发布后复算。"
...
# 京张城市原型制造公地：AI从实验到日常的开放部件链

本方案的核心判断是：AI创新带的城市价值不只在于“展示一个模型”，而在于把模型、传感器、导视、座椅、遮荫、服务终端和维护工具变成可采购、可更换、可维修、可公开评估的城市部件。京张遗址公园因此被设为一条“部件试用街”，而不是重复已有的蓝绿主轴叙事；空间组织采用“制造—接口—维护”三段链，三处重点区分别成为原型工场、开放接口社区和城市维修市场。这里的设计是开放共创建议，不替代法定规划、采购审批、工程设计或专业团队的最终判断。[source:AGENT-TASKBOOK] [data:geometry/phasing.geojson#PHASE-001] [depth:phasing_implementation]

## 独特命题：城市原型制造公地

“城市原型制造公地”把AI的空间落地拆成一条可追溯的生命周期：**提出问题 → 设计部件 → 小批量制造 → 公共空间试用 → 人工验收 → 维修/再配置 → 公开归档**。每个部件都有一张“城市部件护照”，记录来源、材料或版本、服务对象、安装位置、维护责任、采购条件、退出条件和公众反馈；护照只登记经授权的公共资产信息，不采集个人轨迹。[source:AGENT-TASKBOOK] [depth:ai_ecosystem_and_talent]

三类部件作为方案的空间抓手：

1. **日常部件**：遮荫座椅、无障碍导视、可移动摊位、饮水与休息节点，优先服务居民、老人、儿童和通勤者。
2. **创新部件**：端侧算力箱、模型评测接口、传感器杆件、机器人低速停靠位，只在明确的测试边界内使用。
3. **维护部件**：可替换铺装、照明电源盒、雨洪模块、清洁与检修接口，把“谁来修、多久修、坏了如何撤除”写入项目清单。

众智园负责组件规格、兼容性和安全测试；北京AI原点社区负责开放设计、公众试用和贡献者培训；大钟寺AI产业聚集区负责小批量制造、展示、维修和部件再配置。公共采购采用“先租赁/试用、后采购/固化”的概念流程，正式采购规则、预算、权属和工程条件仍需专业及主管部门确认。[data:geometry/key_areas.geojson#PROV-KEY-001] [data:geometry/key_areas.geojson#PROV-KEY-002] [data:geometry/key_areas.geojson#PROV-KEY-003] 这一采购流程仍需依据 [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK] 深化。
...
本方案建议的总体概念为“京张城市原型制造公地”：京张遗址公园承担部件的公共试用与反馈，众智园承担规格和安全验证，AI原点社区承担开放接口与共创，大钟寺承担制造、维修和再配置。总体设计不新增伪精确红线，而是把制造链投射到已有土地、建筑、道路、绿地、公共空间和分期图层中；每个空间动作都对应一个可验收、可维护、可退出的部件对象。[data:geometry/public_space.geojson#PUBLIC-001] [data:geometry/buildings.geojson#BLDG-001] [depth:overall_spatial_structure]
