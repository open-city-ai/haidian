...
> **降精度统一声明（概念建议 / 参考方案）**：本方案中所有的规划控制指标（建筑高度、容积率、建筑密度、绿地率、退线）、拆改留分类、TOD 交通组织、市政承载、政策激励与实施时序，均为基于公开信息的**概念建议与参考方案**，仅供专业团队深化研究，**不作为审批、出让、工程或投资决策依据**；正式控制条件以官方控规、专项规划与批复文件为准。凡标注 `provisional_assumption` / `missing` / `NEEDS OFFICIAL DATA` 的量值，均非审定指标，待官方数据补齐后须重算并刷新 `manifest` 哈希。
...
**第二层：总体设计范围（约11.4km²）——控规深度城市设计。** 该层级回应公告1.4，达到控制性详细规划城市设计深度 [standard:MOHURD-CONTROL-DETAILED-PLANNING]。范围内落实空间结构、功能布局、交通组织、蓝绿系统、城市风貌与建筑总量控制。口径说明：官方公告文本为约11.4km²（文字口径，高置信）；本方案临时几何复算为约12.0km²（provisional_rough，边界为临时勾绘，待官方红线发布后重算并以官方值为准）[metric:site_area][metric:site_area_official_sqm]。设计深度为控规深度城市设计。
...
建筑总量控制原则：尊重现状容积率，不突破已批控规上限；新增以低层/多层为主；高度控制梯度为"北低南高"概念——北部众智园以低密度科研院落为主（示意限高24-36m）、中部AI原点社区以多层混合为主（示意限高30-45m）、南部大钟寺以中高层TOD为核心（示意限高45-60m）；**上述数值为示意性体量梯度，非审定高度，具体限高以官方控规为准**。容积率、建筑高度、建筑密度、绿地率、退线等控制指标因官方资料缺失，均标记为 `provisional_assumption` 或 `missing`，待正式控规条件补齐 [standard:MOHURD-CONTROL-DETAILED-PLANNING][metric:site_area]。
...
**建筑形态（示意性）：** 低密度科研院落（示意 2-3 层）+中高层算力中心（示意 4-6 层），整体北低南高，与北段生态预留区形成高度过渡；**层数为示意性建筑体量，非审定层数**。建筑总规模为 `provisional_assumption`，待控规条件补齐 [metric:site_area]。
...
为避免AI场景加剧数字鸿沟，针对五类弱势群体设计专属空间与服务流程（属设计建议，非已批项目；具体落地须依年度政府投资计划与专项规划批复后衔接）[source:SRC-2023-BARRIER-FREE-ENVIRONMENT-LAW][standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]：

| 群体 | 主要障碍 | 空间应对 | 服务应对 | 兜底机制 |
|---|---|---|---|---|
| 老年人（60+，含独居/失能） | 数字工具不熟、AI响应快慢不一 | 公共客厅保留线下窗口与大字版标识；公园座椅每200m设休息点；夜间照度提升 | 智能书屋设"老人一对一陪办"；AI医疗咨询强制转人工；语音替代触屏 | 24h社区呼叫中心（人工）+ 上门巡访 |
| 残障（含视障、听障、肢残） | 物理可达性、信息可达性 | 全线无障碍贯通（坡道≤1:12、连续盲道、低位服务台）；视听双通道导视；触觉导览图 | AI翻译手语屏、字幕版导览、听障一键文字客服 | 残障服务专员驻点；服务投诉直通车 |
| 儿童照护者（0-12岁家长） | 婴儿车推行、临时托管、亲子安全 | 公园全线无台阶婴儿车路径；母婴室与儿童洗手间每500m；安全护栏区 | 智能书屋设亲子共读角；AI教育智启体限定时长强制休息 | 现场照护志愿者轮值 |
| 低收入群体 | 设备门槛、网络门槛、信任门槛 | 公共客厅设免费上网与共享平板；AI场景设"免费体验通道" | AI招聘舱/法律咨询保留人工窗口与免费时段；不强制下载App | 政府/社工转介通道 |
| 非智能机用户 | 仅功能机或无终端 | 公园电话亭式"一键问询"机；社区信息板每日更新 | 客服中心面对面服务；纸质版活动日历按周发放 | 社区网格员上门通知 |

**通用原则：** (1) 所有AI场景必须配置"人工可替代"按钮（语音/触屏/线下三选一）；(2) 公共空间按无障碍环境建设法与城市设计管理办法同步设计、同步验收 [standard:MOHURD-URBAN-DESIGN-MEASURES]；(3) 不收集弱势群体的非必要生物特征信息，遵循生成式AI办法最小化原则 [standard:GENERATIVE-AI-INTERIM-MEASURES]。
...
**近期（2026-2028，示意性实施节奏，非确定工期）：** 京张遗址公园二期全线9km贯通（至2026年底），大钟寺TOD启动，北京AI原点社区深化设计，场景卡S01-S06全面落地推广。近期目标是完成"绿轴贯通+场景落地+南部启动" [source:SRC-2026-JINGZHANG-PARK-PHASE2][data:geometry/phasing.geojson]。

**中期（2028-2030，示意性实施节奏）：** 众智园AI全栈自主创新体系建设，国家级AI算力平台与AI安全靶场落地；北纬社区联动启动，15分钟创新圈成形；13号线高架段入地完成后高线绿地改造；场景卡S07-S09全覆盖 [source:SRC-2026-HAIDIAN-GOV-REPORT]。

**远期（2030-2035，示意性实施节奏）：** 北延至五环，生态预留区激活，全面国际运营。京张AI创新带成为全球AI创新朝圣地与海淀"两区一带"战略的核心承载 [depth:phasing_and_implementation]。上述各期节点为示意性实施节奏，须与年度政府投资计划、专项规划批复与责任主体确认后衔接，不构成确定工期或投资承诺。
...
`metrics.json` 记录全部指标的计算公式、来源文件与置信度 [metric:site_area]。口径统一说明：为消除多版本数值冲突，全部公开展示指标以 `metrics.json` 为单一真值来源（详见 `changelog.md` 指标真值表）；不同口径对象分列如下，任何文件不得混用。核心指标包括：

- 总体设计范围面积：官方公告约11.4km²（文字口径，高置信）；临时几何复算12,000,000㎡（约12.0km²，provisional_rough）[metric:site_area][metric:site_area_official_sqm]
- 用地总面积：12,000,000㎡（临时几何分区汇总，provisional_rough）[metric:land_use_total]
- 绿地面积：2,385,000㎡（绿地率19.875%，provisional_rough），目标≥30% [metric:green_ratio]
- 公共空间面积：600,000㎡（公共空间率5.0%，provisional_rough）[metric:public_space_ratio]
- 重点区域总面积：368.4ha＝众智园192.1ha＋AI原点社区104.3ha＋大钟寺72.0ha（官方口径；临时几何复算同口径，provisional）[metric:key_areas_total_ha]
- 建筑数量：15栋（概念性体量示意） [metric:building_count]

口径对象辨析（不得混用）：① 11.4km²＝公告总体设计范围（官方文字）；② 12.0km²＝本方案临时边界几何复算（provisional）；③ 16.68km²（1668.2ha）＝市规自委街区控规批复范围（背景参考，来源待中心来源注册表复核，非本方案设计范围）；④ 43.6km²＝公告统筹研究范围。绿地率/公共空间率的早期粗估值（18.1%/4.3% 等）均已废弃，以 19.875%/5.0%（临时几何复算）为准。
...
## 14. 近期试点项目卡与公共利益影响评估（阶段 D 实质）

本章为阶段 D 实质填实（对应任务 #38）。项目卡绑定海淀城市更新政策与近期载体（遗址公园二期、大钟寺 TOD、北京 AI 原点社区、场景卡 S01–S06）；责任主体与资源量级为示意性，须经正式确认。

### 14.1 近期试点项目卡

| 项目卡 | 名称 | 责任主体（示意） | 实施范围 | 资源量级（provisional） | 运维机制 | 数据治理 | 人工兜底 | 无障碍替代 | KPI | 停止条件 | 可逆退出 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| P1 | 京张遗址公园二期全线贯通工程 | 海淀区园林绿化局 / 公园管理处 | 9km 绿廊贯通、5 组团、边界拆除缝合 | 投资以政府年度计划为准 | 公园运营 + 属地街道 | 视频流匿名聚合 | 安保人员监控 | 无障碍步道与标识 | 贯通率、客流承载 | 安全/文保风险 | 分段交付可逆 |
| P2 | 大钟寺站 TOD 一体化启动区 | 京投公司 / 海淀规自分局 | 站点周边混合功能 + 慢行接驳 | 站点方案待轨道部门确认 | TOD 一体化运营 | 客流实时匿名 | 调度人工介入 | 无障碍换乘 | TOD 覆盖率 | 轨道条件未达 | 分期开发 |
| P3 | 北京 AI 原点社区深化设计 | 海淀园管委会 / 清华-北大协同 | 原点广场 + 孵化加速器 + 公共客厅 | 以控规与年度投资为准 | 社区运营 + 开发者社群 | 学习/行为脱敏 | 教师/专家复核 | 全龄友好设计 | 孵化企业数 | 权属/文保冲突 | 模块可逆 |
| P4 | 场景卡 S01–S06 规模化落地 | 公园运营 + 各场景运营商 | 公园/社区/校园场景网络 | 运营商自筹 + 试点补贴 | 沙盒 + 运营方 | 最小必要/授权 | 各场景人工复核 | 可关闭/可导出 | 场景覆盖率 | 隐私/安全事件 | 即停即退 |
| P5 | 众智园国家级 AI 算力平台 | 海淀区政府 / 算力运营公司 | 北段生态预留区周边 | 投资量级待定（provisional） | 算力调度运营 | 实验数据不出沙盒 | 安全靶场围栏 | 国际人才公寓配套 | 算力规模/人才密度 | 能耗/安全超限 | 弹性缩容 |
| P6 | 小月河具身智能测试区（S11） | 企业中试 + 政府监管 | 小月河翼限定区域 | 中试专项（provisional） | 围栏 + 急停 | 环境感知限定区 | 围栏内 + 急停 | 公众隔离带 | 测试通过率 | 安全事故 | 撤场可逆 |

### 14.2 公共利益影响评估（六维）

| 维度 | 评估要点 | 本方案应对 | 风险与缓释 |
|---|---|---|---|
| 公平性 | 是否加剧数字鸿沟 | 公共客厅/智能书屋普惠；AI 培训进社区 | 老年/低收入覆盖不足 → 保留人工窗口与免费通道 |
| 隐私 | 数据最小化与权利保障 | 视频匿名、学习行为脱敏、可关闭导出 | 边界场景数据留存 → 沙盒 + 最短留存 + 审计 |
| 可达性 | 物理/数字无障碍 | 无障碍步道/换乘/全龄友好；多语种翻译 | 老旧片区改造滞后 → 分期 + 临时替代动线 |
| 就业 | 替代 vs 新增 | 新增 AI 研发/运营/维护岗位；保留改造类就业 | 自动化替代 → 技能再培训 + 创业孵化 |
| 环境 | 能耗/碳排/蓝绿 | 分布式能源 + 海绵城市 + 蓝绿复合 | 算力能耗 → 绿电 + 能效约束 |
| 可逆性 | 退出成本与社会影响 | 模块化/分段/沙盒，即停即退 | 重资产沉没 → 轻资产试点优先 |

- 说明：上述项目卡与评估为阶段 D 实质填实版，责任主体与资源量级为示意性，须经正式责任主体确认、年度投资计划与专项规划批复后实施；不构成确定工程或投资承诺。
