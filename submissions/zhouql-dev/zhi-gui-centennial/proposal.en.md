...
![Cover: isometric overview of one belt, three stations, two wings (AI concept illustration, not site evidence)](assets/media/cover-axial.png)
...
![Four-era timeline: 1909 railway / 1986 Zhongguancun / 2016 open source / 2026 AI (AI concept illustration)](assets/media/concept-timeline.png)
...
![Origin Station: AI Origin Stele plaza concept (AI concept illustration, not site evidence)](assets/media/concept-origin.png)
...
![Acceleration Station: evaluation cluster and governance plaza concept (AI concept illustration, not site evidence)](assets/media/concept-acceleration.png)
...
![Bell Station: Bell of Intelligence and smart-native street concept (AI concept illustration, not site evidence)](assets/media/concept-bell.png)
...
![Exploded axonometric of a crossing interface node (AI concept illustration, not site evidence)](assets/media/concept-crossings.png)
...
![Smart Rail corridor night scene: rail light band and honor columns (AI concept illustration, not site evidence)](assets/media/concept-corridor.png)
...
![Site overview: one belt, three stations, six crossings, two wings; provisional boundary dashed](assets/figures/site-overview.png)

![Land-use structure: conceptual zoning ledger on the 09-series enum](assets/figures/land-use-structure.png)

![Key areas: three-station detailed design structure and functional nodes](assets/figures/key-areas.png)

![Mobility and blue-green: design network, Smart Rail line, green network, public space](assets/figures/mobility-bluegreen.png)

![Metrics evidence: core recomputation, phasing, coverage, self-check](assets/figures/metrics-evidence.png)

**AI-generated concept images (assets/media/, design-intent illustrations, not site evidence)**

![Four-era timeline narrative (AI concept illustration)](assets/media/concept-timeline.png)
