---
title: "Jing-Zhang Commons Line: An Open Intelligent City on a Centennial Rail Trace"
...
> **Status:** This is an open-call AI-generated concept proposal. It is not a statutory plan, an approval document, an engineering design, or a government commitment. The site boundary and three key areas use provisional rough polygons. Any precision-sensitive conclusion must be recalculated when cleared official geometry is available. [source:BOUNDARY-SOURCE] [depth:risk_missing_data]

“Jing-Zhang Commons Line” translates the memory of a railway into an open intelligent public infrastructure. Each station must answer four questions: what is the evidence, what is tested, who reviews it, and how can it stop or exit? The structure is one public spine, three cores, two wings, twelve scenario stations, and three governance loops. It is a reference concept for professional teams to deepen, not a final spatial decision.

## Design Basis and Source List

The proposal uses the public announcement, the cleared agent taskbook, the local source registry, professional standard snapshots, and the repository’s explicit data-gap register. The announcement supports project names, scope descriptions and approximate areas; it does not support a precise polygon or statutory control. Official and cleared sources, their permitted uses, and their prohibited uses are recorded in `sources.json`. [source:OFFICIAL-ANNOUNCEMENT] [source:AGENT-TASKBOOK] [source:SOURCE-REGISTRY] [standard:PROJECT-OFFICIAL-ANNOUNCEMENT]

## Three-Level Scope Framework

The strategic research area addresses Haidian’s AI innovation ecosystem and future-city mechanisms. The approximately 11.4 km² overall design area addresses renewal, public space, blue-green continuity, slow mobility and scenario distribution. The approximately 368.4 ha key-area scope tests three spatial prototypes: trusted verification, open-source transfer and urban application. These areas remain provisional and are used only for concept generation, visualization and self-checking. [source:OFFICIAL-ANNOUNCEMENT] [data:geometry/key_areas.geojson#PROV-KEY-001] [metric:key_area_count]

The overall structure is deliberately transferable: a public rail-memory spine links research, learning, community life and urban services; the three cores have different responsibilities; and the two wings provide service and everyday-scenario interfaces. When official geometry arrives, the complete generation chain must be rerun: all geometry layers, metrics, figures, PDFs, HTML, matrices, hashes and the difference report. [source:BOUNDARY-SOURCE] [source:KEY-AREA-SOURCE] [depth:three_level_scope_framework]
...
The spatial system is one spine, three cores, five east-west seams, two diagonal collaboration chains and twelve stations. The rail-memory spine carries culture, slow mobility, landscape and public scenarios. The seams reconnect campuses, districts, communities and rail entrances to the public spine. The submitted road network is a conceptual slow-mobility relationship, not a road red line or engineering alignment. [data:geometry/roads.geojson#ROAD-001] [data:geometry/land_use.geojson#LU-001] [depth:overall_spatial_structure]

Land-use partitions first reserve the continuous public spine, public nodes and seams, then distribute research, education, residential, service and cultural functions. Their union matches the submitted provisional boundary, which proves topology only and does not change statutory land use. Building envelopes are conceptual capacity and interface prototypes; FAR, height and total floor area remain unknown. [standard:MNR-LAND-USE-CLASSIFICATION-GUIDE] [data:geometry/land_use.geojson#LU-001] [metric:land_use_partition_area_sqm] [metric:floor_area_ratio]

## Detailed Design of Key Areas

The three prototypes use a shared spatial–scenario–responsibility checklist. The next professional deepening pass should show a context plan, entrance and walking interface, one section, scenario placement, constraints and an operating responsibility for each prototype. This deliberately records what is not known instead of drawing false precision. [data:geometry/key_areas.geojson#PROV-KEY-001] [depth:three_key_area_detailed_design]

**Zhongzhiyuan Trusted Verification Garden** is the verification front door: a Qinghe ecological interface, shared verification workshop, governance court and northern seam. It hosts model red-team, robot yielding and low-carbon compute validation. Blue lines, flood control, energy, fire, noise and property conditions must be checked before expansion. [data:geometry/public_space.geojson#PUBLIC-007]

**AI Origin Open-Source Transfer District** is a near-campus transfer and talent neighborhood: contribution station, release hall, transfer corner and university–city collaboration garden. It keeps a visible chain for open-source release, IP, ethics, compliance, scenario recruitment and talent service. It retains a human and offline service route. [data:geometry/public_space.geojson#PUBLIC-005] [source:AGENT-TASKBOOK]

**Dazhongsi Urban Application Living Room** is an urban-facing application district: Commons living room, trustworthy AI theatre and technology-service workshop. Its ground floor is designed to be enterable, stayable and withdrawable; it is not an enterprise showroom. Rail, traffic, fire and property interfaces remain relationships to be professionally checked. [data:geometry/key_areas.geojson#PROV-KEY-003] [data:geometry/roads.geojson#ROAD-003]
...
The north emphasizes verification and talent services, the middle supports university transfer and everyday learning, and the south supports intelligent-native services, culture and international exchange. Retain, adaptive renovation, re-argued demolition and conditional new build are evidence gates, not parcel-level conclusions. Existing building status remains unknown because survey, ownership, heritage and structural data are unavailable. [data:geometry/buildings.geojson#BLDG-006] [depth:retain_renovate_demolish] [depth:development_intensity_controls]

## Transport, Rail, Municipal Infrastructure, and Public Services

The main spine, five seams and two diagonal chains support walking, cycling and transfers. The conceptual network is approximately 23.9 km. Plug-in infrastructure is tested only after energy, thermal, fire, noise, accessibility and security review. Public sensing prioritizes environmental aggregates; no identity-targeted deployment is proposed. Public health navigation, accessibility guidance, talent service and compliance consultation all retain offline entrances. [data:geometry/roads.geojson#ROAD-001] [metric:walking_cycling_network_length_m] [data:geometry/constraints.geojson#known_constraint_data_gaps]

## Blue-Green Network, Public Space, and Urban Character

The blue-green network is the public protocol layer: it carries slow mobility, rest, heritage narration and low-risk testing. Four character segments are proposed from south to north: cultural memory garden, Dazhongsi urban vitality garden, Origin open-source garden and Qinghe innovation garden. The conceptual green envelope is approximately 138.3 ha; public-space nodes are approximately 7.8 ha. These are provisional design ratios, not approved controls. [data:geometry/green_space.geojson#GREEN-001] [data:geometry/public_space.geojson#PUBLIC-003] [metric:green_ratio] [metric:public_space_ratio]

Four conceptual civic landmarks are proposed: Centennial Origin, AI Origin Contribution Station, Trustworthy AI Theatre and Commons Governance Court. Cultural narration moves through railway time, Zhongguancun time and AI time. Facts require sources, generated content is labeled, and the identity system is separate from any corporate or government brand. [source:AGENT-TASKBOOK] [depth:height_massing_character]

## Renewal Projects, Implementation Policy, and Phasing

Nine projects are phased by dependencies rather than calendar promises. Near-term light-touch projects activate heritage guidance, the Commons living room and the trustworthy AI theatre. Mid-term projects connect open-source exchange, contribution and university–city collaboration. Long-term projects deepen governance, low-carbon observation and edge-compute stations only after official geometry, controls, safety and infrastructure data are available. [data:geometry/phasing.geojson#PHASE-001] [metric:renewal_project_count] [depth:phasing_implementation]

The annual operation loop is: open-source problem season, safety validation season, global commons week and evidence review season. The conversion path is public issue → compliance pre-review → sandbox → human evaluation → procurement or collaboration separately decided. No activity date, funding, procurement, land right or government arrangement is asserted. [source:AGENT-TASKBOOK] [data:geometry/phasing.geojson#PHASE-007]
...
The package explicitly records provisional boundary, missing controls, conceptual land use, missing building survey, conceptual roads, missing blue-green and heritage controls, unknown public-space permissions, non-government phasing and privacy safeguards. Official geometry must trigger a full recalculation of geometry, metrics, figures, PDFs, HTML, matrices and hashes. All spatial actions are concept recommendations. Human and professional teams retain final judgment in planning, architecture, transport, municipal engineering, landscape, heritage, law, medicine and public safety. [depth:risk_missing_data] [source:AGENT-TASKBOOK]

The proposal, geometry, metrics, figures, HTML, logo and drawings are generated from the submission package. No external map tiles, photography, portraits, corporate marks or copied visual identity are embedded. International cases are summarized from official public pages only and are not transferred as site controls or targets. The asset-level record is in `report/copyright_statement.md`.

## References

- [source:OFFICIAL-ANNOUNCEMENT] Official public announcement and local snapshot.
- [source:AGENT-TASKBOOK] Cleared agent open-call taskbook.
- [source:SOURCE-REGISTRY] Submission source registry and data-gap record.
- [standard:PROJECT-OFFICIAL-ANNOUNCEMENT] Official project announcement snapshot.
- [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK] Agent taskbook snapshot.
