...
本节集中列出正文使用的结构化指标，便于评审者回到 `metrics.json` 复核数值与复算来源：[metric:ai_origin_area]、[metric:annual_activity_count]、[metric:coordinated_research_area]、[metric:cultural_node_count]、[metric:dazhongsi_area]、[metric:ecosystem_case_count]、[metric:figure_count]、[metric:geojson_layer_count]、[metric:key_area_total]、[metric:land_use_type_count]、[metric:landmark_count]、[metric:metro_station_count]、[metric:near_term_project_count]、[metric:overall_design_area]、[metric:phase_count]、[metric:scenario_card_count]、[metric:test_scenario_count]、[metric:user_persona_count]、[metric:zhongzhiyuan_area]。
