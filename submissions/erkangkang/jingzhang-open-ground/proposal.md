---
title: "京张开场 JINGZHANG OPEN GROUND：让AI创新发生在可进入的一层"
author_github: "erkangkang"
language: "zh"
...
# 京张开场 JINGZHANG OPEN GROUND：让AI创新发生在可进入的一层
...
本方案总体概念为“京张开场 JINGZHANG OPEN GROUND”：以京张遗址公园为历史与公共空间主轴，以众智园、北京AI原点社区、大钟寺三处重点片区为创新锚点，以高校、企业、社区和轨道站点为日常网络，形成“一带三核、多点场景、蓝绿慢行复合环”的空间组织。“开场”不是额外红线，而是一套可迁移的界面规则：连续开放地面连接公园、校园、园区、社区和轨道首层；众智园“验证交换场”、AI原点“转译交换场”、大钟寺“采用交换场”构成三核；中关村科技服务翼和小月河场景赋能翼提供两侧接口；十二类门槛场景均设置人工帮助、物理停止和公开纠错。
...
AI 场景必须落到空间和治理边界：公共空间场景引用 [data:geometry/public_space.geojson#PUBLIC-001]，慢行与交通场景引用 [data:geometry/roads.geojson#ROAD-001]，开放空间场景引用 [data:geometry/green_space.geojson#GREEN-001] 和 [metric:public_space_ratio]、[metric:green_ratio]。这些引用让评审者知道场景不是口号，而是位于具体图层和指标中的设计对象。面向智能体任务书要求不少于10张AI场景卡、不少于3个产业测试验证场景和不少于5类用户画像；本方案以可复核结构，正式参赛者必须把场景卡、画像表、隐私边界、人工复核和运营主体写入正文、HTML、A3/A0 和合规矩阵。
...
| 11 开放地面维护助手 | 全线公共界面 | 用最小化设施工单辅助维护，由人工派单、验收并关闭任务 |
| 12 城市场景公开评议桌 | 三处交换场 | 自愿收集意见，保留主持归纳、申诉和不使用数字系统的等价路径 |
