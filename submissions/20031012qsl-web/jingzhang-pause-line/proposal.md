---
title: "京张暂停线 / JINGZHANG PAUSE LINE"
author_github: "20031012qsl-web"
language: "zh"
...
本方案建议的总体概念为“京张暂停线”：以京张遗址公园为历史与公共空间主轴，以众智园、北京AI原点社区、大钟寺三处重点片区为创新锚点，以高校、企业、社区和轨道站点为日常网络，形成“一条可逆公共主脊、三座暂停站、双翼回退网络、十二个可退出场景”的空间组织。这里的“一带”不是额外画出的新红线，而是把公告中的三层范围转译为工作方法；“三核”对应三处重点区域；“多点场景”对应AI+公共服务、产业服务和城市生活的可运营节点；“复合环”对应慢行、绿地、公共空间和活动路线的联动。
...
### 核心设计协议：暂停、解释、申诉、回退、恢复

京张暂停线把五项能力写入空间与运营：任何 AI 场景必须显示运行状态和责任人；居民可选择人工服务与无画像路径；一线运维者拥有安全停机权；场景进入前先确定退出和空间恢复方式；事故与纠错进入公开复盘。总体形成“一条可逆公共主脊、三座暂停站、双翼回退网络、十二个可退出场景”。这些均为概念建议，不是法定控制或已确定政策。[source:AGENT-TASKBOOK] [depth:overall_spatial_structure]

三座暂停站分别是：众智园“模型检修场”，负责受控测试、人工接管与一键清场；AI 原点社区“申诉客厅”，提供人工窗口、纸质流程、解释屏与纠错回执；大钟寺“回退市集”，让智能零售与导览采用短租、可撤装柜体和无画像模式。[data:geometry/key_areas.geojson#PROV-KEY-001] [depth:three_key_area_detailed_design]

十二张场景卡为低速机器人测试廊、无障碍导航校准、公共服务共译台、社区照护提醒、低碳算力排程、智能路缘预约、AI 导览与人工讲解双轨、生成内容出处签、夜间安全照明自检、消费推荐无画像模式、城市事件复盘桌、青年开源训练营。每卡明确用户、空间、最小数据、接管者、停止条件和恢复方式。

五类核心画像为算法研究者、创业团队、社区居民、一线运维者、访客与青少年。三处 AI 朝圣地标为“暂停信号塔”“模型账本厅”“模拟花园”，分别展示系统状态、贡献与纠错记录、完全离线的公共生活。

实施分三期：第一期建立标识、人工回退和三个小尺度试点；第二期在独立评估后扩展十二场景；第三期才讨论固定改造和国际活动。每一项目使用“进入条件—运行上限—暂停触发—退出恢复—复盘公开”五栏管理。
