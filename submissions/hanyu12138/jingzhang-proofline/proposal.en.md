---
title: "Jing-Zhang Proofline: Verifiable, Shared and Evolvable Civic AI Infrastructure"
...
The proposal first asks what each source can support, then asks what spatial response is defensible. The project title, three scope descriptions, approximate areas, three key-area names and design tasks come from the official announcement and support the formal task definition. The six agent tasks, scenario quantity, identity and operations requirements come from a rights-cleared taskbook excerpt. Official repository snapshots support urban-design, regulatory-planning and land-use terminology. Exact spatial boundaries have not been published, so all submitted geometry is explicitly a provisional constraint. [source:OFFICIAL-ANNOUNCEMENT] [source:AGENT-TASKBOOK] [source:URBAN-DESIGN-MEASURES] [source:CONTROL-DETAILED-PLANNING] [source:LAND-USE-CLASSIFICATION]

`data/source_registry.json` controls source classification; `data/processed/agent_fact_pack.md` is reading navigation and creates no new authoritative fact. This proposal does not use commercial map tiles, news screenshots, OSM-derived planning boundaries, uncleared planning images, unauthorized company material or personal data. [source:SOURCE-REGISTRY] [source:PROCESSED-FACT-PACK]
...
| Public administrative statistics | Haidian, national and Beijing annual materials | Calibrate industry, transfer, public-service and green-mobility questions | Corridor flows, station OD, facility capacity, siting or project performance |
...
The authority order is GeoJSON, metrics, the three matrices, sources and assumptions, `proposal.md`, then figures, PDFs and HTML. Every known metric records its formula, source files, confidence and assumptions. Statutory Floor Area Ratio remains unknown; conceptual capacity does not substitute for an official control. [standard:MOHURD-CONTROL-DETAILED-PLANNING] [depth:existing_conditions_diagnosis] [metric:site_area_sqm]

![Proofline overall concept and spatial structure](assets/figures/site-overview.en.png)

### 2. Data baseline and decision translation

This iteration includes only observations traceable to official public pages or credible public reports. Each record states its statistical scale, the resulting design action and what cannot be inferred. All observations below are `background_only` and carry `not_spatially_allocable=true` in `sources.json`; none enters `metrics.json` or changes GeoJSON, areas, alignments or phasing. [source:HAIDIAN-2025-STATISTICAL-BULLETIN] [source:NBS-2025-STATISTICAL-COMMUNIQUE] [source:HAIDIAN-37-UNIVERSITIES-SERVICE-NEEDS] [source:BJTRC-2026-TRANSPORT-REPORT]

All four source groups were rechecked in a visible browser on 2026-08-08 against the publishing institutions' original pages. `sources.json` records collection method, spatial and temporal coverage, source location, license status, transformations, cross-checks and limits. The pages and reports do not state a clear open-data license, so the package attributes and extracts facts without redistributing source documents; the transport source also records the SHA-256 of its 129-page PDF. Percentages are stored as ratios, `39.24 million_person_trips` converts the displayed Chinese unit, and `3.576 / 1.127 billion_person_trips` preserves auditable unit conversion.
...
| China, 2025 | 16 high-value invention patents per 10,000 people and CNY 7.5734 trillion in technology-contract value; the two administrative-scale releases place Haidian's figures at about 37.4 times and 5.35% respectively [source:NBS-2025-STATISTICAL-COMMUNIQUE] | Shift Proofline's value test from more quantity to validation quality, clear responsibility, negative results and reuse | Full institutional comparability, corridor targets, rankings or causal conclusions |
...
Courier, ride-hailing, delivery and commercial heat-map data could help identify loading, short-stay and night demand. This iteration found no source that simultaneously had public permission, aggregate anonymity, corridor coverage, a stated sampling method and bias disclosure, so these variables remain unknown. Later material may enter analysis only after license, time window, aggregation, sample coverage, missingness, bias, privacy suppression and retention are recorded. Personal traces, exact homes, order records and unlicensed platform data are prohibited. Their absence cannot block basic service or justify substituting citywide heat for field observation.
...
![Complete land-use partition and spatial structure](assets/figures/land-use-structure.en.png)
...
![Proofline concept logo and bilingual lockup](assets/proofline-logo.svg)
...
Land-use codes use a subset of the Ministry of Natural Resources classification and express conceptual capacity and functional relationships only. Within the provisional extent, scientific-research land is about 31.6%, park green 16.6%, urban residential 14.7%, commercial service 13.1%, conceptual roads 9.8%, education 8.4%, plazas 4.5% and protective green 1.4%. These are recalculated from submitted geometry and are not statutory planning controls; each must be compared, rebuilt and explained when formal controls arrive. [metric:land_use_0802_sqm] [metric:land_use_1401_sqm] [metric:land_use_0701_sqm] [metric:land_use_05_sqm]
...
Recalculated areas are approximately 360.31 ha scientific research, 149.49 ha commercial service, 168.08 ha residential, 95.30 ha education, 111.34 ha conceptual roads, 189.28 ha park green, 15.69 ha protective green and 51.79 ha plaza. Evidence includes [metric:land_use_0804_sqm], [metric:land_use_1207_sqm], [metric:land_use_1402_sqm] and [metric:land_use_1403_sqm]. Every value is affected by the provisional boundary.
...
![Walking and cycling with the blue-green public-space system](assets/figures/mobility-bluegreen.en.png)
...
Conceptual green space totals about 204.97 ha, or 17.96%; plaza-type Public Space totals about 51.79 ha, or 4.54%. Green derives from park and northern protective-green parcels, while Public Space derives from conceptual plazas. They separately support ecological continuity and intensive civic use and are not double-counted. [data:geometry/green_space.geojson#GREEN-001] [data:geometry/public_space.geojson#PUBLIC-001] [metric:green_space_area_sqm] [metric:green_ratio] [metric:public_space_area_sqm] [metric:public_space_ratio]
...
Phasing geometry fully partitions the provisional site into Lightweight Proof, Three-Station Connection and Adaptive Renewal. Near term covers about 60.67 ha or 5.3% and prioritizes protocols, events, wayfinding and low-impact nodes. Medium term covers about 353.93 ha or 31.0% and details three stations and cross-connections after official evidence. Long term covers about 726.68 ha or 63.7% and advances adaptive renewal through operations evaluation and statutory procedures. [data:geometry/phasing.geojson#PHASE-001] [metric:phase_001_area_sqm] [metric:phase_002_area_sqm] [metric:phase_003_area_sqm]
...
| Conceptual floor-area capacity | 8,593,930.819 m2 / 0.753 [metric:concept_floor_area_sqm] [metric:concept_floor_area_ratio] | `footprint x conceptual_floors`; statutory FAR remains unknown |
...
Known land-class metrics also include [metric:land_use_05_sqm], [metric:land_use_0701_sqm], [metric:land_use_0802_sqm], [metric:land_use_0804_sqm], [metric:land_use_1207_sqm], [metric:land_use_1401_sqm], [metric:land_use_1402_sqm] and [metric:land_use_1403_sqm]. Their sum equals site area; formulas and source files are auditable in `metrics.json`.

### 2. Background observations are not spatial metrics

Haidian innovation resources, university-service needs, national comparison and Beijing transport data are stored as observations in `sources.json`, each with its scale and `not_spatially_allocable`. They select the design actions validation, transfer, active travel and referral. They do not enter core metrics or pilot performance targets. Corridor flows, station OD, bicycle occupancy, accessibility continuity, complaint baselines and aggregate courier / ride-hailing / delivery data remain missing. When license, sampling and bias cannot be explained, a value remains unknown rather than being filled by a district or city average.
...
| --- | --- | --- |
| Provisional boundary read as official | Repeated provisional labels and low-contrast dashed graphics | Recalculate the entire package after a rights-cleared official polygon |
| Conceptual land use and capacity read as statutory | Every value is a low-confidence proposal and statutory FAR stays unknown | Reconcile official controls, planning conditions and technical review |
...
| District or city statistics assigned to corridor | Scale and non-allocability recorded; observations excluded from metrics | Collect five corridor baselines before time, place or expansion decisions |
...
- Haidian 2025 statistical bulletin and National Bureau of Statistics 2025 communique, administrative-scale background only: [source:HAIDIAN-2025-STATISTICAL-BULLETIN] [source:NBS-2025-STATISTICAL-COMMUNIQUE]
- Public case covering 37 Haidian universities and Beijing transport annual report, service-interface and transport-principle background only: [source:HAIDIAN-37-UNIVERSITIES-SERVICE-NEEDS] [source:BJTRC-2026-TRANSPORT-REPORT]
...
The proposal cites every core data file: [data:geometry/site_boundary.geojson#SITE-001], [data:geometry/key_areas.geojson#PROV-KEY-001], [data:geometry/land_use.geojson#LU-001], [data:geometry/buildings.geojson#BLDG-001], [data:geometry/roads.geojson#ROAD-001], [data:geometry/green_space.geojson#GREEN-001], [data:geometry/public_space.geojson#PUBLIC-001], [data:geometry/constraints.geojson] and [data:geometry/phasing.geojson#PHASE-001]. Together they form a replaceable, reproducible and auditable base. Where a figure or narrative conflicts, structured data and later official material prevail.

The full design-depth index is [depth:existing_conditions_diagnosis], [depth:three_level_scope_framework], [depth:overall_spatial_structure], [depth:land_use_layout], [depth:development_intensity_controls], [depth:height_massing_character], [depth:retain_renovate_demolish], [depth:traffic_rail_slow_parking], [depth:municipal_new_infrastructure], [depth:blue_green_public_space], [depth:three_key_area_detailed_design], [depth:renewal_project_list], [depth:phasing_implementation], [depth:metrics_recalculation] and [depth:risk_missing_data]. These references let a reviewer move from narrative to matrices, geometry, metrics, drawings, sources and assumptions.
