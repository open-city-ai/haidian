...
一张无文字的横向三联图。三幅均为普通工作日的步行视角，并把连续、无台阶的日常路径放在画面主轴；没有闸机、二维码、识别设备或必须使用的屏幕。

左幅为“众智园平行验证庭”概念：左侧普通步行带连续通过，右侧低矮、可拆的木质隔离边界围合临时验证庭；一名工作人员站在边界侧提供人工说明与停止交接。验证设备、围挡和线缆均不跨越普通路径，故障时可关闭庭院而保留旁路。

中幅为“北京 AI 原点社区无屏日常街”概念：一条居民街串联两侧庭院，儿童、老人、照护者和轮椅使用者在无屏桌面活动、步行和停留；旁侧小型人工桌可用于纸面说明和同意撤回。活动家具不封闭中轴，居民无需注册或使用 AI 即可通行与使用。

右幅为“大钟寺通勤旁侧人工服务”概念：宽阔步行主轴保持四向通勤感，安静的人工服务厅和低平台退在路径两侧；通勤者持续通过，少量停留不形成围挡或排队。即使发布或活动暂停，普通通勤、休息与人工服务仍可独立存在。

The image is a text-free horizontal triptych. Each panel uses an ordinary-weekday pedestrian viewpoint and places a continuous step-free daily route on the main visual axis. There are no turnstiles, QR codes, recognition devices, or mandatory screens.

The left panel conceptually shows the **Zhongzhiyuan parallel proof court**. A continuous ordinary walking band runs on the left; a low, removable timber isolation edge contains a temporary proof court on the right. A staff member stands at the edge for explanation and manual stop handoff. Equipment, enclosure, and cables do not cross the ordinary route, so the court can close while the bypass remains open.

The middle panel conceptually shows the **screen-free daily street of Beijing AI Origin Community**. One resident street links two side courts. Children, older people, caregivers, and a wheelchair user walk, stay, and join screen-free tabletop activities. A modest staffed table at the side supports paper explanation and consent withdrawal. Furniture does not enclose the central route, and residents need no registration or AI use to pass or participate in ordinary life.
...
2. **验证 / Proof:** 仅在公布、获准且有人负责的未来时窗，把可拆叠层放在日常路径之外；图中不证明该时窗、责任人或设施已经存在。 / Only in a future announced, authorized, accountable window may a removable overlay sit outside the daily route; the image does not prove that such a window, responsible role, or facility exists.
3. **故障 / Fault:** 停止可选叠层、隔离设备、人工说明并保留绕行；普通任务不得随之关闭。 / Stop the optional overlay, isolate equipment, explain through staff, and keep the bypass; the ordinary task must not close with it.
4. **恢复 / Recovery:** 先撤除叠层并恢复地面、绿化、静音和通行，再由未来独立复核决定是否重开；否则保持 G0 或退役。 / Remove the overlay and restore surface, planting, quiet, and passage first; a future independent review may then decide whether reopening is possible. Otherwise remain at G0 or retire.
