...
- [x] manifest 已从当前最终文件字节刷新为 66 个包文件、65 个非 manifest SHA-256；权利台账的 5 个兼容组与 66 条逐文件记录具有同一路径集，除 manifest 与 ledger 的显式不可自引用项外，摘要逐项一致。
...
- [x] The manifest has been refreshed from the current final file bytes to 66 package files and 65 non-manifest SHA-256 values. The rights ledger's five compatibility groups and 66 file-level records have the same path set; every digest matches except the explicit non-self-referential manifest and ledger cases.
...
|---|---|---|
| `drawings/a3-booklet.pdf` | 33 / A3 portrait | `f07197214040f55e991c06bd7d86da4e694062cb492fb7523d165ab49aca9ab6` |
| `drawings/a3-booklet.en.pdf` | 36 / A3 portrait | `1fe6fdde25a154be0dc41b136255981e27a47fca31a965b765e6750d762e4bce` |
