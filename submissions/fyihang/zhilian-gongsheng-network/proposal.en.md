---
title: "Zhilian Symbiosis Network: Zero-carbon Collaborative Renewal Framework for the Centennial Jing-Zhang AI Innovation Belt"
...
![Overall structure and existing-condition evidence](assets/figures/site-overview.en.png)
...
![Land use, walking and blue-green structure](assets/figures/land-use-structure.en.png)
...
![Three key-area concept plans and nodes](assets/figures/key-areas.en.png)
...
![Walking, blue-green space and low-impact renewal](assets/figures/mobility-bluegreen.en.png)
...
![Projects, responsibility and evidence](assets/figures/metrics-evidence.en.png)
