...
| 版本 | 关键升级 | 对应评审关注 |
|------|----------|--------------|
| v2 | 区域协同文字分析 + 场景卡10列 | 协同机制、场景深度 |
| v3 | 协同硬核化（分工表/共享机制）+ 闭环样板 | 可追责、可验证 |
| v4 | 人字形铁路机制化（坡度/道岔/信号/K标） | 原创性、机制化 |
| v5 | 结构化证据层（7 JSON + 12 空间锚点） | 可独立审计（67/100） |
| v6 | 真实几何落位（12 EX-*）+ risk/spatial + 概念约束空间 | 空间绑定、不可替代性 |
