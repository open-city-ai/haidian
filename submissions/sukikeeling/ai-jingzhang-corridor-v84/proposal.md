...
**第一幕·自主建造（1909）**：京张铁路由詹天佑主持，以青龙桥人字形展线解决 33‰ 极限坡度——停车、换向、以退为进 [source:JZ-PARK-PHASE1-OPENED] [source:PROCESSED-FACT-PACK]。这份自主工程经验转化为城市 AI 的第一条原则：技术遇极限先停先查，不沿原方向硬冲 [depth:switchback_governance]。
