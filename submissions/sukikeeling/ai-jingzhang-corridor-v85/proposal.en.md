...
**Industry fact anchors (official figures, 2026 Zhongguancun Forum).** Haidian is building the Centennial Jing-Zhang AI Innovation Belt with the approximately 9 km Jing-Zhang Railway Heritage Park as its "innovation link" and "three areas, two wings" as its spatial layout; Haidian hosts over 2,000 AI enterprises, 26 unicorns, and 130 registered foundation models, with AI core-industry scale above 350 billion yuan, about 30% of the national total [source:HD-AI-CORRIDOR-FACTS-2026].

The 2026 Haidian District Government Work Report states "building an AI innovation district based on the AI Origin Community, the AI Beiwei Community, and the Jing-Zhang Railway Heritage Park innovation belt," and the block-level regulatory plan along the park has passed technical review and is advancing toward approval [source:HD-GOV-WORK-REPORT-2026] [source:HD00-1601-CONTROL-PLAN-NOTICE]. Our "three areas, two wings" naming maps directly onto the official spatial layout; our institutional design adds the piece the official documents leave open: **who decides whether an AI deserves to enter the city**.

**Core judgment.** What Haidian most lacks is not more compute clusters, but a public track where residents, researchers, enterprises, operators and regulators can jointly judge "is this intelligence worth entering the city". Modeled on the Ren-shaped switchback line at Qinglongqiao, this proposal turns the Jingzhang Heritage Park into a walkable **switchback governance corridor**: Zhongzhi Park for full-stack safety evaluation, AI Origin Community for research-to-street conversion, Dazhongsi for public experience and consumer rights; the Zhongguancun service wing and Xiaoyue River scenario wing provide capital, standards, talent and controlled tests [source:AGENT-TASKBOOK] [depth:three_level_scope_framework].

**Institutional loop.** Before entering public space, every urban AI scenario must pass the switchback loop — stop at the node, pass the Teach-Back Gate (report—inquiry—vote), then pass / turn back / enter depot. Not understood means turn back; any party's veto forces a turn-back; no automatic recovery [depth:switchback_governance] [depth:teach_back_gate]. Every turn-back, depot entry and recalculation is recorded in the K-marker chain [depth:kmarker_versioning]. This "Ren-three-meanings — switchback node — teach-back gate — K-marker chain" is the original closed loop: space is not a technology container but an institutional interface where the public can question, reject and re-test urban AI [assumption:A-SWITCHBACK-HISTORY-001].

**First phase only prepares low-regret moves.** First 90 days: official-data replacement list, accessibility audit and issue collection; then three reversible prototypes and a public evaluation protocol; any unresolved major safety/rights/data issue stops progress. Budgets, owners, procurement and construction timings stay unknown where data is missing — no conceptual commitments disguised as implementability [depth:phasing_implementation].

**Four auditable deliverables.** `visual/assets/switchback-gate.json` machine-codes the three switchback states and teach-back gate; `visual/assets/delivery-matrix.json` records action-package dependencies, owners, deliverables, acceptance and hard stops; `geometry/public_space.geojson` provides a 73.37 ha continuous public validation belt; each of the 12 scenario cards binds a grade and a switchback condition [metric:public_space_area_sqm] [metric:scenario_node_count] [metric:machine_readable_contract_count].

**Five fast facts.** ①12 scenario cards, each bound to grade and switchback node; ②73.37 ha continuous public belt (6.43%), 3 belts + 4 plazas + 12 nodes; ③Teach-Back Gate three steps, not understood means turn back; ④K-marker chain — every recalculation/turn-back/depot permanently recorded; ⑤all 53+ files declared, zero fabricated values — missing baselines stay pending [metric:public_space_ratio] [metric:sunset_clause_trigger_count].

| Review question | Verifiable answer in this proposal | Must not be read as |
|---|---|---|
| Brief alignment | Six agent tasks mapped to space, switchback institution, machine contracts and deliverables | Government adoption or institutional commitment |
| AI-planning integration | AI must pass switchback node, teach-back gate, grade access and public decision | "Installing sensors" equals innovation |
| Implementation | 90-day low-regret prep → 3 reversible prototypes → K-marker phases | Budget, site, procurement or operator already secured |
| Public interest | Six public-representative groups vote at the gate; worst-group and appeals take priority | Real user testing already completed |
| Failure handling | Turn-back, depot, refusal, takeover and minority views recorded in K-marker chain | Zero risk or performance guarantee |


## Design Basis and Source Inventory
This deliverable is an open co-creation conceptual urban design; it does not replace statutory planning, government approval, or engineering design. It is based on the official announcement, the agent taskbook, the public site package, and the repository source registry [source:OFFICIAL-ANNOUNCEMENT] [source:AGENT-TASKBOOK] [source:SITE-PACKAGE] [source:SOURCE-REGISTRY]. The current SITE_BOUNDARY and the three KEY_AREAs come from the repository provisional geometry [source:BOUNDARY-SOURCE] [source:BOUNDARY-SOURCE]: they are used only for generation, discussion, display, and entry self-check, and are not an official redline; they do not support floor-area-ratio, height, retain/renovate/demolish, ownership, road redline, or precise-area conclusions. Full recalculation is required after official polygons are released [depth:metrics_recalculation].

The method is an "evidence — switchback — metrics — versioning" quadruple: every strategy binds a source, a spatial layer, switchback conditions, reviewable metrics, and version records. All urban AI follows minimal data, opt-in, appealable, human-final-review, logged, and independently evaluated principles, aligned with the national Interim Measures for Generative AI Services [standard:GENERATIVE-AI-INTERIM-MEASURES]; accessible participation and alternative channels align with the Barrier-free Environment Law [standard:BARRIER-FREE-ENVIRONMENT-LAW]. [standard:PROJECT-OFFICIAL-ANNOUNCEMENT] [depth:existing_conditions_diagnosis]

![Evidence chain and site concept overview](assets/figures/site-overview.png)

## Switchback Governance Protocol (Core Institution)
This proposal uses the Ren-shaped switchback line at Qinglongqiao on the Jingzhang Railway as its institutional prototype: a train climbing a steep grade cannot go straight; it must stop at a switchback point, change direction, and continue. Along the belt, the Qinghuayuan Station site is a municipal-level protected cultural relic with its protection scope and construction-control zone delineated (Jing Zheng Fa [2025] No. 3) [source:HERITAGE-QINGHUAYUAN-STATION-SCOPE]; all heritage-related concepts along the line take special review as a precondition. Innovation works the same way: any urban AI scenario, before reaching its capability limit, should be re-evaluated at a switchback point instead of automatically continuing in its original direction. Four mechanisms:

- **Switchback Nodes (R1–R3)**: every AI scenario sets fixed switchback nodes on its running track [depth:switchback_governance]. R1: at each node the scenario must stop — no automatic continuation [depth:switch_states]. R2: a three-party review — scenario responsible entity (decision), professional review (technical), public representative (rights) — decides "pass / turn back / pull into depot"; any party's veto forces a turn-back [depth:switchback_governance]. R3: a stopped or turned-back scenario must self-check before re-entry; no automatic recovery — returning from depot to mainline requires re-evaluation at a switchback node [depth:switch_states] [depth:kmarker_versioning].
- **Teach-Back Gate**: before the vote, the scenario must pass three steps [depth:teach_back_gate] — **Report**: the responsible entity explains in plain language what the AI does, where it might fail, and how to stop it; **Inquiry**: public representatives ask questions until they confirm understanding; **Vote**: the three parties decide pass / turn back / depot. If the public does not understand, the scenario turns back [metric:public_issue_closure_rate] [assumption:A-TEACHBACK-001].
- **Veto Procedure**: any public representative may file a veto motion (verbally accepted, recorded by the secretariat); within 48 hours the scenario degrades to siding operation (speed/scope/data limited); the responsible entity may request one public rehearing with at least five public representatives present; every veto is recorded in the K-marker chain permanently [depth:switchback_governance] [depth:teach_back_gate].
...
![Three-level scope and three-core two-wing framework](assets/figures/land-use-structure.png)
...
|Case|Learning point|Jingzhang translation|Not to copy|
|---|---|---|---|
|Singapore Smart Nation / AI Verify [source:CASE-SG-AIVERIFY]|Public-interest goals, standardized testing|Public AI evaluation protocol for urban AI|National identity and data conditions|
|Barcelona 22@ [source:CASE-BCN-22B]|Old industrial mixed renewal, innovation network|Railway heritage + incremental activation of existing stock|Large-scale real-estate renewal|
|Eindhoven Brainport [source:CASE-EHV-BRAINPORT]|Enterprise–university–government collaboration|Task-based alliance of three cores and two wings|Single-champion dependence|
|Toronto Waterfront digital-governance debate [source:CASE-TOR-WATERFRONT]|Learning from failure in data governance and public consent|Data impact assessment, turn-back and depot entry|Platform-enterprise-led governance|
|Boston Kendall Square [source:CASE-BOS-KENDALL]|High-density research commercialization and public space|Origin Community walkable innovation network|High-rent exclusion effect|
|Shenzhen Nanshan [source:CASE-SZ-NANSHAN]|Industrial chain, capital, rapid scenario iteration|Zhongzhi full-stack validation + Dazhongsi market feedback|Speed replacing safety evaluation|
...
The overall design uses "railway culture spine + switchback governance ring + horizontal stitching openings" as its skeleton: retain reusable stock, supplement continuous slow mobility and public services, and add new volume only after official control plans, ownership, heritage, and municipal conditions are confirmed.

Renewal methods follow the Beijing Urban Renewal Regulation (effective 2023-03-01) [source:BJ-RENEWAL-REGULATION] and MOHURD's no-large-scale-demolition requirements (Jian Ke [2021] No. 63) [source:MOHURD-63-NO-MASS-DEMOLITION], consistent with the Haidian Urban Renewal Guide (2025 edition)'s emphasis on AI innovation districts and rail-station integration [source:HD-RENEWAL-GUIDE-2025]; the Beijing Urban Renewal Policy Incentive Toolkit (1.0) provides the policy background [source:BJ-RENEWAL-TOOLKIT-2026].

Four conceptual land-use categories carry innovation R&D, mixed services, culture-public, and blue-green open functions [data:geometry/land_use.geojson#LU-001]; building scale is only a conceptual-base recalculation [data:geometry/buildings.geojson#BLD-001] [metric:building_footprint_area_sqm], not statutory capacity. [standard:MOHURD-CONTROL-DETAILED-PLANNING] [depth:land_use_layout] [depth:development_intensity_controls]
...
- **Dazhongsi AI Industry Cluster** [data:geometry/key_areas.geojson#PROV-KEY-003]: urban AI-native economy blocks; four-quadrant stitching of commerce, data-factor theater, and public experience, avoiding closed campus-ization. Within the area, the Lanjinglijia project is confirmed by the Haidian branch of the Beijing Municipal Commission of Planning and Natural Resources: Beijing Yunyue Changshi Technology Co., Ltd. acquired plots HD00-1603-01 and 03A (total site area about 3.95 ha) via listed transfer — Haidian's first urban-renewal case bringing social capital to help a key enterprise land [source:HD-LANJINGLIJIA-CASE-2026]. Our proposal only organizes conceptual public interfaces around the plots and draws no regulatory conclusions.
...
This section develops users, scenarios, testing, and operations according to the agent open-call taskbook, rather than treating AI as a decorative label [source:AGENT-TASKBOOK] [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK].
Six user types: commuters, elderly/disabled, students and researchers, startups and SMEs, tourists and families, and frontline operators. Every scenario must publish its purpose, data, model limitations, human responsible entity, switchback nodes, and stop conditions.

### Twelve Scenario Cards (with Grade and Switchback Condition)
|#|Scenario—space—operation|Grade|Switchback condition (stop and evaluate)|Success metrics (evaluation criteria)|
|---|---|---|---|---|
|01|Accessible route assistant—full belt slow network—community co-test|Gentle|Route suggestion rejected 3 consecutive times|Accessible route coverage, correction time|
|02|Crowd guidance suggestion—node plaza—on-site dispatch|Medium|False-alarm rate above threshold|Wait time, false-alarm rate|
|03|Multilingual cultural guide—railway heritage—heritage review|Gentle|Historical error corrected|Correction rate, comprehensibility|
|04|Community service navigation—Origin Community—block service desk|Gentle|One-stop rate below baseline|One-stop completion rate|
|05|SME compliance assistant—service wing—professional review|Medium|Adoption and withdrawal rate anomaly|Adoption/withdrawal rate|
|06|Open-source compute scheduling—Zhongzhi Park—resource committee|Steep|Resource fairness complaints|SME availability|
|07|Robot low-speed delivery—Xiaoyue River wing—time-windowed|Steep|Any takeover failure|Zero harm, takeover rate|
|08|Public-space microclimate suggestion—park node—landscape review|Gentle|Suggestion rejected by landscape dept|Thermal comfort improvement|
|09|Aged-care health service navigation—community node—medical referral|Medium|Misleading rate above threshold|Misleading rate, referral completion|
|10|Consumer service translation—Dazhongsi—merchant co-governance|Gentle|Complaint rate above threshold|Complaint rate, response time|
|11|Public-safety review assistant—operation center—post-hoc review|Steep|Review conclusion challenged|Review loop closure rate|
|12|Resident issue synthesis—switchback assembly hall—random audit|Medium|Fairness audit fails|Viewpoint coverage, fairness error|
...
**Completed-facts vs planned-target layering (reviewable):** Phase 1 of the Jingzhang Railway Heritage Park **opened in June 2023**, 2.4 km long and 16.8 ha, forming a public park with slow paths and cycling [source:JZ-PARK-PHASE1-OPENED] [source:JZ-PARK-PHASE1-REPORT]; the Wudaokou startup zone completed about 800 m / 1.7 ha of landscape enhancement in September 2019 [source:JZ-PARK-STARTUP-2019]. In 2025 Phase 1 hosted 60+ themed events and received 4.3+ million visitors (operator statistics) [source:JZ-PARK-2025-EVENTS]. **Phase 2 site area 530,900 m² (official project figure)**, running south from Xizhimen to the North Fifth Ring along Line 13, extending the park to 9 km with four strategies of "merge, demolish, retreat, complement" [source:JZ-PARK-PHASE2-53HA]; in September 2024 the Beijing Municipal Development and Reform Commission announced Phase 2 groundbreaking within the year (branch-road connections, under-bridge activation, driving renewal of the Xijiao Refrigeration Plant / Mingguangcun) [source:JZ-PARK-PHASE2-PLAN-2024]; in July 2026 the Beijing Municipal Forestry and Parks Bureau announced completion of Phase 2 supporting projects [source:JZ-PARK-PHASE2-COMPLETED-2026]. Phase 2 plans five clusters — Jingzhang water-vein, community vitality, heritage memorial, youth international exchange, and natural leisure — with "about 9 km serving nearly 70 communities and about 450,000 residents" as a planned service target, not completed status [source:JZ-PARK-PHASE2-PLANNED]. All "about 9.7 km spine" statements in this proposal refer to the planned target; spatial evidence uses provisional boundaries.

The conceptual blue-green base consists of the Jingzhang Heritage Park, Qinghe/Xiaoyue River connections, and pocket gardens [data:geometry/green_space.geojson#GRN-001] [depth:blue_green_public_space]; actual shorelines, ecology, and heritage boundaries await official data review.
Public space uses a three-level "continuous slow spine—horizontal stitching openings—switchback validation stations": the park spine organizes walking, cycling, rest, and culture; horizontal stitching prioritizes improving existing crossings and accessibility, with new bridges/tunnels only as concepts awaiting special study; validation stations embed removable, modular components into existing space [data:geometry/public_space.geojson#PUB-001] [metric:public_space_ratio].

1. **AI Origin·Open-Source Dome**: an open-source achievement growth-ring and real-time evaluation wall, showing data sources, versions, failure records, and contributors; no commercial rankings.
2. **Jingzhang Centennial·Timeline Station**: uses switchback signal language to connect 1909, the innovation era, and the AI future; all historical facts are reviewed by professional institutions.
3. **Switchback Assembly Hall**: a circular space where residents, developers, and operators jointly review urban AI, with quiet rooms, accessible seats, children's viewing platforms, and human appeal windows.
...
The project list is organized into four categories: reversible prototypes, public-evidence facilities, slow-mobility stitching, and existing-stock ground-floor renewal; the conceptual phasing layer records near-term pilots, switchback nodes, and exit conditions [data:geometry/phasing.geojson#PHASE-001] [depth:renewal_project_list] [depth:phasing_implementation], and does not represent government investment, recruitment, or approval arrangements.
The annual rhythm follows real urban problems rather than exhibition traffic:
...
|Phase|Low-regret actions|Gate to next phase|
|---|---|---|
|K0—K3 (0–6 months)|Official data completion, accessibility audit, issue solicitation, existing-stock inventory|Source clearing, public-representative participation, risk ledger complete|
|K3—K6 (6–18 months)|3 reversible prototypes, public evaluation protocol, contributor system|Independent evaluation passed, major risks can depot-enter|
|K6—K9 (18–36 months)|Three-core two-wing linkage, annual events, open component reuse|Public-value metrics continuously improving|
|K9+ (36 months+)|Deepen selectively after statutory procedures and special studies|Human professional team final judgment|
...
A resident's on-the-record criticism of "performance-style" urban construction (issue #1061) [source:PUBLIC-ISSUE-1061] is the real-world starting point for the Teach-Back Gate and the veto procedure: participation is a decision step, not a display step.
