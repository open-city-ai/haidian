---
title: Jing-Zhang Open Ground
subtitle: Turn a century-old railway into a nine-kilometre AI city prototyping ground
author_github: mumu-bird
license: CC-BY-4.0
summary: One public intelligence spine, two innovation wings, three open grounds and multiple east-west stitches bring industry, mobility, public space and daily AI life into the real nine-kilometre Jing-Zhang corridor.
language: en
...
![Three design scales and three key areas](assets/figures/scope-framework.en.png)
...
![V3 evidence: Three-Level Scope Framework](assets/figures/site-overview.en.png)
...
![AI industry chain and five spatial moves](assets/figures/industry-chain.en.png)
...
![Industrial division of three grounds and two wings](assets/figures/district-division.en.png)
...
![V3 evidence: Overall Design Area: Urban Renewal and Regulatory-Plan-Level Urban Design](assets/figures/land-use-structure.en.png)
...
![V3 evidence: Detailed Design of Key Areas](assets/figures/key-areas.en.png)
...
![V3 evidence: Blue-Green Network, Public Space, and Urban Character](assets/figures/mobility-bluegreen.en.png)
...
![V3 evidence: Metrics, Area Recalculation, and Compliance Matrix](assets/figures/metrics-evidence.en.png)
