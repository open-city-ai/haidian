...
本方案的**总体概念**是：延根青龙桥的"人字形折返"为几何母题，形成"百年自主，人字向上"的空间叙事。通过四个原点的自主创新事件与 AI 治理示范，赋予海淀"自主创新源头"的空间身份。

概念从一开始就是三层一体，而不是后加章节：**空间层**用“人”字折角组织一脉三台两翼双缝；**运营层**把百年贡献、当代试验和未来修正记录为“时间公地”；**治理层**以“人工兜底＋公开答卷”决定每项 AI 能否进入公共空间。三个层次分别回答长什么样、如何长期积累、凭什么被允许。
...
本页只做**证据导航**，不以自我评价代替评审。每一行都指向正文中可直接核对的制度、空间、实施或交付物；若索引与正文、结构化文件或图件不一致，以结构化证据与公开边界声明为准。
...
| 机制环节 | 法定或政策依据 | 本包引用边界 |
| --- | --- | --- |
| 人工兜底 | 《无障碍环境建设法》第三十九条 [standard:BARRIER-FREE-ENVIRONMENT-LAW] [source:BARRIER-FREE-ENVIRONMENT-LAW] | **仅**适用于该条列举的医疗、社会保障、金融、生活缴费等公共服务场景；场景之外的人工兜底属方案倡议，不冒充法定义务 |
| 公开答卷 | 《生成式人工智能服务管理暂行办法》第二、十四、十五、十七条 [standard:GENERATIVE-AI-INTERIM-MEASURES] [source:GENERATIVE-AI-INTERIM-MEASURES] | 该办法**未设定数值化法定响应时限**，也**未规定普遍的用户一键关闭义务**；答卷中的时限与关闭项标注为方案自设运营承诺 |
...
这三条依据均取自组织方站点资料包的标准清单 [source:STANDARDS-INDEX]，本包对其中 9 条标准做到**全部响应**，包括 5 条强制项与 4 条非强制项，逐条响应记录见 `standard_matrix.json`。选择响应非强制项，是因为本方案的治理内核若失去法律锚点就退化为口号；而引用法律的同时逐条写明"不可扩大解释"的边界，是为了不把参赛方案的主张伪装成法定要求 [assumption:A-OPERATIONS-001]。

| 依据层级 | 内容 | 本包落点 |
| --- | --- | --- |
| 征集要求 | 公告 1.3/1.4/1.5 任务与 agent.1–agent.6 | `compliance_matrix.json` 23 条逐条映射 |
| 技术标准 | 城市设计管理办法、控规、用地分类、设计深度 | `standard_matrix.json` 强制 5 项 |
...
公告与任务书给定了三大定位、五大功能与三区两翼三组框架 [source:AGENT-TASKBOOK] [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]。**本方案不重新发明这三组框架，也不改写其名称**，而是回答一个更要紧的问题：三者之间**如何形成闭合回路**，而不是三张各自独立的清单 [depth:overall_spatial_structure]。

### 一、三大定位不是并列，是一条时间线

| 定位 | 回答的问题 | 时间性 | 本方案的对应动作 |
| --- | --- | --- | --- |
| **百年京张文化带** | 我们从哪来 | 过去 → 现在 | 四个原点（1909 自主 / 1949 赶考 / 1980 创新 / 2026 AI）串成 9.6 公里可步行的百年 |
| **都市AI生活体验带** | 现在的人怎么用 | 现在 | 12 张 AI+ 场景卡落到通勤、就医、办事、育儿、就业等日常，配人工兜底通道 |
| **AI融合创新带** | 我们往哪去 | 现在 → 未来 | 全栈自主创新链 + 开源生态 + 产业级测试场景 |

**三者的关系是「昨天—今天—明天」的同一条线，不是三条平行的带。** 一个只讲历史的方案会变成纪念公园，一个只讲产业的方案会变成产业园，一个只讲体验的方案会变成商业街。本方案坚持三者共用同一条空间主脉——遗址主脉 9,574.15 米 [metric:heritage_spine_length_m]，使定位之间不必抢地，而是在同一段路上分层叠加。

### 二、五大功能的分工与承载

| 功能 | 核心承载 | 空间落点 | 可检验的落地方式 |
| --- | --- | --- | --- |
| **AI全栈自主创新体系** | 从芯片、框架、模型到应用的自主链条 | 众智园AI自主创新加速区（智源台） | 全栈街坊按链条环节组织用地，而非按企业规模 |
| **世界级AI创新生态** | 开源社区、人才、资本、成果转化 | AI原点社区（原点坊） | 开源发布厅、走廊工位、近校型转化街坊 |
| **AI+场景赋能新范式** | 场景开放、测试、迭代 | 小月河场景赋能翼 | 12 张场景卡 + 4 类产业级测试场景 |
| **智能化AI活力城市** | 日常可感的智能公共服务 | 全带主脉与三台 | 三色状态可视化 + 人工兜底通道 |
| **AI治理全球话语权** | 标准、评测、制度输出 | 众智园AI自主创新加速区（智源台） | 人工兜底与公开答卷制度，作为可复制的最低要求 |

**其中「AI治理全球话语权」是本方案投入最重的一项。** 理由写在正文后段：芯片与模型的追赶需要时间，而**治理规则的空位是现在就存在的**。全球城市都还没回答「AI 进入公共服务后出错了谁负责」。本方案给出的答案不是宣言，是一套六项公开答卷加五项人工兜底硬要求的**可照抄清单**——这是最有可能被国际引用、也最符合「话语权」本义的路径 [depth:risk_missing_data]。

### 三、三区两翼的协同回路：让要素真的转起来

三区两翼若只是五个并置的片区，它就只是分区图。本方案将其组织为**一条有方向的闭合回路**：

> **众智园（造能力）→ 原点坊（聚人才、转成果）→ 小月河翼（给场景、做验证）→ 大钟寺（成业态、接市场）→ 中关村翼（配要素、给资本）→ 回流众智园（再投入研发）**

| 环节 | 片区（官方名称） | 投入什么 | 产出什么 | 交给下一环 |
| --- | --- | --- | --- | --- |
| 1 造能力 | 众智园AI自主创新加速区 | 研发投入、算力、标准 | 自主模型与评测口径 | 可被验证的能力 |
| 2 聚人才 | AI原点社区 | 开源社区、住房、转化空间 | 团队、开源成果 | 待验证的产品 |
| 3 给场景 | 小月河场景赋能翼 | 真实场景、测试许可 | 验证数据与失败记录 | 被证明可用的方案 |
| 4 成业态 | 大钟寺AI产业集聚区 | 站城一体流量、消费与数据要素 | 营收与市场反馈 | 商业验证 |
| 5 配要素 | 中关村科技服务翼 | 资本、IP、全球化配置 | 再投资与国际通道 | 回到第 1 环 |

**这个回路的价值在于它可以被检验。** 任一环断裂都有可观察的征兆：造出的能力无人验证（1→3 断）、开源成果无法商业化（2→4 断）、有营收却不反哺研发（4→5→1 断）。本方案因此把「回路是否闭合」列为年度公开复算的观察项之一，而不只是画一张箭头图 [depth:phasing_implementation]。

**两翼为什么是翼而不是区。** 中关村科技服务翼与小月河场景赋能翼不承担独立的空间主体地位，它们的作用是**向三区双向输血**：一个输入要素与资本，一个输入场景与验证。翼的绩效不看自身产值，而看**它让三区多完成了多少次闭环**。

### 四、区域创新协同关系

本带不是孤岛，需说明其在北京乃至京津冀创新格局中的位置 [depth:three_level_scope_framework]：

| 协同对象 | 关系性质 | 本带的分工 |
| --- | --- | --- |
| **怀柔科学城** | 上游 | 承接大科学装置与基础研究成果的产业化下游，不重复布局大科学装置 |
| **未来科学城**（昌平） | 平行互补 | 与其能源、医药产业化平台形成「通用AI能力—行业场景」上下游 |
| **北京经济技术开发区（经开区／亦庄）** | 下游 | 输出算法与标准，由其承担高端制造与智能网联汽车的规模化落地，不争夺制造用地 |
| **北纬社区** | 近邻创新社区 | 作为公告点名的协同对象纳入本带的创新社区网络：共享开源发布、活动体系与人才服务，并在慢行与公共服务层面预留衔接接口 |
| **京津冀（张家口端）** | 走廊另一端 | 算法与标准留海淀，大规模训练算力与绿电由张家口端承担（详见「区域协同」章） |

**须说明的边界**：除本设计范围外，上述各方均**不在本次城市设计范围内**，本方案不对其提出用地、指标或建设安排，相关表述均为协同关系判断与概念建议 [assumption:A-CONTROLS-001]。公告点名的「北纬社区」在组织方公开资料中未给出边界与法定范围，本方案仅将其作为**协同对象**表述，不推断其地理范围、不为其安排空间，待官方资料发布后按复算协议一并更新。

### 五、综合规划内涵、空间产业融合与国土空间规划创新

任务书 `agent.1` 要求回答综合规划、空间产业融合与国土空间规划的创新思路 [source:AGENT-TASKBOOK]。本方案给出三条，均立足于「**这条带与常规产业园区到底有什么不同**」这一问题 [depth:overall_spatial_structure]。

**其一，综合规划的内涵：从"安排用地"转向"安排关系"。** 常规控规回答的是每块地做什么、多大强度；而一条创新带的成败往往不取决于单块地的用途，而取决于**地块之间的关系是否支持要素流动**。本方案因此把「三区两翼协同回路」作为规划的一级对象——回路是否闭合，比某一块地是不是研发用地更重要。具体做法是把"回路是否闭合"写入年度公开复算的观察项，使关系本身成为可被检验的规划成果，而不是一张示意箭头图。

**其二，空间产业融合：按创新链环节组织空间，而非按企业规模。** 传统园区按"孵化器—加速器—总部"的企业规模分级布局，结果是同一条技术链上的上下游被切散到不同园区。本方案主张**全栈街坊**——按芯片、框架、模型、应用的链条环节组织街坊，使一条链上的团队在步行距离内完成协作。这一取向也决定了本带不追求单体地标式的大体量总部，而追求**中小尺度、高密度、可步行的混合街坊**。

**其三，国土空间规划创新：把"减量"变成一种设计能力，而不只是约束。** 北京实施减量发展，海淀新增建设用地极其有限。本方案的回应不是争取指标，而是提出三条在存量条件下提升效能的路径：

- **纵向复合**：算力、能源、公共服务等新型基础设施随公共节点集约布设（"新基建随公共节点走"），不单独占地形成机房孤岛。
- **时间复用**：同一空间在通勤时段、工作时段、夜间活动时段承担不同功能，以时间维度换取空间容量——这是存量地区最被低估的资源。
- **跨区配置**：把高能耗的训练算力放到能源禀赋更合适的走廊另一端，使海淀的土地与能耗指标用在附加值最高的环节上。**这是国土空间层面的分工，而非简单的产业转移。**

**边界声明**：以上均为规划思路层面的**概念建议**，可供专业团队深化研究。涉及国土空间规划的法定内容、指标分配与用地性质调整，须依法定程序由具备资质的编制单位完成，本方案不作规划结论 [assumption:A-CONTROLS-001] [standard:MOHURD-CONTROL-DETAILED-PLANNING]。
...
#### AI 创新生态图谱：八类要素不是清单，而是同一条转化链

任务书要求同时回答土地、空间、产业、资金、人才、算力、数据与场景机制。本方案不把八类要素分别堆放，而把它们组织成“**进入条件—空间接口—可核成果—回流方向**”的生态图谱 [depth:overall_spatial_structure]：
...
这张图谱表达的是**概念性责任关系**，不是现有政策、资金或机构承诺。真正的闭环不是“八项都写过”，而是任一项都能说明上一环给了什么、下一环凭什么接收、失败后退回哪里 [assumption:A-CONTROLS-001]。
...
任务书要求的不只是地标数量，还包括**荣誉展示体系和公共空间组件库**。本方案把二者合并为一套可复制、可撤回、无需手机也能使用的“人字组件家族” [depth:blue_green_public_space]。

**荣誉展示不是名人墙，而是贡献与纠错的公开账本。** 原点碑保存经核验的长期贡献；开源发布厅设置季度版本栏；算力之钟显示服务三色状态；年度“一榜”同时记录新增贡献、失败复盘与公开修正。每条记录只包含贡献内容、版本、证据、公共回报、失败与修正状态，不展示无关个人信息，不把企业宣传、捐赠金额或行政级别当作荣誉依据。未经独立复核的内容只能进入“待验证”，不能刻入永久层。
...
六类组件只规定**任务、信息和家族几何**，不在缺少实测时规定尺寸、材料构造与工程做法。折角来自同一 Logo 母题，但组件首先要好用，其次才是可识别；任何组件不得以品牌完整为由妨碍通行、无障碍、文保或日常服务。
...
方案编制 12 张**完整运营卡** [metric:scenario_card_count]。下表同时完成任务书要求的“场景—空间—运营映射”：每张卡写明用户任务、承载空间、建议责任组合、最小数据、非 AI 路径、放行证据与退出条件。所有“放行证据”均为**未来试点开始前必须取得的证据**，不是本方案声称已经实现的现场绩效；没有授权、基线和人工路径时，场景保持未开放状态 [source:AGENT-TASKBOOK] [depth:risk_missing_data]。
...
**必须同时写清不可扩大解释的部分**，否则引用法律反而会变成误导：《无障碍环境建设法》第三十九条的人工服务要求限于该条列举的服务场景，本方案将其推广到全部公共 AI 服务，属于**方案主张而非法定义务**；《生成式人工智能服务管理暂行办法》**没有设定数值化的法定响应时限**，也**没有规定普遍适用的用户一键关闭义务**，因此下文答卷中出现的任何时限与关闭选项，均为本方案自设的运营承诺，不得被读作法定要求 [assumption:A-OPERATIONS-001]。本方案宁可把制度的法律边界说得比主张更清楚，也不愿用一句含糊的"依法依规"把参赛方案的构想伪装成既有法律责任。
...
**时间公地是本方案的核心差异价值主张。** 与其说京张向上是一条"地理空间"，不如说它是一条**时间轴上的数据开放基础设施** [depth:overall_spatial_structure] [depth:phasing_implementation]。

#### 5.1 从地理空间到时间公地的转变

| 维度 | 传统产业园模式 | 京张向上"时间公地"模式 |
|------|---------------|----------------------|
| 空间角色 | 地块出租、物业管理 | 数据枢纽、治理实验室 |
| 价值流向 | 土地级差收益归属 | 创新成果与数据贡献共享 |
| 企业关系 | 竞争或兼并 | 协作与"贡献-赋能"循环 |
| 时间尺度 | 5-10 年更新周期 | 百年遗产→现代创新→未来生态的三代递进 |
| 数据流向 | 各自闭源、数据孤岛 | 公共层数据公开、应用层数据贡献、治理层答卷透明 |
| 评价体系 | GDP、人才落户数量 | "数据贡献率"、"人工兜底覆盖率"、"治理失败记录" |

#### 5.2 时间公地的四层数据架构

**层级 1：公共基础数据层（政府发布，常年开放）**
- 来源：城市建成环境扫描、气象、交通流量、公共事件
- 权限：企业与科研机构可用于产品开发与算法验证
- 责任：主管部门定期更新、标注数据来源与收集方法
- 承载空间：智源台"AI 数据开放中心"[data:geometry/key_areas.geojson#PROV-KEY-001]

**层级 2：产业应用数据层（企业上报，条件公开）**
- 流程：企业在试点场景中的 AI 产品运行产生的数据（如交通信号优化的实际通行效率、推荐算法的选择率等）
- 回流机制：产品上线后，每季度须提交"应用效果复盘"，可公开部分在带内共享（降低重复开发成本）
- 激励设计：贡献优质数据的团队可获得后续融资对接、政府采购倾斜、税收优惠等
- 承载空间：原点坊"创新成果转化中心" [data:geometry/key_areas.geojson#PROV-KEY-002]

**层级 3：治理透明数据层（系统生成，实时可查）**
- 内容：AI 服务的三色状态卡、失败记录、人工通道响应时间、公众投诉与反馈汇总
- 可视化：三维实时仪表板（集中展示于"算力之钟"等公共构筑物）
- 访问权：全社会可查（不含个人身份信息），实时更新不延迟
- 承载空间：智汇钟"治理可视化中心" [data:geometry/key_areas.geojson#PROV-KEY-003]

**层级 4：学术与社区数据层（协议公开，研究反馈）**
- 流程：高校与社区组织可申请访问脱敏数据集，用于学术研究与社会评估
- 责任：发表成果时须致谢数据来源，向带内社区反馈研究发现
- 成果物：年度"京张数据故事集"，汇总学术发现、社区反馈、政策建议
- 承载空间：北大、清华、中科院在带内的研究中心（具体数据授权规则须依《中华人民共和国数据安全法》等现行法规另行论证，本方案不预设标准名称）

#### 5.3 时间递进的共创框架

**过去—现在—未来三代人的对话** [depth:overall_spatial_structure]：

| 时代 | 代表人物 | 留下的遗产 | 当代者的责任 | 未来者的继承 |
|------|---------|----------|-----------|-----------|
| **百年过往**（1909-2009） | 詹天佑等自主创新先驱 | 京张铁路遗址（物理）、自主精神（文化） | 保护遗产、讲好故事、激发后人 | 承诺延续自主品质 |
| **现在**（2009-2026） | 中关村创新者、海淀规划者 | 全栈自主创新链、算力集聚、治理探索 | 开放场景、共享数据、记录失败 | 可复制的方法论 |
| **未来**（2026 及之后） | AI 开发者、社区居民、全球参与者 | 新技术、新产品、新治理经验 | 持续贡献数据、参与评议、推动迭代 | 应用于全球 |

**物化形式**：
- 时间轴步道：9.6 公里主脉上嵌入四个原点的"时代柱"（1909、1949、1980、2026），每个柱体上刻有"我们从哪来"、"我们在这里做什么"、"下一代会如何用"
- 年度共创论坛：每年秋季在智源台举办"跨代对话"主题论坛，邀请铁路历史研究者、当代创新领导者、年轻开发者与外地访客共议
- 开放数据奖：每年评选"最有社会价值的数据贡献"、"最诚实的失败记录"，向优胜者发放带内消费券与社区荣誉证书

#### 5.4 与全球 AI 治理的对标

京张向上提出的"时间公地 + 数据透明 + 失败记录"模式，与以下**公开可查的国际治理实践类别**相呼应但各有差异。这里列出的是国际上广为人知的治理范式名称，用于说明本方案定位的相对坐标，并非对某一具体项目的绩效数据引用，不作为可复算指标：

| 参考范式 | 代表地区 | 核心机制 | 京张的创新点 |
|---------|------|---------|-----------|
| Open Data Movement（开放数据运动） | 全球通行做法 | 公共数据开放 | 京张加入"应用数据回流"（企业必须贡献） + "失败记录透明"（不只报成功） |
| Regulatory Sandbox（监管沙箱） | 新加坡、英国等地采用的通行监管工具 | 管制沙箱、有限试验 | 京张加入"时间递进"框架（沙箱不只是短期试验，而是长期生态） |
| AI Ethics Board（AI 伦理审查委员会） | 欧盟、美国加州等地的通行治理形式 | 伦理审查 | 京张加入"人工兜底"（审查结果要落实到人工通道设计） |
| Data Commons（社区数据共有） | 印度、肯尼亚等地的社区实践形式 | 社区数据共有 | 京张加入"三色状态"可视化（让数据治理成为公共景观） |

**必须声明**：上表为治理范式类别的一般性比较，不代表本方案团队核实过具体项目的官方数据或绩效指标；如需引用具体案例数据，须另行核实并标注可查来源。

#### 5.5 时间公地的风险与边界

**必须声明**的限制与假设 [assumption:A-CONTROLS-001]：

1. **数据安全与隐私的法律边界**：本方案涉及的所有数据共享与公开须严格遵守《中华人民共和国数据安全法》《个人信息保护法》等法律，任何数据处理方案须经专业评估与监管批准。
2. **企业数据产权边界**：企业应用产生的数据所有权、使用权、收益权的归属须在招商合同中明确约定，本方案不涉及产权争议裁决。
3. **政府数据公开的政治风险**：某些类型的公共数据可能涉及安全敏感性，公开前须经过法定的安全审查程序。
4. **时间递进框架的可持续性**：百年规划周期超出任何单一主体的治理能力范围，需要制度性、法律性的长期保障机制（如修订城市总规、立法保护等）。

本方案建议将"时间公地"的指导原则纳入《京张向上地区城市设计导则》，但具体的数据治理规则须由数据保护部门、信息化部门与行业协会协议制定，而非单一规划部门决定。
...
一条创新带真正的门槛不在于有没有好想法，而在于**想法在哪一环会断掉**。本方案针对四类关键要素给出保障机制建议 [depth:overall_spatial_structure]：
...
**与轨道的关系。** 本带沿线既有轨道站点是走廊的骨架，本方案不新增线路建议——线网调整须依法定程序，非本方案可决 [assumption:A-CONTROLS-001]。方案能做的是**把站点周边 300 米从"通过空间"改造为"停留空间"**，通过站前公共厅、四象限步行连接与首末站接驳组织，使换乘不必走出风雨与日晒。
...
**AI 创新带绕不开一个尴尬事实：算力是耗电大户。** 一个只谈算力规模、不谈能耗代价的方案是不诚实的，在减量发展导向下也无法通过审视 [depth:municipal_new_infrastructure]。

本方案的处理分三层：

**第一层，总量上把大头移出去。** 大规模训练算力由张家口端承担（见"区域协同"章），海淀端只保留推理与开发所需的轻量算力。**这不是修辞上的分工，是能耗账上的分工。**

**第二层，留下来的部分必须公开代价。** 本带内的端侧算力驿站与边缘节点须公开三项数据：实时能耗、绿电占比、以及**余热去向**。算力设备的散热是确定会产生的，问题只在于它被排到空气里，还是被回收利用。方案建议在具备条件的公共节点探索余热回收用于周边建筑采暖或生活热水预热——**是否可行须经专业热工核算，本方案不作工程结论，也不承诺回收比例**。

**第三层，把能耗变成公共可见的信息。** 算力之钟不只是雕塑，它同时是能耗与绿电占比的实时可视化装置。**当市民能看见"这条带今天用了多少电、其中多少是绿电"，算力才从抽象概念变成公共议题。** 这与"公开答卷"制度是同一条逻辑：**先公开，才谈得上讨论；先可见，才谈得上约束。**

具体的用电负荷预测、变电容量与热力管网承载力评估，须依据官方市政资料由专业单位完成，本方案不作工程结论 [assumption:A-CONTROLS-001]。

### 七、公共服务设施

按"十五分钟创新生活圈"配置教育、医疗、养老、托育、文化、体育设施，重点补齐两类缺口：面向青年创业者的**低成本居住与共享生活设施**，面向老年居民的**适老化与数字帮扶设施**。全线执行连续无障碍设计，落实《无障碍环境建设法》要求 [standard:BARRIER-FREE-ENVIRONMENT-LAW]。涉及出行、就医、消费、文娱、办事等高频场景的服务点位，方案建议同时保留非智能的传统办理路径与可达的人工协助点位，使不使用智能终端的居民仍能完成全流程；此项以国办发〔2020〕45号为政策背景参照，该文件在本包中登记为 `background_only`，不作为法定编制依据 [standard:ELDERLY-SMART-TECH-PLAN-2020-45]。
...
**弱势群体的处境不能靠事后补救，只能靠事前约束。** 本方案把三项要求写进准入而非倡议：

**其一，无障碍是连续的，还是不算数的。** 无障碍设计的常见失败是"点状达标、线上断裂"——每个建筑单体都合规，但从家门口到地铁口的整条路走不通。本方案要求以**连续路径**而非单点设施作为验收单位，任一处断点即视为该路径不达标。相关设计须落实《无障碍环境建设法》要求 [standard:BARRIER-FREE-ENVIRONMENT-LAW]；其中第三十九条对医疗、社会保障、金融、生活缴费等公共服务场所提出保留现场指导和人工服务的要求，本方案的人工兜底机制即以此为法定基线。需要说明边界：该条列举的服务场景之外，本方案主张的人工兜底属**方案倡议而非法定义务**，不得据此宣称所有 AI 服务都负有普遍的人工兜底法律责任；具体无障碍技术指标由专业单位依现行规范确定 [assumption:A-CONTROLS-001]。

**其二，无障碍信息必须免费且开放。** 哪条路有台阶、哪个坡道在维修、哪个电梯停用——这些信息对轮椅与推车使用者是刚需。方案要求此类信息**不得作为付费功能、不得强制下载专用 App**，并应以开放数据形式发布，允许第三方接入。

**其三，数字弱势者的兜底不设门槛。** 人工兜底通道的五项硬性要求（同址、同时、同权、显著、可切换）**不区分办事人身份**，不需要证明自己"不会用手机"才能获得人工服务。**一项需要先自证弱势才能享受的照顾，本身就是新的门槛。**

**关于游客与本地居民的关系。** 本带的文化叙事面向外来访客，但**不应以牺牲本地日常为代价**。方案要求活动体系与朝圣地标的组织避免形成"节庆时人满为患、平日空无一人"的景区化倾向：四个原点首先是本地居民的日常步行路径，其次才是访客的打卡点。**这条带的成功标志不是游客量，而是本地人是否每天都在用它。**
...
活动如果只生产人流，不生产维护者、验证记录和后续项目，就不构成长期运营。本方案建议建立**月度维护、季度复演、年度公开**的开发者社区节奏；它是概念性运营机制，不代表已有组织或经费安排 [depth:phasing_implementation]。
...
社区设三类角色而不新设行政层级：**维护者**负责代码、数据和文档版本；**场景责任人**负责许可、现场、人工接管与恢复；**公众评议员**负责从实际任务验证是否能理解、完成和退出。任何人可以提出问题，但进入现场试点必须有唯一责任主体和专业复核；贡献身份不得替代许可与安全审查。
...
一份方案是否可实施，不取决于它画了几期，而取决于**它敢不敢指定第一个试点、并预先写下失败判据**。本方案因此提出三个**首启试点区**。它们优先使用既有服务窗口、既有步行接口和清单制度，不预设权属简单，也不涉及大规模拆迁。任何现场动作仍须先取得权属、许可和实测条件，可在不把临时边界当作正式红线的前提下开展前期核验 [depth:phasing_implementation] [assumption:A-CONTROLS-001]。
...
下表把三个一年期试点的**共同前 90 天**压缩为六道证据门。它是拟议的执行顺序，不是已完成试验；D1 之前三项试点均保持“未授权、未现场运行”。年份安排不能替代证据门，任何一门未通过都停在原状态 [depth:phasing_implementation]。
...
三项试点各自的**特殊核验**不同：样板窗口核验五项人工通道；缝合链核验真实绕行、无障碍连续性与日常通行；场景清单核验申请是否能从纸面走到合法进场。共用证据门不把三者简化成同一种项目，只确保任何项目都不能绕过基线、人工路径、停止和恢复责任。

**为什么是这三个。** 它们分别验证本方案三条最核心的主张是否成立：治理内核能否落到一个真实窗口（试点一）、空间缝合能否真正改变步行行为（试点二）、场景开放能否吸引真实团队（试点三）。**三者都不依赖官方边界发布，都不涉及拆除决策，都能在一年内给出是或否的答案。**

**关于失败判据的说明。** 上表最后一列不是免责条款，而是本方案的方法论立场：**一个不肯预先写下失败判据的实施计划，事后就无法被追责**。三项试点若未达标，应公开记录原因并调整方案，而非默默扩大规模。这与"公开答卷"中的"失败记录"与"退出条件"两项是同一套逻辑 [depth:risk_missing_data]。

**里程碑与责任接口。** 一期（2026–2028）以三项试点与主脉北段贯通为里程碑；二期（2029–2031）以缝合链成网与全栈街坊成形为里程碑；三期（2032–2035）以站城一体与活动体系常态化为里程碑。每一期开始前须完成上一期的公开复算与试点结论发布，**未完成则不进入下一期**。上述牵头主体均为**建议**，实际事权划分须由法定程序确定，本方案不代任何单位作出承诺 [assumption:A-CONTROLS-001]。

### 八、从一次性投入到可沉淀的品牌资产与合作通道

**一条创新带最终留下什么？** 不是建筑，建筑会老；也不是某一届活动，活动会散。真正能沉淀下来的只有三样东西 [depth:phasing_implementation]：

**其一，品牌资产：让"京张向上"成为可被继承的名字。** 本方案的命名、"人"字向上母题、四个原点与算力之钟构成一套**可延展的视觉与叙事系统**，可用于活动、出版、文创、导视与国际传播而不失一致性。品牌资产的判据很朴素：**十年后换了一批人来运营，这套东西还认不认得出来。** 因此方案要求视觉系统随方案一并开源、允许非商业再用，而不是锁在某家运营公司手里——**被广泛使用的符号才会变成资产，被独占的符号只会变成成本。**

**其二，合作通道：把偶然的来访变成稳定的关系。** "一会一赛一节一榜"活动体系的真正价值不在办会本身，而在**它每年固定生产一批可延续的合作关系**：全球开源大会带来国际团队与机构的年度接触点，场景挑战赛带来企业与场景权属方的常态化对接，开源贡献榜带来个人开发者与本带的长期身份联结。方案建议为这些关系设立明确的承接机制——走廊工位、场景开放清单、开源社区维护者席位——**否则大会一散，通道就断了。**

**其三，可推广的方法，而不只是可参观的成果。** 本带真正值得被外地复制的，不是某段绿道的断面，而是**"人工兜底＋公开答卷"这套制度、"回路是否闭合"这种检验方式、以及"预先写下失败判据"这个习惯**。这些都是不依赖本地条件、可推广到任何城市的做法。方案因此建议把制度文本、评测口径与复算脚本一并公开，使其可被引用、可被质疑、可被改进。

**这三样东西共同支撑一个更高的目标**：让这条带不只是国内的产业空间，而是承载全球人工智能产业高地与朝圣地目标的载体——**产业高地靠的是产业链的完整度，朝圣地靠的是有没有值得专程前来的理由。** 前者由三区两翼的闭合回路回答，后者由四个原点与开源社区的荣誉体系回答。

**边界声明**：上述品牌、活动与合作机制均为**概念建议**，可供专业运营团队深化研究，不构成已确定的政府决策、实施安排或对任何机构的邀约 [assumption:A-CONTROLS-001]。
...
下表每一项都同时给出**数值**与**这个数值不是什么**。后一列比前一列更重要：城市设计里绝大多数误读，不是因为算错了数，而是因为把一个概念口径的数当成了法定口径的数。

| 指标 | 数值 | 解释边界（此数**不是**什么） |
| --- | --- | --- |
| 总体设计范围面积 | 11.41 km² [metric:site_area_sqm] | 基于临时粗略边界复算，**不等同于官方精确面积**；官方 polygon 发布后须整体重算 [assumption:A-BOUNDARY-001] |
| 遗址公园主脉长度 | 9.57 km | 概念线位长度，**不是**工程里程、征地长度或施工图线位 |
| 用地地块数 | 31 [metric:land_use_parcel_count] | 概念分区单元，**不是**法定地块划分或宗地边界 |
| 绿地率 | 29.49% | 概念绿地分区占比，**不是**法定绿地率指标，也不是绿线范围 |
| 公共空间占比 | 7.42% | 仅计入广场与开放空间面型要素，**不含**点位型场景节点 |
| 建筑覆盖率 | 7.29% | 容量原型推算，**不是**现状建筑密度，也不是审定建筑密度 |
| 慢行网络长度 | 25.93 km | 表达连接意图的概念网络，**不是**道路红线或已建成里程 [assumption:A-TRANSPORT-001] |
| 东西缝合链 | 7 条 | 跨廊道步行联系的设计提案，**不是**已批准的过街工程 |
| 重点区域 | 3 处，约 369.3 公顷 [metric:key_area_count] | 临时边界下的范围，**不是**官方划定的重点区四至 |

### 三、保持 unknown 的三项，以及为什么不填

**容积率、建筑限高、总建筑面积**三项在 `metrics.json` 中状态为 `unknown`，本包拒绝以任何方式补齐 [standard:MOHURD-CONTROL-DETAILED-PLANNING]。

这不是能力不足，而是**口径纪律**：这三项属于控规法定控制指标，其取值必须来自现行控规与主管部门核定，不能由城市设计方案自行推断，也不能用周边地区或全市平均值代入。若本包给出一个"看起来合理"的容积率，它在评审中会被当作设计结论，在后续使用中会被当作控制依据——**一个编出来的数一旦进入流程，纠正它的成本远高于当初留空的成本。** 因此本方案的处理方式是：留空、写明原因、写明谁来补、写明补齐后要重算什么 [assumption:A-CONTROLS-001]。

同理，走廊客流、站点 OD、无障碍断点数量、投诉基线与产业绩效等运行数据，本包**不设定为试点绩效目标**，也不以全区或全市平均值填充。相关背景观察仅用于选择设计动作，不冒充空间指标 [assumption:A-DATA-001]。
