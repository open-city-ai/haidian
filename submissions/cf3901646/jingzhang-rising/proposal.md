...
**其一，无障碍是连续的，还是不算数的。** 无障碍设计的常见失败是"点状达标、线上断裂"——每个建筑单体都合规，但从家门口到地铁口的整条路走不通。本方案要求以**连续路径**而非单点设施作为验收单位，任一处断点即视为该路径不达标。相关设计须落实《无障碍环境建设法》要求，具体技术指标由专业单位依规范确定 [assumption:A-CONTROLS-001]。
