...
title: "JingZhang AI Loop - From the Zigzag Railway to the Agent Network"
author_github: rwdenj9-blip
language: en
license: CC-BY-4.0
translation_of: "proposal.md"
summary: "Taking the Jingzhang Railway Heritage Park vitality belt as the spine, this is a conceptual overall scheme for an AI innovation belt formed as 'one axis, three cores, two wings, multi-node'. It covers 14 AI scenario cards (grouped by six AI application domains), 6 user personas, 7 global cases, 4 pilgrimage landmarks and a four-season operation system. All content is a conceptual suggestion that professional teams may deepen."
---
...
![Three key areas: AI Origin Community, Zhongzhiyuan, Dazhongsi and functional positioning](assets/figures/key-areas.en.png)
...
![Scenario--landmark--event node map (provisional, illustrative, from submitted roads/key-areas/public-space layers)](assets/figures/scenario-node-map.en.png)
...
![Land-use and spatial structure: public/scenario along axis, mixed-use cores](assets/figures/land-use-structure.en.png)
...
![Slow walk, blue-green public space: Jingzhang vitality belt, Xiaoyuehe water and AI scenario nodes](assets/figures/mobility-bluegreen.en.png)
...
![Indicator evidence: suggested indicators and evidence caliber, to be recalculated](assets/figures/metrics-evidence.en.png)
