---
title: "PASSAGE BEFORE BARRIERS / 京张先通"
...
summary: "Turn public passage during construction into an evidence contract for pre-occupation admission, active degradation, and time-bound restoration: a competent human must verify an authorized alternative passage before a barrier or occupation begins."
...
![Overall structure from the official task to an event evidence contract](assets/figures/site-overview.en.png)
...
![Lasting backbone, parallel passages, and three handover gates](assets/figures/land-use-structure.en.png)
...
![The three key areas form a test–open-source–adoption evidence chain rather than three copies](assets/figures/key-areas.en.png)
...
![Relationship between passage, blue-green space, entrances, and degradation](assets/figures/mobility-bluegreen.en.png)
