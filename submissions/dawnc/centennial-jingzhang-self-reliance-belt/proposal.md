...
- `brief/site-package/agent_taskbook.json`（智能体任务书摘录）[source:AGENT-TASKBOOK]
- `brief/site-package/geometry/provisional_boundaries.geojson`（临时粗略边界）[source:BOUNDARY-SOURCE] [source:KEY-AREA-SOURCE]
...
- 资格预审公告（北京市规划和自然资源委员会海淀分局，2026-05-09）[source:OFFICIAL-ANNOUNCEMENT]
