---
title: "Jing-Zhang Working Timetable / 京张运行图"
...
![Three key-area prototypes](assets/figures/key-areas.en.png)

![Ground floor to curb interface](assets/figures/ground-floor-interface.en.png)
...
![AI+ scenarios, innovation lifecycle and public authority](assets/figures/scenario-operations.en.png)
...
![Mobility, blue-green continuity and public interfaces](assets/figures/mobility-bluegreen.en.png)

![Street-edge proof case: tested, falsified, reframed](assets/figures/proof-case.en.png)
...
![How the Timetable Is Published, Reviewed and Reversed](assets/figures/metrics-evidence.en.png)
