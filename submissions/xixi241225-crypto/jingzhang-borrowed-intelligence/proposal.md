...
![统筹研究、总体设计与重点区三层范围及 provisional boundary 关系](assets/figures/site-overview.png)
...
![众智园、AI 原点与大钟寺三处重点区的比较框架](assets/figures/key-areas.png)
...
![完整覆盖 provisional site boundary 的概念性用地结构](assets/figures/land-use-structure.png)
...
![南北慢行骨架、六道东西向生活缝合与蓝绿联系](assets/figures/mobility-bluegreen.png)
...
![范围、蓝绿与公共空间指标及其证据置信度](assets/figures/metrics-evidence.png)
