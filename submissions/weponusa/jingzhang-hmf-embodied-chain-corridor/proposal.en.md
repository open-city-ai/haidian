---
title: "Human–Machine Friendly Jing-Zhang: A Concept Urban Design for Shared Movement, Shared Work and Shared Governance in the Age of Embodied AI"
...
![Overall concept and evidence chain: the shared spine, the three-tier scope and connection intensity](assets/figures/site-overview.en.png)
...
![Analysis of the three-tier scope, the linear form and the land-use structure](assets/figures/land-use-structure.en.png)
...
![Human–Machine Friendly Jing-Zhang brand and identity system: primary mark, naming, applications and limits of use](assets/figures/brand-identity.en.png)

### Proposal Self-Positioning

This page is strictly an **internal positioning exercise for this proposal**. It makes no factual claim about the number, quality or narrative frequency of other entries. Its reference frame comes from three generic expression goals in the taskbook: open collaboration, translation of railway culture, and auditable machine operation [source:AGENT-TASKBOOK]. This proposal chooses **an executable order for shared human–machine movement** as its core position: a recomputable curved spine; four-tier H0–H3 rights; accessibility, opt-out, takeover and vulnerable-user journeys as public value; and precision grading plus "baseline to be surveyed" as evidence discipline. The table is a self-calibration framework, not a competitor ranking.

![Proposal self-positioning: generic taskbook goals and the choices made by Human–Machine Friendly Jing-Zhang](assets/figures/differentiation.en.png)
...
### Six Global AI Innovation-Ecosystem Comparators (agent.2)

All six cases use a public page from a government, university or non-profit research institution as their evidence entry point. The table records only mechanisms explicitly described by those sources. Where no comparable official data are available, the status is "not verified from this source"; promotional rankings and investment outcomes are not extrapolated as facts. The fixed comparison dimensions are **spatial scale; industry and talent; compute and data; finance and incubation; scenario validation; and the boundary of translation to Jing-Zhang**.

| Case and public source | Spatial scale | Industry / talent / compute / data / finance / scenario mechanism | Boundary of known outcomes | Transferable to Jing-Zhang | Explicitly not transferred |
|---|---|---|---|---|---|
| Singapore one-north / LaunchPad + Kampong AI [source:CASE-GLOBAL-ONE-NORTH] | Innovation district — startup quarter — mixed work/living node | JTC organises modular startup space, incubator/capital networks, proximity to university research and cross-site trials; Kampong AI adds collaboration among AI startups, talent, companies and academia | JTC publishes space, institutional and historical tenancy figures; long-term performance by company is not verified here | Two-wing services + adaptable space + access to an estate-wide testbed | Lease concessions, eligibility and national policy |
| Seoul AI Hub, Yangjae [source:CASE-GLOBAL-SEOUL-AI-HUB] | City-level specialist organisation — anchor facility — distributed company space | Municipal support links staged education, startup incubation, high-performance computing, PoC, university-industry-research collaboration and global partnerships | The official page documents programmes and facilities; business outcomes are not assigned causal attribution | A single service sheet connecting talent, compute, PoC and open innovation | Equivalent grant amounts, compute capacity or tenancy policy |
| Vector Institute, Toronto [source:CASE-GLOBAL-VECTOR] | Research institute + regional enterprise network | Research talent, FastLane/DaRMoD, engineering support, data readiness, model development/deployment and prototype validation | The website publishes programme design and cumulative companies served; no claim is made about the success of each firm | An enterprise gate of problem definition — data readiness — prototype — deployment | Canadian geographic eligibility, funding conditions or compute configuration |
| Mila / Mila Ventures, Montréal [source:CASE-GLOBAL-MILA] | Research community — shared headquarters — venture programmes | University research talent, industry partners, startup challenge/incubation/Launchpad, mentors and investors, cloud resources and pilot connections | The website publishes community, partner and programme figures; scale is not equated with city output | A researcher-to-founder ladder and shared community for the AI Origin Community | Brand, investment commitments, partner lists or talent scale |
| Paris-Saclay, France [source:CASE-GLOBAL-PARIS-SACLAY] | Regional innovation cluster — universities/labs — multi-incubator network | DATAIA and related research networks, university talent, public and academic incubation, industry collaboration, funding navigation, and health/environment/mobility applications | Public institutions describe the ecosystem composition; rankings, output and project outcomes are not extrapolated | A polycentric research — industry — scenario network at the coordinated-study scale | Campus scale, national funds or company siting |
| CMU Hazelwood Green Robotics Innovation Center, Pittsburgh [source:CASE-GLOBAL-CMU-RIC] | University translational facility — large test spaces — adjacent manufacturing testbeds | Fundamental research, system integration, reconfigurable testing, pre-incubation and commercialisation links to manufacturing research | The university publishes facility goals, space types and development information; no regional-economic causality is claimed | Zhongzhi Park's chain of fundamental research — integration — testing — pre-incubation | Defence scenarios, donation amounts, building area or institutional governance |

**Common finding**: the six cases show that an AI ecosystem is not one "AI building", but a combination of talent, adaptable space, compute/data support, finance/incubation, scenario validation and rule-based governance. Jing-Zhang therefore uses a three-tier ecosystem map: Zhongzhi Park for integration testing and safety protocols; the AI Origin Community for talent, prototypes and ventures; Dazhongsi for public and commercial validation; the west wing for capital, IP, legal/ethical and international services; the east wing for real scenario demand; and the twin substrates as reusable corridor-wide interfaces. Compute, finance and company names remain future service mechanisms, not resources claimed to be secured [source:AGENT-TASKBOOK] [depth:overall_spatial_structure].
...
### Centennial Jing-Zhang — Zhongguancun — New AI Culture Resource System (agent.5)

The culture system uses a three-tier index of **factual heritage — innovation ethos — contemporary question**, rather than treating culture as technological decoration. The factual layer relies on public material from the National Railway Administration, Beijing Municipal Cultural Heritage Bureau, and the Beijing and Haidian governments. The Zhongguancun layer uses the publicly stated roles of the Zhongguancun History Museum and the National Innovation Demonstration Zone Exhibition Center. The new-AI-culture layer is a proposal for discussion, not an existing historical fact.

| Period / resource | Verifiable content and source | Spatial carrier | Narrative node and wayfinding tier |
|---|---|---|---|
| 1905–1909 construction and opening of the Jing-Zhang Railway | The first state-owned trunk railway surveyed, designed, built and managed by Chinese engineers; historical images document people, stations, bridges, tunnels and track [source:CULTURE-JINGZHANG-NRA] | Entire spine, historic rails and switches, linear heritage edge | **L1 belt identity**: year markers + short bilingual copy; do not reproduce historical images, only link to the public archive |
| Former Qinghuayuan Station | A ninth-batch Beijing municipal protected heritage site; the first Beijing arrival of the 1949 "journey to take the test", now carrying a dedicated exhibition and thematic route signage [source:CULTURE-QINGHUAYUAN-HERITAGE] [source:CULTURE-QINGHUAYUAN-ROUTE] | GRN-002 / Qinghuayuan H0 quiet segment | **L2 heritage node**: the station building follows heritage interpretation; new elements step back and do not cover the existing exhibition |
| Phase I of Jing-Zhang Railway Heritage Park | The former railway and station have become ecological, cultural and leisure public space; official records describe opening, slow mobility and reuse of railway remains [source:CULTURE-JINGZHANG-PARK] | Southern and central green spine, crossings and public activity points | **L3 place interpretation**: rail, crossing, sound and slow-mobility stories; machine guidance always has a parallel human option |
| Zhongguancun innovation culture | The Zhongguancun History Museum records settlement, science and technology, innovation ideas, and scientist/entrepreneur stories; the exhibition centre supports results display, forums, education and cultural communication [source:CULTURE-ZGC-HISTORY] [source:CULTURE-ZGC-EXHIBITION] | AI Origin Community — west-wing technology-service nodes | **L2 innovation node**: oral history, prototype archives, records of failure and open talks; no company-logo wall as a substitute for culture |
| New AI culture (proposal) | Transparency, opt-out, takeover, accountability and public co-creation in shared human–machine life [source:AGENT-TASKBOOK] | Scenario cards, Twelve Shichen and three field gates across the key areas | **L3 contemporary question**: machine identity, accountable-party code, near-miss review and public proposals; clearly marked conceptual |

**Spatial storyline**: south, "Dazhongsi — the public encounters new technology" → centre, "Qinghuayuan Station — a century of engineering agency and the memory of the journey to take the test" → AI Origin Community, "Zhongguancun's service to the nation through science, entrepreneurship and open collaboration" → north, Zhongzhi Park, "embodied-AI testing, learning from failure and safety responsibility". The four parts progress as **self-built infrastructure — public mission — open innovation — responsible intelligence**. H0 heritage segments retain interpretation and slow mobility; efficiency-oriented machines move to H3.

**Boundary between signage systems**: the belt-wide Logo provides master-brand recognition; cultural signs provide dates, resource type and place interpretation; machine signs provide identity, intent and the accountable party. Their colours may coordinate, but their graphic and legal meanings must not merge. Historical photographs, portraits, collection images and third-party trademarks do not enter submission graphics without item-by-item permission.

**International communication copy**: Chinese lead line, `从自主修路到负责任智能`; English lead line, **From self-built railway to responsible intelligence**. Supporting copy: **A century of engineering agency becomes a civic test of how people and embodied AI can share space safely, accessibly and accountably.** This connects independent innovation to public responsibility; it does not allow AI to overwrite railway history and does not claim that any event or facility has been approved.
...
![Relationship between the three key areas and the shared spine](assets/figures/key-areas.en.png)
...
![The Jing-Zhang human–machine friendly Twelve Shichen: the time-slot shared-movement dial and twelve operating clauses across one day](assets/figures/twelve-hours.en.png)

![Concept rendering C-06: scene rendering of the Jing-Zhang human–machine friendly Twelve Shichen](assets/figures/concept/twelve-hours.en.webp)
...
![The three field acceptance gates: return-to-depot closure, yielding at peak, logistics kept outside, and corridor-wide downgrade](assets/figures/implementation-gates.en.png)
...
![The shared spine and the blue-green public space system](assets/figures/mobility-bluegreen.en.png)
...
![Translating the human–machine friendly guideline: the four-stage implementation playbook and Five Friendliness acceptance](assets/figures/hmf-playbook.en.png)
...
![Operational map for international communication and global events: annual rhythm, conversion funnel and portable assets](assets/figures/global-ops.en.png)
...
![Core indicators, connection intensity and the evidence chain](assets/figures/metrics-evidence.en.png)
...
![Geometric alignment and drawing precision: spine alignment, key-area placement and precision grades](assets/figures/alignment-precision.en.png)
...
![Concept rendering C-01: overall concept, the three area endpoints, and two columns for the Five Settings and Five Friendliness Principles](assets/figures/concept/site-overview.en.webp)

![Concept rendering C-02: the three-tier scope, the 9.7 km north–south linear form, and six structural diagnoses](assets/figures/concept/land-use-structure.en.webp)

![Concept rendering C-03: the three key areas, the curved spine and the H0–H3 tiered right-of-way bands](assets/figures/concept/key-areas.en.webp)

![Concept rendering C-04: the shared human–machine cross-section, the blue-green shared corridor in plan, and the four right-of-way tier cards](assets/figures/concept/mobility-bluegreen.en.webp)

![Concept rendering C-05: the connection-intensity monitoring framework and the statement that baselines are yet to be measured](assets/figures/concept/metrics-evidence.en.webp)
