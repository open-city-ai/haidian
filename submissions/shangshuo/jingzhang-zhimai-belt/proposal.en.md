---
title: "Jingzhang Smart Vein Innovation Belt: Urban Design Proposal for Heritage-AI Convergence"
author_github: "shangshuo"
language: "en"
translation_of: "proposal.md"
license: "COMMUNITY-DISPLAY-ONLY"
summary: "Where Iron Rails Meet Neural Networks — The Jingzhang Smart Vein Innovation Belt transforms a century-old railway heritage into a world-class AI innovation corridor. Stretching 11.41 km² along the former Beijing-Zhangjiakou Railway, the proposal follows a 'One Belt · Three Cores · Multi-Scenario · Blue-Green-Walk Composite Loop' spatial framework, designed to serve everyone from open-source developers to neighborhood elders."
tracks: ["jingzhang-heritage-narrative", "ai-traffic-walkability", "youth-friendly-public-space"]
---

![Jingzhang Smart Vein — Full Logo](assets/figures/logo-full.png)

# Jingzhang Smart Vein Innovation Belt
### Where Iron Rails Meet Neural Networks

![Jingzhang Cultural Green Corridor — Heritage railway meets AI smart navigation](assets/renderings/01_jingzhang-green-corridor.png)
...
![Jingzhang Smart Vein — Icon Mark](assets/figures/logo-icon.png)
...
![Three-Level Scope Overview — Research area / Overall Design area / Three Key Areas](assets/figures/site-overview.en.png)

![Land Use Layout — 31 Parcels Seamless Full Coverage, Zero Overlap](assets/figures/land-use-structure.en.png)
...
![Three Wings Synergy & Flow Loops — Talent / Computing / Capital / Scenario Two-Way Flow](assets/figures/three-wings-synergy.en.png)
...
![Three Key Areas Detailed Index — Zhongzhiyuan / AI Origin Community / Dazhongsi](assets/figures/key-areas.en.png)
...
![AI Ecosystem Map — Source → Transformation → Cluster → Experience Four-Stage Spatial Industry Chain](assets/figures/ai-ecosystem-map.en.png)

---

![Mobility, Slow Traffic & Blue-Green Public Space Composite System](assets/figures/mobility-bluegreen.en.png)
...
![AI Scenario Network — 10 Scenario Cards + Unified PIA + Algorithm Filing + Test Verification Framework](assets/figures/scenario-network.en.png)
...
![Public Space Component Library — Eight Standard Modules + AI Health Detection Station](assets/figures/public-space-components.en.png)

### Brand Identity

![Jingzhang Smart Vein — Wordmark](assets/figures/logo-wordmark.en.png)
...
![Core Indicator Recalculation & Evidence Chain](assets/figures/metrics-evidence.en.png)
