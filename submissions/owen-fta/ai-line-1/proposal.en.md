---
title: "GLOBAL AI FRONTLINE | AI LINE 1: A Distributed Innovation Network of Three Areas, Two Wings and Multiple Nodes"
...
1. **From parallel districts to one innovation production chain.** The Three Passes define why all three areas and both wings are necessary rather than arranging functions and scenarios along a railway.
2. **From ecosystem diagnosis to project decisions.** The Five Highs determine immediate start, conditional start, defer, or do-not-build status, with annual review and exit mechanisms.
3. **From an abstract ecosystem to urban engines.** A Super Innovation Element in each district concentrates shared services, public exchange, key scenarios, and an operating interface; the Distributed Innovation Network connects them into a phased urban system.
...
![Machine-readable scope and evidence diagram](assets/figures/site-overview.png)

*Submission audit diagram only: retained for provisional scope and evidence anchors, not used as the principal design image.*

## Four-Level Scope Framework

AI LINE 1 applies four levels: city mission, regional network, innovation district, and core engine. At 43.6 km², the study asks how Haidian supports Beijing as a global AI-first city. At 11.4 km², it asks how Jing-Zhang heritage becomes shared innovation infrastructure. The three key areas are differentiated innovation districts with relatively complete innovation cycles. Each then identifies a Super Innovation Element that concentrates shared facilities, public exchange, and operation. [source:DATA-SRC-OFFICIAL-ANNOUNCEMENT-20260509] [depth:three_level_scope_framework]
...
![Three-level scope and distributed network](assets/figures/land-use-structure.png)

![Technical atlas of scopes, district roles and evidence boundaries](assets/figures/scope-node-technical-atlas.png)
...
### From city mission to spatial choice: the Diamond Model
...
![Five Highs maturity, urgency and current action-resource recommendation](assets/figures/five-highs-diagnosis.png)
...
### Five Highs project decisions: from diagnosis to resource allocation
...
### Regional vision, objectives, and positioning
...
![AI LINE 1 distributed innovation network aerial concept](assets/media/scene-overall-network-aerial-v2.png)
...
#### Three key-area aerials: one network, three spatial missions
...
![Dazhongsi transit hub and application-scenario innovation district aerial](assets/media/scene-dazhongsi-aerial-v2-transit-warm-focus.png)
...
![AI Origin Community original-AI source innovation district aerial](assets/media/scene-origin-community-aerial-v2-enhanced-balanced.png)
...
![Zhongzhiyuan standards and ecosystem innovation district aerial](assets/media/scene-zhongzhiyuan-aerial-v2-enhanced.png)
...
### Dazhongsi: AI Application and Scenario Innovation District

**FTA real-project foundation.** Dazhongsi also derives from FTA's actual node diagnosis, placemaking, and operating research rather than a generic transit-oriented case assembled for the competition. The proposal carries forward a real working chain—Five Highs diagnosis, station-city stitching, active public ground floors, application launch, and operating review—then reorganizes it for the three-district/two-wing brief. The public version excludes client material, internal drawings, company-cooperation details, and unconfirmed engineering conditions. [source:FTA-DAZHONGSI-INTERNAL-20260812]

**Positioning and division of responsibility.** Dazhongsi focuses on **AI + applications and scenarios**. Its platform economy, content industries, and market demand can support AIGC, smart hardware, offline experience, urban Agents, and local-life services. Specific platform companies are examples of potential ecosystem participants; without authorization they are not confirmed partners, naming sponsors, or implementation commitments. [source:FTA-DAZHONGSI-INTERNAL-20260812] [data:geometry/key_areas.geojson#KEY-PROV-003] [depth:three_key_area_detailed_design]
...
![Dazhongsi transit hub and AI application innovation district aerial](assets/media/scene-dazhongsi-aerial-v2-transit-warm-focus.png)
...
![Three differentiated innovation engines](assets/figures/key-areas.png)

### Zhongzhiyuan: AI Standards and Ecosystem Innovation District

**Positioning and division of responsibility.** Zhongzhiyuan focuses on **AI + standards and ecosystem**. Platform enterprises, professional institutions, and developer networks are potential anchor participants for technology standards, open ecosystems, global-market services, public validation, and result display; specific participation remains subject to authorization. [data:geometry/key_areas.geojson#KEY-PROV-001] [depth:three_key_area_detailed_design]
...
![Zhongzhiyuan shared validation and governed test-garden aerial](assets/media/scene-zhongzhiyuan-aerial-v2-enhanced.png)
...
### Zhongguancun Technology Service Wing: cross-area value amplifier
...
### Xiaoyue River Scenario Empowerment Wing: open urban test field
...
### Regional Coordination: Export Interfaces, Not Copied Parks
...
<article class="persona-card"><span class="persona-avatar persona-engineer" aria-hidden="true">R&amp;D</span><div><strong>Researchers and engineers</strong><p>Need computing, data, peer collaboration, quiet work, and rapid validation.</p></div></article>
<article class="persona-card"><span class="persona-avatar persona-startup" aria-hidden="true">START</span><div><strong>Startups and growth companies</strong><p>Need accessible space, client scenarios, capital, and professional services.</p></div></article>
<article class="persona-card"><span class="persona-avatar persona-student" aria-hidden="true">LEARN</span><div><strong>Students and young talent</strong><p>Need translation pathways, learning communities, affordable life, and international exchange.</p></div></article>
<article class="persona-card"><span class="persona-avatar persona-family" aria-hidden="true">LIFE</span><div><strong>Residents and families</strong><p>Need understandable, optional, human-backed AI public services.</p></div></article>
...
![Mobility, blue-green, and service network](assets/figures/mobility-bluegreen.png)

## Blue-Green Network, Public Space, and Urban Character

The Jing-Zhang Railway Heritage Park is treated as accessible public innovation infrastructure. Its first obligations are ecology, walking, rest, play, and neighborhood use; AI exhibition and testing are secondary. Every technical installation must be switchable, maintainable, accessible, and non-obstructive to essential public service. Low light, low noise, universal access, and child safety preserve the ordinary civic character. [standard:MOHURD-URBAN-DESIGN-MEASURES] [data:geometry/public_space.geojson#PS-SPINE-001]
...
Implementation follows FTA's full-life-cycle loop of **diagnosis—strategy—design—operation—investment feedback**, with operation tested before space is consolidated. [data:geometry/phasing.geojson#PHASE-001] [depth:phasing_implementation] Phase 1 establishes one reversible prototype in each key area and records a Five Highs baseline. Phase 2 connects validation, incubation, services, living rooms, and scenario opening as a cross-area network. Phase 3 matures the innovation-district network and its catalytic Super Innovation Elements, publishing annual progress and the rationale for adjusting current action resources.
...
### Stage Gates: No Evidence, No Expansion
...
### Three preregistered 90-day pilots: write the decision rules before seeing results

These thresholds are **future decision lines, not current performance**. Each pilot locks a measured T0 baseline in week 0 and repeats measurement at D30, D60, and D90. Raw logs, accountable sign-offs, incidents, and exit decisions enter an auditable register. Full fields are in `simulation.json`. [metric:pilot_protocol_count] [metric:pilot_duration_days]
...
The Origin and Dazhongsi briefs draw on confirmed FTA project practice; Zhongzhiyuan is a design prototype proposed for this call. None is an approved engineering commitment. Delivery remains subject to competent authorities, professional review, and supplemental data. [source:FTA-AI-ORIGIN-INTERNAL-20260812] [source:FTA-DAZHONGSI-INTERNAL-20260812]
...
1. Haidian Branch of the Beijing Municipal Commission of Planning and Natural Resources, *Prequalification Announcement for the Centennial Jing-Zhang AI Innovation Belt Urban Design International Solicitation*, 2026. This source supports the official task structure and announced approximate areas but not precise polygons or planning controls.
2. *Agent Open Call Taskbook Extract for the Centennial Jing-Zhang AI Innovation Belt Urban Design*, 2026. This cleared taskbook supports the three positionings, five functions, three areas and two wings, six Agent tasks, and contribution boundaries.
3. Ministry of Housing and Urban-Rural Development, *Measures for the Administration of Urban Design* and *Measures for the Preparation and Approval of Regulatory Detailed Planning for Cities and Towns*.
4. Ministry of Natural Resources, *Guidelines for Land and Sea Use Classification in Territorial Spatial Survey, Planning and Use Control*.
5. Cyberspace Administration of China and other authorities, *Interim Measures for the Management of Generative Artificial Intelligence Services*; Standing Committee of the National People's Congress, *Law on Building an Accessible Environment*.
6. Public materials for Kendall Square, Eindhoven High Tech Campus, STATION F, Toronto MaRS, Jurong Innovation District, Barcelona 22@, and Seoul Digital Media City. Registered URLs, access dates, authority, permitted uses, and limitations are recorded in `sources.json`; no private FTA GROUP material is included.
