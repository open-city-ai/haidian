...
license: "CC-BY-4.0"
summary: "以百年京张为公共创新主轴，通过区域定链、走廊织网和重点区落项目，形成一脊三廊三结六界面的空间体系，贯通开放问题、自主验证、首用转化与知识回流。"
...
“轨迹织城 / RailWeave Open City”以百年京张为公共创新主轴，依托“三核两翼”构建“开放问题—自主验证—首用转化—知识回流”的城市创新链，在文化叙事中沉淀新知识，在日常空间中体验 AI，在产业网络中推动融合创新。空间上形成“一脊三廊三结六界面”：一条京张公共创新经脊保持慢行、普通服务、文化叙事和公共空间连续；三条横向纬廊连接高校、园区、社区、站点、河道和两翼；三处重点区形成差异化创新织结；六个可逆公共界面承接首期项目。**普通服务不断线，AI 应用按需接入，创新成果持续沉淀。**

### 评审首屏：区域定链、走廊织网、重点区落项目

三层范围不是三份平行规划，而是同一条创新链的三次收敛：约 43.6 平方公里统筹研究范围负责**区域定链**，明确三区两翼、八类创新要素和五类区域协同接口；约 11.4 平方公里总体设计范围负责**走廊织网**，统筹京张主轴、三条横向廊道、慢行蓝绿、公共服务、文化展示和更新接口；约 368.4 公顷三处重点区域负责**重点区落项目**，形成众智园“可旁观的验证院”、AI 原点“开源修补街”和大钟寺“首用四象限站厅”三个差异化原型。[source:OFFICIAL-ANNOUNCEMENT] [source:AGENT-TASKBOOK] [depth:three_level_scope_framework]

| 三层范围 | 规划任务 | 空间成果 | 首期抓手 |
|---|---|---|---|
| **统筹研究范围｜区域定链** | 统筹创新链、产业链、城市服务链和区域协同 | 三核两翼、五类外部接口、八类要素保障 | 双语开放问题清单与年度知识回流机制 |
| **总体设计范围｜走廊织网** | 统筹城市更新、交通市政、蓝绿公共空间与文化风貌 | 一脊三廊、九个核查分段、八个调查锚点 | 连续普通路径、三条横向缝合与六组变量剖面 |
| **重点区域｜落项目** | 将验证、协同和转化落实为空间原型 | 三个创新织结、六个可逆公共界面 | 三项重点项目和一个 100 日限定样布 |

AI 辅助设计搜索在同一底图、同一组约束下比较三种空间织法：`SW-A` 单轴连续型保留形象主轴但缺少横向协同，`SW-B` 三核集聚型强化片区分工但易形成空间孤岛，`SW-C` 经纬协同型同时保持公共经脊、横向纬廊和三核差异化，作为 L5 概念深化底稿。该过程公开输入、规则、候选差异和未入选原因，用于支持专业人员比较与修订，不宣称算法最优，也不产生规划审定。[data:visual/assets/spatial_weave_options.json]

当前已形成概念方案、项目台账和前置核验清单，处于 **G0 前置核验阶段**。场地权利、真实需求、普通服务基线、代表性用户参与、专业核验和责任角色确认完成后，可形成限量验证建议；是否启动由有权主体依法决定。项目尚未获现场授权、尚未运行，现场绩效保持空值，完整决定回执见 `visual/assets/readiness_decision_receipt.json`。
...
**一名需要无障碍支持且选择不注册账号的访客的一天。** 访客沿连续京张公共经脊到达重点区，通过固定导视、触觉地图、纸质资料、电话和有人柜台完成到达与咨询；自愿启用 AI 时获得个性化建议，但例外、决定和申诉仍由人工处理。众智园可以旁观经脱敏的验证过程，AI 原点可以提出问题并查看修补进度，大钟寺可以比较普通服务与智能辅助后决定是否采用。断网、误导或退出时，普通路径与有人服务继续运行，已经形成的固定导视、开放工具和失败档案继续服务城市。该旅程是 S06 的设计验收逻辑，不是已经发生的现场绩效。
...
| **大钟寺｜首用四象限站厅** | 四象限地面优先回路—静态与触觉地图—有人柜台—安静等候—申诉台 | 可逆信息棚架、触觉地图、排队状态牌、便携服务台、反馈回执架 | 公众和应用单位可比较普通服务与智能辅助，再形成采用、整改或退出意见 | 站点接口、地面通行、客流、消防、文保、真实需求、采购权限与运维责任 |
...
| 91—100日：撤权、复原与再决策 | 撤销权限、删除或合法移交数据、拆除设备、恢复饰面、校正固定导视并续接人工服务 | E5退出六项回执、E6第100日保留/修改/撤除/不推进决定 | 任一退出项未签收、退出预算或维护主体缺失时不得扩展 |

四阶段预登记、六个决策窗口、RACI、控制指标和六项退出回执见 `visual/assets/s06_minimum_delivery_package.json`。该文件仅供依法确定的专业团队后续深化，不构成场地、数据处理、参与招募、预算、采购或上线批准。
...
### 首个100日限定样布：AI原点开源修补街

为避免三项重点项目同时铺开，本方案建议在完成 G0 前置核验后，优先把 AI 原点一处共享首层候选界面作为“开源修补街”100 日限定样布。样布只占用经核验的一条约100至150米决策路线、有限前廊和受控后室，设置3至5个待实测确认的决策点和一个1:1无障碍服务湾。前廊保持连续通行，设置固定与触觉导向、纸质问题卡、需求门诊、开放零件墙、人工转介台和公开回执；后室仅处理经授权的材料、版本和复核工作。AI 只提供建议，不替代人工受理、例外判断、申诉和停止决定。路线长度、点位、权属、开放时段、消防和可达性均为设计控制包，待 G0 现场核验，不作为已落实事实。[data:geometry/public_space.geojson#DC-V21-AI-001]
...
100 日是相对工作段，不是已确定日历。当前主体、场地、预算和运行均未确认；详细的普通服务基线、影子验证、限量共测、停止和退出字段见 `visual/assets/s06_minimum_delivery_package.json`。本轮以“一块样布”检验总体织法，未通过不扩展到整条走廊或其他重点区。
