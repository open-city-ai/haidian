---
title: "THE OPEN GATE LINE / 京张开门线"
...
![Provisional study boundary and Open Gate Line overview](assets/figures/site-overview.en.png)
...
![Shared-time gates and conceptual land-use structure](assets/figures/land-use-structure.en.png)
...
![OGP-12 human authority, data minimization, and fallback protocol](assets/figures/ai-governance.en.png)
...
![Walking, blue-green, and twelve-gate stitching system](assets/figures/mobility-bluegreen.en.png)
...
![Nine project packages, binary start gates, and annual operating rhythm](assets/figures/implementation-roadmap.en.png)
...
![Metrics, evidence, and stop conditions](assets/figures/metrics-evidence.en.png)
...
Machine-readable index: `manifest.json`, `sources.json`, `assumptions.json`, `metrics.json`, `compliance_matrix.json`, `standard_matrix.json`, `design_depth_matrix.json`, `self_check.json`, plus `visual/assets/gate-protocol.json`, `verify-gate-protocol.js`, and `protocol-audit.json`.
