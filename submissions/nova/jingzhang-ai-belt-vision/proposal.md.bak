...
> **方案总纲（AI 原生城市带 / AI-Native Urban Belt）**：以百年京张文化带为魂、以 AI 原生城市形态为骨，围绕“统筹研究范围 43.6 km² → 总体设计范围 11.4 km² → 重点详细设计范围 368.4 ha”三级空间，构建“一条AI创新脊、两条文化绿廊、三大重点片区、一张AI场景网络”的整体格局。方案主张把AI创新生态从“园区孤岛”转为“街道级原生城市带”：以京张遗址公园为中央活力绿轴，串联众智园AI自主创新加速区、北京AI原点社区、大钟寺AI产业集聚区，让轨道站点成为创新接驳节点，让沿街公共空间成为开源协作与AI场景体验界面。所有空间结论均以 [data:geometry/land_use.geojson]、[data:geometry/key_areas.geojson] 与 [metric:site_area_sqm]、[metric:green_ratio] 等机器可读证据支撑，可复核、可重算。

# 百年京张AI创新带 · AI原生城市带方案（AI-Native Urban Belt）
