...
![京张智织总体概念与证据边界图](assets/figures/site-overview.png)
...
![京张智织三层范围与五类织片结构图](assets/figures/land-use-structure.png)
...
![三处重点区域差异化原型与前置条件图](assets/figures/key-areas.png)
...
![交通慢行、蓝绿公共空间与公共智能节点复合图](assets/figures/mobility-bluegreen.png)
...
![核心指标、证据链与不确定性仪表盘](assets/figures/metrics-evidence.png)
