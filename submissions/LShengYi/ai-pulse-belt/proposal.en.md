...
| Cores | Three cores: Zhongzhiyuan, Beijing AI Origin Community, Dazhongsi | Three key areas: Test-Sandbox Quarter (P2) → Release-Lounge Quarter (P3) → Bequest-Acceptance Quarter (P4) |
