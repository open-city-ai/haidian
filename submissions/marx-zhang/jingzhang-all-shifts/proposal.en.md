---
title: "ALL SHIFTS JING-ZHANG: One city, every shift"
...
summary: "A dignity-first, round-the-clock civic infrastructure proposal: one Shift Commons Spine, three Shift Yards and twelve no-scan Shift Stations."
...
![Scope, concept and evidence hierarchy](assets/figures/site-overview.en.png)
...
![Land-use and All Shifts structure](assets/figures/land-use-structure.en.png)
...
![Metrics, evidence and governance gates](assets/figures/metrics-evidence.en.png)
