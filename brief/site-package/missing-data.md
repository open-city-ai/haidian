...
- 三个重点区域的精确 polygon，以及它们与公告点名道路、地物和站点的官方锚定关系：众智园 AI 自主创新加速区、北京 AI 原点社区、大钟寺 AI 产业聚集区。
- 正式坐标系统和测绘基准说明。
...
`PROV-KEY-001/002/003` 只按公告南北顺序和约面积配置占位矩形，未与五环路、清河、五道口、清华东路西口或大钟寺站完成锚定核验。不得因要素名称或 `derivation_method` 中的任务线索，把矩形解释为同名地物、站点路口或站城一体化范围。具体位置冲突与复核边界见 `provisional_boundaries_basis.md`、Issue #846 和 Issue #1029。
