...
def build_prompt(review_input: dict) -> str:
    return "\n".join(
        [
            ...
            "- Gate check summaries for deterministic validation, spatial review, visual review, and professional evidence review",
            ...
            "If pre-submit self-check, spatial review, visual review, or professional evidence review is FAIL, the package cannot enter formal professional scoring.",
            "",
            "Submission path:",
