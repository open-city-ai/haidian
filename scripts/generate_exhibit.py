...
def build_exhibit(submission_dir: Path) -> dict[str, Any]:
    ...
    readiness = "官方边界就绪" if official else "临时边界 intake，暂不可正式评分"
    ...
    return {
        ...
        "card": {
            ...
            "status": "featured" if official else "under-review",
        },
        "links": {"proposal": "proposal.md", "detail": "index.html"},
        "hero": {
            "eyebrow": "AI 城市方案展示",
...
def main() -> int:
    ...
    exhibit = build_exhibit(submission_dir)
