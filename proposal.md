---
title: "京张人字新线：以AI攻克城市陡坡"
author_github: "cynixway"
language: "zh"
license: "COMMUNITY-DISPLAY-ONLY"
summary: "1909年詹天佑面对八达岭陡坡——看似不可能的工程难题——发明'人'字形折返线，用创造力让列车折返而上。2026年我们的城市面临三个'陡坡'：生产力瓶颈、生活品质压力、全球竞争加剧。京张人字新线以AI为这个时代的'人字线'，用智能创造力攻克城市陡坡，提高生产力，改善生活工作舒适度，赢在未来。一轴三极两翼空间结构、17子块设计矩阵、14 AI场景卡、NG-6创新契约与韧性降级体系。"
...
> **人字新线 / The Switchback Line** — 1909年，詹天佑面对八达岭的陡坡，没有蛮干。他在青龙桥设计了"人"字形折返线——**用创造力攻克了看似不可能的坡度** `[source:HISTORY-ZHAN-TIANYOU]`。这种"以巧妙工程方案解决难题"的精神，正是京张的开拓底色。2026年，百年京张AI创新带要回答的问题不是"再建一个AI园区"，而是：**当城市面临生产力瓶颈、生活品质压力和全球竞争加剧的'三重陡坡'时，我们能否以AI为这个时代的'人字线'，用智能创造力攻克城市陡坡，提高生产力，改善生活工作舒适度，赢在未来？** `[source:HISTORY-JINGZHANG-1909]`

**三个城市陡坡**——本方案的核心分析框架：

| 陡坡 | 具体挑战 | AI人字线攻克方向 | 对应极 |
|---|---|---|---|
| **生产力陡坡** | 研发转化慢、产业升级瓶颈、算力不足 | AI+基准测试+共享算力+开源共创 | **创新极·众智园** |
| **生活陡坡** | 通勤压力、老龄化、健康/教育资源不均 | AI+健康驿站+教育节点+全龄慢行+便民 | **生活极·AI原点** |
| **竞争陡坡** | 全球AI竞赛、人才流失、创新生态碎片化 | AI+产业集聚+国际传播+人才吸引+区域协同 | **产业极·大钟寺** |

**诚实约束**（未掩盖）：仅 provisional 边界 `[source:PROVISIONAL-BOUNDARY]`；FAR/高度 = `unknown`（缺官方控规 `[metric:floor_area_ratio]`）；全部空间内容均为概念建议。

## 三分钟读懂：人字线 × 三个陡坡 × 三次城市决定

**1909 年，詹天佑发明"人"字形折返线攻克八达岭陡坡；2026 年，我们以 AI 为这个时代的人字线，攻克城市三个陡坡。**

| 极 | 不可退让的空间决定 | 运行凭证 | 不成立时 |
|---|---|---|---|
| **创新极·众智园** | AI 算力只能经有人值守、公众优先、无旁路的受控交叉点接近测试区 | Test Receipt | TEST 不开；院落与公共绿带继续 |
| **生活极·AI 原点** | 开放创新方法、版权状态、撤回动作必须在同一发布界面可见 | Release Ticket | RELEASE 不开；撤下发布，教学与协作继续 |
| **产业极·大钟寺** | 人工非 AI 路径不长于 AI 路径，投诉点与试用同接公共主链 | Public Verdict | USE 不开；设备折返，商业、休息与人工服务继续 |

三条凭证（Test / Release / Public Verdict）互不替代：技术 PASS 不能覆盖权利判断或公众决定，旧 FAIL 不能被新 PASS 抹去——这与京张"人字形折返"的工程逻辑一致：**改变方向不是抹去来路，而是保留前段状态后折返** `[source:HISTORY-ZHAN-TIANYOU]`。

## NG-6 创新契约

借鉴铁路"时刻表"的公开性与可问责性，本方案为每项城市 AI 服务提出 **NG-6 创新契约**——把抽象的"AI治理"转化为空间中可见、运营中留痕、治理中可追责的公共契约 `[standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]` `[depth:phasing_implementation]`。NG-6 不是法定指标，也不宣称已形成政府承诺；它是一组可由专业团队、运营主体与公众共同校准的城市设计参考方案 `[assumption:A-IMPLEMENTATION-001]`：

| 步骤 | 含义 | 空间要求 | 运营要求 |
|---|---|---|---|
| **① 立约 Declare** | 申明服务边界与责任人 | 每个响应点设可读告示（服务范围/责任主体/数据用途） | 公开登记，可审计 |
...
三层范围从战略研究、控规深度城市设计到重点区精细化设计逐级收束，把"人字新线"的总体概念沿京张走廊向北中南三处重点区落地。

![三层范围与用地结构](assets/figures/land-use-structure.png)

## 统筹研究范围产业与未来城市研究

**总体概念：京张人字新线 / The Switchback Line**。核心隐喻——1909年詹天佑在青龙桥用"人"字形折返线攻克陡坡，用工程智慧而非蛮力解决问题 `[source:HISTORY-ZHAN-TIANYOU]`；本带为AI原生城市定下"人字新线"（新标准），让数据、算力、场景、人才、企业、治理在统一标准下互通互联。这不是给传统园区贴AI标签，而是**用标准与工程方法解决"AI如何服务人/企业/社会"的问题** `[standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]`。

**三大定位的呼应**（公告/任务书）：
- **百年京张文化带** → "人字新线"承接詹天佑开拓精神，把铁路遗产转译为AI时代的工程标准叙事。
- **都市AI生活体验带** → "生活极"把AI嵌入居民日常，让创造力服务所有人。
- **AI融合创新带** → "创新极+产业极"以工程基准支撑自主创新与产业转化。

**五大功能的映射**：AI全栈自主创新体系（创新极·众智园）、世界级AI创新生态（三极协同）、AI+场景赋能新范式（生活极+道岔两翼）、智能化AI活力城市（主轴+蓝绿+公共空间）、AI治理全球话语权（可复核证据链与共创公约）。

**命名体系**（agent.1 `[standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]`）：

| 层级 | 中文 | 英文 | 隐喻 |
|---|---|---|---|
| 总名 | 京张人字新线 | The Switchback Line | 为AI原生城市定下人字新线(新标准)——承接京张"自主建造+开放标准+工程创新"精神 |
| 主轴 | 京张人字创新主轴 | Innovation Spine | 沿铁路遗址走廊贯通三区 |
| 三区·众智园 | 创新极 | Innovation Pole | 自主创新的工程基准 |
| 三区·AI原点社区 | 生活极 | Life Pole | AI服务于人日常 |
...
- **延展规则**：三极各有子色（创新极=蓝、生活极=品红 `#db2777`、产业极=紫 `#7c3aed`），两翼用渐变过渡色，保持系统一致性同时区分功能区。
...
**三区两翼协同回路**：众智园(创新极·研发)→AI原点社区(生活极·转化体验)→大钟寺(产业极·规模化)，中关村科技服务翼注入资本与IP，小月河场景赋能翼开放测试场景，形成"研发—生活—产业—服务—测试"的闭环 `[data:geometry/key_areas.geojson#PROV-KEY-001]`。
...
1. **中关村历史演进**——1980年代从"电子一条街"起步，1988年国务院批准北京市新技术产业开发试验区，2009年成为中国首个国家自主创新示范区 `[source:CASE-ZGC]`。验证"标准+政策+人才"协同的长期价值；转化为创新极的制度设计。
...
4. **深圳高新区(南山科技园)**——1996年设立，规划核心区约11.5 km²，国家级高新技术产业开发区，聚集腾讯/中兴/大疆等1200+高新技术企业 `[source:CASE-SHENZHEN]`。转译为大钟寺产业极的密度与配套。
...
6. **新加坡One-North**——200公顷旗舰混合研发创新区，JTC为主开发商、A*STAR为核心锚点，含Biopolis(生物医学)/Fusionopolis(ICT)子区，集成工作-生活-休闲 `[source:CASE-ONE-NORTH]`。转译为三极并置的空间结构。
7. **阿姆斯特丹开放数据**——data.amsterdam.nl 官方开放数据门户(19000+数据集)+ Amsterdam Smart City 公私合作创新平台 `[source:CASE-AMSTERDAM]`。转译为人字新线的"数据标准"层。

共同启示：成功的AI/科技带都以**开放标准+混合功能+公共空间+长期运营**为底座，而非单一产业园。这正是"人字新线"概念的可信依据。

### 区域协同与京津冀创新网络（任务书regional_synergy回应）

任务书要求回应与**北纬社区、未来科学城、怀柔科学城、经开区及京津冀**的创新协同 `[standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]`。本方案的"人字新线"概念天然面向标准互通，提出以下协同回路（均为概念建议，待主体与接口确认 `[assumption:A-REGIONAL-SYNERGY-001]`）：

| 协同对象 | 功能互补（已核验）`[source:REGIONAL-SOURCES]` | "人字新线"接口 | 概念机制 |
|---|---|---|---|
| 北太平庄/北下关等遗址公园沿线社区 | 京张遗址公园(约9km)沿线7街镇，服务8所高校26社区，教育居住功能为主 `[source:HERITAGE-PARK]` | 生活极 | 共建AI便民服务节点、全龄慢行网衔接 |
| 未来科学城（昌平，约170.6km²）`[source:FUTURE-SCIENCE-CITY]` | 能源谷+生命科学园+沙河高教园(IT/AI)，"两区一中心"布局 | 创新极·算力标准 | 算力调度互备、基准测试数据共享 |
| 怀柔科学城（约100.9km²）`[source:HUAIROU-SCIENCE-CITY]` | 北京综合性国家科学中心(2017年国家发改委/科技部批复，全国第三个)，物质/空间/地球系统/生命/智能五方向，40+大科学装置 | 创新极·研发标准 | 研究成果转化通道、联合实验室概念 |
| 经开区/亦庄（三城一区之"一区"）`[source:BDA]` | 北京唯一兼具国家级经开区+国家级高新区双 статус，高精尖产业/科技成果转化承载区，约225km² | 产业极 | "海淀研发-亦庄制造"概念分工 |
...
总体设计范围（约11.4 km²，provisional `[data:geometry/site_boundary.geojson#SITE-001]`）的城市更新框架采用**"五带分区"**——将范围划分为五条南北向功能带，每带再细分为 3-4 个命名子块（共 **17 子块**，详见下章"地块级设计意图矩阵"）。分区的依据并非抽象等宽切割，而是从以下**可公开场地条件**推导 `[depth:land_use_layout]` `[depth:overall_spatial_structure]` `[depth:existing_conditions_diagnosis]`：

1. **京张铁路遗址走廊（南北向遗产主轴）**——遗址公园约9km贯通南北 `[source:HERITAGE-PARK]`，构成"绿带"的骨架与东西缝合的公共空间基底。
2. **三处重点区的功能需求差异**——众智园(北)以研发/算力为主→创新轨；AI原点社区(中)以生活/体验为主→生活极；大钟寺(南)以产业/商务为主→产业极。三区沿走廊北中南布局 `[data:geometry/key_areas.geojson]`。
3. **交通节点与街区界面**——遗址走廊两侧的既有街区界面（学院路、西土城路、大钟寺东路等）天然形成东西向分隔，五带的东西边界尽量贴合这些既有界面，而非任意切线。
4. **基建承载**——道路、轨道、算力、能源需要连续走廊→"基建带"。
...
| 绿带 | 1401 公园绿地与开敞空间 | 2.85 km² | 25.0% | 京张遗址公园绿带、缓冲 |
| 产业极 | 05 产业服务与商业服务 | 2.85 km² | 25.0% | 企业总部、转化、商务 |
| 生活极 | 0702 居住与社区服务 | 2.33 km² | 20.4% | 人才公寓、社区配套 |
| 基建带 | 1207 交通与市政设施 | 1.49 km² | 13.0% | 道路、轨道、算力、能源 |

各带面积与占比的完整数值索引见 `metrics.json`（`land_use_area_{code}_sqm` 与 `land_use_ratio_{code}` 系列），用地代码遵循国土空间用地用海分类指南 `[standard:MNR-LAND-USE-CLASSIFICATION-GUIDE]`。创新轨 0802：`[metric:land_use_area_0802_sqm]` `[metric:land_use_ratio_0802]`；绿带 1401：`[metric:land_use_area_1401_sqm]` `[metric:land_use_ratio_1401]`。

产业极 05：`[metric:land_use_area_05_sqm]` `[metric:land_use_ratio_05]`；生活极 0702：`[metric:land_use_area_0702_sqm]` `[metric:land_use_ratio_0702]`；基建带 1207：`[metric:land_use_area_1207_sqm]` `[metric:land_use_ratio_1207]`。
...
不能只写"打造活力带、完善配套"——本方案具体说明：五带如何相互支撑（创新轨产研、产业极承载、生活极留人、绿带提质、基建带承载），以及缺控规条件时如何写成待确认而非伪造。
...
### 大钟寺AI产业集聚区·产业极（南，约0.72 km²）

- **定位**：智能原生新业态的"产业极"，产业规模化与商务承载。
...
五带带进一步细化为 **17 个命名子块**，每个子块都是 `geometry/land_use.geojson` 中一个独立 polygon，带 `parcel_id`（如 `LU-0802-A1`）、中英文名、子功能与父轨字段。子块划分在每条轨带内部用水平切线生成，与垂直切线一样共享顶点、无重叠、无空洞，故 union 仍等于 site boundary；同一 `land_use_code` 的子块 union 面积 = 原轨带面积，per-code 指标不变 `[depth:land_use_layout]` `[depth:overall_spatial_structure]`。
...
| **GRN-B1** 遗址公园主轴带 | 绿带 | 1401 | 约9km南北向铁路遗址公园、解说节点 | 低层（地被+解说装置） | 保留-改造（铁路遗存） | 故事段①-⑤ 五节点 `[data:geometry/green_space.geojson#GR-001]` | S10 京张遗产AI导览 | 访客满意度、史料准确性 |
| **GRN-B2** 重点区绿环 | 绿带 | 1401 | 三个重点区绿环串联 | 低层（绿道+小型驿站） | 保留-改造 | 绿环广场三处 | S4 全龄友好慢行导引 | 无障碍路径连通率 |
| **GRN-B3** 海绵调蓄区 | 绿带 | 1401 | 雨水花园、滞留植草沟 | 低层（地被+植草沟） | 新建（生态设施） | 海绵科普园 | （非AI主导，配 S4 慢行） | 调蓄容积、年径流控制率（待水文模型 `[assumption:A-GREEN-BLUE-CONCEPT-001]`） |
| **IND-C1** 企业总部基地 | 产业极 | 05 | 总部塔楼、锚定企业 | 高层 landmark（塔楼群） | 改造更新为主 | 大钟寺产业广场 `[data:geometry/public_space.geojson#PS-004]` | S7 智能原生消费 | 入驻率、企业锚定数 |
| **IND-C2** 智能原生商业 | 产业极 | 05 | 沉浸式体验店、体验广场 | 中-高层 podium-tower（商业+办公） | 改造更新为主 | 体验广场 | S7 智能原生消费 | 消费满意度、申诉解决率 |
| **IND-C3** 产业服务配套 | 产业极 | 05 | 银行、IP服务、会议中心 | 中层 podium（服务聚合） | 改造更新为主 | 产业服务庭院 | （非AI主导，配 S11 治理看板） | 服务响应时长 |
| **IND-C4** 创新企业孵化器 | 产业极 | 05 | 弹性空间、demo室 | 中层灵活型（可分可合） | 改造与新建混合 | 创新庭院 | S2 开源共创工坊 | 孵化项目数、毕业率 |
| **LIFE-D1** 人才公寓组团 | 生活极 | 0702 | 租售并举、混合收入人才公寓 | 中-高层板楼（居住型） | 改造与新建混合 | 公寓邻里院落 | （非AI主导，配 S5/S6 便民） | 居住满意度、混合收入比例 |
| **LIFE-D2** 混合社区中心 | 生活极 | 0702 | 第三空间、托育、社区诊所 | 中层混合型（底商+社区设施） | 改造更新为主 | 原点生活广场 `[data:geometry/public_space.geojson#PS-003]` | S5 AI+社区健康驿站、S6 AI+教育便民节点 | 预筛准确率、儿童数据合规率、满意度 |
| **LIFE-D3** 体验型零售带 | 生活极 | 0702 | 主街零售、餐饮 | 中层底商型（主街界面） | 改造更新为主 | 主街集市广场 | S7 智能原生消费 | 消费满意度、申诉解决率 |
| **INF-E1** 主轴道路与轨道站点 | 基建带 | 1207 | TOD节点、公交流廊 | 中层（站城一体） | 新建与改造 | 站点广场（三处） `[data:geometry/roads.geojson#RD-001]` | S3 AI+轨道接驳导航、S9 自动驾驶接驳试点 | 接驳等待时间、安全里程数 |
| **INF-E2** 算力管道与边缘节点 | 基建带 | 1207 | 区域算力分配、边缘推理柜 | 低-中层（机房+边缘柜） | 新建（隐蔽型基础设施） | （不设公共空间锚点，地下/后台） | S1 算力调度（边缘补充） | 边缘节点覆盖率、延迟 |
| **INF-E3** 区域能源中心 | 基建带 | 1207 | 冷热电三联供、变电站 | 中层（能源建筑） | 新建 | 能源科普窗口 | （非AI主导） | 综合能耗、可再生能源比例 |

设计意图矩阵把"五带分区"从带级（5 块）下沉到子块级（17 块），每块都给出可读的功能、定性强度方向、拆改留倾向、公共空间锚点、主导 AI 场景与 KPI 示例。所有定性强度方向（"低/中/高层 campus / podium-tower / landmark"）均为**城市设计概念表达**，不替代法定控规的 FAR/高度/退线指标（仍标 `unknown` `[metric:floor_area_ratio]` `[assumption:A-CONTROLS-001]`）。拆改留倾向为概念分类，须以现状测绘与权属为准 `[assumption:A-BOUNDARY-PROVISIONAL-001]`。
...
#### 众智园 AI 自主创新加速区 · 创新极（北，约 1.93 km²）— 3 子片区
...
#### 北京 AI 原点社区 · 生活极（中，约 1.04 km²）— 3 子片区
...
#### 大钟寺 AI 产业集聚区 · 产业极（南，约 0.72 km²）— 3 子片区
...
1. **AI研究员/工程师**——需要算力、测试场、同行交流；落点创新极。
2. **创业者/开发者**——需要低成本空间、资本对接、场景入口；落点道岔两翼。
3. **企业团队**——需要总部、展示、转化通道；落点产业极。
4. **居民/家庭**——需要便民、健康、教育、安全的AI服务；落点生活极。
...
### 场景到专业责任的逐项锁定（14 场景 × 7 字段矩阵）

`visual/assets/scenario_professional_review_matrix.json` 将 S1—S14 逐项锁定到空间原型、最小数据、人工最终责任、RC 合同、G1 案头专业角色、G2 控制/独立复核角色、可测空间或容量代理、冲突/失败情景、暂停线和恢复证据。14/14 均有完整字段，但所有实测值仍为 `null`、真实机构确认为 0、现场证据为 0。这里的"可进入 G1/G2"仅指模板足以启动案头审查和演练设计；在权属、实测、专业结论、责任机构、预算与授权补齐前，G3 现场试点保持关闭 `[standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]` `[depth:ai_scenario_service_nodes]`。

14 张场景卡的简明锁定表：

| 场景 | 空间原型 | 最小数据+人工最终责任 | 暂停线 / 恢复证据 |
|---|---|---|---|
| **S1 算力调度与基准测试** | INNO-A2 共享算力中心 | 脱敏基准集；算力联盟代表人工复核 | 算力故障→降级本地节点；人工标记并回滚 `[data:visual/assets/sc04-relay-receipt.json]` |
| **S2 开源共创工坊** | INNO-A1 研发组团 | 公开仓库；社区治理 | 争议代码→投票撤销 `[data:visual/assets/evidence-ledger.json]` |
| **S3 AI+轨道接驳导航** | INF-E1 主轴站点 | 匿名化人流；交通运营人工复核 | 误导高风险→物理导引兜底 `[data:geometry/roads.geojson#RD-001]` |
| **S4 全龄友好慢行导引** | GRN-B1 绿带 | 无识别环境感知；社区+物业 | 无障碍路径不连续即停 `[data:geometry/green_space.geojson#GR-001]` |
| **S5 AI+社区健康驿站** | LIFE-D2 社区中心 | 本地化健康数据；社区医生复核 | AI 异常→直接转医生 `[source:WHO-URBAN-HEALTH-AND-GREEN]` |
| **S6 AI+教育便民节点** | LIFE-D2/D3 | 儿童数据本地化；教师家长审核 | 任何自动决策触发即回滚 `[assumption:A-AI-GOVERNANCE-001]` |
| **S7 智能原生消费体验** | IND-C2 智能原生商业 | 消费记录合规采集；商户+平台人工 | 推荐异常→人工服务 `[metric:road_centerline_length_m]` |
| **S8 机器人低速配送试点** | LIFE-D3 体验型零售带（夜间段） | 不追踪行人；配送企业+值班员 | 任何碰撞立即停止 `[source:ISO-13482-SERVICE-ROBOT-SAFETY]` |
| **S9 自动驾驶接驳试点** | INF-E1 主轴 | 不存个人生物特征；交通企业 | 异常→靠边+人工接管 `[data:visual/assets/tabletop_cases.json#T09-REJ]` |
| **S10 京张遗产AI导览** | GRN-B1 故事节点②-④ | 公开史料；文保编辑复核 | 虚构人物事件即下架 `[data:geometry/green_space.geojson#GR-001]` |
| **S11 城市智能体治理看板** | 共创平台 | 公开资料+风险提示；治理联合体 | 误操作→审计追溯+回滚 `[data:visual/assets/evidence-ledger.json]` |
| **S12 开发者社区活动场地** | 公共空间（IND-C3/C4 周边） | 公开活动报名；社区组织人工 | 活动取消→线上替代 `[depth:phasing_implementation]` |
| **S13 城市智能体应急回滚**（v5.2 新增） | 治理联合体值班 | 触发器：高温/断网/不可接管/无障碍阻断 | 5 步退出动作+记录 `[metric:tabletop_case_count]` |
| **S14 公共利益审计**（v5.2 新增） | 公平账本复核委员会 | 季度复核+匿名化事件登记 | 最弱 20% 体验恶化→暂停 `[data:visual/assets/edge-matrix.json]` |

三类公共底线贯穿全部 14 张场景卡：

1. **高影响决定 100% 人工最终确认**
2. **默认生物识别与连续个人轨迹留存 = 0**
3. **基本服务保留非数字通道**（语音、按键、纸质、人工窗口） `[depth:ai_governance_charter]`

### 最小可执行试点：SC-04

为避免14张场景卡停留在"可读合同"层，本方案将 **S1（算力调度与基准测试）** 收敛为唯一最小可执行试点 **SC-04**，把 NG-6 创新契约从抽象框架落为可运行的具体切片。试点**从 12 条边界条件中选 3 条作为最先验证的目标**（EDGE-01 轮椅/盲杖 + EDGE-05 夜间雨雪 + EDGE-09 弱网断网），针对这 3 条边界各生成**1 份合成工单元**（共 3 份合成工单，加 1 份控制样本 = 4 份），合成工单只触发对应边界的人工退路与停止条件，不连接真实服务、不处理真实个人数据、不发送消息、不能批准/拒绝/关闭真实事项。空间点位仍为 provisional 候选，真实运营主体、值守排班、预算、现场数据、公众参与结果和服务绩效均为 unknown `[assumption:A-OPERATIONS-001]` `[assumption:A-EDGE-START-001]`。试点目标从"验证 4 张工单可复跑"升级为"验证 3 条边界的人工退路可复跑"——后者直接对应"AI 失效时如何有人兜底"的核心命题。
...
**生态图谱（agent.2 ecosystem_map）**：以"人字新线标准层"为底座，连接算力/数据/场景/人才/资本/治理六个要素层，三极(基准/生活/产业)两翼(中关村/小月河)为节点，形成"标准→要素→节点→场景"的四层生态图谱 `[standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]`：

```
┌─────────────────────────────────────────────────────────┐
│  标准层：人字新线 NG-6 创新契约（立约/计时/接管/告知/复核/退场）  │
├──────────┬──────────┬──────────┬──────────┬──────────┬──────────┤
│  算力     │  数据     │  场景     │  人才     │  资本     │  治理     │
├──────────┴──────────┴──────────┴──────────┴──────────┴──────────┤
│  创新极(众智园)──→生活极(AI原点)──→产业极(大钟寺)               │
...
要素流向：创新极产研→生活极转化体验→产业极规模化，两翼注入资本/场景。图谱的每一层都可审计、可追溯。

**荣誉展示体系（agent.4 honor_display_system）**：沿京张人字创新主轴设荣誉展示序列——基准测试排行榜墙（众智园）、开发者贡献星谱（AI原点）、企业创新荣誉廊（大钟寺），统一视觉系统，公开可审计。均为概念建议 `[standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]`。

**公共空间组件库（agent.4 component_library）**：模块化公共空间组件，每个遵循"人字新线"统一标准（标准模数、可组合、可维护、无障碍），可部署到三区广场与绿带 `[standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]`：

| 组件 | 标准模数 | 功能 | 无障碍 |
|---|---|---|---|
| 折返线座椅 | "人"字形折返线母题 | 休息、社交、观察 | 轮椅可达、扶手 |
...
以"从标准轨距到AI人字新线"为叙事主线，沿遗址公园约9km绿带 `[source:HERITAGE-PARK]` 设五段故事节点，每段配独立的导视类型与符号语言：
...
| ⑤ 百年传承 | 遗址公园北端 | 纪念碑式标识 | 人字新线符号+时间轴 | 耐候钢+光刻 |
...
- 英文主张：*"The Switchback Line — setting the standard for AI-native cities, inspired by the Jing-Zhang Railway's legacy of engineering ingenuity."*
...
| 状态 | 触发条件 | AI 服务降级 | 最低服务标准 | 恢复路径 |
|---|---|---|---|---|
| **R0 正常态** | 晴天、网络通、电力通 | 全部运行 | 所有 NG-6 步骤正常 | — |
| **R1 雨天态** | 降雨>50mm/24h | 接驳/配送/自动驾驶暂停 | 物理标识+人工配送+避雨点每200m | 雨停后人工检查→恢复 |
| **R2 断网态** | 网络中断>30min | 所有 AI 场景暂停 | 物理标识+人工窗口+离线地图 | 网络恢复→重新校验→逐步恢复 |
| **R3 断电态** | 电力中断>15min | 全部暂停+备用电池 | 应急照明+人工疏散+急停可触发 | 电力恢复→设备自检→恢复 |

韧性态设计原则：最低服务不可省略；急停优先于性能；恢复须过 Gate；年度演练 `[assumption:A-GREEN-BLUE-CONCEPT-001]`。
...
用地布局见上节"五带分区"，并进一步细化为 17 子块（详见"地块级设计意图矩阵"章节）。建筑规模表达 `[depth:height_massing_character]` `[depth:retain_renovate_demolish]`：
...
**道路与慢行** `[depth:traffic_rail_slow_parking]`：京张人字创新主轴（南北贯通）+4条东西联络道（概念建议 `[data:geometry/roads.geojson]`），主轴长 `[metric:road_centerline_length_m]`。慢行系统沿绿带与公共空间串联三区，全龄友好。
...
**公共空间**：新轨中央广场 `[data:geometry/public_space.geojson#PS-001]` + 三区广场（创新极/生活极/产业极广场），公共空间率 `[metric:public_space_ratio]`。

**AI朝圣地标（agent.4，≥3个）**——均为概念建议，须清权，不写成已批准建设 `[standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]`：

1. **人字线纪念碑**——位于中央广场，以"人"字形折返线为母题的极简工程艺术装置，象征"人字新线"。
2. **人字线体验馆**——位于AI原点社区，铁路遗产+AI历史的可体验节点。
3. **基准测试场观景台**——位于众智园，可观摩AI基准测试的公共荣誉展示节点。

**城市风貌**：以工程蓝+琥珀色为基调，强调技术图解、仪表盘、蓝图风格，避免过度娱乐化/网红化 `[standard:MOHURD-URBAN-DESIGN-MEASURES]`。

### 人字新线服务契约 NG-6（可实施性核心机制）
...
NG-6 将 12 张场景卡（S1–S12）统一纳入服务契约框架：每张卡的服务蓝图必须覆盖这六步。这使得"人字新线"不仅是空间概念，更是一套**可操作的城市 AI 公共契约标准**——呼应京张铁路"采用开放标准 + 工程创新"的精神。该契约为概念建议，具体合规须依据《个人信息保护法》《数据安全法》等及专业法律审查 `[assumption:A-AI-GOVERNANCE-001]`。

## C01-C10 可委托、可验收、可否决工作包

`visual/assets/delivery_contracts.json` 把现实缺口转成 **C01—C10 十个可委托、可验收、可否决工作包**——不把准备好的委托范围误写成已经取得的现场证据。每包独立可激活/可暂停/可退出，与 G0-G4 五道门配合使用。所有数量/机构/金额/授权均保持 `unconfirmed` / `null` / `not_started` `[depth:implementation_policy]` `[depth:renewal_project_list]`。

| 包 | 内容 | 责任角色类型 | 否决条件 |
|---|---|---|---|
| **C01** | 正式几何与资料请求 | 政府规划主管部门 | 官方红线未补齐 → 整包 HOLD |
| **C02** | 责任机构与授权确认 | 政府+企业联盟+社区 | 任一主体未签字 → G2 不激活 |
| **C03** | 权属、文保、消防三线核查 | 文保+消防+规划 | 三线任一冲突 → G1 不通过 |
| **C04** | 实测人流量与无障碍动线 | 独立专业团队 | 6 类无障碍任一不达标 → G3 不开 |
| **C05** | 市政、防洪、能源网络容量 | 市政+能源公司 | 容量未达 → 试点不开 |
| **C06** | 数据隐私与 AI 安全审查 | 法务+伦理委员会 | 任一未审 → G3 不激活 |
| **C07** | 公共利益共测（6 类人群） | 居民+残障+老人代表 | 最弱 20% 体验连续 2 周恶化 → PAUSE |
| **C08** | 工程量/规格/全周期成本 | 工程造价咨询 | 实测+可比询价<2 项 → 不计算预算 |
| **C09** | 采购、保险、运营、5 区接口 | 采购+法务 | 任一未签 → G3 不开 |
| **C10** | 综合 Go/No-Go 与 G2 演练 | 治理联合体 | 任一项缺失 → 整包 HOLD |

**就绪梯度**（明确分层，禁止越级）：

- **T0**：规则与合成复演完成（当前状态）
- **T1**：C01-C10 全部 NOT_BLOCKED，可启动案头审查和演练设计
- **T2**：专业委任、实测、结论、工程量、询价和签认尚未启动
- **T3**：采购、施工、真实数据、招募和 G3 现场试点关闭——C01-C10 全部完成且 G2 演练通过前不得进入

每包另有一张实施前置表——场地/权利证据、候选责任方确认方法、必需专业、授权文件、基线与最小样本、资本/运营/维护/撤除恢复费用、关闭条件。表格字段在 `visual/assets/delivery_contracts.json` 的 `implementation_preflight` 字段；所有单元均保持 `not_started` 或 `unconfirmed`，不填写机构名称和虚假金额 `[assumption:A-IMPLEMENTATION-001]`。

## 人字线 Tabletop 重放包

`visual/assets/tabletop_cases.json` 是**零网络+零个人数据+零现场输入**的离线桌面演练包。每张场景卡（S1-S12）生成 1 个全字段合成通过分支 + 1 个拒绝/暂停分支，**12 张场景卡 = 24 个案例** `[depth:ai_scenario_service_nodes]`。

```
T01-PASS / T01-REJ   (S1 算力调度与基准测试)
T02-PASS / T02-REJ   (S2 开源共创工坊)
T03-PASS / T03-REJ   (S3 AI+轨道接驳导航)
T04-PASS / T04-REJ   (S4 全龄友好慢行导引)
T05-PASS / T05-REJ   (S5 AI+社区健康驿站)
T06-PASS / T06-REJ   (S6 AI+教育便民节点)
T07-PASS / T07-REJ   (S7 智能原生消费体验)
T08-PASS / T08-REJ   (S8 机器人低速配送试点)
T09-PASS / T09-REJ   (S9 自动驾驶接驳试点)
T10-PASS / T10-REJ   (S10 京张遗产AI导览)
T11-PASS / T11-REJ   (S11 城市智能体治理看板)
T12-PASS / T12-REJ   (S12 开发者社区活动场地)
```

**每个案例包含**：

- `inputs`：合成数据源 + 隔离沙箱 + 人工 Gate 主体（`unconfirmed`）
- `expected_outcome`：PASS / REJECT / PAUSE / ESCALATE / STOP / ROLLBACK / REPLACE
- `verifiable_fields`：可机器核验字段（数据来源、人工签注、回滚路径、暂停/恢复证据）
- `evidence_artifacts`：可指向的具体工件（`sc04-relay-receipt.json`、`evidence-ledger.json`、`tabletop_cases.json`）

**执行环境硬约束**（机器可验证）：

- `network`: `offline`（无网络）
- `real_personal_data`: `none`（无真实个人数据）
- `real_field_data`: `none`（无真实现场数据）
- `real_services_connected`: `none`（无真实服务接入）
- `messages_sent`: `none`（不发送消息）
- `field_runs`: `0`（零现场运行）

**证据边界**：本包仅证明参与者编写的规则和回执格式可执行；**不证明现场验证、无障碍合规、产品认证、政府审批或实施授权** `[assumption:A-EVIDENCE-001]` `[assumption:A-OPERATIONS-001]`。
...
| P4 京张人字创新主轴慢行 | 中期 | 交通专项+安全审计 | 交通+市政 | 中 | 交通安全+无障碍 | 无障碍连通率 | 事故→停车+审查 | 交通运营 |
...
- **年度活动体系**：人字新线峰会（年度）、基准测试开放周、开发者大会、AI朝圣节。
- **活动品牌**：The Switchback Line，统一视觉系统。
- **开发者社区运营机制**：开源共创仓库、场景开放申请-测试-复核-回滚流程、基准排行榜、贡献者荣誉积分。
- **场景开放运营**：12张场景卡每张含开放→测试→人工复核→放行→可回滚的运营闭环。
- **治理结构（概念）**：建议设"人字新线共治理事会"（政府+企业+社区+公众+AI代理观察员），重大决策人工判断、可审计、可回滚。
...
在 provisional 边界 + 缺控规 + 缺现状测绘的条件下，"每项都做到最高"既不可核验也难以实施。本方案采用**"最低后悔"优先级原则**——不追求单项最优，而是确保**最弱体验达标**，把有限的确定性用在"避免最差结果"上 `[depth:phasing_implementation]` `[depth:risk_missing_data]`。

**判断标准**：对 17 子块的每个设计决策，问的不是"能做到多好"，而是"最差会怎样"——如果最差情况可接受（有兜底、可回滚、不伤害弱势群体）则推进；如果最差情况不可接受（无兜底、不可逆、伤害公共利益）则降级或停止。

| 优先级 | 判断标准 | 对应子块示例 | 实施策略 |
|---|---|---|---|
| **P-确保** | 最差=有物理兜底、可回滚、不伤害弱势群体 | GRN-B1 遗产公园（物理导览兜底）、LIFE-D2 社区中心（人工窗口兜底） | 近期优先，不依赖 AI 成熟度 |
| **P-条件** | 最差=AI 失效降级为人工，但需额外运营成本 | INNO-A2 算力中心、IND-C1 总部基地 | 中期实施，前置=运营主体+成本确认 |
| **P-试点** | 最差=AI 失效且人工兜底困难，需严格 geofence | S8 机器人配送、S9 自动驾驶 | 仅 SC-04 级最小试点，G0-G6 全过才扩容 |

这与詹天佑"人字形折返线"的工程智慧一致——他没有追求最短路径或最高速度，而是选择了**最可靠**的方案来攻克陡坡 `[source:HISTORY-ZHAN-TIANYOU]`。AI 人字线的第一原则同样如此：**最可靠，而非最高性能**。
...
| **T2 SC-04 试点** | Year 1-3 | SC-04 Relay Receipt G0-G4 通过、3 条边界（EDGE-01/05/09）+ 1 份控制样本 = 4 份合成工单测试完成 | 算力联盟（概念）+ 治理联合体 | G2-G4 数据/权限/人工 Gate | 任一 Gate 缺证据→保持沙箱 |
| **T3 创新极启动** | Year 2-4 | 众智园基准测试场（INNO-A3）+ 共享算力中心（INNO-A2）建成 | 园区+企业联盟 | G5 限域试用（SC-04 通过后） | 达标率不达标→降级试点 |
| **T4 生活极推进** | Year 3-5 | AI 原点社区便民节点（LIFE-D2）+ 慢行主轴贯通 | 社区+卫生/教育机构 | G0-G4 + 居民参与基线 | 隐私违规→暂停+整改 |
| **T5 产业极深化** | Year 4-7 | 大钟寺产业更新（IND-C1/C2）+ 两翼道岔协同 | 业主+企业+协同园区 | G5 + 商业意愿确认 | 市场不达→延期 |
...
### 成本量级估算（order-of-magnitude，非工程预算）

基于公开城市建设造价基准给出**量级范围**（非工程预算，不虚构精确金额），用于判断项目可行性的数量级 `[depth:phasing_implementation]` `[assumption:A-IMPLEMENTATION-001]`：

| 子块类型 | 单价量级（RMB/m²，含建设+基本配套） | 对应子块 | 近期优先级 |
|---|---|---|---|
| 绿地与公园 | 300-800 | GRN-B1/B2/B3 | P-确保 |
| 慢行与公共空间 | 1,500-4,000 | 各区广场、主轴慢行道 | P-确保 |
| 道路与市政（含机器人兼容断面） | 3,000-6,000 | INF-E1/E3 | P-条件 |
| 算力机房（地下，含冷却+电力） | 15,000-30,000 | INNO-A2、INF-E2 | P-条件 |
| 研发办公（地面，中层） | 8,000-15,000 | INNO-A1/A3/A4 | P-条件 |
| 产业商业（改造更新） | 5,000-12,000 | IND-C1/C2/C3/C4 | P-条件 |
| 居住社区 | 6,000-12,000 | LIFE-D1/D2/D3 | P-条件 |

**三期总量级**（provisional 面积 × 单价中值，仅供数量级判断）：

- **近期（T1-T2，~5 km² 绿带+慢行+试点）**：量级约 50-150 亿元——以绿地、慢行和 SC-04 最小试点为主，资本强度低、可快速启动。
- **中期（T3-T4，~3.3 km² 算力+研发+社区）**：量级约 200-500 亿元——算力机房与研发载体是资本密集项，需企业联盟投资+政府配套。
- **远期（T5，~3.1 km² 产业更新+两翼）**：量级约 100-300 亿元——以商业改造和协同发展为主，依赖市场意愿。
...
7 个评审维度各自指向 **3 个首要证据入口**——共 21 条可追溯路径。**每条路径都可在工件中机器核验** `[standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]` `[depth:risk_missing_data]`：

| 评审维度 | 首要证据 1 | 首要证据 2 | 首要证据 3 |
|---|---|---|---|
...
把任务书 agent.1–agent.6 与公告"三大定位 / 五大功能 / 三区两翼 / 共创公约 / 未来城市形态"逐条拆开，再把本方案的对应机制一格一格对回去——避免"概念沾边"而不能机器追溯。本表只列本方案新增的、可在工件中直接核验的承接机制，不重复任务书原文 `[standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]`：

| 任务书条目 | 任务书关键词 | 本方案承接机制 | 直接证据工件 | 可核验字段 |
|---|---|---|---|---|
| agent.1 logo_or_visual_identity_direction | 视觉识别方向 | 三色VI（工程蓝#1d4ed8 / 琥珀#b45309 / 石板灰#475569）+ 三极子色 | `proposal.md` §Logo与视觉识别系统方向 | 主色 hex、子色 hex、禁用项清单 |
| agent.2 ecosystem_map | 生态图谱 | 四层图谱（标准→要素→节点→场景）+ 七国/地区案例转译 | `proposal.md` §AI 创新生态图谱与 agent 交付物 | 6 要素层名称、7 案例来源链接 |
| agent.3 personas+scenarios | 用户画像≥5 + 场景卡≥10（≥3 产业测试） | 6 类用户画像 + 14 场景卡（含 S7 智能原生消费 / S8 机器人低速 / S9 自动驾驶三产业测试） | `proposal.md` §场景到专业责任锁定 + `visual/assets/scenario_professional_review_matrix.json` | persona_count=6, scenario_count=14, industry_test_count=3 |
| agent.4 honor_display_system | 荣誉展示体系 | 主轴三段荣誉（基准测试排行榜墙 / 开发者贡献星谱 / 企业创新荣誉廊） | `proposal.md` §荣誉展示体系 | 三段命名、对应子片区 |
| agent.4 component_library | 公共空间组件库 | 6 组件（折返线座椅 / 标准铺装 / AI 导览桩 / 可移动单元 / 无障碍坡道 / 智能照明杆） | `proposal.md` §公共空间组件库 | component_count=6, 无障碍字段每组件齐全 |
| agent.5 signage_system_direction + spatial_storyline | 文化导视 + 空间故事线 | 沿遗址公园 9km 五段故事节点 + 无障碍多模态 | `proposal.md` §文化导视与空间故事线 | 故事段数=5, 多模态覆盖语音/大字/触觉 |
| agent.5 international_communication_copy | 国际传播文案 | "The Switchback Line"英文主张 + 詹天佑→AI 标准共建叙事 | `proposal.md` §国际传播文案方向 | slogan_en, narrative_thread |
| agent.6 long_term_operations | 长期运营治理 | 年度活动体系（人字新线峰会 / 开放周 / 开发者大会 / 朝圣节）+ 共治理事会概念 | `proposal.md` §全球AI创新活动体系 | 活动数=4, 治理主体=5 |
| 三大定位之 1：百年京张文化带 | 文化叙事 | 人字线纪念碑 + 五段故事节点 + 1435mm 实体轨距刻线 | `proposal.md` §文化导视与空间故事线 + 朝圣地标清单 | 朝圣地标数=3 |
| 三大定位之 2：都市AI生活体验带 | 生活体验 | 生活极·AI原点 ③ 体验型零售带 + S5/S6/S7 场景 + 非数字替代 | `proposal.md` §北京AI原点社区 §14场景锁定表 | 场景 S5/S6/S7 锁定 + 人工兜底 |
| 三大定位之 3：AI融合创新带 | 产业转化 | 创新极→生活极→产业极主轴 + 中关村/小月河两翼 + S1/S2/S3 场景 | `proposal.md` §三区两翼协同回路 + 区域协同表 | 三极命名、两翼命名、6 协同对象 |
| 五大功能之 AI 全栈自主创新 | 基准/算力 | S1 算力调度与基准测试 + INNO-A2 共享算力中心 + SC-04 试点 | `proposal.md` §最小可执行试点 + §场景锁定 + `visual/assets/sc04-relay-receipt.json` | SC-04 G0-G4 Gate 状态 |
| 五大功能之 世界级 AI 创新生态 | 要素协同 | 生态图谱四层 + 7 国案例转译 + 京津冀协同 5 对象 | `proposal.md` §生态图谱 §区域协同与京津冀 | 案例数=7, 协同对象=5 |
| 五大功能之 AI+场景赋能新范式 | 14 场景卡 | 14 场景 × 7 字段矩阵（含空间原型 / 最小数据 / 人工 Gate / G1-G2 角色 / 暂停线 / 恢复证据） | `visual/assets/scenario_professional_review_matrix.json` | 14/14 完整字段 |
| 五大功能之 智能化 AI 活力城市 | 公共空间+蓝绿 | GRN-B1 9km 主轴 + GRN-B2 三区绿环 + 6 公共空间组件 | `proposal.md` §蓝绿空间 §公共空间组件库 | 绿带面积、绿地率、组件数=6 |
| 五大功能之 AI 治理全球话语权 | 共创公约 | NG-6 六步 + 公平账本 + R0-R3 韧性态 + 共治理事会 | `proposal.md` §NG-6 §公平账本 §R0-R3 §致谢 | NG-6 步骤=6, ledger 字段=6 |
| 新城市形态：AI 文化/社会/城市 | 未来城市形态 | 一轴三极两翼空间结构 + 17 子块 + 9 子片区 + 14 场景卡 | `proposal.md` §地块级设计意图矩阵 §三区九子片区深化 | 子块数=17, 子片区数=9 |
| 公共利益：青年友好 | 人才与社区 | LIFE-D1 人才公寓 + LIFE-D2 混合社区中心 + 开发者社区活动场地 S12 | `proposal.md` §三区九子片区 + §14场景 S12 | 居住子块 + S12 场景 |
| 公共利益：公共空间活化 | 主轴+绿环 | 主轴中央广场 PS-001 + 三区广场 PS-002/003/004 + 6 组件 | `proposal.md` §公共空间 §公共空间组件库 | 广场数=4, 组件数=6 |
| 公共利益：东西缝合 | 跨走廊 | 京张遗址公园绿带（南北）+ 4 条东西联络道 + INF-E1 主轴 | `proposal.md` §交通慢行 §蓝绿空间 | 主轴长度、东西道=4 |
| 公共利益：南北连通 | 主轴贯通 | 京张人字创新主轴贯穿三区（北/中/南） | `proposal.md` §三区两翼协同 | 主轴命名、三区序列 |
| 共创公约与边界声明 | 边界 | 资料分级（usable_for_formal=yes / provisional_only）+ 官方承诺禁用 + 版权台账 | `proposal.md` §资料分级 §风险版权 §致谢 | sources.json 等级 + copyright_statement.md |
| 多模态表达 | 图/视/音/3D | 6 figures + 4 PDFs + 视觉系统（Logo/VI/导视/故事线/荣誉墙/朝圣节） | `proposal.md` §七维证据地图 表行 表达完整度 | figures=6, drawings=4 |

**承接-缺口声明**（诚实标注）：任务书 agent.4 "≥3 个 AI 朝圣地标"已落 3 项（人字线纪念碑 / 体验馆 / 基准测试场观景台），但其物理形态与清权细节属于"待深化建议"；任务书 agent.5 "国际传播文案"仅给主张方向，未提交最终译稿——均按任务书"概念建议"层级处理，不伪装为已审定结论 `[assumption:A-BRIEF-MAPPING-001]`。

## 命名主体、可量 KPI 与可触发节点（implementation_feasibility 升级）

把 v7.0 的 P1-P6 项目组合与 T0-T5 时间线从"概念级 + 角色类型"升级到**"命名主体类型 + 候选机构类别 + KPI 量级 + 触发节点 + 退出门槛"**——这是"可实施性"评审维度最常缺失的部分。本节不虚构具体单位名称或金额，所有字段保留 `to_be_confirmed` / 量级范围 / 公开基准口径 `[assumption:A-IMPLEMENTATION-001]` `[assumption:A-OPERATIONS-001]` `[depth:phasing_implementation]`。

**主体类型表**（六类，不写机构名，仅写主体类型与必备签字）：

| 主体类型 | 必备角色 | 签字对象 | 当前状态 |
|---|---|---|---|
| 政府规划主管部门 | 红线与控规权威 | C01 红线请求 | `unconfirmed` |
| 政府+企业联盟+社区三方 | 任一未签字则 G2 不激活 | C02 责任机构 | `unconfirmed` |
| 文保+消防+规划三线 | 三线冲突→G1 不通过 | C03 三线核查 | `unconfirmed` |
| 独立专业团队 | 6 类无障碍任一不达标→G3 不开 | C04 实测 | `unconfirmed` |
| 市政+能源公司 | 容量未达→试点不开 | C05 网络容量 | `unconfirmed` |
| 法务+伦理委员会 | 任一未审→G3 不激活 | C06 数据审查 | `unconfirmed` |
| 居民+残障+老人代表 | 最弱 20% 体验连续 2 周恶化→PAUSE | C07 公共利益共测 | `unconfirmed` |
| 治理联合体（5 方） | 任一项缺失→整包 HOLD | C10 综合 Go/No-Go | `unconfirmed` |

**P1-P6 升级版（量级 + 触发节点 + 退出门槛）**：

| 项目 | 期 | 候选主体类型 | 启动触发节点 | 退出门槛 | KPI（示例，量级） | 量级成本带（RMB） |
|---|---|---|---|---|---|---|
| P1 众智园基准测试场 | 近期 | 园区+企业联盟+算力联盟 | 官方边界补齐 + 算力环评通过 + 控规落实 | 基准复现率<90% 连续 2 周 | 基准复现率≥95% / 算力利用率≥70% / 风险预警准确率 | 30-80 亿（INNO-A2/A3 算力机房+测试场） |
| P2 中央绿带贯通 | 近期 | 园林+文保+市政 | 文保三线核查通过 + 海绵水文模型完成 | 文保冲突→调整线位 | 连通率+绿地率+无障碍主链连通率 | 5-15 亿（GRN-B1/B2 绿带+驿站） |
| P3 AI原点社区便民节点 | 中期 | 社区+卫生/教育+物业 | 居民参与基线建立 + 儿童数据合规审查通过 | 隐私违规→暂停+整改 | 预筛准确率 / 儿童数据合规率 / 申诉响应时长 | 10-30 亿（LIFE-D2/D3 节点+改造） |
| P4 京张人字创新主轴慢行 | 中期 | 交通+市政+园林 | 交通专项确认 + 安全审计通过 | 事故→停车+审查 | 接驳等待时间 / 无障碍连通率 / 安全里程 | 15-40 亿（INF-E1 主轴慢行+站点） |
| P5 大钟寺产业更新 | 远期 | 业主+企业+商业运营 | 权属确认 + 商业意愿确认 + 消防通过 | 市场不达→延期 | 入驻率 / 转化率 / 消费满意度 | 80-200 亿（IND-C1/C2/C3/C4 改造） |
| P6 两翼道岔(中关村/小月河) | 远期 | 协同园区+联合体 | 协同主体确认 + 接口标准达成 | 协同不达→收缩 | 协同项目数 / 算力调度次数 | 20-60 亿（两翼接口+场景测试） |

**三时段总量级**（基于公开基准推算，仅供数量级判断）：

- **近期（T1-T2，~5 km² 绿带+慢行+试点）**：约 50-150 亿元——绿地、慢行与 SC-04 最小试点为主，资本强度低、可快速启动
- **中期（T3-T4，~3.3 km² 算力+研发+社区）**：约 200-500 亿元——算力机房与研发载体资本密集，需企业联盟+政府配套
- **远期（T5，~3.1 km² 产业更新+两翼）**：约 100-300 亿元——以商业改造与协同发展为主，依赖市场意愿
- **三期合计**：约 350-950 亿元（量级区间，公开基准口径，非工程预算）

**Go/No-Go 触发节点**（机器可追溯）：

1. **G0→G1 触发**：C01 红线请求有官方回函 + provisional 边界补齐 + 6 类无障碍初步筛查通过
2. **G2→G3 触发**：C02 三方签字齐全 + C03 三线核查通过 + C05 市政/能源/防洪容量确认 + C06 法务伦理通过
3. **G3→G4 触发**：C04 6 类人群实测基线建立 + C07 公共利益共测首轮反馈 + C08 工程量/规格/询价≥2 项
4. **G4→G5 触发**：C09 采购/保险/5 区接口齐备 + C10 综合 Go/No-Go 通过 + SC-04 G0-G4 全部有证据
5. **G5→G6 触发**：试点期满评估 + 公平账本季度复核通过 + 最弱 20% 体验未连续恶化

**诚实约束**（未掩盖）：上述量级为公开基准推算的**数量级**，非工程概算或投资承诺；机构名称、保险费率、采购清单均待主体确认 `[assumption:A-IMPLEMENTATION-001]` `[assumption:A-OPERATIONS-001]`。所有"主体类型"仅为公开口径的角色分类，不指向具体单位、不构成委托要约。
...
**叙事准确性说明**：1435mm标准轨距源于Stephenson、1937年UIC正式确立的国际标准，京张铁路采用此标准。詹天佑的标志性工程创新是青龙桥"人"字形折返线（攻克八达岭陡坡）和竖井法隧道掘进 `[source:HISTORY-ZHAN-TIANYOU]`。本方案"人字新线"母题的核心不是"首创轨距"，而是承接京张**用工程智慧解决难题、为后代留下标准**的开拓精神 `[assumption:A-SOURCE-REGISTRY-001]`。
...
|---|---|---|---|---|
| 京张准点城 ON-TIME JINGZHANG | [#458](https://github.com/open-city-ai/haidian/pull/458) `submissions/to-real/jingzhang-on-time-city` | to-real | JZ-TIME 6 服务时限契约（Declare/Time/Handoff/Notify/Review/Sunset） | 转化为本方案的 **NG-6 人字新线服务契约**，用"创新/工程"隐喻重述服务时限，适配"人字新线"概念 |
...
本方案的核心概念（京张人字新线/The Switchback Line、一轴三极两翼、创新极/生活极/产业极命名体系）、全部 GeoJSON 几何、指标复算、图面与 PDF 均为独立生成。上述致谢仅涉及机制思路的启发与学习，符合共创公约的"公开资料边界"与"贡献可记忆"原则 `[standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]`。
