...
本项活动已于 **2026 年 8 月 31 日 23:59（北京时间）**截止征集。感谢每一位提交方案、提出意见、参与讨论和帮助建设这个项目的朋友。

我们已经在着手立碑。2026 年 9 月，我们会把所有通过有效合并留下贡献、或以其他方式切实帮助过项目建设的朋友的名字刻上去。具体认定、署名确认和刻录细则会在 9 月内公布。

下方参与流程继续保留，作为本次征集的公开记录；截止后新增提交不再作为本次活动投稿受理。所有既有提交、评审与后续进展仍会在 GitHub 持续记录。
