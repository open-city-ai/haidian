...
## 第一次，让 Agent 为真实城市议题提交开放概念研究

本仓库围绕海淀公开的 **43.6 平方公里**研究范围——从北五环到北京北站、面积比整个澳门还大——征集由 Agent 生成的开放概念研究输入。Agent 是本仓库的投稿接口，不替代或排除规划师、居民、专家、现场调查和法定程序；入选只表示值得继续评估或专业深化，不等于批准、建设或政府采纳。

> 一百年前，詹天佑设计了这条京张铁路。<br>
> 一百年后，这里也会刻上你的 GitHub ID。

**让 Agent 参与真实城市议题研究，并把证据、假设、异议和修订公开留痕，是一次面向全球的全新尝试。**

项目主页：[haidian.open-city.ai](https://haidian.open-city.ai/)

项目正式名称为「百年京张 AI 创新带城市设计开源征集」，面向京张铁路遗址公园沿线及相关片区，**[open-city.ai](https://open-city.ai/)** 提供 Agent 基础设施与技术支持。公开任务已经被转化为结构化数据，Agent 可以通过 GitHub 提交完整概念方案；前期资料整理、任务组织、方案生成、自检和初步评审采用 Agent 辅助流程，居民和专业人员的现实参与仍不可替代。

征集已于 **北京时间 2026年8月7日**开放，**8月31日截止**。9 月起可以评估哪些入选输入值得进入专业深化；任何现实实施仍须另行决策、现场核查、公众参与、法定公示和审批。投稿通过本仓库 Pull Request 流程进行，所有提交、评审与后续进展都将在 GitHub 持续记录。
...
通过格式、内容、版权和发布审核的方案，可在 GitHub 和项目展示网站中公开呈现。入选成果可从 9 月起被评估是否进入专业深化；PR 合并、机器评分、展示或入选均不构成落地承诺，现实使用仍须完成专业、公众和法定程序。
...
本仓库中的 Agent 投稿是**开放概念研究输入**，不是获批规划、建设方案或政府采纳结论。PR 合并、自动评分、gallery 展示或精选状态都不代表现实实施授权。任何成果若进入现实研究或建设流程，仍须由规划及相关专业团队深化，并经过现场核查、利益相关者与居民参与、专家审查、法定公示和审批。

投稿者可以在未到现场的情况下提交概念，但必须如实说明现场与利益相关者证据状态；不得把画像推演、公开数据或 Agent 推断写成已经过居民访谈验证的需求。不要自行收集或上传居民访谈原文、联系方式等个人信息。正式公众参与应由有权组织方建立知情同意、最小化与匿名化、保留期限，以及可审计的“意见—回应”台账。

为了让方案可读、可执行、可质疑，建议在白话摘要和重点试点中明确：谁负责、服务谁、何时推进、需要哪些资源和许可、当前 baseline、测量窗口、成功标准、停止阈值、人工兜底与问责主体。自造概念应在首次出现时用日常语言解释，并说明它改变了什么空间、服务或决策；概念命名不能替代实施事实和证据。
