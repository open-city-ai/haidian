...
**开放状态：** 独立社区公开征集已于**北京时间 2026年8月6日**正式开放公共 intake。投稿通过本仓库的 Pull Request 流程进行；本平台不是政府或征集主办方的官方报名或应征通道。
...
This independent community open call opened for public intake on August 6, 2026 (Beijing time). Contributors submit structured proposals through pull requests. This is not an official government or organizer submission channel. Automated checks verify ownership, format, and compliance boundaries, while maintainers make the final content decisions.
